...
test('2D and 3D KML panels bind session expiry before account recovery and expose sync status', async () => {
  ...
  assert.ok(mapInit.indexOf('bindAccountSessionExpiry(map)') < mapInit.indexOf('loadInitialKmlFiles()'))
  assert.ok(map3dInit.indexOf('bindAccountSessionExpiry3d()') < map3dInit.indexOf('loadInitialKmlFiles()'))
