...
- [用户体系、角色权限、个人空间与多 KML 分享需求](./user-system-rbac-and-multi-kml-sharing.md)（核心功能已实施，验收中）
- [KML 分享空间访问控制与半公开地图需求](./kml-share-spatial-access-and-semi-public-map.md)（需求评审稿，待实施）
