...
export const adminApi = {
  ...
  cachePolicy: () => requestAdminApi('/admin/cache/policy'),
  updateCachePolicy: (body) => requestAdminApi('/admin/cache/policy', { method: 'PUT', body }),
  reconcileCacheIndex: (body = {}) => requestAdminApi('/admin/cache/index/reconcile', { method: 'POST', body }),
  previewCacheCleanup: (body) => requestAdminApi('/admin/cache/cleanup/preview', { method: 'POST', body }),
  createCacheCleanupJob: (body) => requestAdminApi('/admin/cache/cleanup/jobs', { method: 'POST', body }),
  cacheCleanupJobs: (params = {}) => requestAdminApi(`/admin/cache/cleanup/jobs${queryString(params)}`),
  cancelCacheCleanupJob: (id) => requestAdminApi(`/admin/cache/cleanup/jobs/${encodeURIComponent(id)}/cancel`, { method: 'POST' }),
  analyzeCacheKeyPolicy: (body) => requestAdminApi('/admin/cache/key-analysis', { method: 'POST', body }),
  cacheKeyPolicies: () => requestAdminApi('/admin/cache/key-policies'),
  updateCacheKeyPolicy: (sourceId, body) => requestAdminApi(`/admin/cache/key-policies/${encodeURIComponent(sourceId)}`, { method: 'PUT', body }),
  ...
  interactionAiSettings: () => requestAdminApi('/admin/moderation/ai/settings'),
  updateInteractionAiSettings: (body) => requestAdminApi('/admin/moderation/ai/settings', { method: 'PUT', body }),
  previewInteractionAiImpact: (body) => requestAdminApi('/admin/moderation/ai/impact-preview', { method: 'POST', body }),
  interactionAiPrompts: () => requestAdminApi('/admin/moderation/ai/prompts'),
  createInteractionAiPrompt: (body) => requestAdminApi('/admin/moderation/ai/prompts', { method: 'POST', body }),
  ...
  previewInteractionKeywords: (body) => requestAdminApi('/admin/moderation/keywords/preview', { method: 'POST', body }),
  replayInteractionModerationEvents: (body = {}) => requestAdminApi('/admin/moderation/events/replay', { method: 'POST', body }),
  replayInteractionAiReview: (id) => requestAdminApi(`/admin/comments/${encodeURIComponent(id)}/ai-replay`, { method: 'POST', body: {} }),
  interactionAiProviders: () => requestAdminApi('/admin/moderation/providers'),
  createInteractionAiProvider: (body) => requestAdminApi('/admin/moderation/providers', { method: 'POST', body }),
  updateInteractionAiProvider: (body) => requestAdminApi('/admin/moderation/providers', { method: 'PUT', body }),
  verifyInteractionAiProvider: (id) => requestAdminApi(`/admin/moderation/providers/${encodeURIComponent(id)}/verify`, { method: 'POST', body: {} }),
  setDefaultInteractionAiProvider: (id) => requestAdminApi(`/admin/moderation/providers/${encodeURIComponent(id)}/default`, { method: 'POST', body: {} }),
  artalkStatus: () => requestAdminApi('/admin/comment-providers/artalk/status'),
  verifyArtalk: () => requestAdminApi('/admin/comment-providers/artalk/verify', { method: 'POST', body: {} }),
  drainArtalk: (body = {}) => requestAdminApi('/admin/comment-providers/artalk/drain', { method: 'POST', body }),
}
