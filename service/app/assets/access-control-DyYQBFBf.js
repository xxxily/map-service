...
`)}var Bt=/^\d{10,32}$/,Vt=/^[A-Za-z0-9_-]{4,100}$/;function Ht(e){let t=String(e||``).trim();for(;/^[<([{"'“‘]+/.test(t);)t=t.slice(1);for(;/[>),.;:!?，。；：！？、\]}"'”’]+$/.test(t);)t=t.slice(0,-1);return t.trim()}function Ut(e){let t=Ht(e);if(!t)return null;try{let e=new URL(t);return e.protocol!==`https:`||e.username||e.password||e.port?null:(e.hostname=e.hostname.toLowerCase().replace(/\.$/,``),e)}catch{return null}}function Wt(e){let t=new URL(e);if(t.hash=``,t.hostname===`v.douyin.com`){t.search=``;let e=t.pathname.split(`/`).filter(Boolean);if(e.length!==1)return``;let n=e[0]||``;return Vt.test(n)?(t.pathname=`/${n}/`,t.toString()):``}let n=Gt(t);return n?Kt(n):``}function Gt(e){let t=e.hostname.toLowerCase(),n=``;return t===`open.douyin.com`&&e.pathname===`/player/video`?n=e.searchParams.get(`vid`)||``:t===`douyin.com`||t===`www.douyin.com`?n=/^\/video\/(\d+)\/?$/i.exec(e.pathname)?.[1]||``:(t===`iesdouyin.com`||t===`www.iesdouyin.com`)&&(n=/^\/share\/video\/(\d+)\/?$/i.exec(e.pathname)?.[1]||``),Bt.test(n)?n:``}function Kt(e){return`https://www.douyin.com/video/${e}`}function qt(e){return`https://open.douyin.com/player/video?vid=${e}`}function U(e){let t=new URL(qt(e));return t.searchParams.set(`width`,`100vw`),t.searchParams.set(`height`,`100vh`),t.toString()}var Jt=Object.freeze({id:`douyin`,label:`抖音`,title:`抖音视频`,shortHosts:Object.freeze([`v.douyin.com`]),redirectHosts:Object.freeze([`v.douyin.com`,`douyin.com`,`www.douyin.com`,`iesdouyin.com`,`www.iesdouyin.com`]),match(e){return[`v.douyin.com`,`douyin.com`,`www.douyin.com`,`iesdouyin.com`,`www.iesdouyin.com`,`open.douyin.com`].includes(e.hostname.toLowerCase())},normalizeSourceUrl:Wt,extractResourceId:Gt,requiresServerResolution(e){return e.hostname.toLowerCase()===`v.douyin.com`&&!Gt(e)},buildCanonicalUrl:Kt,buildEmbedUrl:qt,buildPreviewUrl:U,embedPolicy:Object.freeze({sandbox:`allow-scripts allow-same-origin allow-forms allow-popups allow-popups-to-escape-sandbox allow-presentation`,referrerPolicy:`no-referrer`,allow:`autoplay; encrypted-media; picture-in-picture; fullscreen`,allowFullscreen:!0})}),W=Object.freeze([Jt]);function Yt(e){return W.find(t=>t.id===String(e||``))||null}function Xt(e){return W.find(t=>t.match(e))||null}function Zt(e,t,n=``){let r=Yt(e),i=String(t||``).trim();if(!r||r.id===`douyin`&&!Bt.test(i))return null;let a=r.buildCanonicalUrl(i),o=a,s=Ut(n);return s&&r.match(s)&&(o=r.normalizeSourceUrl(s)||a),{provider:r.id,providerLabel:r.label,mediaType:`iframe`,resourceId:i,title:r.title,sourceUrl:o,canonicalUrl:a,embedUrl:r.buildEmbedUrl(i)}}function Qt(e){let t=Ut(e);if(!t)return{recognized:!1};let n=Xt(t);if(!n)return{recognized:!1};let r=n.normalizeSourceUrl(t);if(!r)return{recognized:!1};let i=n.extractResourceId(t);return i?{recognized:!0,requiresServerResolution:!1,provider:n.id,sourceUrl:r,item:Zt(n.id,i,r)}:n.requiresServerResolution(t)?{recognized:!0,requiresServerResolution:!0,provider:n.id,sourceUrl:r,item:null}:{recognized:!1}}function $t(e,t={}){let n=Number.isSafeInteger(Number(t.limit))&&Number(t.limit)>0?Number(t.limit):10,r=String(e||``),i=/https?:\/\/[^\s<>"'`]+/gi,a=[],o=new Set,s=0,c;for(;(c=i.exec(r))!==null;){if(r.lastIndexOf(`<`,c.index)>r.lastIndexOf(`>`,c.index))continue;let e=Qt(c[0]);!e.recognized||o.has(e.sourceUrl)||(o.add(e.sourceUrl),s+=1,a.length<n&&a.push({index:c.index,rawUrl:Ht(c[0]),...e}))}return{candidates:a,supportedCount:s,truncated:s>a.length,limit:n}}function en(e){let t=String(e||``);return t.replace(/https?:\/\/[^\s<>"'`]+/gi,(e,n)=>{if(t.lastIndexOf(`<`,n)>t.lastIndexOf(`>`,n))return e;let r=Ht(e),i=Qt(r);if(!i.recognized)return e;let a=e.indexOf(r);return`${e.slice(0,a)}${i.sourceUrl}${e.slice(a+r.length)}`})}function tn(e){return String(e||``).replace(/&quot;/gi,`"`).replace(/&#39;|&apos;/gi,`'`).replace(/&lt;/gi,`<`).replace(/&gt;/gi,`>`).replace(/&amp;/gi,`&`)}function nn(e){let t={},n=/([^\s"'=<>`]+)(?:\s*=\s*(?:"([^"]*)"|'([^']*)'|([^\s"'=<>`]+)))?/g,r;for(;(r=n.exec(e))!==null;)t[r[1].toLowerCase()]=tn(r[2]??r[3]??r[4]??``);return t}function rn(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`)}function an(e){let t=Ut(e);if(!t)return null;let n=Xt(t);if(!n)return null;let r=n.extractResourceId(t);if(!r||t.hostname!==`open.douyin.com`||t.pathname!==`/player/video`)return null;let i=[...t.searchParams.keys()];if(i.length!==1||i[0]!==`vid`||t.hash)return null;let a=Zt(n.id,r);return!a||t.toString()!==a.embedUrl?null:{...a,previewUrl:n.buildPreviewUrl?.(r)||a.embedUrl,embedPolicy:{...n.embedPolicy}}}function on(e){return!e||typeof e!=`object`?null:Zt(e.provider,e.resourceId,e.sourceUrl)}function sn(e){let t=[],n=new Set,r=/<iframe\b([^>]*)>\s*<\/iframe\s*>/gi,i;for(;(i=r.exec(String(e||``)))!==null;){let e=nn(i[1]),r=e[`data-kml-share-provider`]||``;if(!r)continue;let a=an(e.src);if(!a||a.provider!==r)continue;let o=Zt(r,a.resourceId,e[`data-kml-share-source`]),s=`${o.provider}:${o.resourceId}`;n.has(s)||(n.add(s),t.push(o))}return t}function cn(e){return String(e||``).replace(/<iframe\b([^>]*)>\s*<\/iframe\s*>/gi,(e,t)=>nn(t)[`data-kml-share-provider`]?``:e).replace(/\n{3,}/g,`

`).trim()}function ln(e){let t=on(e);return t?`<iframe src="${rn(t.embedUrl)}" title="${rn(t.title)}" data-kml-share-provider="${rn(t.provider)}" data-kml-share-source="${rn(t.sourceUrl)}" data-kml-share-canonical="${rn(t.canonicalUrl)}"></iframe>`:``}function un(e,t=[]){let n=cn(e),r=new Set,i=[];return t.forEach(e=>{let t=on(e);if(!t)return;let n=`${t.provider}:${t.resourceId}`;r.has(n)||(r.add(n),i.push(ln(t)))}),[n,...i].filter(Boolean).join(`

`)}var dn=50,G=`/api/v1/kml/media`,fn=new Map([[`down-files.2bulu.com`,new Set([`/f/dn1`])]]),pn=`down-files.2bulu.com`,mn=new Set([`/f/d1`,`/f/dn1`]),hn=[`image`,`video`,`audio`,`iframe`,`link`],gn={image:`图片`,video:`视频`,audio:`音频`,iframe:`页面`,link:`链接`},_n=new Set([`jpg`,`jpeg`,`png`,`webp`,`gif`,`avif`,`bmp`,`svg`]),vn=new Set([`mp4`,`webm`,`mov`,`m4v`,`m3u8`,`ogv`]),yn=new Set([`mp3`,`wav`,`ogg`,`oga`,`m4a`,`aac`,`flac`,`opus`]),bn=new Set([`token`,`access_token`,`key`,`api_key`,`apikey`,`secret`,`password`,`signature`,`sign`,`session`,`tk`,`appid`]),xn=new Set(`address.article.aside.blockquote.div.dl.fieldset.figcaption.figure.footer.form.h1.h2.h3.h4.h5.h6.header.li.main.nav.ol.p.pre.section.table.tr.ul`.split(`.`)),Sn={amp:`&`,apos:`'`,gt:`>`,lt:`<`,nbsp:` `,quot:`"`};function Cn(e){let t=String(e||``).trim();for(;/^[<([{"'“‘]+/.test(t);)t=t.slice(1);for(;/[>),.;:!?，。；：！？、\]}"'”’]+$/.test(t);)t=t.slice(0,-1);return t.trim()}function wn(e){let t=Cn(Mn(e));if(!t)return null;try{return new URL(t)}catch{return null}}function Tn(e){let t=wn(e);if(!t||t.protocol!==`https:`||t.username||t.password||t.port&&t.port!==`443`||!fn.get(t.hostname.toLowerCase())?.has(t.pathname))return``;let n=[...t.searchParams.keys()];return n.length!==1||n[0]!==`downParams`||!t.searchParams.get(`downParams`)?``:t.toString()}function En(e){let t=Tn(e);return t?`${G}?url=${encodeURIComponent(t)}`:String(e||``)}function Dn(e){let t=e.split(`.`).map(e=>Number(e));if(t.length!==4||t.some(e=>!Number.isInteger(e)||e<0||e>255))return!1;let[n,r]=t;return n===10||n===127||n===169&&r===254||n===172&&r>=16&&r<=31||n===192&&r===168||n===0}function On(e){let t=String(e||``).toLowerCase().replace(/^\[|\]$/g,``);return!t||t===`localhost`||t.endsWith(`.localhost`)||t.endsWith(`.local`)||t===`metadata.google.internal`||t===`169.254.169.254`||Dn(t)||t===`::`||t===`::1`||t.startsWith(`fc`)||t.startsWith(`fd`)||t.startsWith(`fe80:`)?!0:t.startsWith(`::ffff:`)?Dn(t.slice(7)):!1}function kn(e){let t=new URL(e.toString());for(let e of[...t.searchParams.keys()])bn.has(e.toLowerCase())&&t.searchParams.set(e,`****`);return t.toString()}function An(e){let t=/\.([a-z0-9]+)$/i.exec(e.pathname),n=t?t[1].toLowerCase():``;return _n.has(n)?`image`:vn.has(n)?`video`:yn.has(n)?`audio`:``}function jn(e,t=[]){let n=e.hostname.toLowerCase(),r=`${e.origin}${e.pathname}`.toLowerCase();return t.some(e=>{let t=String(e||``).trim().toLowerCase();if(!t)return!1;if(t.startsWith(`https://`))return r.startsWith(t);if(t.startsWith(`*.`)){let e=t.slice(1);return n.endsWith(e)&&n!==e.slice(1)}return n===t})}function Mn(e){return String(e||``).replace(/&(#x[0-9a-f]+|#\d+|[a-z]+);/gi,(e,t)=>{let n=t.toLowerCase();if(n.startsWith(`#x`)){let t=Number.parseInt(n.slice(2),16);return Nn(t)?String.fromCodePoint(t):e}if(n.startsWith(`#`)){let t=Number.parseInt(n.slice(1),10);return Nn(t)?String.fromCodePoint(t):e}return Sn[n]??e})}function Nn(e){return Number.isInteger(e)&&e>=0&&e<=1114111&&!(e>=55296&&e<=57343)}function Pn(e){let t={},n=/([^\s"'=<>`]+)(?:\s*=\s*(?:"([^"]*)"|'([^']*)'|([^\s"'=<>`]+)))?/g,r;for(;(r=n.exec(e))!==null;)t[r[1].toLowerCase()]=Mn(r[2]??r[3]??r[4]??``);return t}function Fn(e){let t=String(e||``).toLowerCase();return t.startsWith(`image/`)?`image`:t.startsWith(`video/`)?`video`:t.startsWith(`audio/`)?`audio`:``}function In(e){let t=wn(e);return!t||t.protocol!==`https:`||t.username||t.password||On(t.hostname)?null:t}function Ln(e){return String(e||``).split(`,`)[0]?.trim().split(/\s+/)[0]||``}function Rn(e){let t=[],n=[],r=[],i=/<\s*(\/?)\s*([a-z][\w:-]*)\b([^>]*)>/gi,a,o=(e,n,r,i,a,o={})=>{e&&t.push({url:e,typeHint:n||``,tagName:r,title:i.alt||i.title||``,index:a,...o})},s=()=>{let e=r.map(e=>e.tagName).lastIndexOf(`a`);if(e===-1)return;let t=r.splice(e,1)[0],n=t.imageUrl&&(t.href===t.imageUrl||Bn(t.href,t.imageUrl));t.href&&(!t.hasImage||!n)&&o(t.href,``,`a`,t.attributes,t.index)};for(;(a=i.exec(e))!==null;){let e=!!a[1],t=a[2].toLowerCase();if(e){if(t===`a`){s();continue}let e=n.map(e=>e.tagName).lastIndexOf(t);e!==-1&&n.splice(e);continue}let i=Pn(a[3]),c=/\/\s*$/.test(a[3]);if(t===`img`){let e=i.src||Ln(i.srcset),n=r.at(-1);n&&(n.hasImage=!0,n.imageUrl||=e),o(e,`image`,t,i,a.index,{linkedUrl:n?.href||``})}else if(t===`image`){let e=i.href||i[`xlink:href`],n=r.at(-1);n&&(n.hasImage=!0,n.imageUrl||=e),o(e,`image`,t,i,a.index,{linkedUrl:n?.href||``})}else if(t===`video`||t===`audio`)o(i.src,t,t,i,a.index),c||n.push({tagName:t,type:t});else if(t===`picture`)c||n.push({tagName:t,type:`image`});else if(t===`source`){let e=n.at(-1)?.type||``;o(i.src||Ln(i.srcset),e||Fn(i.type),t,i,a.index)}else t===`iframe`?o(i.src,`iframe`,t,i,a.index,{provider:i[`data-kml-share-provider`]||``,sourceUrl:i[`data-kml-share-source`]||``,canonicalUrl:i[`data-kml-share-canonical`]||``}):t===`embed`?o(i.src,Fn(i.type),t,i,a.index):t===`object`?o(i.data,Fn(i.type),t,i,a.index):t===`a`&&r.push({tagName:t,href:i.href||``,attributes:i,index:a.index,hasImage:!1})}for(;r.length;){let e=r.pop();!e.hasImage&&e.href&&o(e.href,``,`a`,e.attributes,e.index)}return t}function zn(e){let t=e instanceof URL?e:wn(e);return t?_n.has((/\.([a-z0-9]+)$/i.exec(t.pathname)?.[1]||``).toLowerCase()):!1}function Bn(e,t){if(!e||!t||e.toString()===t.toString())return!1;let n=e instanceof URL?e:wn(e),r=t instanceof URL?t:wn(t);return!n||!r||n.protocol!==`https:`||r.protocol!==`https:`?!1:n.hostname.toLowerCase()===r.hostname.toLowerCase()&&n.pathname===r.pathname||n.hostname.toLowerCase()===pn&&r.hostname.toLowerCase()===pn&&mn.has(n.pathname)&&mn.has(r.pathname)?!0:zn(n)&&zn(r)}function Vn(e,t){return String(e||``).lastIndexOf(`<`,t)>String(e||``).lastIndexOf(`>`,t)}function Hn(e,t={}){let n=Number.isInteger(t.limit)?t.limit:dn,r=String(e||``),i=Rn(r),a=/https?:\/\/[^\s<>"'`]+/gi,o;for(;(o=a.exec(r))!==null;)Vn(r,o.index)||i.push({url:o[0],typeHint:``,tagName:``,title:``,index:o.index});i.sort((e,t)=>e.index-t.index);let s=[],c=new Map,l=!1;for(let e of i){let t=wn(e.url);if(!t)continue;let r=null;if(e.typeHint===`image`&&e.linkedUrl){let n=wn(e.linkedUrl);Bn(n,t)&&(r=t,t=n)}let i=t.toString(),a=c.get(i);if(a){!a.typeHint&&e.typeHint&&(a.typeHint=e.typeHint,a.tagName=e.tagName),!a.title&&e.title&&(a.title=e.title),!a.thumbnailUrl&&r&&(a.thumbnailUrl=r);continue}if(s.length>=n){l=!0;continue}let o={url:t,typeHint:e.typeHint,tagName:e.tagName,title:e.title,thumbnailUrl:r,provider:e.provider||``,sourceUrl:e.sourceUrl||``,canonicalUrl:e.canonicalUrl||``};s.push(o),c.set(i,o)}return{references:s,truncated:l}}function Un(e,t,n={}){let r=an(e),i=[`image`,`video`,`audio`,`iframe`].includes(n.typeHint)?n.typeHint:``,a=[`image`,`video`,`audio`].includes(i)?i:An(e)||`link`;(r||i===`iframe`||a===`link`&&jn(e,n.iframeAllowlist))&&(a=r||jn(e,n.iframeAllowlist)?`iframe`:`link`);let o=kn(e),s=a===`image`?En(o):a===`iframe`&&r?.previewUrl||o,c=a===`image`?In(n.thumbnailUrl):null,l=c?kn(c):``,u=l?En(l):``,d=``;if(r){let e=Qt(n.sourceUrl||``);d=e.recognized&&e.provider===r.provider&&(!e.item||e.item.resourceId===r.resourceId)?e.sourceUrl:r.canonicalUrl}let f=d?kn(new URL(d)):``,p=String(n.title||``).trim()||r?.title||e.hostname;return{id:`description-link-${t+1}`,type:a,title:p,description:``,url:o,renderUrl:s,displayUrl:r?.canonicalUrl||f||o,thumbnailUrl:a===`image`?u||s:``,sourceType:r?`description-share-embed`:`description-link`,...r?{provider:r.provider,resourceId:r.resourceId,sourceUrl:f,canonicalUrl:r.canonicalUrl}:{},autoplay:a===`video`,embedPolicy:a===`iframe`?r?.embedPolicy||{sandbox:`allow-scripts allow-forms allow-popups`,referrerPolicy:`no-referrer`}:null}}function Wn(e,t={}){let n=wn(e);return n?n.protocol===`https:`?On(n.hostname)?{accepted:!1,reason:`URL 主机不允许访问`}:{accepted:!0,item:Un(n,Number(t.index||0),t)}:{accepted:!1,reason:`仅支持 HTTPS URL`}:{accepted:!1,reason:`URL 格式不合法`}}function Gn(e){return new Set(e.flatMap(e=>{let t=an(e.url)?Qt(e.sourceUrl||``):null;return t?.recognized?[t.sourceUrl]:[]}))}function Kn(e,t){let n=Qt(e.url);return!e.typeHint&&n.recognized&&t.has(n.sourceUrl)}function qn(e,t={}){let{references:n,truncated:r}=Hn(e?.description||``,t),i=Gn(n),a=Xn(e?.styleUrl),o=[],s=hn.map(e=>({type:e,title:gn[e],items:[]})),c=new Map(s.map(e=>[e.type,e]));n.forEach((e,n)=>{if(Kn(e,i))return;let r=[`embed`,`object`].includes(e.tagName)&&!e.typeHint&&a===`video`?`video`:e.typeHint,s=Wn(e.url.toString(),{...t,index:n,typeHint:r,title:e.title,tagName:e.tagName,thumbnailUrl:e.thumbnailUrl,provider:e.provider,sourceUrl:e.sourceUrl,canonicalUrl:e.canonicalUrl});if(!s.accepted){o.push({url:kn(e.url),reason:s.reason});return}c.get(s.item.type)?.items.push(s.item)});let l={imageCount:c.get(`image`).items.length,videoCount:c.get(`video`).items.length,audioCount:c.get(`audio`).items.length,iframeCount:c.get(`iframe`).items.length,linkCount:c.get(`link`).items.length};return l.hasRichContent=hn.some(e=>c.get(e).items.length>0),{featureId:String(e?.id||``),groups:s,contentSummary:l,sourceSummary:{bindings:0,libraries:0,descriptionLinks:n.length,rejected:o.length,truncated:r},rejected:o}}function Jn(e={}){let t=[];return e.imageCount&&t.push(`${e.imageCount} 张图片`),e.videoCount&&t.push(`${e.videoCount} 个视频`),e.audioCount&&t.push(`${e.audioCount} 段音频`),e.iframeCount&&t.push(`${e.iframeCount} 个页面`),e.linkCount&&t.push(`${e.linkCount} 个链接`),t.join(` / `)}function Yn(e){let t=String(typeof e==`object`?e?.description||``:e||``);return t=t.replace(/^\s*<!\[CDATA\[([\s\S]*)\]\]>\s*$/i,`$1`),t=t.replace(/<!--[\s\S]*?-->/g,``).replace(/<(script|style)\b[^>]*>[\s\S]*?<\/\1\s*>/gi,``).replace(/<br\s*\/?>/gi,`
`).replace(/<\s*\/\s*([a-z][\w:-]*)\s*>/gi,(e,t)=>xn.has(t.toLowerCase())?`
`:``).replace(/<[^>]*>/g,``),Mn(t).replace(/\u00a0/g,` `).split(/\r?\n/).map(e=>e.replace(/[\t ]+/g,` `).trim()).filter(Boolean).join(`
`)}function Xn(e){let t=String(e||``).toLowerCase();return/(?:picture|photo|image)/.test(t)?`image`:/video/.test(t)?`video`:/(?:sound|audio)/.test(t)?`audio`:``}function Zn(e,t={}){let{references:n}=Hn(e?.description||``,t),r=Gn(n),i=n.flatMap((e,n)=>{if(Kn(e,r))return[];let i=Wn(e.url.toString(),{...t,index:n,typeHint:e.typeHint});return i.accepted?e.typeHint||i.item.type:[]}),a=Xn(e?.styleUrl);return[...new Set([a,...i].filter(Boolean))]}function Qn(e,t={}){return Zn(e,t)[0]||``}var $n=new Set([`image`,`video`,`audio`,`iframe`]);function er(e,t,n){let r=/description-link-(\d+)$/i.exec(String(e?.id||``));if(r)return Number(r[1]);let i=Number(e?.sortOrder);return Number.isFinite(i)?i:1e5+t*1e4+n}function tr(e,t){return e?e instanceof Map?e.get(t)||null:e[t]||null:null}function nr(e){try{return new URL(e).hostname}catch{return``}}function rr(e,t,n={}){let r=t||qn(e,n.contentOptions),i=String(e?.name||``).trim()||`未命名点位`,a=String(e?.id||``),o=[];return(r?.groups||[]).forEach((t,n)=>{$n.has(t?.type)&&(t.items||[]).forEach((r,s)=>{let c=String(r?.title||``).trim();o.push({...r,title:c&&c!==nr(r?.url)?c:i,type:t.type,featureId:a,featureName:i,featureType:String(e?.type||``),sourceOrder:er(r,n,s)})})}),o.sort((e,t)=>e.sourceOrder-t.sourceOrder),o.map((e,t)=>({...e,featureMediaIndex:t,galleryId:`${a||`feature`}:${e.id||e.type}:${t}`}))}function ir(e,t={}){let n=Array.isArray(e?.features)?e.features:[],r=String(e?.id||``),i=String(e?.name||``).trim()||`未命名 KML`;return n.flatMap((e,n)=>{let a=String(e?.id||``);return rr(e,tr(t.featureViews,a),t).map(e=>({...e,kmlId:r,kmlName:i,featureIndex:n}))}).map((e,t)=>({...e,galleryIndex:t}))}function ar(e,t={}){if(!Array.isArray(e)||!e.length)return 0;let n=String(t.featureId||``),r=String(t.id||``),i=String(t.url||``),a=String(t.type||``),o=Number(t.featureMediaIndex),s=e.findIndex(e=>n&&e.featureId!==n||a&&e.type!==a?!1:r&&e.id===r||i&&e.url===i&&(!a||e.type===a)||!r&&!i&&a?!0:Number.isInteger(o)&&e.featureMediaIndex===o);return s===-1&&n&&(s=e.findIndex(e=>e.featureId===n)),s===-1?0:s}function or(e,t={}){let n=Math.max(1,Number.parseInt(t.limit,10)||4),r=t.view||qn(e,t.contentOptions),i=rr(e,r,t),a=i.length>n?Math.max(1,n-1):n,o=i.slice(0,a);return{items:o,overflowItem:i[o.length]||null,total:i.length,remaining:Math.max(0,i.length-a),contentSummary:r?.contentSummary||{}}}typeof window<`u`&&(window.NodeList&&!NodeList.prototype.forEach&&(NodeList.prototype.forEach=Array.prototype.forEach),typeof window.CustomEvent!=`function`&&(window.CustomEvent=function(e,t){t||={bubbles:!1,cancelable:!1,detail:null};var n=document.createEvent(`CustomEvent`);return n.initCustomEvent(e,t.bubbles,t.cancelable,t.detail),n}));var sr=typeof document<`u`&&!!document.documentMode,cr;function lr(){return cr||=document.createElement(`div`).style}var ur=[`webkit`,`moz`,`ms`],dr={};function fr(e){if(dr[e])return dr[e];let t=lr();if(e in t)return dr[e]=e;let n=e[0].toUpperCase()+e.slice(1),r=ur.length;for(;r--;){let i=`${ur[r]}${n}`;if(i in t)return dr[e]=i}}function pr(e,t){return parseFloat(t[fr(e)])||0}function mr(e,t,n=window.getComputedStyle(e)){let r=t===`border`?`Width`:``;return{left:pr(`${t}Left${r}`,n),right:pr(`${t}Right${r}`,n),top:pr(`${t}Top${r}`,n),bottom:pr(`${t}Bottom${r}`,n)}}function hr(e,t,n){e.style[fr(t)]=n}function gr(e,t){hr(e,`transition`,`${fr(`transform`)} ${t.duration}ms ${t.easing}`)}function _r(e,{x:t,y:n,scale:r,isSVG:i},a){if(hr(e,`transform`,`scale(${r}) translate(${t}px, ${n}px)`),i&&sr){let t=window.getComputedStyle(e).getPropertyValue(`transform`);e.setAttribute(`transform`,t)}}function vr(e){let t=e.parentNode;(!t||t.nodeType!==1)&&(t=document.documentElement);let n=window.getComputedStyle(e),r=window.getComputedStyle(t),i=e.getBoundingClientRect(),a=t.getBoundingClientRect();return{elem:{style:n,width:i.width,height:i.height,top:i.top,bottom:i.bottom,left:i.left,right:i.right,margin:mr(e,`margin`,n),border:mr(e,`border`,n)},parent:{style:r,width:a.width,height:a.height,top:a.top,bottom:a.bottom,left:a.left,right:a.right,padding:mr(t,`padding`,r),border:mr(t,`border`,r)}}}var yr={down:`mousedown`,move:`mousemove`,up:`mouseup mouseleave`};typeof window<`u`&&(typeof window.PointerEvent==`function`?yr={down:`pointerdown`,move:`pointermove`,up:`pointerup pointerleave pointercancel`}:typeof window.TouchEvent==`function`&&(yr={down:`touchstart`,move:`touchmove`,up:`touchend touchcancel`}));function br(e,t,n,r){yr[e].split(` `).forEach(e=>{t.addEventListener(e,n,r)})}function xr(e,t,n){yr[e].split(` `).forEach(e=>{t.removeEventListener(e,n)})}function Sr(e,t){let n=e.length;for(;n--;)if(e[n].pointerId===t.pointerId)return n;return-1}function Cr(e,t){let n;if(t.touches){n=0;for(let r of t.touches)r.pointerId=n++,Cr(e,r);return}n=Sr(e,t),n>-1&&e.splice(n,1),e.push(t)}function wr(e,t){if(t.touches){for(;e.length;)e.pop();return}let n=Sr(e,t);n>-1&&e.splice(n,1)}function Tr(e){e=e.slice(0);let t=e.pop(),n;for(;n=e.pop();)t={clientX:(n.clientX-t.clientX)/2+t.clientX,clientY:(n.clientY-t.clientY)/2+t.clientY};return t}function Er(e){if(e.length<2)return 0;let t=e[0],n=e[1];return Math.sqrt(Math.abs(n.clientX-t.clientX)**2+Math.abs(n.clientY-t.clientY)**2)}function Dr(e){let t=e;for(;t&&t.parentNode;){if(t.parentNode===document)return!0;t=t.parentNode instanceof ShadowRoot?t.parentNode.host:t.parentNode}return!1}function Or(e){return(e.getAttribute(`class`)||``).trim()}function kr(e,t){return e.nodeType===1&&` ${Or(e)} `.indexOf(` ${t} `)>-1}function Ar(e,t){for(let n=e;n!=null;n=n.parentNode)if(kr(n,t.excludeClass)||t.exclude.indexOf(n)>-1)return!0;return!1}var jr=/^http:[\w\.\/]+svg$/;function Mr(e){return jr.test(e.namespaceURI)&&e.nodeName.toLowerCase()!==`svg`}function Nr(e){let t={};for(let n in e)e.hasOwnProperty(n)&&(t[n]=e[n]);return t}var Pr={animate:!1,canvas:!1,cursor:`move`,disablePan:!1,disableZoom:!1,disableXAxis:!1,disableYAxis:!1,duration:200,easing:`ease-in-out`,exclude:[],excludeClass:`panzoom-exclude`,handleStartEvent:e=>{e.preventDefault(),e.stopPropagation()},maxScale:4,minScale:.125,overflow:`hidden`,panOnlyWhenZoomed:!1,pinchAndPan:!1,relative:!1,setTransform:_r,startX:0,startY:0,startScale:1,step:.3,touchAction:`none`};function Fr(e,t){if(!e)throw Error(`Panzoom requires an element as an argument`);if(e.nodeType!==1)throw Error(`Panzoom requires an element with a nodeType of 1`);if(!Dr(e))throw Error(`Panzoom should be called on elements that have been attached to the DOM`);t={...Pr,...t};let n=Mr(e),r=e.parentNode;r.style.overflow=t.overflow,r.style.userSelect=`none`,r.style.touchAction=t.touchAction,(t.canvas?r:e).style.cursor=t.cursor,e.style.userSelect=`none`,e.style.touchAction=t.touchAction,hr(e,`transformOrigin`,typeof t.origin==`string`?t.origin:n?`0 0`:`50% 50%`);function i(){r.style.overflow=``,r.style.userSelect=``,r.style.touchAction=``,r.style.cursor=``,e.style.cursor=``,e.style.userSelect=``,e.style.touchAction=``,hr(e,`transformOrigin`,``)}function a(n={}){for(let e in n)n.hasOwnProperty(e)&&(t[e]=n[e]);(n.hasOwnProperty(`cursor`)||n.hasOwnProperty(`canvas`))&&(r.style.cursor=e.style.cursor=``,(t.canvas?r:e).style.cursor=t.cursor),n.hasOwnProperty(`overflow`)&&(r.style.overflow=n.overflow),n.hasOwnProperty(`touchAction`)&&(r.style.touchAction=n.touchAction,e.style.touchAction=n.touchAction)}let o=0,s=0,c=1,l=!1;h(t.startScale,{animate:!1,force:!0}),setTimeout(()=>{m(t.startX,t.startY,{animate:!1,force:!0})});function u(t,n,r){if(r.silent)return;let i=new CustomEvent(t,{detail:n});e.dispatchEvent(i)}function d(t,r,i){let a={x:o,y:s,scale:c,isSVG:n,originalEvent:i};return requestAnimationFrame(()=>{typeof r.animate==`boolean`&&(r.animate?gr(e,r):hr(e,`transition`,`none`)),r.setTransform(e,a,r),u(t,a,r),u(`panzoomchange`,a,r)}),a}function f(n,r,i,a){let l={...t,...a},u={x:o,y:s,opts:l};if(!a?.force&&(l.disablePan||l.panOnlyWhenZoomed&&c===l.startScale))return u;if(n=parseFloat(n),r=parseFloat(r),l.disableXAxis||(u.x=(l.relative?o:0)+n),l.disableYAxis||(u.y=(l.relative?s:0)+r),l.contain){let t=vr(e),n=t.elem.width/c,r=t.elem.height/c,a=n*i,o=r*i,s=(a-n)/2,d=(o-r)/2;if(l.contain===`inside`){let e=(-t.elem.margin.left-t.parent.padding.left+s)/i,n=(t.parent.width-a-t.parent.padding.left-t.elem.margin.left-t.parent.border.left-t.parent.border.right+s)/i;u.x=Math.max(Math.min(u.x,n),e);let r=(-t.elem.margin.top-t.parent.padding.top+d)/i,c=(t.parent.height-o-t.parent.padding.top-t.elem.margin.top-t.parent.border.top-t.parent.border.bottom+d)/i;u.y=Math.max(Math.min(u.y,c),r)}else if(l.contain===`outside`){let e=(-(a-t.parent.width)-t.parent.padding.left-t.parent.border.left-t.parent.border.right+s)/i,n=(s-t.parent.padding.left)/i;u.x=Math.max(Math.min(u.x,n),e);let r=(-(o-t.parent.height)-t.parent.padding.top-t.parent.border.top-t.parent.border.bottom+d)/i,c=(d-t.parent.padding.top)/i;u.y=Math.max(Math.min(u.y,c),r)}}return l.roundPixels&&(u.x=Math.round(u.x),u.y=Math.round(u.y)),u}function p(n,r){let i={...t,...r},a={scale:c,opts:i};if(!r?.force&&i.disableZoom)return a;let o=t.minScale,s=t.maxScale;if(i.contain){let n=vr(e),r=n.elem.width/c,i=n.elem.height/c;if(r>1&&i>1){let e=n.parent.width-n.parent.border.left-n.parent.border.right,a=n.parent.height-n.parent.border.top-n.parent.border.bottom,c=e/r,l=a/i;t.contain===`inside`?s=Math.min(s,c,l):t.contain===`outside`&&(o=Math.max(o,c,l))}}return a.scale=Math.min(Math.max(n,o),s),a}function m(e,t,r,i){let a=f(e,t,c,r);return o!==a.x||s!==a.y?(o=a.x,s=a.y,d(`panzoompan`,a.opts,i)):{x:o,y:s,scale:c,isSVG:n,originalEvent:i}}function h(e,t,n){let r=p(e,t),i=r.opts;if(!t?.force&&i.disableZoom)return;e=r.scale;let a=o,l=s;if(i.focal){let t=i.focal;a=(t.x/e-t.x/c+o*e)/e,l=(t.y/e-t.y/c+s*e)/e}let u=f(a,l,e,{relative:!1,force:!0});return o=u.x,s=u.y,c=e,d(`panzoomzoom`,i,n)}function g(e,n){let r={...t,animate:!0,...n};return h(c*Math.exp((e?1:-1)*r.step),r)}function _(e){return g(!0,e)}function ee(e){return g(!1,e)}function te(t,r,i,a){let o=vr(e),s={width:o.parent.width-o.parent.padding.left-o.parent.padding.right-o.parent.border.left-o.parent.border.right,height:o.parent.height-o.parent.padding.top-o.parent.padding.bottom-o.parent.border.top-o.parent.border.bottom},l=r.clientX-o.parent.left-o.parent.padding.left-o.parent.border.left-o.elem.margin.left,u=r.clientY-o.parent.top-o.parent.padding.top-o.parent.border.top-o.elem.margin.top;n||(l-=o.elem.width/c/2,u-=o.elem.height/c/2);let d={x:l/s.width*(s.width*t),y:u/s.height*(s.height*t)};return h(t,{...i,animate:!1,focal:d},a)}function v(e,n){e.preventDefault();let r={...t,...n,animate:!1},i=(e.deltaY===0&&e.deltaX?e.deltaX:e.deltaY)<0?1:-1,a=p(c*Math.exp(i*r.step/3),r).scale;return te(a,e,r,e)}function ne(e){let n={...t,animate:!0,force:!0,...e};c=p(n.startScale,n).scale;let r=f(n.startX,n.startY,c,n);return o=r.x,s=r.y,d(`panzoomreset`,n)}let re,y,b,x,S,ie,C=[];function ae(e){if(Ar(e.target,t))return;Cr(C,e),l=!0,t.handleStartEvent(e),re=o,y=s,u(`panzoomstart`,{x:o,y:s,scale:c,isSVG:n,originalEvent:e},t);let r=Tr(C);b=r.clientX,x=r.clientY,S=c,ie=Er(C)}function w(e){if(!l||re===void 0||y===void 0||b===void 0||x===void 0)return;Cr(C,e);let n=Tr(C),r=C.length>1,i=c;r&&(ie===0&&(ie=Er(C)),i=p((Er(C)-ie)*t.step/80+S).scale,te(i,n,{animate:!1},e)),(!r||t.pinchAndPan)&&m(re+(n.clientX-b)/i,y+(n.clientY-x)/i,{animate:!1},e)}function T(e){C.length===1&&u(`panzoomend`,{x:o,y:s,scale:c,isSVG:n,originalEvent:e},t),wr(C,e),l&&(l=!1,re=y=b=x=void 0)}let E=!1;function oe(){E||(E=!0,br(`down`,t.canvas?r:e,ae),br(`move`,document,w,{passive:!0}),br(`up`,document,T,{passive:!0}))}function D(){E=!1,xr(`down`,t.canvas?r:e,ae),xr(`move`,document,w),xr(`up`,document,T)}return t.noBind||oe(),{bind:oe,destroy:D,eventNames:yr,getPan:()=>({x:o,y:s}),getScale:()=>c,getOptions:()=>Nr(t),handleDown:ae,handleMove:w,handleUp:T,pan:m,reset:ne,resetStyle:i,setOptions:a,setStyle:(t,n)=>hr(e,t,n),zoom:h,zoomIn:_,zoomOut:ee,zoomToPoint:te,zoomWithWheel:v}}Fr.defaultOptions=Pr;var Ir=new Set([`image`,`video`,`audio`,`iframe`]);function Lr(e,t){let n=Math.max(0,Number.parseInt(t,10)||0);return n?((Number.parseInt(e,10)||0)%n+n)%n:0}function Rr(e){let t=Number(e);return Number.isFinite(t)?Math.min(6,Math.max(1,t)):1}function zr(e,t=``){return Array.isArray(e)?e.flatMap(e=>{let n=String(e?.type||``)||t,r=String(e?.url||``).trim();return!Ir.has(n)||!/^https:\/\//i.test(r)?[]:[{...e,type:n,url:r}]}):[]}var Br=`modulepreload`,Vr=function(e){return`/`+e},Hr={},Ur=function(e,t,n){let r=Promise.resolve();if(t&&t.length>0){let e=document.getElementsByTagName(`link`),i=document.querySelector(`meta[property=csp-nonce]`),a=i?.nonce||i?.getAttribute(`nonce`);function o(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))}r=o(t.map(t=>{if(t=Vr(t,n),t in Hr)return;Hr[t]=!0;let r=t.endsWith(`.css`),i=r?`[rel="stylesheet"]`:``;if(n)for(let n=e.length-1;n>=0;n--){let i=e[n];if(i.href===t&&(!r||i.rel===`stylesheet`))return}else if(document.querySelector(`link[href="${t}"]${i}`))return;let o=document.createElement(`link`);if(o.rel=r?`stylesheet`:Br,r||(o.as=`script`),o.crossOrigin=``,o.href=t,a&&o.setAttribute(`nonce`,a),document.head.appendChild(o),r)return new Promise((e,n)=>{o.addEventListener(`load`,e),o.addEventListener(`error`,()=>n(Error(`Unable to preload CSS for ${t}`)))})}))}function i(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return r.then(t=>{for(let e of t||[])e.status===`rejected`&&i(e.reason);return e().catch(i)})},Wr={image:`图片`,video:`视频`,audio:`音频`,iframe:`页面`},K=[],q=0,Gr=null,Kr=null,qr=null,Jr=null,Yr=null,Xr=0,Zr=null,Qr=!1,$r=``,ei=null,ti=null;function ni(){return window.matchMedia?.(`(prefers-reduced-motion: reduce)`).matches===!0}function ri(e){return String(e?.title||Wr[e?.type]||`媒体预览`)}function ii(e){if(e?.displayUrl)return String(e.displayUrl);try{return new URL(e?.url).hostname}catch{return``}}function ai(e){return String(e?.renderUrl||e?.url||``)}function oi(e){return String(e?.canonicalUrl||e?.sourceUrl||e?.url||``)}function si(e){return{video:`▶`,audio:`♪`,iframe:`▣`}[e]||`◫`}function ci(e){return/\.m3u8(?:$|[?#])/i.test(String(e||``))}function li(){let e=document.createElement(`div`);return e.id=`app-media-preview`,e.className=`media-preview-root`,e.hidden=!0,e.setAttribute(`aria-hidden`,`true`),e.innerHTML=`
  ...
  `,e.addEventListener(`click`,Oi),e.addEventListener(`input`,ki),document.body.appendChild(e),e}function ui(){return Yr||=document.getElementById(`app-media-preview`)||li(),Yr}function J(e){return ui().querySelector(e)}function di(e,t){let n=J(e);n&&(n.textContent=t)}function fi(){qr&&Jr&&qr.removeEventListener(`wheel`,Jr),Kr?.destroy(),Kr=null,qr=null,Jr=null}function pi(){fi(),Zr?.destroy(),Zr=null;let e=J(`[data-media-preview-content]`);e?.querySelectorAll(`video, audio`).forEach(e=>{e.pause(),e.removeAttribute(`src`),e.load()}),e?.querySelectorAll(`iframe`).forEach(e=>e.removeAttribute(`src`)),e?.replaceChildren()}function mi(){ei?.disconnect(),ei=null}function hi(e,t){if(t!==Xr||Yr?.hidden)return;let n=J(`[data-media-preview-content]`);if(!n)return;let r=document.createElement(`div`);r.className=`media-preview-load-error`,r.setAttribute(`role`,`status`),r.textContent=e,n.replaceChildren(r)}function gi(e){let t=Rr(e),n=J(`[data-media-preview-zoom]`),r=J(`[data-media-preview-zoom-output]`),i=J(`[data-media-preview-stage]`);n&&(n.value=String(t)),r&&(r.textContent=`${Math.round(t*100)}%`),i?.classList.toggle(`is-zoomed`,t>1.01)}function _i(e,t=!ni()){Kr&&Kr.zoom(Rr(e),{animate:t})}function vi(e=!ni()){Kr&&(Kr.reset({animate:e}),gi(1))}function yi(e,t){fi(),Kr=Fr(e,{canvas:!0,minScale:1,maxScale:6,startScale:1,step:.2,duration:ni()?0:160,panOnlyWhenZoomed:!0,pinchAndPan:!0,cursor:`grab`}),e.addEventListener(`panzoomchange`,e=>gi(e.detail?.scale??Kr?.getScale())),t.addEventListener(`dblclick`,e=>{e.preventDefault(),_i((Kr?.getScale()||1)>1.05?1:2)}),qr=t,Jr=Kr.zoomWithWheel,t.addEventListener(`wheel`,Jr,{passive:!1}),gi(1)}function bi(e,t){let n=J(`[data-media-preview-content]`);if(!n)return;let r=document.createElement(`div`);r.className=`media-preview-image-canvas`;let i=document.createElement(`img`);i.className=`media-preview-image`,i.alt=ri(e),i.draggable=!1,i.referrerPolicy=`no-referrer`,i.addEventListener(`load`,()=>{t===Xr&&i.isConnected&&yi(i,r)},{once:!0}),i.addEventListener(`error`,()=>hi(`图片加载失败`,t),{once:!0}),i.src=ai(e),r.appendChild(i),n.appendChild(r)}async function xi(e,t,n){try{let{default:r}=await Ur(async()=>{let{default:e}=await import(`./hls-IujbK-0_.js`);return{default:e}},[]);if(n!==Xr||!e.isConnected)return;if(!r.isSupported()){e.src=t;return}Zr=new r({enableWorker:!0}),Zr.on(r.Events.ERROR,(e,t)=>{t?.fatal&&(Zr?.destroy(),Zr=null,hi(`HLS 视频加载失败`,n))}),Zr.loadSource(t),Zr.attachMedia(e)}catch{n===Xr&&e.isConnected&&(e.src=t)}}function Si(e,t){let n=J(`[data-media-preview-content]`);if(!n)return;let r=document.createElement(`video`);r.className=`media-preview-video`,r.controls=!0,r.autoplay=!0,r.playsInline=!0,r.preload=`metadata`,r.referrerPolicy=`no-referrer`,r.addEventListener(`error`,()=>hi(`视频加载失败`,t),{once:!0});let i=ai(e);ci(i)&&!r.canPlayType(`application/vnd.apple.mpegurl`)?xi(r,i,t):r.src=i,n.appendChild(r);let a=()=>{if(t!==Xr||!r.isConnected)return;r.muted=!1;let e=r.play();e?.catch&&e.catch(()=>{t!==Xr||!r.isConnected||(r.muted=!0,r.play().catch(()=>{}))})};a(),r.addEventListener(`loadedmetadata`,a,{once:!0})}function Ci(e,t){let n=J(`[data-media-preview-content]`);if(!n)return;let r=document.createElement(`div`);r.className=`media-preview-audio-shell`;let i=document.createElement(`span`);i.className=`media-preview-audio-icon`,i.setAttribute(`aria-hidden`,`true`),i.textContent=`♪`;let a=document.createElement(`audio`);a.controls=!0,a.preload=`metadata`,a.addEventListener(`error`,()=>hi(`音频加载失败`,t),{once:!0}),a.src=ai(e),r.append(i,a),n.appendChild(r)}function wi(e){let t=J(`[data-media-preview-content]`);if(!t)return;let n=e.embedPolicy||{},r=document.createElement(`div`);r.className=`media-preview-iframe-shell`,e.provider&&(r.dataset.provider=String(e.provider));let i=document.createElement(`iframe`);i.className=`media-preview-iframe`,i.title=ri(e),i.loading=`eager`,i.referrerPolicy=n.referrerPolicy||`no-referrer`,i.setAttribute(`sandbox`,n.sandbox||`allow-scripts allow-forms allow-popups`),n.allow&&i.setAttribute(`allow`,n.allow),n.allowFullscreen&&(i.allowFullscreen=!0),i.src=ai(e),r.appendChild(i),t.appendChild(r)}function Ti(){let e=J(`[data-media-preview-track]`);if(!e)return;mi();let t=K.map(e=>e.galleryId||`${e.type}:${e.url}`).join(`|`),n=e.children.length!==K.length||e.dataset.signature!==t;n&&(e.replaceChildren(),e.dataset.signature=t),K.forEach((t,r)=>{if(!n){let t=e.children[r];if(t){t.classList.toggle(`is-active`,r===q),t.tabIndex=r===q?0:-1,t.setAttribute(`aria-current`,r===q?`true`:`false`);return}}let i=document.createElement(`button`);if(i.type=`button`,i.className=`media-preview-track-item`,i.dataset.mediaPreviewAction=`select`,i.dataset.mediaPreviewIndex=String(r),i.tabIndex=r===q?0:-1,i.setAttribute(`aria-current`,r===q?`true`:`false`),i.setAttribute(`aria-label`,`查看第 ${r+1} 项，${Wr[t.type]||`媒体`}：${ri(t)}`),i.title=`${ri(t)} · ${t.featureName||``}`,t.type===`image`){let e=document.createElement(`img`),n=String(t.thumbnailUrl||t.renderUrl||t.url||``);e.alt=``,e.loading=`lazy`,e.referrerPolicy=`no-referrer`,e.addEventListener(`error`,()=>i.classList.add(`is-load-error`),{once:!0}),`IntersectionObserver`in window?e.dataset.src=n:e.src=n,i.appendChild(e)}else{let e=document.createElement(`span`);e.className=`media-preview-track-icon media-preview-track-icon-${t.type}`,e.setAttribute(`aria-hidden`,`true`),e.textContent=si(t.type),i.appendChild(e)}let a=document.createElement(`span`);a.className=`media-preview-track-marker`,a.textContent=String(r+1).padStart(2,`0`),i.appendChild(a),e.appendChild(i)}),`IntersectionObserver`in window&&(ei=new IntersectionObserver(e=>{e.forEach(e=>{if(!e.isIntersecting)return;let t=e.target;t.src=t.dataset.src||``,t.removeAttribute(`data-src`),ei?.unobserve(t)})},{root:e,rootMargin:`0px 160px`}),e.querySelectorAll(`img[data-src]`).forEach(e=>ei.observe(e))),e.querySelectorAll(`.media-preview-track-item`).forEach((e,t)=>{e.classList.toggle(`is-active`,t===q),e.tabIndex=t===q?0:-1,e.setAttribute(`aria-current`,t===q?`true`:`false`)}),e.querySelector(`.media-preview-track-item.is-active`)?.scrollIntoView?.({block:`nearest`,inline:`center`})}function Ei(){let e=++Xr;pi();let t=K[q];if(!t)return;let n=ui(),r=J(`[data-media-preview-source]`),i=J(`[data-media-preview-action="previous"]`),a=J(`[data-media-preview-action="next"]`),o=J(`[data-media-preview-zoom-controls]`),s=Wr[t.type]||`媒体`,c=ri(t);n.dataset.mediaType=t.type,n.dataset.mediaIndex=String(q),di(`[data-media-preview-kind]`,s),di(`[data-media-preview-collection]`,$r||t.kmlName||`媒体预览`),di(`[data-media-preview-title]`,c),di(`[data-media-preview-position]`,K.length>1?`${q+1} / ${K.length}`:`单项`),di(`[data-media-preview-caption]`,c),di(`[data-media-preview-url]`,ii(t)),di(`[data-media-preview-restore-title]`,c),di(`[data-media-preview-restore-position]`,`${q+1} / ${K.length}`),r&&(r.href=oi(t),r.title=t.type===`iframe`?`打开原始页面`:`打开原始文件`),di(`.media-preview-source-label`,t.type===`iframe`?`原始页面`:`原始文件`);let l=K.length>1;i&&(i.hidden=!l),a&&(a.hidden=!l),o&&(o.hidden=t.type!==`image`),gi(1),Ti();let u={image:bi,video:Si,audio:Ci,iframe:wi}[t.type];u?.(t,e),ti?.(t),Qr||J(`.media-preview-stage`)?.focus({preventScroll:!0})}function Di(e){K.length<2||(q=Lr(q+e,K.length),Ei())}function Oi(e){let t=ui();if(e.target===t){Pi();return}let n=e.target.closest(`[data-media-preview-action]`)?.dataset.mediaPreviewAction;n&&(n===`close`&&Pi(),n===`previous`&&Di(-1),n===`next`&&Di(1),n===`select`&&(q=Lr(e.target.closest(`[data-media-preview-action]`)?.dataset.mediaPreviewIndex,K.length),Ei()),n===`minimize`&&Ni(!0),n===`restore`&&Ni(!1),n===`zoom-in`&&_i((Kr?.getScale()||1)+.5),n===`zoom-out`&&_i((Kr?.getScale()||1)-.5),n===`reset`&&vi())}function ki(e){e.target.matches(`[data-media-preview-zoom]`)&&_i(Number(e.target.value),!1)}function Ai(e){if(Qr)return;let t=ui(),n=[...t.querySelectorAll(`a[href], button:not([hidden]):not([tabindex="-1"]), input:not([hidden]), video[controls], audio[controls]`)].filter(e=>!e.disabled&&e.getClientRects().length);if(!n.length)return;let r=n[0],i=n.at(-1);t.contains(document.activeElement)?e.shiftKey&&document.activeElement===r?(e.preventDefault(),i.focus()):!e.shiftKey&&document.activeElement===i&&(e.preventDefault(),r.focus()):(e.preventDefault(),r.focus())}function ji(e){if(ui().hidden)return;if(e.key===`Escape`){e.preventDefault(),Pi();return}if(Qr){let t=ui();t.contains(e.target)&&e.key===`ArrowLeft`&&(e.preventDefault(),Di(-1)),t.contains(e.target)&&e.key===`ArrowRight`&&(e.preventDefault(),Di(1));return}if(e.key===`Tab`&&!Qr){Ai(e);return}let t=e.target.matches?.(`input, video, audio`);!t&&(e.key===`ArrowLeft`||e.key===`ArrowUp`)&&(e.preventDefault(),Di(-1)),!t&&(e.key===`ArrowRight`||e.key===`ArrowDown`)&&(e.preventDefault(),Di(1)),!t&&K[q]?.type===`image`&&((e.key===`+`||e.key===`=`)&&(e.preventDefault(),_i((Kr?.getScale()||1)+.5)),e.key===`-`&&(e.preventDefault(),_i((Kr?.getScale()||1)-.5)),e.key===`0`&&(e.preventDefault(),vi()))}function Mi(){!ui().hidden&&!Qr&&K[q]?.type===`image`&&vi(!1)}function Ni(e){let t=ui();if(t.hidden)return;Qr=!!e,t.classList.toggle(`is-minimized`,Qr),J(`.media-preview-dialog`)?.setAttribute(`aria-modal`,Qr?`false`:`true`),document.body.classList.toggle(`media-preview-open`,!Qr);let n=J(`[data-media-preview-action="minimize"]`);n&&(n.hidden=Qr,n.setAttribute(`aria-label`,Qr?`预览已收缩`:`收缩为小窗`)),requestAnimationFrame(Qr?()=>J(`[data-media-preview-action="restore"]`)?.focus():()=>J(`.media-preview-stage`)?.focus({preventScroll:!0}))}function Pi(){let e=Yr||document.getElementById(`app-media-preview`);!e||e.hidden||(Xr+=1,pi(),mi(),e.hidden=!0,e.setAttribute(`aria-hidden`,`true`),e.removeAttribute(`data-media-type`),e.classList.remove(`is-minimized`),document.body.classList.remove(`media-preview-open`),document.removeEventListener(`keydown`,ji),window.removeEventListener(`resize`,Mi),K=[],q=0,$r=``,ti=null,Qr=!1,Gr?.isConnected&&Gr.focus({preventScroll:!0}),Gr=null)}function Fi({items:e,index:t=0,type:n=``,trigger:r=null,collectionTitle:i=``,onActiveItemChange:a=null}={}){let o=zr(e,n);if(!o.length)return!1;let s=ui();(s.hidden||Qr)&&(Gr=r||document.activeElement),K=o,q=Lr(t,K.length),$r=String(i||o[q]?.kmlName||``).trim(),ti=typeof a==`function`?a:null,Qr=!1,s.classList.remove(`is-minimized`),J(`.media-preview-dialog`)?.setAttribute(`aria-modal`,`true`);let c=J(`[data-media-preview-action="minimize"]`);return c&&(c.hidden=!1),s.hidden=!1,s.setAttribute(`aria-hidden`,`false`),document.body.classList.add(`media-preview-open`),document.removeEventListener(`keydown`,ji),document.addEventListener(`keydown`,ji),window.removeEventListener(`resize`,Mi),window.addEventListener(`resize`,Mi),Ei(),requestAnimationFrame(()=>J(`.media-preview-stage`)?.focus({preventScroll:!0})),!0}var Ii=`/api/v1`,Li=new Set([`GET`,`HEAD`,`OPTIONS`]),Ri=class extends Error{constructor(e,t={}){super(e||`请求失败`),this.name=`ApiError`,this.status=Number(t.status||0),this.code=t.code||`REQUEST_FAILED`,this.details=t.details||null}};function zi(e=``){return String(e).split(`;`).map(e=>e.trim()).filter(Boolean).reduce((e,t)=>{let n=t.indexOf(`=`);if(n<=0)return e;let r=t.slice(0,n).trim(),i=t.slice(n+1);try{e[r]=decodeURIComponent(i)}catch{e[r]=i}return e},{})}function Bi(e){return zi(e===void 0&&typeof document<`u`?document.cookie:e).map_csrf_token||``}function Vi(e){return!Li.has(String(e||`GET`).toUpperCase())}function Hi(e,t){let n=String(e||``).startsWith(`/`)?String(e):`/${e||``}`,r=(t instanceof URLSearchParams?t:new URLSearchParams(Object.entries(t||{}).filter(([,e])=>e!==``&&e!=null))).toString();return`${Ii}${n}${r?`?${r}`:``}`}function Ui(e){return typeof FormData<`u`&&e instanceof FormData}function Wi(e){e.status!==401||e.code!==`AUTH_REQUIRED`||typeof window<`u`&&window.dispatchEvent instanceof Function&&window.dispatchEvent(new CustomEvent(`map-auth-session-expired`))}async function Gi(e){if((e.headers.get(`content-type`)||``).includes(`application/json`))return e.json().catch(()=>null);let t=await e.text().catch(()=>``);return t?{message:t}:null}function Ki(e,t){let n=t?.error||t||{};return new Ri(n.message||e.statusText||`请求失败`,{status:e.status,code:n.code||`HTTP_${e.status}`,details:n.details||null})}async function qi(e,t={}){let n=String(t.method||`GET`).toUpperCase(),r=new Headers(t.headers||{});r.set(`Accept`,`application/json`);let i;if(t.body!==void 0&&(Ui(t.body)||typeof t.body==`string`||t.body instanceof Blob?i=t.body:(r.set(`Content-Type`,`application/json`),i=JSON.stringify(t.body))),Vi(n)&&t.csrf!==!1){let e=Bi();e&&r.set(`X-CSRF-Token`,e)}let a=await fetch(Hi(e,t.query),{method:n,headers:r,body:i,credentials:`same-origin`,cache:`no-store`,redirect:`error`,signal:t.signal}),o=await Gi(a);if(!a.ok||o&&Object.hasOwn(o,`code`)&&o.code!==0){let e=Ki(a,o);throw Wi(e),e}return o&&Object.hasOwn(o,`result`)?o.result:o}async function Ji(e,t={}){let n=String(t.method||`GET`).toUpperCase(),r=new Headers(t.headers||{});if(r.set(`Accept`,t.accept||`application/octet-stream`),Vi(n)&&t.csrf!==!1){let e=Bi();e&&r.set(`X-CSRF-Token`,e)}let i=await fetch(Hi(e,t.query),{method:n,headers:r,credentials:`same-origin`,cache:`no-store`,redirect:`error`,signal:t.signal});if(!i.ok){let e=Ki(i,await Gi(i));throw Wi(e),e}return{blob:await i.blob(),contentDisposition:i.headers.get(`content-disposition`)||``,contentType:i.headers.get(`content-type`)||``}}var Yi=new Set,Xi={loaded:!1,loading:!1,authenticated:!1,user:null,session:null,config:null,error:``};function Zi(){let e=ea();Yi.forEach(t=>t(e))}function Qi(e){return Xi={...Xi,...e},Zi(),ea()}function $i(e){return!e||e.authenticated===!1||!e.user?{authenticated:!1,user:null,session:null}:{authenticated:!0,user:e.user,session:e.session||{expiresAt:e.expiresAt||null}}}function ea(){return{...Xi,user:Xi.user?{...Xi.user}:null,session:Xi.session?{...Xi.session}:null,config:Xi.config?{...Xi.config}:null}}function ta(e){return e instanceof Function?(Yi.add(e),()=>Yi.delete(e)):()=>{}}async function na(){let e=await qi(`/auth/config`,{csrf:!1});return Qi({config:e}),e}async function ra(){Qi({loading:!0,error:``});try{return Qi({...$i(await qi(`/auth/session`,{csrf:!1})),loaded:!0,loading:!1,error:``})}catch(e){if(e.status===401)return Qi({authenticated:!1,user:null,session:null,loaded:!0,loading:!1,error:``});throw Qi({loaded:!0,loading:!1,error:e.message}),e}}async function ia(){let e=(await Promise.allSettled([na(),ra()])).find(e=>e.status===`rejected`);if(e&&!Xi.loaded)throw e.reason;return ea()}async function aa(e){return await qi(`/auth/login`,{method:`POST`,body:e,csrf:!1}),ra()}async function oa(e){return qi(`/auth/register`,{method:`POST`,body:e,csrf:!1})}async function sa(){try{await qi(`/auth/logout`,{method:`POST`})}catch(e){if(e.status!==401||e.code!==`AUTH_REQUIRED`)throw e}return Qi({authenticated:!1,user:null,session:null,loaded:!0,loading:!1,error:``})}function ca(e,t=Xi){let n=t?.user?.permissions||[];return!!(n.includes(e)||n.includes(`system.super_admin`)||e===`account.self.read`&&n.includes(`account.self.update`)||e===`kml.own.read`&&n.includes(`kml.own.write`)||e===`kml.any.read`&&n.includes(`kml.any.manage`))}typeof window<`u`&&window.addEventListener(`map-auth-session-expired`,()=>{Qi({authenticated:!1,user:null,session:null,loaded:!0,loading:!1,error:`登录已失效，请重新登录`})});var la=`favorite.own.manage`,ua=new Set([`search`,`map`,`location`,`kml`,`manual`]),da=/^#[0-9a-f]{6}$/i,fa=`#2563eb`,pa=Object.freeze({search:`搜索结果`,map:`地图中心`,location:`定位结果`,kml:`KML 点位`,manual:`手动位置`}),ma={readOnly:!1},ha=null,ga=null,_a=!1;function va(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function ya(e,t=1e3){return String(e??``).normalize(`NFKC`).replace(/[\u0000-\u0008\u000b\u000c\u000e-\u001f\u007f]/g,``).trim().slice(0,t)}function ba(e,t,n,r){let i=Number(e);if(!Number.isFinite(i)||i<n||i>r)throw TypeError(`${t}不是有效坐标`);return i}function xa(e){return e>=-180&&e<=180?e:ae(e)}function Sa(e){let t=Array.isArray(e)?e:String(e??``).split(/[,，\n]/),n=[],r=new Set;for(let e of t){let t=ya(e,31);if(!t)continue;if(t.length>30)throw TypeError(`单个标签不能超过 30 个字符`);let i=t.toLocaleLowerCase();r.has(i)||(r.add(i),n.push(t))}if(n.length>20)throw TypeError(`标签数量不能超过 20 个`);return n}function Ca(e={}){let t=ua.has(e.sourceType)?e.sourceType:`map`,n=e.coordType===`wgs84`?`wgs84`:`gcj02`,r=xa(ba(e.longitude??e.lng,`经度`,-360,360)),i=ba(e.latitude??e.lat,`纬度`,-90,90),[a,o]=n===`gcj02`?T([r,i]):[r,i],s=ba(xa(a),`经度`,-180,180),c=ba(o,`纬度`,-90,90);return{name:ya(e.name||pa[t]||`收藏位置`,120)||`收藏位置`,note:ya(e.note,2e3),address:ya(e.address,500),category:ya(e.category,80),tags:Sa(e.tags),color:da.test(String(e.color||``))?String(e.color).toLowerCase():fa,longitude:s,latitude:c,coordType:`wgs84`,sourceType:t,sourceRef:ya(e.sourceRef,200)}}function wa(e,t){if(e?.isShare||t?.type!==`Point`||!Array.isArray(t.coordinates))return null;try{let n=String(e?.id||``),r=!e?.isPublic&&/^kml_[A-Za-z0-9_-]+$/.test(n);return Ca({name:t.name||`KML 点位`,note:t.description||``,longitude:t.coordinates[0],latitude:t.coordinates[1],coordType:e?.coordCorrection===`none`?`gcj02`:`wgs84`,sourceType:`kml`,sourceRef:r?n:``,color:e?.color})}catch{return null}}function Ta(e,t={}){let n=Ca(e),r=ya(t.name,121),i=ya(t.note,2001),a=ya(t.category,81),o=Sa(t.tags),s=String(t.color||n.color||fa).trim().toLowerCase();if(!r)throw TypeError(`请填写收藏名称`);if(r.length>120)throw TypeError(`收藏名称不能超过 120 个字符`);if(i.length>2e3)throw TypeError(`备注不能超过 2000 个字符`);if(a.length>80)throw TypeError(`分类不能超过 80 个字符`);if(!da.test(s))throw TypeError(`请选择有效的收藏颜色`);return{name:r,note:i,longitude:n.longitude,latitude:n.latitude,sourceType:n.sourceType,sourceRef:n.sourceRef,address:n.address,category:a,tags:o,color:s}}function Ea(e={}){let t=String(e.pathname||`/`);return`${/^\/(?!\/)/.test(t)&&!t.includes(`\\`)?t:`/`}${String(e.search||``).startsWith(`?`)?String(e.search):``}${String(e.hash||``).startsWith(`#`)?String(e.hash):``}`}function Da(e={}){return`/account?returnTo=${encodeURIComponent(Ea(e))}`}function Oa(e,t=``,n=Date.now()){if(!e?.authenticated||!ca(`favorite.own.manage`,e))return!1;let r=String(e.session?.id||``);if(t&&r!==String(t))return!1;let i=Date.parse(String(e.session?.expiresAt||``));return!Number.isFinite(i)||i>n}function ka(){if(ma.readOnly)return!1;let e=ea();return!e.loaded||!e.authenticated?!0:ca(la,e)}function Aa(){let e=ka();typeof document<`u`&&document.querySelectorAll(`[data-favorite-action]`).forEach(t=>{t.hidden=!e}),Ma()}function ja(){if(typeof document>`u`)return null;let e=document.getElementById(`favorite-candidate-bar`);return e||(e=document.createElement(`section`),e.id=`favorite-candidate-bar`,e.className=`favorite-candidate-bar`,e.hidden=!0,e.setAttribute(`aria-live`,`polite`),e.innerHTML=`
  ...
  `,e.querySelector(`[data-favorite-candidate-save]`)?.addEventListener(`click`,()=>{ha&&Ra(ha)}),e.querySelector(`[data-favorite-candidate-close]`)?.addEventListener(`click`,()=>{ha=null,Ma()}),document.body.appendChild(e),e)}function Ma(){let e=ja();if(!e)return;if(!ha||!ka()){e.hidden=!0;return}e.hidden=!1,e.querySelector(`[data-favorite-candidate-source]`).textContent=pa[ha.sourceType]||`候选位置`,e.querySelector(`[data-favorite-candidate-name]`).textContent=ha.name,e.querySelector(`[data-favorite-candidate-coordinates]`).textContent=`WGS84 · ${ha.latitude.toFixed(6)}, ${ha.longitude.toFixed(6)}`;let t=e.querySelector(`[data-favorite-candidate-save]`);t&&(t.disabled=_a)}function Na(e){if(ma.readOnly)return null;try{ha=Ca(e)}catch(e){return console.warn(`忽略无效的收藏候选位置`,e),null}return Ma(),{...ha}}function Pa(){let e=document.getElementById(`app-dialog-root`);return e||(e=document.createElement(`div`),e.id=`app-dialog-root`,document.body.appendChild(e)),e}function Fa(e){let t=Pa();t.hidden=!1,t.innerHTML=`
    <div class="app-dialog-backdrop" data-favorite-dialog-cancel>
      <form class="app-dialog favorite-dialog" role="dialog" aria-modal="true" aria-labelledby="favorite-dialog-title" data-favorite-dialog-form autocomplete="off">
        ...
        <p class="favorite-dialog-position"><strong>${va(pa[e.sourceType]||`候选位置`)}</strong><span>${va(e.latitude.toFixed(6))}, ${va(e.longitude.toFixed(6))} · WGS84</span></p>
        <div class="favorite-dialog-fields">
          <label><span>名称</span><input name="name" maxlength="120" value="${va(e.name)}" required></label>
          <label><span>备注</span><textarea name="note" maxlength="2000" rows="3"></textarea></label>
          <label><span>分类</span><input name="category" maxlength="80" value="${va(e.category)}" placeholder="例如：出行"></label>
          <label><span>标签</span><input name="tags" value="${va(e.tags.join(`, `))}" placeholder="使用逗号分隔，最多 20 个"></label>
          <label class="favorite-dialog-color"><span>颜色</span><input name="color" type="color" value="${va(e.color)}"><code data-favorite-color-value>${va(e.color)}</code></label>
        </div>
  ...
  `;let n=t.querySelector(`[data-favorite-dialog-form]`),r=n.elements.note;r.value=e.note;let i=n.elements.color,a=n.querySelector(`[data-favorite-color-value]`);return i.addEventListener(`input`,()=>{a.textContent=i.value}),n.elements.name.focus(),new Promise(r=>{let i=!1,a=()=>{t.removeEventListener(`click`,s),n.removeEventListener(`submit`,c),document.removeEventListener(`keydown`,l),window.removeEventListener(`map-auth-session-expired`,u)},o=e=>{i||(i=!0,a(),t.innerHTML=``,t.hidden=!0,r(e))},s=e=>{let t=e.target.closest(`[data-favorite-dialog-cancel]`);t&&(t.classList.contains(`app-dialog-backdrop`)&&e.target!==t||o(null))},c=t=>{t.preventDefault();let r=n.querySelector(`[data-favorite-dialog-error]`);try{o({payload:Ta(e,{name:n.elements.name.value,note:n.elements.note.value,category:n.elements.category.value,tags:n.elements.tags.value,color:n.elements.color.value})})}catch(e){r.textContent=e.message||`收藏信息不正确`,r.hidden=!1}},l=e=>{e.key===`Escape`&&(e.preventDefault(),o(null))},u=()=>o({sessionExpired:!0});t.addEventListener(`click`,s),n.addEventListener(`submit`,c),document.addEventListener(`keydown`,l),window.addEventListener(`map-auth-session-expired`,u,{once:!0})})}async function Ia(){let e=ea(),t=Date.parse(String(e.session?.expiresAt||``));if(!e.loaded||e.authenticated&&Number.isFinite(t)&&t<=Date.now())try{e=await ra()}catch{return await Ce(`暂时无法确认登录状态，请稍后重试。`),null}return e.authenticated?ca(`favorite.own.manage`,e)?e:(await Ce(`当前账号没有管理个人收藏的权限。`),null):(await we(`保存位置收藏需要先登录。是否前往用户中心登录？`,{title:`登录后保存收藏`,confirmText:`前往登录`})&&window.location.assign(Da(window.location)),null)}async function La(){await we(`登录已失效，本次收藏未提交。是否重新登录？`,{title:`登录已失效`,confirmText:`重新登录`})&&window.location.assign(Da(window.location))}async function Ra(e=ha){if(ma.readOnly||_a)return null;let t;try{t=Ca(e)}catch{return await Ce(`当前位置坐标无效，无法保存收藏。`),null}let n=await Ia();if(!n)return null;let r=String(n.session?.id||``),i=await Fa(t);if(!i)return null;if(i.sessionExpired||!Oa(ea(),r))return await La(),null;_a=!0,Ma();try{let e=await qi(`/favorites`,{method:`POST`,body:i.payload});return ha&&ha.sourceType===t.sourceType&&ha.longitude===t.longitude&&ha.latitude===t.latitude&&(ha=null),await Ce(`已保存收藏“${e?.name||i.payload.name}”。`),e}catch(e){return e?.status===401||e?.code===`AUTH_REQUIRED`?await La():await Ce(`收藏保存失败：${e?.message||`请稍后重试`}`),null}finally{_a=!1,Ma()}}function za(e,t){return!wa(e,t)||ma.readOnly||!ka()?``:`
    <button type="button" class="favorite-inline-button" data-favorite-action aria-label="保存为位置收藏" title="保存为位置收藏">
      <svg class="svg-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true"><path d="M12 21s-7-4.35-9.33-8.28C.9 9.73 2.04 6 5.4 5.1A5.35 5.35 0 0 1 12 8a5.35 5.35 0 0 1 6.6-2.9c3.36.9 4.5 4.63 2.73 7.62C19 16.65 12 21 12 21Z"/></svg>
    </button>
  `}function Ba(e,t,n){let r=wa(t,n);!r||ma.readOnly||!e||e.querySelectorAll(`[data-favorite-action]`).forEach(e=>{e.dataset.favoriteBound!==`true`&&(e.dataset.favoriteBound=`true`,e.addEventListener(`click`,e=>{e.preventDefault(),e.stopPropagation(),Ra(r)}))})}function Va(e={}){ma={...ma,readOnly:!!e.readOnly},ga||=ta(Aa),Aa()}var Ha=``.split(`,`).map(e=>e.trim()).filter(Boolean),Ua=null;function Y(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function Wa(){let e=typeof window<`u`?window:null,t=e?.MAP_SERVICE_KML_IFRAME_ALLOWLIST||e?.mapServiceKmlIframeAllowlist||Ha;return Array.isArray(t)?t:String(t||``).split(`,`).map(e=>e.trim()).filter(Boolean)}function Ga(){return{iframeAllowlist:Wa()}}function Ka(e){return qn(e,Ga())}function qa(e){return{image:`图片`,video:`视频`,audio:`音频`,iframe:`页面`}[e]||`媒体`}function Ja(e){return{video:`▶`,audio:`♪`,iframe:`▣`}[e]||`◫`}function Ya(e){let t=String(e?.name||``).trim();return/^未命名(?:点位|要素(?:\s*\d+)?)$/.test(t)?``:t}function Xa(e){return Ya({name:e?.title})||Ya({name:e?.featureName})}function Za(e){let t=qa(e.type),n=Xa(e);return e.type===`image`?`
    ...
    <button type="button" class="kml-popup-media-item kml-popup-media-type kml-popup-media-${Y(e.type)}" data-kml-popup-media data-media-id="${Y(e.id)}" data-media-url="${Y(e.url)}" data-media-type="${Y(e.type)}" aria-label="预览${Y(t)}${n?`：${Y(n)}`:``}">
      <span class="kml-popup-media-icon" aria-hidden="true">${Y(Ja(e.type))}</span>
      <span class="kml-popup-media-copy"><strong>${Y(t)}</strong><small>${Y(n||`点击查看`)}</small></span>
    </button>
  `}function Qa(e,t,n){let r=or(t,{contentOptions:Ga()}),i=Jn(r.contentSummary),a=Yn(t),o=za(e,t),s=n?`
    ...
    `:``,l=Ya(t),u=l?`<div class="kml-popup-title">${Y(l)}</div>`:``,d=a?`<div class="kml-popup-desc">${Y(a)}</div>`:``;return`
  ...
  `}function $a(e,t,n=null){let r=ir(e,{featureViews:n&&t?.id?new Map([[String(t.id),n]]):null,contentOptions:Ga()});return r.length?r:rr(t,n||Ka(t)).map((t,n)=>({...t,kmlId:String(e?.id||``),kmlName:String(e?.name||``).trim()||`未命名 KML`,galleryIndex:n}))}function eo(e,t,n,r,i=null){let a=$a(e,t,i);return a.length?Fi({items:a,index:ar(a,{...n,featureId:String(t?.id||``)}),trigger:r,collectionTitle:String(e?.name||``).trim()||`未命名 KML`,onActiveItemChange:e=>window.activateKmlFeatureForMedia?.(e)}):!1}function to(e,t,n){e&&(Ba(e,t,n),e.querySelectorAll(`.kml-popup-media-image img`).forEach(e=>{e.dataset.kmlPopupMediaFallbackBound!==`true`&&(e.dataset.kmlPopupMediaFallbackBound=`true`,e.addEventListener(`error`,()=>e.closest(`.kml-popup-media-image`)?.classList.add(`is-load-error`),{once:!0}))}),e.querySelectorAll(`[data-kml-popup-media]`).forEach(e=>{e.dataset.kmlPopupMediaBound!==`true`&&(e.dataset.kmlPopupMediaBound=`true`,e.addEventListener(`click`,r=>{r.stopPropagation(),r.preventDefault(),eo(t,n,{id:e.dataset.mediaId,url:e.dataset.mediaUrl,type:e.dataset.mediaType},e)}))}))}function no(){let e=document.getElementById(`kml-feature-content-panel`);return e||(e=document.createElement(`section`),e.id=`kml-feature-content-panel`,e.className=`kml-content-panel`,e.setAttribute(`role`,`dialog`),e.setAttribute(`aria-modal`,`false`),e.hidden=!0,document.body.appendChild(e)),e}function ro(){Ua?.abort(),Ua=null;let e=document.getElementById(`kml-feature-content-panel`);e&&(e.hidden=!0,e.innerHTML=``)}async function io(e,t){if(e?.isPublic&&!e?.isShare&&e.id&&t?.id){Ua?.abort(),Ua=new AbortController;try{let n=await window.fetch(`/api/v1/kml/shared/${encodeURIComponent(e.id)}/features/${encodeURIComponent(t.id)}/content`,{signal:Ua.signal}),r=await n.json();if(!n.ok||r.code!==0)throw Error(r.error?.message||`点位内容加载失败`);return r.result}finally{Ua=null}}return Ka(t)}function ao(e,t){let n=Yn(t),r=Array.isArray(t?.coordinates)&&t.type===`Point`?`${Number(t.coordinates[0]).toFixed(6)}, ${Number(t.coordinates[1]).toFixed(6)}`:``;return`
  ...
  `}function so(e,t,n,r,i,a){return`
  ...
  `}function co(e,t,n){return so(e,t,n,`video`,`视频`,`▶`)}function lo(e,t,n){return so(e,t,n,`audio`,`音频`,`♪`)}function uo(e,t,n){return so(e,t,n,`iframe`,`页面`,`▣`)}function fo(e){return`
  ...
  `}function po(e,t){if(!e.items?.length)return``;let n={image:oo,video:co,audio:lo,iframe:uo,link:fo}[e.type]||fo,r={image:`◫`,video:`▶`,audio:`♪`,iframe:`▣`,link:`↗`}[e.type]||`•`;return`
  ...
  `}function mo(e){e.querySelectorAll(`.kml-content-image-item img`).forEach(e=>{e.addEventListener(`error`,()=>e.closest(`.kml-content-image-item`)?.classList.add(`is-load-error`),{once:!0})})}function ho(e,t,n,r){let i=r?.groups||[];e.querySelectorAll(`[data-kml-media-preview]`).forEach(e=>{e.addEventListener(`click`,()=>{let a=i[Number(e.dataset.kmlMediaGroup)],o=a?.items?.[Number(e.dataset.kmlMediaIndex)];o&&eo(t,n,{id:o.id,url:o.url,type:a.type},e,r)})})}function go(e,t,n,r,i=``){let a=Jn(r?.contentSummary),o=(r?.groups||[]).map(po).join(``);e.innerHTML=`
  ...
  `,e.querySelector(`[data-kml-content-close]`)?.addEventListener(`click`,ro),Ba(e,t,n),mo(e),ho(e,t,n,r)}async function _o(e,t){let n=no();n.hidden=!1,n.innerHTML=`
    <header class="kml-content-header">
      <div>
  ...
  `,n.querySelector(`[data-kml-content-close]`)?.addEventListener(`click`,ro),Ba(n,e,t);try{go(n,e,t,await io(e,t))}catch(r){if(r.name===`AbortError`)return;go(n,e,t,Ka(t),r.message||`点位内容加载失败，已展示本地解析结果。`)}}var vo={image:`包含图片`,video:`包含视频`,audio:`包含音频`,iframe:`包含页面`,link:`包含链接`},yo={image:`#0f766e`,video:`#dc2626`,audio:`#7c3aed`,iframe:`#2563eb`,link:`#475569`},bo={image:`<rect x="8" y="8" width="16" height="13" rx="2"/><circle cx="13" cy="12.5" r="1.5"/><path d="m9.5 19 4.5-4 3 2.5 2-2 3.5 3.5"/>`,video:`<rect x="8" y="8" width="16" height="13" rx="2"/><path d="m14 12 5 3-5 3z"/>`,audio:`<path d="M9 14h3l4-4v10l-4-4H9z"/><path d="M19 12.5a4 4 0 0 1 0 5M21 10a7 7 0 0 1 0 10"/>`,iframe:`<rect x="8" y="8" width="16" height="13" rx="2"/><path d="M8 12h16M11 10h.01M14 10h.01"/>`,link:`<path d="M13.5 17.5 12 19a3 3 0 0 1-4.2-4.2l2.5-2.5a3 3 0 0 1 4.2 0M18.5 12.5 20 11a3 3 0 0 1 4.2 4.2l-2.5 2.5a3 3 0 0 1-4.2 0M12.5 15.5h7"/>`};function xo(e){let t=yo[e],n=bo[e];return!t||!n?``:`<svg viewBox="0 0 32 40" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"><path class="kml-media-marker-pin" fill="${t}" d="M16 1C7.9 1 3 6.7 3 14.1 3 24.2 16 38.5 16 38.5S29 24.2 29 14.1C29 6.7 24.1 1 16 1Z"/><path fill="none" stroke="rgba(255,255,255,.9)" stroke-width="1.2" d="M16 2.5C8.9 2.5 4.5 7.4 4.5 14.1c0 8.1 9.2 19.5 11.5 22.3 2.3-2.8 11.5-14.2 11.5-22.3C27.5 7.4 23.1 2.5 16 2.5Z"/><g fill="none" stroke="#fff" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round">${n}</g></svg>`}function So(e){let t=Qn(e);return vo[t]?{type:t,label:vo[t],html:`<span class="kml-media-marker kml-media-marker-${t}" role="img" aria-label="${vo[t]}">${xo(t)}</span>`,iconSize:[32,40],iconAnchor:[16,39],popupAnchor:[0,-36],tooltipAnchor:[16,-26]}:null}function Co(e){let t=So(e);if(!t)return null;let n=xo(t.type);return{...t,image:`data:image/svg+xml;charset=utf-8,${encodeURIComponent(n)}`}}function wo(e){let t=So(e);return t?`<svg class="svg-icon kml-media-list-icon kml-media-list-icon-${t.type}" viewBox="0 0 32 30" role="img" aria-label="${t.label}" xmlns="http://www.w3.org/2000/svg"><g fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">${bo[t.type]}</g></svg>`:``}var To=`map-service-kml-recovery`,Eo=1,Do=`kml-account-drafts`,Oo=`map_kml_account_recovery_v1:`;function ko(e){return`${Oo}${encodeURIComponent(String(e||``))}`}function Ao(e){return!!(e&&typeof e==`object`&&String(e.userId||``))}function jo(e){return!!(Ao(e)&&e.metadataOnly===!0&&!e.deleted)}function Mo(e){return{userId:String(e.userId),generation:Math.max(0,Number(e.generation||0)),updatedAt:e.updatedAt||new Date().toISOString(),metadataOnly:!0,fileCount:Array.isArray(e.files)?e.files.length:0}}function No(e){return[Number(e?.generation||0),Date.parse(e?.updatedAt||``)||0]}function Po(e,t){let n=No(e),r=No(t);return n[0]>r[0]||n[0]===r[0]&&n[1]>=r[1]}function Fo(e,t){return Po(e,t)&&!Po(t,e)}function Io(e,t){let n=Ao(e)?e:null,r=Ao(t)?t:null,i=Math.max(Number(n?.generation||0),Number(r?.generation||0));return r?.deleted&&(!n||Po(r,n))||r&&!jo(r)&&(!n||Fo(r,n))?{record:r,storageGeneration:i,incompleteWrite:!1}:n?{record:n,storageGeneration:i,incompleteWrite:!!(jo(r)&&Fo(r,n))}:{record:null,storageGeneration:i,incompleteWrite:jo(r)}}function Lo(e,t){if(!e?.getItem)return null;try{let n=JSON.parse(e.getItem(ko(t))||`null`);return Ao(n)?n:null}catch{return null}}function Ro(e,t){if(!e?.setItem)throw Error(`本地恢复存储不可用`);e.setItem(ko(t.userId),JSON.stringify(t))}function zo(e,t){if(!e?.setItem)throw Error(`本地恢复存储不可用`);let n=Lo(e,t.userId);(!n||Po(t,n))&&Ro(e,t)}function Bo(e){return new Promise((t,n)=>{let r=e.open(To,Eo);r.onupgradeneeded=()=>{let e=r.result;e.objectStoreNames.contains(Do)||e.createObjectStore(Do,{keyPath:`userId`})},r.onsuccess=()=>t(r.result),r.onerror=()=>n(r.error||Error(`恢复草稿数据库打开失败`))})}function Vo(e,t,n){return new Promise((r,i)=>{let a;try{a=e.transaction(Do,t);let o=n(a.objectStore(Do));o.onsuccess=()=>r(o.result),o.onerror=()=>i(o.error||Error(`恢复草稿数据库请求失败`)),a.onerror=()=>i(a.error||Error(`恢复草稿数据库事务失败`))}catch(e){i(e)}})}function Ho(e,t){return new Promise((n,r)=>{try{let i=e.transaction(Do,`readwrite`),a=i.objectStore(Do),o=a.get(t.userId);o.onsuccess=()=>{let e=o.result;(!Ao(e)||Po(t,e))&&a.put(t)},o.onerror=()=>r(o.error||Error(`恢复草稿数据库读取失败`)),i.oncomplete=()=>n(),i.onerror=()=>r(i.error||Error(`恢复草稿数据库事务失败`)),i.onabort=()=>r(i.error||Error(`恢复草稿数据库事务已中止`))}catch(e){r(e)}})}function Uo(e={}){let t=e.indexedDB||globalThis.indexedDB,n=e.localStorage||globalThis.localStorage,r=null,i=()=>t?.open?(r||=Bo(t),r):Promise.reject(Error(`IndexedDB 不可用`));return{async get(e,t={}){let r=String(e||``),a=Lo(n,r),o;try{o=await Vo(await i(),`readonly`,e=>e.get(r))}catch(e){if(a){if(a.deleted&&t.includeDeleted!==!0)return null;if(jo(a))throw Error(`IndexedDB 不可用，无法读取完整 KML 恢复草稿`,{cause:e});return structuredClone(a)}throw e}let s=Io(o,a);if(!s.record){if(!s.incompleteWrite)return null;throw Error(`最新 KML 恢复草稿尚未完整写入 IndexedDB`)}if(s.record.deleted&&t.includeDeleted!==!0)return null;let c=structuredClone(s.record);return s.incompleteWrite&&(c.incompleteWrite=!0,c.storageGeneration=s.storageGeneration),c},async put(e){if(!Ao(e))throw TypeError(`恢复草稿记录无效`);let t=structuredClone(e),r=!1;try{zo(n,Mo(t)),r=!0}catch{}try{return await Ho(await i(),t),{persistent:r?`indexeddb+metadata`:`indexeddb`}}catch(e){throw Error(`IndexedDB 不可用，完整 KML 恢复草稿未持久化`,{cause:e})}},async delete(e,t={}){let r={userId:String(e||``),deleted:!0,generation:Math.max(0,Number(t.generation||0)),updatedAt:t.updatedAt||new Date().toISOString()},a=!1;try{zo(n,r),a=!0}catch{}try{await Ho(await i(),r)}catch(e){if(!a)throw e}return{persistent:`deleted`}}}}var Wo=null,Go=null;function Ko(){return Go||(Wo||=Uo(),Wo)}var qo=!1,Jo=!1,Yo=``,Xo=new Map,Zo=new Set,Qo=new Set,$o=[],es=null,ts=!1,ns=!1,rs=!1,is=[],as=0,os=0,ss=null,cs=null,ls=!1,us={state:`guest`,detail:{}},ds=Promise.resolve(!0),fs=new Set([`discard`,`restore`,`save-as-all`,`reload-conflicts`,`save-as-conflicts`]);function ps(e){return typeof structuredClone==`function`?structuredClone(e):JSON.parse(JSON.stringify(e))}function ms(e,t={}){let n=String(t.message||``);return{dirty:{visible:!0,label:`待保存`,tone:`dirty`,title:`修改已写入本机恢复草稿，将在稍后同步`},saving:{visible:!0,label:`保存中…`,tone:`saving`,title:`正在同步到账号`},saved:{visible:!0,label:`已保存`,tone:`saved`,title:`账号 KML 已同步`},loaded:{visible:!0,label:`已保存`,tone:`saved`,title:`已加载账号 KML`},readonly:{visible:!0,label:`只读`,tone:`readonly`,title:`当前账号只能查看 KML`},conflict:{visible:!0,label:`保存冲突`,tone:`conflict`,title:n||`服务器内容已更新，点击处理本地恢复草稿`},error:{visible:!0,label:t.phase===`load`?`加载失败`:`保存失败`,tone:`error`,title:n||(t.phase===`load`?`账号 KML 加载失败`:`账号 KML 保存失败`)}}[e]||{visible:!1,label:``,tone:`guest`,title:``}}function hs(e,t=us){let n=ms(t.state,t.detail);e.hidden=!n.visible,e.textContent=n.label,e.dataset.state=n.tone,e.dataset.actionable=t.state===`conflict`?`true`:`false`,e.title=n.title,`disabled`in e&&(e.disabled=t.state!==`conflict`)}function gs(e=`automatic`){typeof window>`u`||!(window.dispatchEvent instanceof Function)||window.dispatchEvent(new CustomEvent(`map-kml-sync-resolution-request`,{detail:{source:e}}))}function _s(e=`kml-sync-status`){if(typeof window>`u`||typeof document>`u`)return()=>{};let t=document.getElementById(e);if(!t||!(window.addEventListener instanceof Function))return()=>{};let n=e=>{let n=e?.detail||{};hs(t,{state:String(n.state||`guest`),detail:n})},r=()=>{us.state===`conflict`&&gs(`status`)};return window.addEventListener(`map-kml-sync-state`,n),t.addEventListener(`click`,r),hs(t),()=>{window.removeEventListener(`map-kml-sync-state`,n),t.removeEventListener(`click`,r)}}function vs(e,t={}){us={state:e,detail:{...t}},!(typeof window>`u`||!(window.dispatchEvent instanceof Function))&&window.dispatchEvent(new CustomEvent(`map-kml-sync-state`,{detail:{state:e,...t}}))}function ys(e){return{name:String(e.name||`未命名 KML`),description:String(e.description||``),isDefault:!!e.isDefault,coordCorrection:e.coordCorrection||`wgs84-to-gcj02`,theme:e.theme||`default`,color:e.color||`#0f766e`,lockDrag:!!e.lockDrag,enabled:e.enabled!==!1,isLiveTrack:!!e.isLiveTrack,features:Array.isArray(e.features)?e.features:[]}}function bs(e){return JSON.stringify(ys(e))}function xs(e,t=e.id){return{localId:String(t||e.id||``),serverId:String(e.id||e.serverId||``),revision:Number(e.revision||1),hash:bs(e),status:e.status===`trashed`?`trashed`:`active`}}function Ss(e=[]){return e instanceof Map?new Map(e):new Map((e||[]).flatMap(e=>{let t=String(e?.localId||``);return t?[[t,{...e,localId:t}]]:[]}))}function Cs(e,t,n=t?.id){let r=Ss(e),i=String(n||``),a=String(t?.id||t?.serverId||``);return!i||!a||!t||typeof t!=`object`||r.set(i,xs({...t,id:a},i)),r}function ws(e=[]){return Array.isArray(e)?e.slice(0,100).flatMap(e=>{let t=String(e?.action||``);if(![`create`,`update`,`trash`,`restore`].includes(t))return[];let n=String(e?.kmlId||``),r=String(e?.clientId||``);return t===`create`?r&&e?.data&&typeof e.data==`object`?[{action:t,clientId:r,data:ps(e.data)}]:[]:t===`update`?n&&e?.data&&typeof e.data==`object`?[{action:t,kmlId:n,data:ps(e.data)}]:[]:!n&&!r?[]:[{action:t,...n?{kmlId:n}:{clientId:r}}]}):[]}function Ts(e,t){let n=Ss(t?.snapshots),r=new Set([...(t?.files||[]).map(e=>String(e?.id||``)).filter(Boolean),...(t?.deletedClientIds||[]).map(e=>String(e||``)).filter(Boolean)]),i=new Set(Array.from(n.values(),e=>String(e.serverId||``)));for(let t of e||[]){let e=String(t?.syncClientId||``),a=String(t?.id||``);!e||!a||!r.has(e)||n.has(e)||i.has(a)||(n.set(e,xs(t,e)),i.add(a))}return n}function Es(e,t=Xo,n=[]){let r=[],i=new Set;e.forEach(e=>{let n=String(e.id||``);if(!n)return;i.add(n);let a=t.get(n),o=ys(e),s=JSON.stringify(o);a?a.status===`trashed`?r.push(a.serverId?{action:`restore`,kmlId:a.serverId}:{action:`restore`,clientId:n}):a.hash!==s&&r.push({action:`update`,kmlId:a.serverId,data:{...o,revision:a.revision}}):r.push({action:`create`,clientId:n,data:o})}),t.forEach(e=>{!i.has(e.localId)&&e.status!==`trashed`&&r.push({action:`trash`,kmlId:e.serverId})});for(let e of n||[]){let n=String(e||``);!n||i.has(n)||t.has(n)||r.push({action:`trash`,clientId:n})}return r}function Ds(e,t){let n=Ss(e),r=new Set,i=new Set,a=e=>[...n.values()].find(t=>t.serverId===String(e||``));for(let e of t?.results||[]){if(e.action===`create`&&e.document){let t=String(e.clientId||``);t&&(n.set(t,xs(e.document,t)),r.add(t));continue}if(e.action===`update`&&e.document){let t=a(e.document.id),r=String(t?.localId||e.document.syncClientId||e.document.id||``);r&&n.set(r,xs(e.document,r));continue}if(e.action===`trash`){let t=a(e.document?.id||e.result?.id),i=String(e.clientId||t?.localId||``);e.document&&i?n.set(i,xs(e.document,i)):i&&n.set(i,{localId:i,serverId:``,revision:0,hash:``,status:`trashed`}),i&&r.add(i);continue}if(e.action===`restore`){let t=String(e.clientId||``),r=e.document?a(e.document.id):null,o=String(t||r?.localId||e.document?.syncClientId||e.document?.id||``);e.document&&o?n.set(o,xs(e.document,o)):t&&(n.delete(o),i.add(o))}}return{snapshots:n,resolvedLocalIds:[...r],releasedClientIds:[...i]}}function Os(e,t,n,r={}){return{version:1,userId:String(e||``),generation:Math.max(1,Number(r.generation||1)),reason:String(r.reason||`dirty`),updatedAt:r.updatedAt||new Date().toISOString(),files:ps(Array.isArray(t)?t:[]),snapshots:Array.from(Ss(n).values(),e=>({...e})),deletedClientIds:[...new Set(Array.from(r.deletedClientIds||[],e=>String(e||``)).filter(Boolean))],pendingOperations:ws(r.pendingOperations)}}function ks(e,t){if(!e||e.version!==1||String(e.userId||``)!==String(t||``)||!Array.isArray(e.files)||!Array.isArray(e.snapshots))return null;let n=Os(t,e.files,e.snapshots,{generation:e.generation,reason:e.reason,updatedAt:e.updatedAt,deletedClientIds:e.deletedClientIds,pendingOperations:e.pendingOperations});return e.incompleteWrite&&(n.incompleteWrite=!0,n.storageGeneration=Math.max(Number(e.storageGeneration||0),Number(e.generation||0))),n}function As(e){return Math.max(Number(e?.generation||0),Number(e?.storageGeneration||0))}function js(e,t){return Number(e?.generation||0)-Number(t?.generation||0)||(Date.parse(e?.updatedAt||``)||0)-(Date.parse(t?.updatedAt||``)||0)}function Ms(e,t){return e.map(e=>ks(e,t)).filter(Boolean).sort((e,t)=>js(t,e))[0]||null}function Ns(e,t){let n=Ts(e,t),r=Es(t?.files||[],n,t?.deletedClientIds),i=ws(t?.pendingOperations),a=new Map((e||[]).map(e=>[String(e.id||``),e])),o=new Map(Array.from(n.values(),e=>[e.serverId,e])),s=[...new Set(i.filter(e=>e.action===`trash`||e.action===`restore`).map(e=>String(e.clientId||o.get(String(e.kmlId||``))?.localId||``)).filter(Boolean))],c=new Set(s),l=new Map(r.filter(e=>e.action===`update`).map(e=>[e.kmlId,e])),u=new Map(r.filter(e=>e.action===`trash`).map(e=>[e.kmlId,e])),d=[];return n.forEach(e=>{if(c.has(e.localId)||!l.has(e.serverId)&&!u.has(e.serverId))return;let t=a.get(e.serverId);(!t||Number(t.revision||0)!==Number(e.revision||0))&&d.push(e.localId)}),{hasChanges:r.length>0||i.length>0,operations:r,pendingOperations:i,pendingPresenceLocalIds:s,conflictedLocalIds:d,createdLocalIds:r.filter(e=>e.action===`create`).map(e=>e.clientId),updatedLocalIds:r.filter(e=>e.action===`update`).map(e=>o.get(e.kmlId)?.localId).filter(Boolean),restoredLocalIds:r.filter(e=>e.action===`restore`).map(e=>e.clientId||o.get(e.kmlId)?.localId).filter(Boolean),deletedLocalIds:r.filter(e=>e.action===`trash`).map(e=>e.clientId||o.get(e.kmlId)?.localId).filter(Boolean)}}function Ps(e){return`kml-recovery-${globalThis.crypto?.randomUUID?.()||`${Date.now()}-${Math.random().toString(16).slice(2)}`}-${e}`}function Fs(e,t,n,r){let i=ys(e);return{...i,id:r(t),name:`${i.name.slice(0,Math.max(1,200-n.length))}${n}`,isDefault:!1}}function Is(e,t){let n=new Map(Array.from(Ss(t).values(),e=>[e.serverId,e]));return(e||[]).map(e=>{let t=n.get(String(e.id||``));return t?{...ps(e),id:t.localId,serverId:e.id}:ps(e)})}function Ls(e,t,n,r={}){if(!fs.has(n))throw Error(`KML 恢复处理方式无效`);let i=Ns(e,t),a=ps(t?.files||[]),o=new Map(a.map(e=>[String(e.id||``),e])),s=Ts(e,t),c=Is(e,s),l=new Map(c.map(e=>[String(e.id||``),e])),u=r.idFactory||Ps,d=new Set(i.conflictedLocalIds),f=new Set(i.createdLocalIds),p=new Set(i.updatedLocalIds),m=new Set(i.restoredLocalIds),h=new Set(i.deletedLocalIds),g=new Set(i.pendingPresenceLocalIds),_=new Map(Array.from(s.values(),e=>[e.serverId,e])),ee=ws(i.pendingOperations),te=e=>String(e.clientId||_.get(String(e.kmlId||``))?.localId||``),v=n===`restore`?ee:[`reload-conflicts`,`save-as-conflicts`].includes(n)?ee.filter(e=>!d.has(te(e))):[],ne=[...new Set((t?.deletedClientIds||[]).map(e=>String(e||``)).filter(Boolean))],re=(t={})=>{let n=Bs(e,s),r=new Set;return t.preserveConflicts&&d.forEach(e=>r.add(e)),t.preserveRestores&&m.forEach(e=>r.add(e)),t.preservePendingPresence&&g.forEach(e=>r.add(e)),r.forEach(e=>{let t=s.get(e);t&&n.set(e,t)}),n},y=e=>Array.from(e.values(),e=>({...e}));if(n===`discard`)return{files:c,snapshots:y(re()),analysis:i,copiedCount:0,shouldSync:!1,blockedByConflict:!1,deletedClientIds:[],pendingOperations:[]};if(n===`save-as-all`){let e=[...new Set([...f,...p,...m,...g])].flatMap((e,t)=>{let n=o.get(e);return n?[Fs(n,t,`（恢复副本）`,u)]:[]});return{files:[...c,...e],snapshots:y(re()),analysis:i,copiedCount:e.length,shouldSync:e.length>0,blockedByConflict:!1,deletedClientIds:[],pendingOperations:[]}}let b=[],x=new Set,S=[];s.forEach(e=>{let t=e.localId;x.add(t);let r=o.get(t),i=l.get(t),a=d.has(t);if(g.has(t)){r&&b.push(r);return}if(h.has(t)){a&&(n===`reload-conflicts`||n===`save-as-conflicts`)&&i&&b.push(i);return}if(m.has(t)){r&&b.push(r);return}if(p.has(t)){a&&(n===`reload-conflicts`||n===`save-as-conflicts`)?(i&&b.push(i),n===`save-as-conflicts`&&r&&S.push(Fs(r,S.length,`（冲突副本）`,u))):r&&b.push(r);return}i&&b.push(i)}),f.forEach(e=>{x.add(e);let t=o.get(e);t&&b.push(t)}),c.forEach(e=>{x.has(String(e.id||``))||b.push(e)});let ie=[...b,...S],C=re({preserveConflicts:n===`restore`&&i.conflictedLocalIds.length>0,preserveRestores:!0,preservePendingPresence:v.length>0}),ae=new Set(ie.map(e=>String(e?.id||``)).filter(Boolean)),w=ne.filter(e=>!ae.has(e));return{files:ie,snapshots:y(C),analysis:i,copiedCount:S.length,shouldSync:!i.conflictedLocalIds.length||n!==`restore`?v.length>0||Es(ie,C,w).length>0:!1,blockedByConflict:n===`restore`&&i.conflictedLocalIds.length>0,deletedClientIds:w,pendingOperations:v}}async function Rs(e,t=4){let n=Array(e.length),r=0;async function i(){for(;r<e.length;){let t=r;r+=1,n[t]=await qi(`/kml/files/${encodeURIComponent(e[t].id)}`)}}return await Promise.all(Array.from({length:Math.min(t,e.length)},i)),n.filter(Boolean)}async function zs(){let e=[],t=1,n=null;for(;t<=100;){let r=await qi(`/kml/files`,{query:{page:t,limit:100,status:`active`}}),i=Array.isArray(r?.items)?r.items:[];e.push(...i),n=r?.usage||n;let a=Number(r?.total||e.length);if(!i.length||e.length>=a||i.length<100)break;t+=1}return{files:await Rs(e),usage:n}}function Bs(e,t=[]){let n=new Map,r=new Map(Array.from(Ss(t).values(),e=>[e.serverId,e]));return e.forEach(e=>{let t=r.get(String(e.id||``))?.localId||e.id;n.set(t,xs(e,t))}),n}function Vs(e){let t=new Set((e||[]).map(e=>String(e?.id||``)).filter(Boolean));t.forEach(e=>{Qo.delete(e),Xo.has(e)?Zo.delete(e):Zo.add(e)});for(let e of Zo)t.has(e)||(Zo.delete(e),Qo.add(e))}function Hs(e=`dirty`){if(!qo||!Jo||!Yo)return null;os+=1;let t=Os(Yo,is,Xo,{generation:os,reason:e,deletedClientIds:Qo,pendingOperations:$o});ss=t,rs&&(cs={...cs||{},draft:ps(t)});let n=Ko().put(t);return ds=Promise.resolve(n).then(()=>!0,e=>(vs(`error`,{phase:`recovery`,code:`KML_RECOVERY_UNAVAILABLE`,message:`本机恢复草稿保存失败：${e.message}`}),!1)),t}function Us(){Yo&&(os+=1,ss=null,cs=null,Promise.resolve(Ko().delete(Yo,{generation:os})).catch(()=>{}))}function Ws(){if(ls||typeof window>`u`)return;ls=!0;let e=e=>{!qo||!Jo||(rs||$o.length>0||Es(is,Xo,Qo).length>0)&&Hs(e)};window.addEventListener(`pagehide`,()=>e(`pagehide`)),typeof document<`u`&&document.addEventListener(`visibilitychange`,()=>{document.visibilityState===`hidden`&&e(`pagehide`)})}async function Gs(){let e=++as;qo=!1,Jo=!1,Yo=``,Xo=new Map,Zo=new Set,Qo=new Set,$o=[],is=[],ts=!1,ns=!1,rs=!1,ss=null,cs=null,es&&clearTimeout(es),es=null,Ws();let t=await ra();if(e!==as)return{mode:`guest`,files:[]};if(qo=!!(t.authenticated&&ca(`kml.own.read`,t)),Jo=!!(qo&&ca(`kml.own.write`,t)),Yo=qo?String(t.user?.id||``):``,!qo)return vs(`guest`),{mode:`guest`,files:[]};try{let t=await zs();if(!qo||e!==as)return{mode:`guest`,files:[]};is=t.files,Xo=Bs(t.files);let n=null,r=null;if(Jo&&Yo)try{let e=await Ko().get(Yo,{includeDeleted:!0});os=Math.max(os,As(e));let r=ks(e,Yo),i=r?Ns(t.files,r):null;r&&(i?.hasChanges||r.incompleteWrite)?(ss=r,os=Math.max(os,As(r)),n={draft:r,analysis:i}):r&&Us()}catch(e){r=e}return r?vs(`error`,{phase:`recovery`,code:`KML_RECOVERY_UNAVAILABLE`,message:`无法读取本机恢复草稿：${r.message}`}):vs(Jo?`loaded`:`readonly`,{count:t.files.length,readOnly:!Jo}),{mode:`account`,files:t.files,usage:t.usage||null,canWrite:Jo,userId:Yo,recovery:n,recoveryError:r}}catch(t){return!qo||e!==as?{mode:`guest`,files:[]}:(vs(`error`,{phase:`load`,code:t.code,message:t.message}),{mode:`account`,files:[],canWrite:Jo,userId:Yo,error:t})}}function Ks(){return qo}function qs(){return qo&&Jo}function Js(e,t={}){if(!qo||!Jo||!e||typeof e!=`object`)return!1;let n=String(t.localId||e.id||``),r=String(e.id||e.serverId||``);if(!n||!r)return!1;Xo=Cs(Xo,{...e,id:r},n),Zo.delete(n),Qo.delete(n),$o=$o.filter(e=>e.action!==`create`||String(e.clientId||``)!==n);let i=is.findIndex(e=>String(e?.id||``)===n);return i>=0?is.splice(i,1,e):is=[...is,e],!0}function Ys(e,t){let n=e?.results||[],r=Ds(Xo,e);Xo=r.snapshots,r.resolvedLocalIds.forEach(e=>{Zo.delete(e),Qo.delete(e)}),r.releasedClientIds.forEach(e=>{t.some(t=>String(t?.id||``)===e)?(Qo.delete(e),Zo.add(e)):(Zo.delete(e),Qo.add(e))}),n.forEach(e=>{if(e.action===`create`&&e.document){let n=String(e.clientId||``),r=t.find(e=>e.id===n);r&&(r.serverId=e.document.id,r.revision=e.document.revision,r.updatedAt=e.document.updatedAt);return}if((e.action===`update`||e.action===`restore`)&&e.document){let n=[...Xo.values()].find(t=>t.serverId===e.document.id)?.localId||e.document.id,r=t.find(e=>e.id===n);r&&(r.revision=e.document.revision,r.updatedAt=e.document.updatedAt)}})}async function Xs(){if(!qo||!Jo||rs)return;if(ts){ns=!0;return}let e=ws($o),t=e.length>0?e:Es(is,Xo,Qo);if(!t.length){Us(),vs(`saved`);return}let n=as;ts=!0,vs(`saving`,{operationCount:t.length});try{if(e.length===0){$o=ws(t),t=ws($o),Hs(`in-flight`);let e=await ds;if(!qo||n!==as)return;if(!e){$o=[];return}}let r=await qi(`/kml/sync`,{method:`POST`,body:{operations:t}});if(!qo||n!==as)return;$o=[],Ys(r,is);let i=Es(is,Xo,Qo);i.length===0?(Us(),vs(`saved`,{syncedAt:r.syncedAt})):(Hs(`dirty`),vs(`dirty`,{operationCount:i.length}),ns=!0)}catch(e){if(!qo||n!==as)return;if(Number(e?.status||0)>0&&($o=[]),e.code===`KML_REVISION_CONFLICT`){rs=!0;let t=Hs(`conflict`)||ss;cs=t?{draft:ps(t)}:null,vs(`conflict`,{code:e.code,message:e.message,recoveryAvailable:!!t}),gs(`automatic`)}else Hs(`error`),vs(`error`,{code:e.code,message:e.message})}finally{if(n!==as)return;ts=!1,ns&&!rs&&(ns=!1,es&&clearTimeout(es),es=null,await Xs())}}function Zs(e,t={}){is=Array.isArray(e)?e:[],Vs(is),t.persist!==!1&&Jo&&Hs(t.reason||`dirty`)}function Qs(e,t={}){return!qo||!Jo?!1:(is=e,Vs(is),Hs(rs?`conflict`:`dirty`),rs?(vs(`conflict`,{code:`KML_REVISION_CONFLICT`,message:`服务器内容已更新，请先处理保存冲突`,recoveryAvailable:!0}),!0):(es&&clearTimeout(es),es=setTimeout(()=>{es=null,Xs()},t.delayMs===0?0:Number(t.delayMs)||600),ts&&(ns=!0),vs(`dirty`),!0))}async function $s(e,t=null){if(!qo||!Jo||!Yo)throw Error(`当前账号不能恢复 KML 草稿`);let n=String(e||``);if(!fs.has(n))throw Error(`KML 恢复处理方式无效`);let r=as,i=Yo,a=Ko(),o=await a.get(Yo,{includeDeleted:!0});os=Math.max(os,As(o));let s=Ms([t?.draft,cs?.draft,ss,o],Yo);if(!s)throw Error(`没有可恢复的 KML 草稿`);if(o?.deleted&&js(o,s)>=0)throw Error(`KML 恢复草稿已被丢弃`);let c=await zs();if(!qo||!Jo||r!==as||i!==Yo)throw Error(`账号会话已变化，请重新加载 KML`);let l=await a.get(Yo,{includeDeleted:!0});os=Math.max(os,As(l));let u=Ms([ss,l],Yo);if(l?.deleted&&js(l,s)>=0||u&&js(u,s)>0)throw Error(`KML 草稿在处理期间又有更新，请重新选择处理方式`);let d=Ls(c.files,s,n);return Xo=Ss(d.snapshots),is=d.files,Qo=new Set(d.deletedClientIds||[]),$o=ws(d.pendingOperations),Zo=new Set,Vs(is),rs=d.blockedByConflict,cs=d.blockedByConflict?{draft:ps(s),analysis:d.analysis}:null,ss=s,n===`discard`?(Us(),vs(`loaded`,{count:d.files.length})):d.blockedByConflict?(Hs(`conflict`),vs(`conflict`,{code:`KML_REVISION_CONFLICT`,message:`恢复草稿基于旧版本，请选择加载服务器版本或另存为新 KML`,recoveryAvailable:!0})):d.shouldSync?(Hs(`recovery`),vs(`dirty`)):(Us(),vs(`loaded`,{count:d.files.length})),d}async function ec(e){if(![`reload`,`save-as`].includes(e))throw Error(`KML 冲突处理方式无效`);return $s(e===`reload`?`reload-conflicts`:`save-as-conflicts`)}function tc(e={}){e.preserveDraft!==!1&&qo&&Jo&&(rs||$o.length>0||Es(is,Xo,Qo).length>0)&&Hs(e.reason||`session-expired`),as+=1,qo=!1,Jo=!1,Yo=``,Xo=new Map,Zo=new Set,Qo=new Set,$o=[],is=[],ts=!1,ns=!1,rs=!1,ss=null,cs=null,es&&clearTimeout(es),es=null,vs(`guest`)}async function nc(e,t){let n=await t(e.files,e),r=Array.isArray(n)?n:e.files;return e.blockedByConflict?Zs(r,{persist:!1}):e.shouldSync?Qs(r,{delayMs:0}):Zs(r,{persist:!1}),{...e,files:r}}async function rc(e,t){if(!e?.draft||!(t instanceof Function))return null;try{let n=e.analysis||{},r=Number(n.operations?.length||0),i=Number(n.conflictedLocalIds?.length||0),a=i?`其中 ${i} 项基于旧的服务器版本，恢复后会暂停同步并要求处理冲突。`:`服务器版本未变化，恢复后会继续自动同步。`,o=e.draft?.incompleteWrite?`浏览器关闭前最后一次草稿写入未完成，将从最近一份完整草稿恢复。`:``,s=[{value:`restore`,text:e.draft?.incompleteWrite?`使用最近完整草稿`:`恢复草稿`,class:`app-dialog-primary`},...r?[{value:`save-as-all`,text:`另存为新 KML`}]:[],{value:`discard`,text:`丢弃草稿`,class:`app-dialog-danger`}];return nc(await $s(await De({title:`恢复未同步的 KML`,message:`${r?`检测到当前账号有 ${r} 项未完成的 KML 修改。`:``}${a}${o}`,dismissible:!1,choices:s}),e),t)}catch(e){return Ks()&&await Ce(e.message||`KML 恢复失败，请稍后重试`,{title:`无法恢复 KML 草稿`}),null}}function ic(e){if(typeof window>`u`||!(e instanceof Function))return()=>{};let t=!1,n=async()=>{if(!t){t=!0;try{let t=await De({title:`处理 KML 保存冲突`,message:`服务器上的 KML 已被其他客户端更新。自动同步已暂停，本地修改仍保存在当前账号的恢复草稿中。`,cancelText:`保留草稿，稍后处理`,choices:[{value:`reload`,text:`加载服务器版本`,class:`app-dialog-primary`},{value:`save-as`,text:`本地版本另存为`}]});if(!t||t===`cancel`)return;await nc(await ec(t),e)}catch(e){if(!Ks())return;await Ce(e.message||`KML 冲突处理失败，请稍后重试`,{title:`无法处理保存冲突`})}finally{t=!1}}};return window.addEventListener(`map-kml-sync-resolution-request`,n),()=>window.removeEventListener(`map-kml-sync-resolution-request`,n)}var ac=null;function oc(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function sc(e=window.location){let t=/^\/share\/([^/]+)\/?$/.exec(e.pathname||``)?.[1]||(e.pathname===`/3d`||e.pathname===`/3d.html`?new URLSearchParams(e.search||``).get(`share`):``);if(!t)return``;try{return decodeURIComponent(t)}catch{return``}}function cc(e=window.location){return!!sc(e)}function lc(){return ac?{publicId:ac.publicId,manifest:{...ac.manifest}}:null}function uc(e){document.body.classList.add(`share-view`,`share-unavailable`),document.getElementById(`map-lock-screen`)?.remove();let t=document.createElement(`div`);t.id=`map-lock-screen`,t.className=`lock-screen-backdrop`,t.innerHTML=`
    <section class="lock-screen-card" role="alert">
      <div class="lock-screen-icon">🗺️</div>
      <h2>分享暂不可用</h2>
      <p>${oc(e||`该分享不存在、已暂停或已过期。`)}</p>
      <a class="lock-screen-link" href="/">返回地图首页</a>
    </section>
  `,document.body.appendChild(t)}function dc(e){document.getElementById(`map-lock-screen`)?.remove();let t=document.createElement(`div`);t.id=`map-lock-screen`,t.className=`lock-screen-backdrop`,t.innerHTML=`
  ...
  `}function zc(e,t){return`${e}?url=${encodeURIComponent(t).replace(/%7B/g,`{`).replace(/%7D/g,`}`)}`}function Bc(e){let t=e.system,n=e.visits||{},r=t?.userSystem||{},i=r.counts||{},a=t?.package?.version||`-`,o=e.visitsError||(e.visitsLoading?`统计中`:``);return`
    <div class="admin-grid">
      <section class="admin-panel">
        ...
        <dl class="admin-metrics">
          ...
          <div><dt>运行</dt><dd>${Fc(t?.uptime||0)}</dd></div>
          <div><dt>环境</dt><dd>${Q(t?.env||`-`)}</dd></div>
          <div><dt>时间</dt><dd>${Ic(t?.serverTime)}</dd></div>
        </dl>
      </section>
      <section class="admin-panel">
        <div class="admin-panel-head">
        ...
        <dl class="admin-metrics">
          ...
          <div><dt>数据库占用</dt><dd>${Pc(r.database?.allocatedBytes||0)}</dd></div>
          ...
          <div><dt>KML 逻辑用量</dt><dd>${Pc(r.storage?.kmlBytes||0)}</dd></div>
        </dl>
      </section>
  ...
  `}function Vc(e){let t=e.cache||{},n=e.cacheError||(e.cacheLoading?`统计中`:``),r=t.bySource||{},i=e.tileSources||[];return`
    <section class="admin-panel">
      <div class="admin-panel-head">
        <h2>缓存治理</h2>
      ...
      <dl class="admin-metrics admin-metrics-five">
        ...
        <div class="metric-size"><dt>总大小</dt><dd>${Pc(t.bytes||0)}</dd></div>
  ...
  `}async function Hc({api:e,event:t,renderDashboard:n,setNotice:r,showConfirm:i,state:a}){let o=t.target.closest(`[data-admin-action]`);if(!o)return!1;let s=o.getAttribute(`data-admin-action`);if(s===`clear-cache`){if(!await i(`清空所有瓦片缓存？此操作不可逆！`))return!0;try{await e.clearCache(),a.cache=await e.cache(),r(`所有瓦片缓存已清空`),n()}catch(e){r(``,e.message),n()}return!0}if(s===`clear-source-cache`){let t=o.getAttribute(`data-source-id`);if(!t)return!1;let s=(a.tileSources||[]).find(e=>e.id===t),c=s?s.name:t;if(!await i(`确定要清空图源【${c}】的全部瓦片缓存吗？`))return!0;try{await e.clearCache({sourceId:t}),a.cache=await e.cache(),r(`已清空图源【${c}】的专属瓦片缓存`),n()}catch(e){r(``,e.message),n()}return!0}return!1}var Uc={queued:`排队中`,running:`执行中`,pausing:`暂停中`,paused:`已暂停`,completed:`已完成`,completed_with_errors:`完成有错误`,failed:`失败`,interrupted:`已中断`,deleting:`删除中`},Wc=1e3,Gc=1500,Kc=new Set([`queued`,`running`,`pausing`,`deleting`]),qc=null,Jc=0,Yc=``,Xc=``,Zc=null,Qc=0;function $c(e){return Uc[e]||e}var el={queued:`⏳`,running:`⚙`,pausing:`⏸`,paused:`⏸`,completed:`✓`,completed_with_errors:`⚠`,failed:`✗`,interrupted:`⏹`,deleting:`🗑`};function tl(e){return el[e]||`•`}function nl(e,t){let n=t[0],r=e.precacheForm||{};return{providerId:t.some(e=>e.id===r.providerId)?r.providerId:n?.id||``,bounds:{west:Number(r.bounds?.west??113.24),south:Number(r.bounds?.south??23.11),east:Number(r.bounds?.east??113.29),north:Number(r.bounds?.north??23.15)},minZoom:Number(r.minZoom??12),maxZoom:Number(r.maxZoom??12),concurrency:Number(r.concurrency??4),requestIntervalMs:Number(r.requestIntervalMs??0),refresh:!!r.refresh}}function rl(e,t){return e.find(e=>e.id===t.providerId)||e[0]||null}function il(e){let t=e.expandedTaskIds||new Set;return(e.tasks||[]).map(e=>({...e,expanded:t.has(e.id)}))}function al(e=[]){return e.some(e=>Kc.has(e.status))}function ol(e){let t=e.precacheCatalog||[],n=nl(e,t),r=rl(t,n),i=il(e);return`
  ...
  `}function sl(e){let t=e.precacheEstimate;return e.precacheEstimateStatus===`loading`?`<div class="admin-estimate" data-precache-estimate><p>正在估算瓦片数量和下载体积</p></div>`:e.precacheEstimateError?`<div class="admin-estimate is-error" data-precache-estimate><p>${Q(e.precacheEstimateError)}</p></div>`:t?`
    <div class="admin-estimate ${t.withinLimit?``:`is-warning`}" data-precache-estimate>
      <dl class="admin-metrics">
        <div><dt>预计文件</dt><dd>${Q(t.total||0)}</dd></div>
        <div><dt>估算体积</dt><dd>${Pc(t.estimatedBytesRange?.min||0)} - ${Pc(t.estimatedBytesRange?.max||0)}</dd></div>
        <div><dt>建议上限</dt><dd>${Q(t.maxTiles||0)}</dd></div>
        <div><dt>建议</dt><dd>${t.withinLimit?`可以创建`:`任务较大，建议设置请求间隔`}</dd></div>
      </dl>
      <p>${ul(t)}</p>
    </div>
  `:`<div class="admin-estimate" data-precache-estimate><p>停止移动地图后会自动估算任务规模</p></div>`}function cl(e){let t=e.root?.querySelector(`[data-precache-estimate]`);t&&(t.outerHTML=sl(e))}function ll(e){return e.length?e.map(e=>`Z${e.z}: ${e.count}`).join(`，`):`暂无分级明细`}function ul(e){if(e.targetType===`layer`){let t=e.sources||[];return t.length?t.map(e=>`${e.sourceName||e.sourceId}: ${e.total||0} 张，约 ${Pc(e.estimatedBytes||0)}`).join(`，`):`暂无可预缓存图源明细`}return ll(e.ranges||[])}function dl(e){return`
    <section class="admin-panel admin-panel-wide admin-precache-task-panel" data-precache-task-panel>
      ...
      <div class="admin-task-list">
        ${e.slice(0,10).map(e=>fl(e)).join(``)||`<p class="admin-empty">暂无任务</p>`}
      </div>
    </section>
  `}function fl(e){let t=e.expanded;return`
    <article class="admin-task-card">
      <div class="admin-task-main">
        <div class="admin-task-title">
          <span class="admin-status admin-status-${e.status}" title="${Q($c(e.status))}">${Q(tl(e.status))}</span>
          <strong>${Q(e.providerId)}</strong>
          <small>${Ic(e.updatedAt)}</small>
        </div>
        ${pl(e)}
      </div>
      <dl class="admin-task-summary">
        <div><dt>体积</dt><dd>${Pc(e.bytes||0)}</dd></div>
  ...
  `}function pl(e){let t=Number(e.completed||0),n=Number(e.total||0),r=n?Math.min(100,Math.round(t/n*100)):0;return`
    <div class="admin-task-progress">
      <span>${Q(t)} / ${Q(n)} (${r}%)</span>
      <small>成功 ${Q(e.succeeded||0)}，失败 ${Q(e.failed||0)}</small>
    </div>
  `}function ml(e){let t=[`queued`,`running`].includes(e.status),n=[`paused`,`interrupted`,`failed`,`completed_with_errors`].includes(e.status),r=e.status!==`deleting`,i=e.expanded?`收起`:`详情`;return`
  ...
  `}function hl(e){let t=e.bounds||{},n=e.ranges||[],r=e.errors||[],i=Object.values(e.failedTiles||{});return`
    <div class="admin-task-details">
      <dl>
        <div><dt>区域</dt><dd>西 ${Q(t.west)} / 南 ${Q(t.south)} / 东 ${Q(t.east)} / 北 ${Q(t.north)}</dd></div>
        <div><dt>级别明细</dt><dd>${ll(n)}</dd></div>
        <div><dt>失败待重试</dt><dd>${Q(i.length)}</dd></div>
        <div><dt>创建时间</dt><dd>${Ic(e.createdAt)}</dd></div>
        <div><dt>完成时间</dt><dd>${Ic(e.finishedAt)}</dd></div>
      </dl>
      ${i.length?`
  ...
  `}function gl(e,t){Pl(e,t);let n=t.elements.providerId,r=n.options[n.selectedIndex]?.getAttribute(`data-type`)||`source`,i=n.value;return{targetType:r,targetId:i,providerId:i,bounds:{west:Number(t.elements.west.value),south:Number(t.elements.south.value),east:Number(t.elements.east.value),north:Number(t.elements.north.value)},minZoom:Number(t.elements.minZoom.value),maxZoom:Number(t.elements.maxZoom.value),concurrency:Number(t.elements.concurrency.value),requestIntervalMs:Number(t.elements.requestIntervalMs.value),refresh:t.elements.refresh.checked}}function _l(e,t){e.tasks=e.tasks.map(e=>e.id===t.id?t:e)}function vl(e,t){e.tasks=e.tasks.filter(e=>e.id!==t)}function yl(e){let t=e.root?.querySelector(`[data-precache-task-panel]`);t&&(t.outerHTML=dl(il(e)))}function bl(e){return Array.isArray(e)?`[${e.map(bl).join(`,`)}]`:e&&typeof e==`object`?`{${Object.keys(e).sort().map(t=>`${JSON.stringify(t)}:${bl(e[t])}`).join(`,`)}}`:JSON.stringify(e)}function xl(e){Jc+=1,Yc=``,e.precacheEstimate=null,e.precacheEstimateStatus=``,e.precacheEstimateError=``,cl(e)}function Sl(e,t,n=Wc){e.activeTab===`precache`&&(window.clearTimeout(qc),qc=window.setTimeout(()=>{Cl(e,t)},n))}async function Cl(e,t){if(e.activeTab!==`precache`)return;let n=e.root?.querySelector(`[data-precache-form]`);if(!n)return;let r=gl(e,n),i=bl(r);if(i===Xc||i===Yc)return;let a=Jc+1;Jc=a,Yc=i,e.precacheEstimateStatus=`loading`,e.precacheEstimateError=``,cl(e);try{let n=await t.estimateTask(r);if(a!==Jc)return;e.precacheEstimate=n,e.precacheEstimateStatus=``,e.precacheEstimateError=``,Xc=i,Yc=``,cl(e)}catch(t){if(a!==Jc)return;e.precacheEstimate=null,e.precacheEstimateStatus=``,e.precacheEstimateError=t.message,Yc=``,cl(e)}}function wl(e,t,n=Gc){window.clearTimeout(Zc),!(e.activeTab!==`precache`||!al(e.tasks))&&(Zc=window.setTimeout(()=>{Tl(e,t)},n))}async function Tl(e,t){if(e.activeTab!==`precache`)return;let n=Qc+1;Qc=n;try{let r=await t.tasks();if(n!==Qc||e.activeTab!==`precache`)return;e.tasks=r,yl(e),wl(e,t)}catch(n){console.warn(`预缓存任务状态刷新失败`,n),wl(e,t,Gc*2)}}async function El({api:e,event:t,renderDashboard:n,setNotice:r,state:i}){let a=t.target.closest(`[data-precache-form]`),o=t.target.closest(`[data-place-search-form]`);if(a)return t.preventDefault(),e.createTask(gl(i,a)).then(t=>{Array.isArray(t)?(i.tasks=[...t,...i.tasks],r(`成功创建了 ${t.length} 个图源缓存子任务`)):(i.tasks=[t,...i.tasks],r(`预缓存任务已创建`)),n(),wl(i,e,300)}).catch(e=>{r(``,e.message),n()}),!0;if(o){t.preventDefault();let e=o.elements.keyword.value.trim();return e&&await zl(i,e),!0}return!1}async function Dl({api:e,event:t,renderDashboard:n,setNotice:r,showCheckboxConfirm:i,showConfirm:a,state:o}){let s=t.target.closest(`[data-precache-task-action]`);if(s)return await kl({actionTarget:s,api:e,renderDashboard:n,setNotice:r,showCheckboxConfirm:i,showConfirm:a,state:o}),!0;let c=t.target.closest(`[data-place-lng][data-place-lat]`);return c?(Ll(o,Number(c.getAttribute(`data-place-lng`)),Number(c.getAttribute(`data-place-lat`))),!0):t.target.closest(`[data-admin-action]`)?.getAttribute(`data-admin-action`)===`sync-bounds`?(Nl(o),xl(o),Sl(o,e),!0):!1}async function Ol({api:e,event:t,state:n}){let r=t.target.closest(`[data-precache-form]`);return r?(Pl(n,r),xl(n),Sl(n,e),!0):!1}async function kl({actionTarget:e,api:t,renderDashboard:n,setNotice:r,showCheckboxConfirm:i,showConfirm:a,state:o}){let s=e.getAttribute(`data-precache-task-action`),c=e.getAttribute(`data-task-id`),l=o.tasks.find(e=>e.id===c);if(!(!s||!c))try{if(s===`pause`){_l(o,await t.pauseTask(c)),r(`预缓存任务已暂停`),n(),wl(o,t,300);return}if(s===`resume`){_l(o,await t.resumeTask(c)),r(`预缓存任务已继续`),n(),wl(o,t,300);return}if(s===`delete`){let e=!1;if(i instanceof Function){let t=await i(`删除此预缓存任务？执行中的任务会停止并从列表移除。`,{confirmText:`删除`,checkboxLabel:`同时删除该任务范围内已缓存的瓦片文件`});if(!t?.confirmed)return;e=!!t.checked}else if(!await a(`删除此预缓存任务？执行中的任务会停止并从列表移除。`))return;await t.deleteTask(c,{deleteCache:e}),vl(o,c),r(e?`预缓存任务已删除，关联缓存文件清理已提交`:`预缓存任务已删除`),n();return}if(s===`edit`&&l){Il(o,l),xl(o),Sl(o,t),r(`任务参数已回填，可调整后创建新任务`),n();return}if(s===`update`&&l){o.tasks=[await t.createTask({providerId:l.providerId,bounds:l.bounds,minZoom:l.minZoom,maxZoom:l.maxZoom,concurrency:l.concurrency,requestIntervalMs:l.requestIntervalMs||0,refresh:!1}),...o.tasks],r(`更新任务已创建，将跳过新鲜缓存并补齐缺失瓦片`),n(),wl(o,t,300);return}if(s===`toggle-details`){o.expandedTaskIds.has(c)?o.expandedTaskIds.delete(c):o.expandedTaskIds.add(c),n();return}s===`preview`&&l&&(window.location.href=Fl(l))}catch(e){r(``,e.message),n(),wl(o,t,300)}}async function Al(e){return e.AMap?e.AMap:(window._AMapSecurityConfig={securityJsCode:_.securityJsCode},e.amapLoader?(e.AMap=await e.amapLoader.load({key:_.key,version:`2.0`,plugins:_.plugins}).catch(e=>(console.warn(`高德 JSAPI 加载失败，后台地点搜索不可用`,e),null)),e.AMap):(console.warn(`高德 JSAPI Loader 未初始化，后台地点搜索不可用`),null))}function jl(e){let t=e.root.querySelector(`[data-precache-form]`);return{west:Number(t?.elements.west.value),south:Number(t?.elements.south.value),east:Number(t?.elements.east.value),north:Number(t?.elements.north.value)}}function Ml(e,t){let n=e.root.querySelector(`[data-precache-form]`);n&&(n.elements.west.value=t.getWest().toFixed(6),n.elements.south.value=t.getSouth().toFixed(6),n.elements.east.value=t.getEast().toFixed(6),n.elements.north.value=t.getNorth().toFixed(6),Pl(e,n))}function Nl(e){if(!e.map||!e.rectangle)return;let t=e.map.getBounds();e.rectangle.setBounds(t),Ml(e,t)}function Pl(e,t){return t?(e.precacheForm={providerId:t.elements.providerId.value,bounds:{west:Number(t.elements.west.value),south:Number(t.elements.south.value),east:Number(t.elements.east.value),north:Number(t.elements.north.value)},minZoom:Number(t.elements.minZoom.value),maxZoom:Number(t.elements.maxZoom.value),concurrency:Number(t.elements.concurrency.value),requestIntervalMs:Number(t.elements.requestIntervalMs.value),refresh:t.elements.refresh.checked},e.precacheForm):null}function Fl(e){let t=e.bounds||{},n=(Number(t.south)+Number(t.north))/2,r=(Number(t.west)+Number(t.east))/2,i=Number(e.maxZoom||e.minZoom||ee.zoom);if(!Number.isFinite(n)||!Number.isFinite(r))return`/`;let a=[n.toFixed(6),r.toFixed(6),Math.max(3,Math.min(20,i)),0].join(`,`);return`/?coords=${encodeURIComponent(a)}`}function Il(e,t){if(!t)return;let n=t.bounds||{};e.precacheForm={providerId:t.providerId||e.precacheForm?.providerId||``,bounds:{west:Number(n.west),south:Number(n.south),east:Number(n.east),north:Number(n.north)},minZoom:Number(t.minZoom),maxZoom:Number(t.maxZoom),concurrency:Number(t.concurrency||e.precacheForm?.concurrency||4),requestIntervalMs:Number(t.requestIntervalMs||e.precacheForm?.requestIntervalMs||0),refresh:!1}}function Ll(e,t,n,r=15){e.map&&(e.map.setView([n,t],r),Nl(e),e.onPrecacheBoundsChange instanceof Function&&e.onPrecacheBoundsChange())}function Rl(e,t){wl(e,t);let n=e.root.querySelector(`#admin-precache-map`);if(!n)return;e.precacheMapHeight&&(n.style.height=`${e.precacheMapHeight}px`),e.onPrecacheBoundsChange=()=>Sl(e,t),document.querySelectorAll(`.amap-sug-result`).forEach(e=>e.remove()),e.map&&(e.map.remove(),e.map=null,e.rectangle=null);let r=p.default.map(n,{center:ee.center,zoom:Math.min(ee.zoom,13),zoomControl:!0,attributionControl:!1});p.default.tileLayer(zc(te,`https://webst01.is.autonavi.com/appmaptile?style=8&x={x}&y={y}&z={z}`),{minZoom:3,maxZoom:18,keepBuffer:4}).addTo(r);let i=jl(e),a=p.default.latLngBounds([i.south,i.west],[i.north,i.east]);e.rectangle=p.default.rectangle(a,{color:`#0f766e`,weight:2,fillColor:`#f59e0b`,fillOpacity:.14}).addTo(r);let o=!1;r.fitBounds(a),r.on(`moveend zoomend`,()=>Nl(e)),r.on(`moveend zoomend`,()=>{o&&e.onPrecacheBoundsChange instanceof Function&&e.onPrecacheBoundsChange()}),window.requestAnimationFrame(()=>{o=!0}),e.map=r;let s=e.root.querySelector(`[data-place-search-form] input[name="keyword"]`);s&&(s.id=`admin-precache-search-input`,Al(e).then(t=>{t&&t.AutoComplete&&new t.AutoComplete({input:`admin-precache-search-input`}).on(`select`,t=>{if(t.poi?.location){let{lng:n,lat:r}=t.poi.location;Ll(e,n,r)}})}));let c=e.root.querySelector(`.admin-map-resizer`);if(c&&n){let t=0,r=0,i=e=>{t=e.clientY,r=n.offsetHeight,document.addEventListener(`pointermove`,a),document.addEventListener(`pointerup`,o),c.classList.add(`is-dragging`),e.preventDefault()},a=i=>{let a=i.clientY-t,o=Math.min(800,Math.max(150,r+a));n.style.height=`${o}px`,e.precacheMapHeight=o,e.map&&e.map.invalidateSize()},o=()=>{document.removeEventListener(`pointermove`,a),document.removeEventListener(`pointerup`,o),c.classList.remove(`is-dragging`)};c.addEventListener(`pointerdown`,i)}}async function zl(e,t){let n=e.root.querySelector(`[data-place-search-results]`);if(!n)return;let r=await Al(e);if(!r){n.innerHTML=`<p>高德搜索暂不可用</p>`;return}let i=new r.PlaceSearch({pageSize:8,pageIndex:1});n.innerHTML=`<p>正在搜索</p>`,i.search(t,(e,t)=>{if(e!==`complete`||!t?.poiList?.pois?.length){n.innerHTML=`<p>没有找到匹配地点</p>`;return}n.innerHTML=t.poiList.pois.map(e=>{let t=e.location;return`
        <button type="button" data-place-lng="${t.lng}" data-place-lat="${t.lat}">
          <strong>${Q(e.name)}</strong>
          <span>${Q(e.address||e.district||``)}</span>
        </button>
      `}).join(``)})}var Bl=4;function Vl(e){let t=e.settings?.access||{};return`
    <div class="admin-grid">
      <section class="admin-panel">
        <div class="admin-panel-head">
          <h2>访问控制</h2>
        ...
        <form class="admin-form" data-access-form autocomplete="off">
          ...
          <label>
            <span>设置访问密码</span>
            <input name="accessPassword" type="password" autocomplete="new-password" placeholder="${t.hasPassword?`已设置，输入新密码以修改`:`输入至少 ${Bl} 位访问密码`}">
          </label>
          ${t.hasPassword?`
            <label class="admin-check">
  ...
  `}async function Wl({api:e,event:t,renderDashboard:n,setNotice:r,showConfirm:i,state:a}){let o=t.target.closest(`[data-admin-action]`);if(!o)return!1;let s=o.getAttribute(`data-admin-action`),c=o.getAttribute(`data-kml-id`);if(s===`create-blank-kml`){let t=await Ee({title:`新建公共 KML`,fields:[{name:`name`,label:`图层名称`,type:`text`}],values:{name:`新建公共 KML ${a.kmls.length+1}`}});if(!t||!t.name?.trim())return!0;try{r(`正在创建...`),await e.createKml({name:t.name.trim(),status:`draft`,coordCorrection:`wgs84-to-gcj02`,features:[]}),a.kmls=await e.kmls(),r(`新建成功`),n()}catch(e){r(``,e.message),n()}return!0}if(s===`trigger-import`)return document.getElementById(`admin-kml-file-input`)?.click(),!0;if(s===`set-status`){let t=o.getAttribute(`data-kml-status`);try{r(`正在更新状态...`),await e.updateKml(c,{status:t}),a.kmls=await e.kmls(),r(`状态已更新`),n()}catch(e){r(``,e.message),n()}return!0}if(s===`rename`){let t=o.getAttribute(`data-kml-name`),i=await Ee({title:`重命名公共 KML`,fields:[{name:`name`,label:`图层名称`,type:`text`}],values:{name:t}});if(!i||!i.name?.trim()||i.name.trim()===t)return!0;try{r(`正在重命名...`),await e.updateKml(c,{name:i.name.trim()}),a.kmls=await e.kmls(),r(`重命名成功`),n()}catch(e){r(``,e.message),n()}return!0}if(s===`export`){try{r(`正在获取数据...`);let t=await e.getKml(c);r(``);let n=zt(t.name,t.features||[]),i=new Blob([n],{type:`application/vnd.google-earth.kml+xml;charset=utf-8`}),a=URL.createObjectURL(i),o=document.createElement(`a`);o.href=a,o.download=`${t.name}.kml`,document.body.appendChild(o),o.click(),document.body.removeChild(o),URL.revokeObjectURL(a)}catch(e){r(``,e.message),n()}return!0}if(s===`delete`){if(!await i(`确认永久删除此公共 KML 图层及其中所有要素？此操作不可撤销。`))return!0;try{r(`正在删除...`),await e.deleteKml(c),a.kmls=await e.kmls(),r(`删除成功`),n()}catch(e){r(``,e.message),n()}return!0}return!1}async function Gl({api:e,event:t,renderDashboard:n,setNotice:r,state:i}){let a=t.target;if(a.id===`admin-kml-file-input`){let t=a.files[0];if(!t)return!0;let o=new FormData;o.append(`file`,t),o.append(`name`,t.name),o.append(`status`,`draft`),o.append(`coordCorrection`,`wgs84-to-gcj02`);try{r(`正在导入 KML 文件...`),await e.importKml(o),i.kmls=await e.kmls(),r(`导入成功（默认为草稿状态）`),n()}catch(e){r(``,e.message),n()}finally{a.value=``}return!0}if(a.matches(`[data-admin-action="toggle-correction"]`)){let t=a.getAttribute(`data-kml-id`),o=a.checked?`wgs84-to-gcj02`:`none`;try{r(`正在更新纠偏设置...`),await e.updateKml(t,{coordCorrection:o}),i.kmls=await e.kmls(),r(`纠偏设置已更新`),n()}catch(e){r(``,e.message),n()}return!0}return!1}var Kl=216e5,ql=2592e6,Jl=60*1e3,Yl=60*Jl,Xl=24*Yl,Zl={1:256,2:512,3:768},Ql=[[`xyz`,`XYZ 栅格`],[`tms`,`TMS 栅格`],[`xyz-raster`,`XYZ 栅格`],[`tms-raster`,`TMS 栅格`],[`wmts-raster`,`WMTS 栅格`],[`arcgis-raster`,`ArcGIS 栅格`],[`quadkey-raster`,`QuadKey 栅格`],[`time-raster`,`时间序列栅格`],[`mvt`,`MVT 矢量瓦片`],[`vector-tilejson`,`矢量 TileJSON`],[`vector-style`,`矢量 Style JSON`],[`pmtiles-vector`,`PMTiles 矢量`],[`pmtiles-raster`,`PMTiles 栅格`],[`google-map-tiles-api`,`Google Map Tiles API`]],$l=[[`satellite`,`卫星`],[`road`,`街道/道路`],[`street`,`街道/道路`],[`label`,`注记`],[`terrain`,`地形`],[`vector`,`矢量`],[`overlay`,`叠加`],[`weather`,`天气`],[`other`,`其他`],[`custom`,`自定义`]],eu=[[`query`,`Query 参数`],[`header`,`请求头`],[`bearer`,`Bearer Token`],[`session`,`会话/适配器`]],tu=[[`round_robin`,`健康 Key 轮询`],[`priority_failover`,`优先级失败切换`],[`random`,`健康 Key 随机`],[`weighted_round_robin`,`按权重轮询`]],nu=[[`global`,`全局`],[`source`,`图源`],[`publish`,`发布项`]],ru=[[`leaflet`,`Leaflet 栅格`],[`maplibre`,`MapLibre 矢量`],[`cesium`,`Cesium 3D`]],iu=new Set([`mvt`,`vector-tilejson`,`vector-style`,`pmtiles-vector`]),au=new Set([`pmtiles-vector`,`pmtiles-raster`]);function ou(e){return e?.errorMessage||e?.error||``}function su(e,t=``){return e.map(([e,n])=>`<option value="${Q(e)}" ${t===e?`selected`:``}>${Q(n)}</option>`).join(``)}function cu(e,t){return!e||t.some(([t])=>t===e)?``:`<option value="${Q(e)}" selected>${Q(e)}</option>`}function lu(e=``){return Ql.find(([t])=>t===e)?.[1]||e||`-`}function uu(e=``){return iu.has(e)}function du(e=``){return au.has(e)}function fu(e={},t){return e.entry?.[t]||e[t]||``}function pu(e={}){return e.kind===`vector-style`?fu(e,`styleJsonUrl`):e.kind===`vector-tilejson`?fu(e,`tileJsonUrl`):du(e.kind)?fu(e,`pmtilesUrl`):fu(e,`template`)}function mu(e,t=`是`,n=`否`){return e?`<span class="badge-green">${Q(t)}</span>`:`<span class="badge-gray">${Q(n)}</span>`}function hu(e=`ready`){return e===`ready`?`<span class="badge-green">可创建</span>`:e===`requires_adapter`?`<span class="badge-blue">需适配器</span>`:e===`research_only`?`<span class="badge-gray">调研参考</span>`:`<span class="badge-gray">${Q(e)}</span>`}function gu(e=[],t=``){return e.map(e=>`<option value="${Q(e.id)}" ${e.id===t?`selected`:``}>${Q(e.name)} (${Q(e.id)})</option>`).join(``)}function _u(e={},t=[]){return e.requiresKey&&(t.find(t=>(t.allowedPresetIds||[]).includes(e.presetId))||t.find(t=>t.id===`default-${e.vendor}-key-pool`)||t.find(t=>t.vendor===e.vendor&&t.scope===`global`))||null}function vu(e={},t=`申请 Key`){return e.credentialUrl?`<a href="${Q(e.credentialUrl)}" target="_blank" rel="noopener noreferrer" class="btn-link">${Q(t)}</a>`:``}function yu(e){return e===`layer`?`组合图层`:e===`dedicated_source`?`专用图源`:`系统图源`}function bu(e){return e.visibility?.scope===`external_only`?`专用发布`:`系统图源`}function xu(e,t){let n=window.location.origin,r=e.pathSlug,i=e.auth?.mode===`token`?`?token=您的TOKEN`:``,a=`${n}/api/v1/external/${r}/tilejson${i}`,o=`${n}/api/v1/external/${r}/tilejson.json${i}`,s=`${n}/api/v1/external/${r}/style.json${i}`,c=e.targetType===`source`||e.targetType===`dedicated_source`?(t.tileSources||[]).find(t=>t.id===e.targetId):null;if(c&&uu(c.kind)){let t=`${n}/api/v1/external/${r}/tiles/{z}/{x}/{y}.pbf${i}`,a=`${n}/api/v1/external/${r}.pmtiles${i}`,l=c.kind===`vector-style`?s:c.kind===`vector-tilejson`?o:du(c.kind)?a:t,u=c.kind===`vector-style`?`const map = new maplibregl.Map({
  container: 'map',
  style: '${s}'
...
`):`// 当前组合图层没有可用图源`;return`
  ...
  `}function Su(e={},t=[],n=[],r=`proxy`){let i=[`fixed`,`pool`].includes(e.mode)?e.mode:`never`;return`
    <div class="form-grid">
  ...
  `}function Cu(e,t){let n=Number.isFinite(Number(e))?Math.max(0,Number(e)):t;return{days:Math.floor(n/Xl),hours:Math.floor(n%Xl/Yl),minutes:Math.floor(n%Yl/Jl)}}function wu(e,t,n,r){let i=Cu(n,r);return`
    <div class="field-group">
      <label>${t}</label>
  ...
  `}function Tu(e={},t=`cache`){return`
    <div class="checkbox-group">
      <input type="checkbox" id="${t}_enabled" name="${t}_enabled" ${e.enabled===!1?``:`checked`}>
      <label for="${t}_enabled">启用服务端缓存</label>
    </div>
    <div class="form-grid" style="margin-top:10px;">
      ${wu(`${t}_ttl`,`缓存有效时间`,e.ttlMs,Kl)}
      ${wu(`${t}_staleTtl`,`软过期时间`,e.staleTtlMs,ql)}
    </div>
  `}function Eu(e,t,n=`proxy`){return{mode:t.get(`${n}_mode`)||`never`,outboundId:t.get(`${n}_outboundId`)||``,poolId:t.get(`${n}_poolId`)||``,fallbackToDirect:!!e.elements[`${n}_fallbackToDirect`]?.checked}}function Du(e,t){let n=Math.max(0,parseInt(e.get(`${t}_days`)||`0`,10)||0),r=Math.max(0,parseInt(e.get(`${t}_hours`)||`0`,10)||0),i=Math.max(0,parseInt(e.get(`${t}_minutes`)||`0`,10)||0);return n*Xl+r*Yl+i*Jl}function Ou(e,t,n=`cache`){return{enabled:!!e.elements[`${n}_enabled`]?.checked,ttlMs:Du(t,`${n}_ttl`),staleTtlMs:Du(t,`${n}_staleTtl`)}}function ku(e,t){return String(e.get(t)||``).split(`,`).map(e=>e.trim()).filter(Boolean)}function Au(e){return{template:String(e.get(`entry_template`)||``).trim(),styleJsonUrl:String(e.get(`entry_styleJsonUrl`)||``).trim(),tileJsonUrl:String(e.get(`entry_tileJsonUrl`)||``).trim(),pmtilesUrl:String(e.get(`entry_pmtilesUrl`)||``).trim(),glyphsUrl:String(e.get(`entry_glyphsUrl`)||``).trim(),spritesUrl:String(e.get(`entry_spritesUrl`)||``).trim()}}function ju(e,t){return{required:!!e.elements.secrets_required?.checked,keyPoolId:t.get(`secrets_keyPoolId`)||``,placement:t.get(`secrets_placement`)||`query`,paramName:t.get(`secrets_paramName`)||`key`}}function Mu(e,t){return{engine:t.get(`rendering_engine`)||`leaflet`,clients:[e.elements.rendering_client_2d?.checked?`2d`:``,e.elements.rendering_client_3d?.checked?`3d`:``].filter(Boolean),fallbackRasterSourceId:t.get(`rendering_fallbackRasterSourceId`)||``}}function Nu(e,t){return{attribution:t.get(`license_attribution`)||``,termsUrl:t.get(`license_termsUrl`)||``,officialStatus:t.get(`license_officialStatus`)||`official`,licenseType:t.get(`license_licenseType`)||`unknown`,cacheAllowedByLicense:!!e.elements.license_cacheAllowedByLicense?.checked,publicUseAllowed:!!e.elements.license_publicUseAllowed?.checked,chinaPublicUseReviewed:!!e.elements.license_chinaPublicUseReviewed?.checked,chinaPublicUseRisk:t.get(`license_chinaPublicUseRisk`)||``}}function Pu(e,t){let n=Array.from(e.querySelectorAll(`[data-key-row]`)).map(e=>{let t=t=>e.querySelector(`[name="${t}"]`),n={id:t(`key_id`)?.value||``,alias:t(`key_alias`)?.value||``,enabled:!!t(`key_enabled`)?.checked,secretType:t(`key_secretType`)?.value||`api_key`,placement:t(`key_placement`)?.value||`query`,paramName:t(`key_paramName`)?.value||`key`,priority:parseInt(t(`key_priority`)?.value||`100`,10),weight:parseInt(t(`key_weight`)?.value||`1`,10),qpsLimit:parseInt(t(`key_qpsLimit`)?.value||`0`,10),dailyLimit:parseInt(t(`key_dailyLimit`)?.value||`0`,10),monthlyLimit:parseInt(t(`key_monthlyLimit`)?.value||`0`,10)},r=t(`key_secret`)?.value||``;return r&&(n.secret=r),n});return{id:t.get(`id`),name:t.get(`name`),vendor:t.get(`vendor`),enabled:!!e.elements.enabled?.checked,scope:t.get(`scope`)||`global`,strategy:t.get(`strategy`)||`round_robin`,cooldownMs:parseInt(t.get(`cooldownMs`)||`300000`,10),maxRetriesPerRequest:parseInt(t.get(`maxRetriesPerRequest`)||`2`,10),defaultSecretType:t.get(`defaultSecretType`)||`api_key`,defaultPlacement:t.get(`defaultPlacement`)||`query`,defaultParamName:t.get(`defaultParamName`)||`key`,credentialUrl:String(t.get(`credentialUrl`)||``).trim(),allowedPresetIds:ku(t,`allowedPresetIds`),allowedSourceIds:ku(t,`allowedSourceIds`),keys:n,description:t.get(`description`)||``}}function Fu(e,t){if(!e.editingKeyPool||!t)return;let n=e.editingKeyPool.keys||[],r=new Map(n.filter(e=>e.id).map(e=>[e.id,e])),i=Pu(t,new FormData(t));i.keys=i.keys.map((e,t)=>({...n[t]||{},...r.get(e.id)||{},...e})),e.editingKeyPool={...e.editingKeyPool,...i}}function Iu(e={}){let t=e.entry||{};return`
  ...
  `}function Lu(e={},t=[]){let n=e.secrets||{};return`
    <fieldset class="form-card" style="margin-top:15px; padding:15px; background:white;">
  ...
  `}function Ru(e={},t=[]){let n=e.rendering||{},r=n.clients||(uu(e.kind)?[`2d`]:[`2d`,`3d`]),i=t.filter(e=>!uu(e.kind)&&!du(e.kind));return`
    <fieldset class="form-card" style="margin-top:15px; padding:15px; background:white;">
      ...
      <div class="form-grid">
        <div class="field-group">
          ...
          <select name="rendering_engine">
            ${su(ru,n.engine||(uu(e.kind)?`maplibre`:`leaflet`))}
          </select>
        </div>
        <div class="field-group">
  ...
  `}function zu(e={}){let t=e.license||{};return`
    <fieldset class="form-card" style="margin-top:15px; padding:15px; background:white;">
      ...
      <div class="form-grid">
        <div class="field-group">
          ...
          <select name="license_officialStatus">
            ${su([[`official`,`官方`],[`unofficial`,`非官方`],[`community`,`社区`],[`internal`,`内部`]],t.officialStatus||`official`)}
          </select>
        </div>
        <div class="field-group">
          <label>授权类型</label>
          <select name="license_licenseType">
            ${su([[`free`,`免费`],[`api-key`,`API Key`],[`commercial`,`商业授权`],[`unknown`,`未知`]],t.licenseType||`unknown`)}
          </select>
        </div>
      </div>
      <div class="checkbox-group" style="margin-top:0;">
  ...
  `}function Bu(e={}){let t=Number(e.retina?.normalValue);return Zl[t]?String(t):`1`}function Vu(e,t,n,r,i){let a=e!==!1,o=a?i:r;return`
    <button
      type="button"
      ...
      title="点击切换为${Q(o)}"
    >${Q(a?r:i)}</button>
  `}function Hu(e){let t=String(e||``).toUpperCase();return t===`HIT`?`<span class="badge-green">HIT</span>`:t===`MISS`?`<span class="badge-red">MISS</span>`:t===`BYPASS`?`<span class="badge-gray">BYPASS</span>`:t===`REVALIDATED`?`<span class="badge-blue">REVAL</span>`:t===`STALE`?`<span class="badge-blue">STALE</span>`:t===`ERROR`?`<span class="badge-red">ERROR</span>`:`<span class="badge-gray">${Q(t||`-`)}</span>`}function Uu(e){let t=Number(e.statusCode||0);return t>=200&&t<300?`<span class="badge-green">200 OK</span>`:`<span class="badge-red" title="${Q(e.errorMessage||``)}">${Q(e.statusCode||`-`)}</span>`}function Wu(e){return e.proxyOutboundId?`<span class="badge-blue" title="池: ${Q(e.proxyPoolId||``)}">${Q(e.proxyOutboundId)}</span>`:e.proxyPoolId?`<span class="badge-blue">${Q(e.proxyPoolId)}</span>`:e.proxyConfigured?`<span class="badge-red" title="已配置代理，但本次未命中可用出口">代理未命中</span>`:`<span style="color:#94a3b8;">直连</span>`}async function Gu(e,t,n={}){let{tileSources:r=!1,sourcePresets:i=!1,keyPools:a=!1,mapLayers:o=!1,externalPublishes:s=!1,precacheCatalog:c=!0}=n,l=[],u=[];r&&(l.push(t.listTileSources()),u.push(t=>{e.tileSources=t})),i&&(l.push(t.listSourcePresets()),u.push(t=>{e.sourcePresets=t})),a&&(l.push(t.listKeyPools()),u.push(t=>{e.keyPools=t})),o&&(l.push(t.listMapLayers()),u.push(t=>{e.mapLayers=t})),s&&(l.push(t.listExternalPublishes()),u.push(t=>{e.externalPublishes=t})),c&&(l.push(t.precacheCatalog()),u.push(t=>{e.precacheCatalog=t})),(await Promise.all(l)).forEach((e,t)=>u[t](e))}function Ku(e){e.tileSourcesSubTab=e.tileSourcesSubTab||`sources`;let t=[{id:`sources`,label:`图源`},{id:`presets`,label:`图源预设`},{id:`key-pools`,label:`密钥池`},{id:`layers`,label:`图层组合`},{id:`publishes`,label:`发布/API`},{id:`diagnostics`,label:`诊断日志`}],n=``;switch(e.tileSourcesSubTab){case`sources`:n=qu(e);break;case`presets`:n=Ju(e);break;case`key-pools`:n=Xu(e);break;case`layers`:n=Zu(e);break;case`publishes`:n=Qu(e);break;case`diagnostics`:n=$u(e);break;default:n=`<p>未知子页面</p>`}return`
  ...
  `}function qu(e){let t=e.tileSources||[],n=e.editingTileSource;if(n){let r=!t.some(e=>e.id===n.id),i=e.proxyOutbounds||[],a=e.proxyPools||[],o=e.keyPools||[],s=Bu(n),c=n.category||`custom`,l=n.kind||`xyz-raster`;return`
      <div class="form-card">
        ...
        <form data-tile-sources-form="source">
          ...
          <div class="form-grid">
            ...
            <div class="field-group">
              <label>适配器</label>
              <input name="adapter" value="${Q(n.adapter||(uu(l)?`maplibre-style`:`template`))}" placeholder="template / wmts-kvp / maplibre-style / pmtiles">
            </div>
          </div>
          <div class="form-grid">
            <div class="field-group">
    ...
    <table class="item-table">
      ...
      <tbody>
        ${t.map(t=>{let n=e[`test_source_${t.id}`]||``,r=pu(t);return`
            <tr>
              <td>
              ...
              <td>
                ...
                <span class="badge-blue" style="margin-left:4px;">${Q(lu(t.kind))}</span>
                <span class="badge-gray" style="margin-left:4px;">${Q(bu(t))}</span>
              </td>
              <td>
              ...
              <td>
                ${Vu(t.enabled,`source`,t.id,`启用中`,`已禁用`)}
              </td>
              <td>
                <div style="display: flex; flex-direction: column; align-items: flex-start; gap: 4px;">
                  ...
                  ${n&&n!==`loading`&&!n.success?`<span class="test-status test-fail" style="margin-left: 0;" title="${Q(ou(n))}">失败</span>`:``}
                </div>
              </td>
              <td>
  ...
  `}function Ju(e){let t=e.sourcePresets||[],n=e.keyPools||[],r=e.creatingSourceFromPreset;if(r){let e=t.find(e=>e.presetId===r.presetId)||r,i=_u(e,n),a=r.keyPoolId||i?.id||``,o=e.status===`ready`;return`
      <div class="form-card">
        ...
        <form data-tile-sources-form="preset-source">
          ...
          <div class="form-grid">
            <div class="field-group">
              <label>预设类型</label>
              <input value="${Q(`${e.vendor||`custom`} / ${lu(e.kind)}`)}" readonly>
            </div>
            <div class="field-group">
              <label>关联密钥池</label>
              ...
              ${i?`<p style="color:#64748b; font-size:12px; margin:6px 0 0;">已自动匹配：${Q(i.name)} ${vu(i)}</p>`:``}
            </div>
          </div>
    ...
    <table class="item-table">
      ...
      <tbody>
        ${t.map(e=>{let t=pu(e),r=_u(e,n);return`
            <tr>
              <td>
                <strong>${Q(e.name)}</strong>
              ...
              <td>
                ...
                <span class="badge-blue" style="margin-left:4px;">${Q(lu(e.kind))}</span>
              ...
              <td>
                ...
                ${r?`<div style="margin-top:4px;"><span class="badge-gray">${Q(r.name)}</span> ${vu(r)}</div>`:``}
              </td>
              <td>${hu(e.status)}</td>
              <td>
                ${mu(e.cacheAllowedByLicense!==!1,`可缓存`,`禁缓存`)}
                ${mu(!!e.publicUseAllowed,`可公开`,`慎公开`)}
              </td>
              <td>
  ...
  `}function Yu(e,t=!1,n={}){return(e.keys||[]).map((r,i)=>{let a=n[`test_key_${e.id}_${r.id}`]||``,o=!r.hasSecret&&!r.maskedPreview,s=r.secretType||e.defaultSecretType||`api_key`,c=r.placement||e.defaultPlacement||`query`,l=r.paramName||e.defaultParamName||`key`;return`
      <div class="key-row" data-key-row="${i}">
        <div class="key-row-main">
          ...
          <select name="key_secretType">
            ${cu(s,[[`api_key`,`api_key`],[`token`,`token`],[`tk`,`tk`],[`ak`,`ak`],[`appid`,`appid`]])}
            ${su([[`api_key`,`api_key`],[`token`,`token`],[`tk`,`tk`],[`ak`,`ak`],[`appid`,`appid`]],s)}
          </select>
        </div>
        <div class="key-row-main">
        ...
        <div class="flex-actions">
          ...
          ${a&&a!==`loading`&&!a.success?`<span class="test-status test-fail" title="${Q(ou(a))}">不可用</span>`:``}
        </div>
      </div>
    `}).join(``)||`<p style="color:#64748b;">暂无 Key，请添加至少一个 Key。</p>`}function Xu(e){let t=e.keyPools||[],n=e.sourcePresets||[],r=e.tileSources||[],i=e.editingKeyPool;if(i){let a=!t.some(e=>e.id===i.id);return`
      <div class="form-card">
          ...
          <div class="form-grid">
            <div class="field-group">
              ...
              <select name="defaultSecretType">
                ${cu(i.defaultSecretType||`api_key`,[[`api_key`,`api_key`],[`token`,`token`],[`tk`,`tk`],[`ak`,`ak`],[`appid`,`appid`]])}
                ${su([[`api_key`,`api_key`],[`token`,`token`],[`tk`,`tk`],[`ak`,`ak`],[`appid`,`appid`]],i.defaultSecretType||`api_key`)}
              </select>
            </div>
            <div class="field-group">
              ...
              <div style="display:grid; grid-template-columns: 1fr 1fr; gap:8px;">
                <select name="defaultPlacement">
                  ${su(eu,i.defaultPlacement||`query`)}
                </select>
        ...
        ${t.map(t=>{let n=e[`test_key_pool_${t.id}`]||``,r=(t.keys||[]).filter(e=>e.enabled!==!1).length;return`
            <tr>
              <td>
                <strong>${Q(t.name)}</strong>
                <div style="color:#64748b; font-size:11px; margin-top:2px;">${Q(t.id)}</div>
                ${t.credentialUrl?`<div style="margin-top:4px;">${vu(t,`申请 / 管理 Key`)}</div>`:``}
              </td>
              <td>
                <span class="badge-gray">${Q(t.vendor)}</span>
                <span class="badge-blue" style="margin-left:4px;">${Q(tu.find(([e])=>e===t.strategy)?.[1]||t.strategy)}</span>
              ...
              <td>
                ...
                ${n&&n!==`loading`&&!n.success?`<span class="test-status test-fail" title="${Q(ou(n))}">失败</span>`:``}
              </td>
              <td>${Vu(t.enabled,`key-pool`,t.id,`启用中`,`已禁用`)}</td>
              <td>
                <div class="flex-actions">
  ...
  `}function Zu(e){let t=e.mapLayers||[],n=e.editingMapLayer;if(n){let r=!t.some(e=>e.id===n.id),i=e.tileSources||[],a=n.items||[{sourceId:``,opacity:1,zIndex:0}];return`
      <div class="form-card">
              ...
              ${a.map((e,t)=>`
                <div class="layer-item-row" data-layer-item-index="${t}">
                  ...
                  <select name="item_sourceId" required>
                    ...
                    ${i.map(t=>`<option value="${t.id}" ${e.sourceId===t.id?`selected`:``}>${Q(t.name)} (${t.id} / ${lu(t.kind)})</option>`).join(``)}
                  </select>
      ...
      <tbody>
        ${t.map(t=>`
          <tr>
            ...
            <td>
              ${Vu(t.enabled,`layer`,t.id,`启用中`,`已禁用`)}
            </td>
            <td>
  ...
  `}function Qu(e){let t=e.externalPublishes||[],n=e.editingExternalPublish,r=e.selectedPublishId||t[0]?.id||``;if(n){let r=!t.some(e=>e.id===n.id),i=e.tileSources||[],a=i.filter(e=>e.visibility?.scope!==`external_only`&&e.permissions?.externalApiAllowed!==!1),o=i.filter(e=>e.visibility?.scope===`external_only`),s=e.mapLayers||[],c=e.proxyOutbounds||[],l=e.proxyPools||[],u=n.targetType||`source`,d=u===`layer`?s.map(e=>`<option value="${e.id}" ${n.targetId===e.id?`selected`:``}>${Q(e.name)} (${e.id})</option>`).join(``):u===`dedicated_source`?o.map(e=>`<option value="${e.id}" ${n.targetId===e.id?`selected`:``}>${Q(e.name)} (${e.id} / ${lu(e.kind)})</option>`).join(``):a.map(e=>`<option value="${e.id}" ${n.targetId===e.id?`selected`:``}>${Q(e.name)} (${e.id} / ${lu(e.kind)})</option>`).join(``),f=n.overrides?.proxy||null,p=n.overrides?.cache||null;return`
      <div class="form-card">
        ...
        <form data-tile-sources-form="publish">
          ...
          <div class="form-grid">
            ...
            <div class="field-group">
              ...
              <select name="targetId" required>
                <option value="">请选择${Q(yu(u))}</option>
                ${d}
              </select>
            </div>
          </div>
          ...
          <fieldset class="form-card" style="margin-top:15px; padding:15px; background:white;">
            ...
            ${Su(f||{mode:`never`},c,l,`publish_proxy`)}
          </fieldset>
    ...
    `}let i=e.lastGeneratedToken?`<div class="admin-token-notice">
       ...
       </div>`:``,a=t.find(e=>e.id===r),o=``;return a&&(o=xu(a,e)),`
    ${i}
      ...
      <tbody>
        ${t.map(t=>{let n=e[`test_publish_${t.id}`]||``;return`
            <tr style="background: ${t.id===r?`#f0fdfa`:`transparent`}; cursor:pointer;" data-tile-sources-select-publish="${t.id}">
              ...
              <td style="white-space: nowrap;"><span class="badge-gray">${Q(yu(t.targetType))}</span></td>
              ...
              <td style="white-space: nowrap;">
                ${Vu(t.enabled,`publish`,t.id,`已发布`,`已禁用`)}
              </td>
              <td style="white-space: nowrap;">
    ...
    ${o}
  `}function $u(e){e.diagnosticsLogType=e.diagnosticsLogType||`source`;let t=e.diagnosticsPublishId||``,n=e.diagnosticsSourceId||``,r=e.externalPublishes||[],i=e.tileSources||[],a=e.diagnosticsLogType===`source`,o=a?e.sourceAccessLogs||[]:e.diagnosticLogs||[],s=a?e.sourceAccessLogsError||``:e.diagnosticLogsError||``;return`
    <div class="admin-panel-head">
      <h3>运行诊断日志</h3>
      <div style="display:flex; gap:10px; align-items:center;">
    ...
    `}else a=`
            ...
            ${t.map(t=>{let n=e[`test_outbound_${t.id}`]||``;return`
                <tr>
                  ...
                  <td>
                    ...
                    ${n&&n!==`loading`&&!n.success?`<span class="test-status test-fail" title="${Q(sd(n))}">失败: ${Q(sd(n))}</span>`:``}
                  </td>
                  <td>
      ...
      <div>
        ...
        <table class="item-table">
          ...
          <tbody>
            ${n.map(t=>{let n=e[`test_pool_${t.id}`]||``,r=n&&n!==`loading`?cd(n):null;return`
                <tr>
                  <td>
                    <strong>${Q(t.name)}</strong>
                    <div style="color: #64748b; font-size:11px; margin-top:2px;">${Q(t.id)}</div>
  ...
  `).join(``)}function bd(e,t,n=1){let r=e?.[t];return r==null||r===``?``:Number(r)/n}function xd(e,t){return{...e.adminUserFilters,page:t,limit:e.adminUsers?.limit||20}}async function Sd(e,t,n=e.adminUsers?.page||1){e.adminUsers=await t.listUsers(xd(e,n))}function Cd(e){let t=e.adminUsers||{items:[]},n=t.items||[],r=e.roles||[],i=Lc(e,`admin.user.manage`),a=Lc(e,`admin.role.manage`),o=e.adminUserFilters||{};return`
        ...
        <form class="admin-filter-form" data-admin-users-filter>
          ...
          <label>
            ...
            <select name="status">
              ...
              ${_d.map(([e,t])=>`<option value="${e}" ${o.status===e?`selected`:``}>${t}</option>`).join(``)}
            </select>
          </label>
          <label>
            <span>角色</span>
            ...
            <tbody>
              ${n.map(e=>`
                <tr>
                  ...
                  <td>
                    <span class="admin-state-pill is-${Q(e.status)}">${Q(vd(e.status))}</span>
                  ...
                  <td>
                    <small class="admin-cell-secondary">登录：${Q(Ic(e.lastLoginAt))}</small>
                    <small class="admin-cell-secondary">创建：${Q(Ic(e.createdAt))}</small>
                  </td>
                  <td>
                    ...
                    ${i?`
                      <details class="admin-inline-details">
                        ...
                        <form class="admin-user-edit-form" data-admin-user-edit data-user-id="${Q(e.id)}">
                          ...
                          <label>
                            <span>账号状态</span>
                            <select name="status">${_d.map(([t,n])=>`<option value="${t}" ${e.status===t?`selected`:``}>${n}</option>`).join(``)}</select>
                          </label>
                          ...
                          <fieldset>
                            ...
                            <label><span>KML 文件数</span><input name="maxKmlFiles" type="number" min="1" max="10000" value="${bd(e.quota,`maxKmlFiles`)}"></label>
                            <label><span>单文件上限（MB）</span><input name="maxKmlFileMb" type="number" min="1" max="100" value="${bd(e.quota,`maxKmlFileBytes`,1024*1024)}"></label>
                            <label><span>单文件要素数</span><input name="maxFeaturesPerKml" type="number" min="1" max="1000000" value="${bd(e.quota,`maxFeaturesPerKml`)}"></label>
                            <label><span>总要素数</span><input name="maxFeaturesPerUser" type="number" min="1" max="5000000" value="${bd(e.quota,`maxFeaturesPerUser`)}"></label>
                            <label><span>回收站天数</span><input name="trashRetentionDays" type="number" min="1" max="3650" value="${bd(e.quota,`trashRetentionDays`)}"></label>
                          </fieldset>
          ...
          <form class="admin-form admin-user-create-form" data-admin-user-create autocomplete="off">
            ...
            ${a?`
              <fieldset class="admin-permission-fieldset">
                <legend>初始角色</legend>
                <div class="admin-checkbox-grid">${yd(r,[`user`])}</div>
              </fieldset>
            `:``}
  ...
  `}async function wd({api:e,event:t,renderDashboard:n,setNotice:r,state:i}){let a=t.target.closest(`[data-admin-users-filter]`);if(a){t.preventDefault();let o=new FormData(a);i.adminUserFilters={search:String(o.get(`search`)||``).trim(),status:String(o.get(`status`)||``),role:String(o.get(`role`)||``)};try{r(`正在筛选用户...`),await Sd(i,e,1),r(``)}catch(e){r(``,e.message)}return n(),!0}let o=t.target.closest(`[data-admin-user-create]`);if(o){t.preventDefault();let a=new FormData(o),s={username:String(a.get(`username`)||``).trim(),displayName:String(a.get(`displayName`)||``).trim(),email:String(a.get(`email`)||``).trim(),roles:a.getAll(`roles`).map(String)},c=String(a.get(`password`)||``);c&&(s.password=c),s.roles.length||(s.roles=[`user`]);try{r(`正在创建用户...`);let t=await gd(e,()=>e.createUser(s));await Sd(i,e,1),o.reset(),r(`用户创建成功`),n(),await Ce(`用户名：${t.user?.username||s.username}\n临时密码：${t.temporaryPassword}\n请通过安全渠道交付，关闭后将不再显示。`,{title:`临时密码（仅显示一次）`,confirmText:`我已安全保存`})}catch(e){r(``,e.code===`ACTION_CANCELLED`?``:e.message),n()}return!0}let s=t.target.closest(`[data-admin-user-roles]`);if(s){t.preventDefault();let a=new FormData(s).getAll(`roles`).map(String);if(!a.length)return r(``,`用户至少需要一个角色`),!0;try{r(`正在更新用户角色...`),await gd(e,()=>e.updateUserRoles(s.dataset.userId,a)),await Sd(i,e),r(`角色已更新，用户原有会话已失效`)}catch(e){r(``,e.code===`ACTION_CANCELLED`?``:e.message)}return n(),!0}let c=t.target.closest(`[data-admin-user-edit]`);if(c){t.preventDefault();let a=new FormData(c),o={},s=!1;if([[`maxKmlFiles`,1],[`maxKmlFileBytes`,1024*1024,`maxKmlFileMb`],[`maxFeaturesPerKml`,1],[`maxFeaturesPerUser`,1],[`trashRetentionDays`,1]].forEach(([e,t,n=e])=>{let r=String(a.get(n)||``).trim();if(!r)return;let i=Number(r);if(!Number.isFinite(i)||i<=0){s=!0;return}o[e]=Math.round(i*t)}),s)return r(``,`个人配额必须为大于 0 的数字，或留空继承系统默认`),!0;let l={displayName:String(a.get(`displayName`)||``).trim(),status:String(a.get(`status`)||``),quota:o};a.get(`replaceEmail`)&&(l.email=String(a.get(`email`)||``).trim());try{r(`正在更新用户资料与配额...`),await gd(e,()=>e.updateUser(c.dataset.userId,l)),await Sd(i,e),r(`用户资料与配额已更新`)}catch(e){r(``,e.code===`ACTION_CANCELLED`?``:e.message)}return n(),!0}return!1}async function Td({api:e,event:t,renderDashboard:n,setNotice:r,showConfirm:i,state:a}){let o=t.target.closest(`[data-admin-action]`);if(!o)return!1;let s=o.dataset.adminAction,c=o.dataset.userId;if(s===`users-page`){let t=Number(o.dataset.page||1);if(t<1)return!0;try{r(`正在加载用户...`),await Sd(a,e,t),r(``)}catch(e){r(``,e.message)}return n(),!0}let l=(a.adminUsers?.items||[]).find(e=>e.id===c);if(!l)return!1;if(s===`reset-user-password`){if(!await i(`确认重置用户“${l.username}”的密码？其全部会话将立即失效。`,{title:`重置用户密码`,confirmText:`确认重置`}))return!0;try{r(`正在重置密码...`);let t=await gd(e,()=>e.resetUserPassword(c));await Sd(a,e),r(`密码已重置`),n(),await Ce(`临时密码：${t.temporaryPassword}\n请通过安全渠道交付，关闭后将不再显示。`,{title:`临时密码（仅显示一次）`,confirmText:`我已安全保存`})}catch(e){r(``,e.code===`ACTION_CANCELLED`?``:e.message),n()}return!0}if(s===`revoke-user-sessions`){if(!await i(`确认强制退出用户“${l.username}”的所有登录会话？`,{title:`强制退出`,confirmText:`确认退出全部会话`}))return!0;try{r(`正在注销用户会话...`);let t=await e.revokeUserSessions(c);r(`已注销 ${Number(t.revokedCount||0)} 个会话`)}catch(e){r(``,e.message)}return n(),!0}return!1}var Ed=Object.freeze([[`account.self.read`,`查看个人账号`],[`account.self.update`,`修改个人账号`],[`session.self.manage`,`管理个人会话`],[`kml.own.read`,`查看个人 KML`],[`kml.own.write`,`管理个人 KML`],[`share.own.manage`,`管理个人分享`],[`favorite.own.manage`,`管理个人收藏`],[`admin.overview.read`,`查看后台概览`],[`admin.cache.manage`,`管理缓存`],[`admin.precache.manage`,`管理预缓存任务`],[`admin.layer.manage`,`管理图源、图层和代理`],[`admin.public_kml.manage`,`管理公共 KML 图层`],[`admin.share.moderate`,`治理用户分享`],[`admin.audit.read`,`查看审计日志`],[`admin.user.read`,`查看用户列表`],[`admin.user.manage`,`管理用户`],[`admin.role.manage`,`管理角色和权限`],[`admin.registration.manage`,`管理注册策略`],[`admin.security.manage`,`管理安全策略`],[`kml.any.read`,`读取任意用户 KML`],[`kml.any.manage`,`管理任意用户 KML`]]);function Dd(e){return e.startsWith(`admin.`)?`后台管理`:e.startsWith(`kml.any.`)?`跨用户数据`:`个人能力`}function Od(e=[],t=``){let n=new Set(e),r=new Map;return Ed.forEach(([e,t])=>{let n=Dd(e);r.has(n)||r.set(n,[]),r.get(n).push([e,t])}),[...r.entries()].map(([e,t])=>`
    <fieldset class="admin-permission-fieldset">
      <legend>${Q(e)}</legend>
  ...
  `}function Ad(e){let t=e.roles||[];return`
    <div class="admin-user-system-stack">
      <section class="admin-panel">
        <div class="admin-panel-head">
          <div>
        ...
        <div class="admin-role-grid">
          ${t.filter(e=>e.builtIn).map(kd).join(``)||`<p class="admin-empty">暂无内置角色数据</p>`}
        </div>
      </section>
  ...
  `}function jd(e,t=!1){let n=new FormData(e),r={name:String(n.get(`name`)||``).trim(),description:String(n.get(`description`)||``).trim(),permissions:n.getAll(`permissions`).map(String)};return t&&(r.code=String(n.get(`code`)||``).trim().toLowerCase()),r}async function Md({api:e,event:t,renderDashboard:n,setNotice:r,state:i}){let a=t.target.closest(`[data-admin-role-create]`);if(a){t.preventDefault();try{r(`正在创建角色...`),await gd(e,()=>e.createRole(jd(a,!0))),i.roles=await e.listRoles(),r(`角色已创建`)}catch(e){r(``,e.code===`ACTION_CANCELLED`?``:e.message)}return n(),!0}let o=t.target.closest(`[data-admin-role-edit]`);if(o){t.preventDefault();try{r(`正在保存角色...`),await gd(e,()=>e.updateRole(o.dataset.roleId,jd(o))),i.roles=await e.listRoles(),r(`角色已更新，受影响用户需重新登录`)}catch(e){r(``,e.code===`ACTION_CANCELLED`?``:e.message)}return n(),!0}return!1}async function Nd({api:e,event:t,renderDashboard:n,setNotice:r,showConfirm:i,state:a}){let o=t.target.closest(`[data-admin-action="delete-role"]`);if(!o)return!1;if(!await i(`确认删除自定义角色“${o.dataset.roleName||``}”？`,{title:`删除角色`,confirmText:`确认删除`}))return!0;try{r(`正在删除角色...`),await gd(e,()=>e.deleteRole(o.dataset.roleId)),a.roles=await e.listRoles(),r(`角色已删除`)}catch(e){r(``,e.code===`ACTION_CANCELLED`?``:e.message)}return n(),!0}var Pd=60*1e3,Fd=60*Pd,Id=24*Fd;function Ld(e,t=1){let n=Number(e||0)/t;return Number.isFinite(n)?n:0}function Rd(e){return(e.roles||[]).filter(e=>{let t=e.permissions||[];return e.code===`user`||!t.some(e=>e.startsWith(`admin.`)||e.startsWith(`kml.any.`)||e===`system.super_admin`)})}function zd(e){let t=e.userSystemSettings||{},n=t.registration||{},r=t.session||{},i=t.quota||{},a=t.share||{},o=Lc(e,`admin.registration.manage`),s=Lc(e,`admin.security.manage`),c=Rd(e),l=new Set(n.defaultRoleCodes||[`user`]);return`
    <div class="admin-user-system-stack">
      ...
      ${s?`
        <section class="admin-panel">
          ...
          <form class="admin-form" data-admin-user-security-settings>
            <div class="admin-field-grid admin-field-grid-three">
              <label><span>普通会话有效期（天）</span><input name="sessionTtlDays" type="number" min="1" max="30" step="1" value="${Ld(r.ttlMs,Id)}" required></label>
              <label><span>记住登录有效期（天）</span><input name="rememberTtlDays" type="number" min="1" max="90" step="1" value="${Ld(r.rememberTtlMs,Id)}" required></label>
              <label><span>高风险操作再验证窗口（分钟）</span><input name="reauthMinutes" type="number" min="1" max="60" step="1" value="${Ld(r.reauthWindowMs,Pd)}" required></label>
            </div>
            ...
            <fieldset class="admin-permission-fieldset">
              ...
              <div class="admin-field-grid admin-field-grid-three">
                ...
                <label><span>单个 KML 上限（MB）</span><input name="maxKmlFileMb" type="number" min="1" max="100" value="${Ld(i.maxKmlFileBytes,1024*1024)}" required></label>
              ...
              <p class="admin-field-help">当前单文件限制：${Q(Pc(i.maxKmlFileBytes||0))}</p>
            </fieldset>
            ...
            <fieldset class="admin-permission-fieldset">
              ...
              <div class="admin-field-grid admin-field-grid-three">
                ...
                <label><span>分享密码授权有效期（小时）</span><input name="shareAccessHours" type="number" min="1" max="168" value="${Ld(a.accessTtlMs,Fd)}" required></label>
              </div>
            </fieldset>
  ...
  `}function Bd(e,t){return Number.parseInt(String(e.get(t)||``),10)}async function Vd({api:e,event:t,renderDashboard:n,setNotice:r,state:i}){let a=t.target.closest(`[data-admin-registration-settings]`);if(a){t.preventDefault();let o=new FormData(a),s=[...new Set(o.getAll(`defaultRoleCodes`).map(String))];try{r(`正在保存注册策略...`),i.userSystemSettings=await gd(e,()=>e.updateUserSystemSettings({registration:{mode:String(o.get(`mode`)||`closed`),defaultRoleCodes:s}})),r(`注册策略已更新`)}catch(e){r(``,e.code===`ACTION_CANCELLED`?``:e.message)}return n(),!0}let o=t.target.closest(`[data-admin-user-security-settings]`);if(o){t.preventDefault();let a=new FormData(o),s={session:{ttlMs:Bd(a,`sessionTtlDays`)*Id,rememberTtlMs:Bd(a,`rememberTtlDays`)*Id,reauthWindowMs:Bd(a,`reauthMinutes`)*Pd},quota:{maxKmlFiles:Bd(a,`maxKmlFiles`),maxKmlFileBytes:Bd(a,`maxKmlFileMb`)*1024*1024,maxFeaturesPerKml:Bd(a,`maxFeaturesPerKml`),maxFeaturesPerUser:Bd(a,`maxFeaturesPerUser`),trashRetentionDays:Bd(a,`trashRetentionDays`)},share:{publicAccessPolicy:String(a.get(`publicAccessPolicy`)||`inherit_site_access`),maxFilesPerShare:Bd(a,`maxFilesPerShare`),accessTtlMs:Bd(a,`shareAccessHours`)*Fd}};try{r(`正在保存用户体系策略...`),i.userSystemSettings=await gd(e,()=>e.updateUserSystemSettings(s)),r(`用户体系策略已更新`)}catch(e){r(``,e.code===`ACTION_CANCELLED`?``:e.message)}return n(),!0}return!1}var Hd=[[`active`,`有效`],[`paused`,`已暂停`],[`blocked`,`已封禁`],[`expired`,`已过期`],[`revoked`,`已撤销`],[`draft`,`草稿`]];function Ud(e){return Hd.find(([t])=>t===e)?.[1]||e||`-`}function Wd(e,t){return{...e.shareFilters,page:t,limit:e.moderatedShares?.limit||20}}async function Gd(e,t,n=e.moderatedShares?.page||1){e.moderatedShares=await t.listUserShares(Wd(e,n))}function Kd(e){let t=e.moderatedShares||{items:[]},n=e.shareFilters||{};return`
    <div class="admin-user-system-stack">
      <section class="admin-panel">
        <div class="admin-panel-head">
          <div>
        ...
        <form class="admin-filter-form admin-filter-form-compact" data-admin-share-filter>
          ...
          <label>
            ...
            <select name="status">
              <option value="">全部状态</option>
              ${Hd.map(([e,t])=>`<option value="${e}" ${n.status===e?`selected`:``}>${t}</option>`).join(``)}
            </select>
          </label>
          <button type="submit">筛选</button>
        </form>
            ...
            <tbody>
              ${(t.items||[]).map(e=>`
                <tr>
                  ...
                  <td>
                    <span class="admin-state-pill is-${Q(e.status)}">${Q(Ud(e.status))}</span>
                  ...
                  <td>
                    ...
                    <small class="admin-cell-secondary">最近：${Q(Ic(e.lastAccessedAt))}</small>
                    <small class="admin-cell-secondary">到期：${Q(Ic(e.expiresAt))}</small>
                  </td>
                  <td>
                    <div class="admin-row-actions">
  ...
  `}async function qd({api:e,event:t,renderDashboard:n,setNotice:r,state:i}){let a=t.target.closest(`[data-admin-share-filter]`);if(!a)return!1;t.preventDefault();let o=new FormData(a);i.shareFilters={search:String(o.get(`search`)||``).trim(),status:String(o.get(`status`)||``)};try{r(`正在筛选分享...`),await Gd(i,e,1),r(``)}catch(e){r(``,e.message)}return n(),!0}async function Jd({api:e,event:t,renderDashboard:n,setNotice:r,showConfirm:i,state:a}){let o=t.target.closest(`[data-admin-action]`);if(!o)return!1;let s=o.dataset.adminAction;if(s===`shares-page`){let t=Number(o.dataset.page||1);if(t<1)return!0;try{r(`正在加载分享...`),await Gd(a,e,t),r(``)}catch(e){r(``,e.message)}return n(),!0}if(s===`block-share`){let t=await Ee({title:`封禁分享：${o.dataset.shareTitle||``}`,fields:[{name:`reason`,label:`封禁原因`,type:`textarea`}],values:{reason:``},confirmText:`确认封禁`}),i=String(t?.reason||``).trim();if(!i)return!0;try{r(`正在封禁分享...`),await e.blockUserShare(o.dataset.shareId,i),await Gd(a,e),r(`分享已封禁，公开访问立即失效`)}catch(e){r(``,e.message)}return n(),!0}if(s===`unblock-share`){if(!await i(`解除封禁后，分享将进入暂停状态，由所有者决定是否恢复公开。`,{title:`解除分享封禁`,confirmText:`解除封禁`}))return!0;try{r(`正在解除封禁...`),await e.unblockUserShare(o.dataset.shareId),await Gd(a,e),r(`已解除封禁，分享当前为暂停状态`)}catch(e){r(``,e.message)}return n(),!0}return!1}function Yd(e,t){return{...e.auditFilters,page:t,limit:e.auditLogs?.limit||20}}async function Xd(e,t,n=e.auditLogs?.page||1){e.auditLogs=await t.listAuditLogs(Yd(e,n))}function Zd(e){try{let t=JSON.stringify(e||{},null,2);return t.length>4e3?`${t.slice(0,4e3)}\n…已截断`:t}catch{return`{}`}}function Qd(e){let t=e.auditLogs||{items:[]},n=e.auditFilters||{};return`
    <div class="admin-user-system-stack">
      <section class="admin-panel">
        <div class="admin-panel-head">
          <div>
          ...
          ${(t.items||[]).map(e=>`
            <article class="admin-audit-entry">
              <header>
                ...
                <time datetime="${Q(e.createdAt||``)}">${Q(Ic(e.createdAt))}</time>
              </header>
              <dl>
  ...
  `}async function $d({api:e,event:t,renderDashboard:n,setNotice:r,state:i}){let a=t.target.closest(`[data-admin-audit-filter]`);if(!a)return!1;t.preventDefault();let o=new FormData(a);i.auditFilters={action:String(o.get(`action`)||``).trim(),targetType:String(o.get(`targetType`)||``).trim()};try{r(`正在筛选审计日志...`),await Xd(i,e,1),r(``)}catch(e){r(``,e.message)}return n(),!0}async function ef({api:e,event:t,renderDashboard:n,setNotice:r,state:i}){let a=t.target.closest(`[data-admin-action="audit-page"]`);if(!a)return!1;let o=Number(a.dataset.page||1);if(o<1)return!0;try{r(`正在加载审计日志...`),await Xd(i,e,o),r(``)}catch(e){r(``,e.message)}return n(),!0}function tf(e){let t=e?.user?.permissions||e?.permissions||[];return Array.isArray(t)?t:[]}function nf(e,t){if(!t)return!!(e?.user||e?.username);let n=tf(e);return n.includes(`system.super_admin`)||n.includes(t)}function rf(e,t){return e?e.permissions?e.permissions.some(e=>nf(t,e)):nf(t,e.permission):!1}function af(e,t){return e.filter(e=>rf(e,t))}var of=[{id:`overview`,label:`概览`,permission:`admin.overview.read`,render:Bc},{id:`cache`,label:`缓存`,permission:`admin.cache.manage`,render:Vc,handleClick:Hc},{id:`kml`,label:`公共 KML`,permission:`admin.public_kml.manage`,render:Ul,handleClick:Wl,handleChange:Gl},{id:`precache`,label:`预缓存`,permission:`admin.precache.manage`,render:ol,afterRender:Rl,afterEnter:Sl,afterLoad:Sl,handleSubmit:El,handleClick:Dl,handleChange:Ol},{id:`tile-sources`,label:`图源管理`,permission:`admin.layer.manage`,render:Ku,afterEnter:ed,afterLoad:ed,handleClick:id,handleSubmit:ad,handleChange:od},{id:`proxy`,label:`代理配置`,permission:`admin.layer.manage`,render:ld,afterEnter:ud,afterLoad:ud,handleClick:dd,handleSubmit:fd,handleChange:pd},{id:`settings`,label:`站点设置`,permission:`admin.security.manage`,render:Vl,handleSubmit:Hl},{id:`users`,label:`用户管理`,permission:`admin.user.read`,render:Cd,handleClick:Td,handleSubmit:wd},{id:`roles`,label:`角色权限`,permission:`admin.role.manage`,render:Ad,handleClick:Nd,handleSubmit:Md},{id:`user-system`,label:`用户体系设置`,permissions:[`admin.registration.manage`,`admin.security.manage`],render:zd,handleSubmit:Vd},{id:`shares`,label:`分享治理`,permission:`admin.share.moderate`,render:Kd,handleClick:Jd,handleSubmit:qd},{id:`audit`,label:`审计日志`,permission:`admin.audit.read`,render:Qd,handleClick:ef,handleSubmit:$d}];function sf(e){return af(of,e)}function cf(e){return`/admin/${lf(e).id}`}function lf(e){return of.find(t=>t.id===e)||of[0]}function uf(e,t){let n=sf(t);return n.find(t=>t.id===e)||n[0]||null}function df(e){return of.some(t=>t.id===e)}function ff(e){return e.pathname===`/admin`||e.pathname.startsWith(`/admin/`)||new URLSearchParams(e.search).get(`view`)===`admin`}function pf(e){let[,t,n]=e.pathname.split(`/`);if(t===`admin`)return df(n)?n:`overview`;let r=new URLSearchParams(e.search).get(`tab`);return df(r)?r:`overview`}function mf(e){if(!e.message&&!e.error&&!e.loading)return``;let t=e.error||e.message||`正在加载`,n=!!e.error,r=!e.error&&(e.message===`正在加载`||e.message===`正在登录`||e.loading);return`
  ...
  `}function hf(e){e.root.innerHTML=`
  ...
  `}function gf(e){let t=e.session?.user?.username||``;e.root.innerHTML=`
    <section class="admin-login">
  ...
  `}function _f(e,t){let n=sf(e.session),r=e.session?.user||{};e.root.innerHTML=`
    <section class="admin-shell">
      ...
      <div class="admin-layout">
        <nav class="admin-tabs" aria-label="后台导航">
          ${n.map(t=>`
            <a href="${cf(t.id)}" data-admin-tab="${t.id}" class="${e.activeTab===t.id?`is-active`:``}">
              ${Q(t.label)}
            </a>
          `).join(``)}
        </nav>
  ...
  `}var $={root:null,activeTab:`overview`,loading:!1,message:``,error:``,session:null,system:null,cache:null,cacheLoading:!1,cacheError:``,visits:null,visitsLoading:!1,visitsError:``,settings:null,userSystemSettings:null,tasks:[],kmls:[],adminUsers:{items:[],page:1,limit:20,total:0},adminUserFilters:{search:``,status:``,role:``},roles:[],moderatedShares:{items:[],page:1,limit:20,total:0},shareFilters:{search:``,status:``},auditLogs:{items:[],page:1,limit:20,total:0},auditFilters:{action:``,targetType:``},precacheForm:{providerId:``,bounds:{west:113.24,south:23.11,east:113.29,north:23.15},minZoom:12,maxZoom:12,concurrency:4,requestIntervalMs:0,refresh:!1},precacheEstimate:null,precacheEstimateStatus:``,precacheEstimateError:``,expandedTaskIds:new Set,amapLoader:null,AMap:null,map:null,rectangle:null,precacheMapHeight:260},vf=null;function yf(e){vf=e}function bf(e=``,t=``){$.message=e,$.error=t,vf&&vf(e,t)}function xf(e){df(e)&&($.activeTab=e)}var Sf=null;function Cf(){$.session?$.session.user?.mustChangePassword?gf($):kf():hf($)}yf((e,t)=>{Sf&&=(clearTimeout(Sf),null);let n=t||e;n&&n!==`正在加载`&&n!==`正在登录`&&(Sf=setTimeout(()=>{bf(``),Cf()},4e3))});function wf(){return pf(window.location)}function Tf(e){window.history.replaceState(null,``,`${cf(e)}${window.location.hash}`)}function Ef(){return uf($.activeTab,$.session)}function Df(){let e=Ef();return e?(e.id!==$.activeTab&&(xf(e.id),Tf(e.id)),e):null}function Of(){let e=Df();return e?e.render($):`
      <section class="admin-panel">
        <h2>无后台访问权限</h2>
        <p class="admin-panel-description">当前账号没有可用的管理权限，请联系超级管理员。</p>
      </section>
    `}function kf(){_f($,Of()),Ef()?.afterRender?.($,Z)}window.renderDashboard=kf;function Af(e){return{api:Z,event:e,renderDashboard:kf,setNotice:bf,showCheckboxConfirm:Te,showConfirm:we,state:$}}function jf(...e){$.session&&(!e.length||e.includes($.activeTab))&&kf()}async function Mf(e,t){let n=Ef()?.[e];return n instanceof Function?!!await n(Af(t)):!1}function Nf(e){if(e?.authenticated===!1||!e?.user){let e=Error(`请先登录管理后台`);throw e.status=401,e.code=`AUTH_REQUIRED`,e}return e}async function Pf(e={}){let t=!!e.cacheOnly,n=nf($.session,`admin.cache.manage`),r=nf($.session,`admin.overview.read`);Object.assign($,{cacheLoading:n,cacheError:``,visitsLoading:t?$.visitsLoading:r,visitsError:t?$.visitsError:``}),jf(`overview`,`cache`),n&&Z.cache().then(e=>{$.cache=e,$.cacheError=``,e.refreshing&&window.setTimeout(()=>Pf({cacheOnly:!0}),1500)}).catch(e=>{$.cacheError=e.message}).finally(()=>{$.cacheLoading=!1,jf(`cache`)}),!(t||!r)&&Z.visits().then(e=>{$.visits=e,$.visitsError=``}).catch(e=>{$.visitsError=e.message}).finally(()=>{$.visitsLoading=!1,jf(`overview`)})}function Ff(e){let t=e=>nf($.session,e);t(`admin.overview.read`)&&e.push([`system`,()=>Z.system()]),t(`admin.security.manage`)&&e.push([`settings`,()=>Z.settings()]),t(`admin.precache.manage`)&&(e.push([`tasks`,()=>Z.tasks()]),e.push([`precacheCatalog`,()=>Z.precacheCatalog()])),t(`admin.public_kml.manage`)&&e.push([`kmls`,()=>Z.kmls()]),t(`admin.layer.manage`)&&e.push([`tileSources`,()=>Z.listTileSources()],[`sourcePresets`,()=>Z.listSourcePresets()],[`keyPools`,()=>Z.listKeyPools()],[`mapLayers`,()=>Z.listMapLayers()],[`proxyOutbounds`,()=>Z.listProxyOutbounds()],[`proxyPools`,()=>Z.listProxyPools()],[`externalPublishes`,()=>Z.listExternalPublishes()]),t(`admin.user.read`)&&e.push([`adminUsers`,()=>Z.listUsers({...$.adminUserFilters,page:1,limit:$.adminUsers.limit})]),t(`admin.role.manage`)&&e.push([`roles`,()=>Z.listRoles()]),(t(`admin.registration.manage`)||t(`admin.security.manage`))&&e.push([`userSystemSettings`,()=>Z.getUserSystemSettings()]),t(`admin.share.moderate`)&&e.push([`moderatedShares`,()=>Z.listUserShares({...$.shareFilters,page:1,limit:$.moderatedShares.limit})]),t(`admin.audit.read`)&&e.push([`auditLogs`,()=>Z.listAuditLogs({...$.auditFilters,page:1,limit:$.auditLogs.limit})])}async function If(){$.loading=!0,bf(`正在加载`),$.session||hf($);try{if($.session=Nf(await Z.session()),$.session.user.mustChangePassword){$.loading=!1,bf(``),gf($);return}Df();let e=[];Ff(e),(await Promise.all(e.map(async([e,t])=>[e,await t()]))).forEach(([e,t])=>{$[e]=t}),$.loading=!1,bf(``),kf(),Ef()?.afterLoad?.($,Z),Pf()}catch(e){$.loading=!1,e.status===401?($.session=null,bf(``,e.message),hf($)):(bf(``,e.message),Cf())}}async function Lf(e){let t=e.target.closest(`[data-admin-login]`);if(t){e.preventDefault();let n={username:t.elements.username.value,password:t.elements.password.value,remember:!!t.elements.remember.checked};bf(`正在登录`),hf($);try{await Ac(n),bf(``),await If()}catch(e){$.session=null,bf(``,e.message),hf($)}return}let n=e.target.closest(`[data-admin-required-password]`);if(n){e.preventDefault();let t=n.elements.currentPassword.value,r=n.elements.newPassword.value;if(r!==n.elements.confirmPassword.value){bf(``,`两次输入的新密码不一致`),gf($);return}try{bf(`正在修改密码`),gf($),await Z.updatePassword({currentPassword:t,newPassword:r}),$.session=null,bf(`密码修改成功，正在加载后台`),await If()}catch(e){bf(``,e.message),gf($)}return}await Mf(`handleSubmit`,e)}async function Rf(e){let t=e.target.closest(`[data-admin-tab]`);if(t){e.preventDefault();let n=uf(t.getAttribute(`data-admin-tab`),$.session);if(!n)return;xf(n.id),Tf(n.id),kf(),Ef()?.afterEnter?.($,Z);return}let n=e.target.closest(`[data-admin-action]`);if(n){let e=n.getAttribute(`data-admin-action`);if(e===`logout`){try{await jc()}catch(e){if(e.status!==401){bf(``,e.message),Cf();return}}$.session=null,bf(``),hf($);return}if(e===`refresh`){await If();return}if(e===`close-notice`){bf(``),Cf();return}}await Mf(`handleClick`,e)}async function zf(e){await Mf(`handleChange`,e)}async function Bf(e={}){document.body.classList.add(`admin-view`),xf(wf()),$.amapLoader=e.amapLoader||null,$.root=document.getElementById(`admin-root`),$.root.hidden=!1,$.root.addEventListener(`submit`,Lf),$.root.addEventListener(`click`,Rf),$.root.addEventListener(`change`,zf),$.root.addEventListener(`input`,zf),hf($),await If()}function Vf(e){let t=e?.user?.permissions||[];return t.includes(`system.super_admin`)||t.some(e=>e.startsWith(`admin.`))}function Hf(e,t,n){if(!e)return;let r=n.authenticated?n.user?.displayName||n.user?.username||`用户`:`登录 / 注册`;e.dataset.authenticated=String(!!n.authenticated),e.setAttribute(`aria-label`,n.authenticated?`用户中心：${r}`:`登录或注册`),e.setAttribute(`title`,n.authenticated?`用户中心 · ${r}`:`登录 / 注册`);let i=e.querySelector(`[data-account-entry-label]`);i&&(i.textContent=n.authenticated?r:`登录`),t&&(t.hidden=!Vf(n))}function Uf(e={}){let t=e.button||document.querySelector(`[data-action="openAccount"]`),n=e.adminItem||document.querySelector(`[data-admin-identity-item]`),r=e=>Hf(t,n,e);r(ea());let i=ta(r);return ra().catch(()=>r(ea())),i}function Wf(){`serviceWorker`in navigator&&window.addEventListener(`load`,()=>{navigator.serviceWorker.register(`/sw.js`).catch(e=>{console.warn(`Service Worker 注册失败`,e)})})}async function Gf(e){let{init:t,title:n=`私有地图服务`,message:r=`管理员启用了访问控制，请输入密码解锁`,submitText:i=`载入地图`,loadingText:a=`正在验证...`}=e;try{(await Mc()).required?Kf({init:t,title:n,message:r,submitText:i,loadingText:a}):await t()}catch(e){console.error(`Failed to check map access status`,e),Kf({init:t,title:n,message:`访问状态检查失败，请稍后重试`,submitText:i,loadingText:a,allowRetry:!0})}}function Kf(e){let{init:t,title:n,message:r,submitText:i,loadingText:a,allowRetry:o=!1}=e;document.getElementById(`map-lock-screen`)?.remove();let s=document.createElement(`div`);s.id=`map-lock-screen`,s.className=`lock-screen-backdrop`,s.innerHTML=`
    <div class="lock-screen-card">
      <div class="lock-screen-icon">🔒</div>
      <h2>${Q(n)}</h2>
      <p>${Q(r)}</p>
  ...
  `,document.body.appendChild(s);let c=document.getElementById(`lock-screen-form`),l=document.getElementById(`lock-screen-error`);s.querySelector(`[data-lock-retry]`)?.addEventListener(`click`,()=>{s.remove(),Gf({init:t,title:n,submitText:i,loadingText:a})}),c.addEventListener(`submit`,async e=>{e.preventDefault(),l.style.display=`none`;let n=c.elements.password.value.trim();if(!n)return;let r=c.querySelector(`button[type="submit"]`);try{r.disabled=!0,r.textContent=a,await Nc(n),s.remove(),await t()}catch(e){r.disabled=!1,r.textContent=i,l.textContent=e.message||`访问密码错误`,l.style.display=`block`}})}export{Tt as $,Va as A,ee as At,Ji as B,tc as C,A as Ct,to as D,ae as Dt,So as E,T as Et,aa as F,o as Ft,Pt as G,zt as H,sa as I,s as It,ct as J,Nt as K,ra as L,u as Lt,ea as M,re as Mt,ca as N,f as Nt,_o as O,E as Ot,ia as P,d as Pt,jt as Q,oa as R,l as Rt,Qs as S,O as St,wo as T,N as Tt,It as U,qi as V,Ft as W,Dt as X,V as Y,yt as Z,_s as _,De as _t,ff as a,pt as at,qs as b,ye as bt,Oc as c,z as ct,lc as d,ot as dt,Et as et,cc as f,Ze as ft,rc as g,Ce as gt,ic as h,Xe as ht,Bf as i,mt as it,Na as j,ne as jt,Qa as k,_ as kt,yc as l,gt as lt,pc as m,it as mt,Wf as n,ft as nt,Q as o,B as ot,mc as p,Ye as pt,st as q,Uf as r,St as rt,Dc as s,bt as st,Gf as t,ht as tt,vc as u,wt as ut,Gs as v,we as vt,Co as w,M as wt,Js as x,_e as xt,Ks as y,Ee as yt,ta as z};