...
`)}function Xn(e){let t=String(e||``).toLowerCase();return/(?:picture|photo|image)/.test(t)?`image`:/video/.test(t)?`video`:/(?:sound|audio)/.test(t)?`audio`:``}function Zn(e,t={}){let{references:n}=Hn(e?.description||``,t),r=Gn(n),i=n.flatMap((e,n)=>{if(Kn(e,r))return[];let i=Wn(e.url.toString(),{...t,index:n,typeHint:e.typeHint});return i.accepted?e.typeHint||i.item.type:[]}),a=Xn(e?.styleUrl);return[...new Set([a,...i].filter(Boolean))]}function Qn(e,t={}){return Zn(e,t)[0]||``}var $n=new Set([`image`,`video`,`audio`,`iframe`]);function er(e,t,n){let r=/description-link-(\d+)$/i.exec(String(e?.id||``));if(r)return Number(r[1]);let i=Number(e?.sortOrder);return Number.isFinite(i)?i:1e5+t*1e4+n}function tr(e,t){return e?e instanceof Map?e.get(t)||null:e[t]||null:null}function nr(e){try{return new URL(e).hostname}catch{return``}}function rr(e,t,n={}){let r=t||qn(e,n.contentOptions),i=String(e?.name||``).trim()||`未命名点位`,a=String(e?.id||``),o=[];return(r?.groups||[]).forEach((t,n)=>{$n.has(t?.type)&&(t.items||[]).forEach((r,s)=>{let c=String(r?.title||``).trim();o.push({...r,title:c&&c!==nr(r?.url)?c:i,type:t.type,featureId:a,featureName:i,featureType:String(e?.type||``),sourceOrder:er(r,n,s)})})}),o.sort((e,t)=>e.sourceOrder-t.sourceOrder),o.map((e,t)=>({...e,featureMediaIndex:t,galleryId:`${a||`feature`}:${e.id||e.type}:${t}`}))}function ir(e,t={}){let n=Array.isArray(e?.features)?e.features:[],r=String(e?.id||``),i=String(e?.name||``).trim()||`未命名 KML`;return n.flatMap((e,n)=>{let a=String(e?.id||``);return rr(e,tr(t.featureViews,a),t).map(e=>({...e,kmlId:r,kmlName:i,featureIndex:n}))}).map((e,t)=>({...e,galleryIndex:t}))}function ar(e,t={}){if(!Array.isArray(e)||!e.length)return 0;let n=String(t.featureId||``),r=String(t.id||``),i=String(t.url||``),a=String(t.type||``),o=Number(t.featureMediaIndex),s=e.findIndex(e=>n&&e.featureId!==n||a&&e.type!==a?!1:r&&e.id===r||i&&e.url===i&&(!a||e.type===a)||!r&&!i&&a?!0:Number.isInteger(o)&&e.featureMediaIndex===o);return s===-1&&n&&(s=e.findIndex(e=>e.featureId===n)),s===-1?0:s}function or(e,t={}){let n=Math.max(1,Number.parseInt(t.limit,10)||4),r=t.view||qn(e,t.contentOptions),i=rr(e,r,t),a=i.length>n?Math.max(1,n-1):n,o=i.slice(0,a);return{items:o,overflowItem:i[o.length]||null,total:i.length,remaining:Math.max(0,i.length-a),contentSummary:r?.contentSummary||{}}}typeof window<`u`&&(window.NodeList&&!NodeList.prototype.forEach&&(NodeList.prototype.forEach=Array.prototype.forEach),typeof window.CustomEvent!=`function`&&(window.CustomEvent=function(e,t){t||={bubbles:!1,cancelable:!1,detail:null};var n=document.createEvent(`CustomEvent`);return n.initCustomEvent(e,t.bubbles,t.cancelable,t.detail),n}));var sr=typeof document<`u`&&!!document.documentMode,cr;function lr(){return cr||=document.createElement(`div`).style}var ur=[`webkit`,`moz`,`ms`],dr={};function fr(e){if(dr[e])return dr[e];let t=lr();if(e in t)return dr[e]=e;let n=e[0].toUpperCase()+e.slice(1),r=ur.length;for(;r--;){let i=`${ur[r]}${n}`;if(i in t)return dr[e]=i}}function pr(e,t){return parseFloat(t[fr(e)])||0}function mr(e,t,n=window.getComputedStyle(e)){let r=t===`border`?`Width`:``;return{left:pr(`${t}Left${r}`,n),right:pr(`${t}Right${r}`,n),top:pr(`${t}Top${r}`,n),bottom:pr(`${t}Bottom${r}`,n)}}function hr(e,t,n){e.style[fr(t)]=n}function gr(e,t){hr(e,`transition`,`${fr(`transform`)} ${t.duration}ms ${t.easing}`)}function _r(e,{x:t,y:n,scale:r,isSVG:i},a){if(hr(e,`transform`,`scale(${r}) translate(${t}px, ${n}px)`),i&&sr){let t=window.getComputedStyle(e).getPropertyValue(`transform`);e.setAttribute(`transform`,t)}}function vr(e){let t=e.parentNode;(!t||t.nodeType!==1)&&(t=document.documentElement);let n=window.getComputedStyle(e),r=window.getComputedStyle(t),i=e.getBoundingClientRect(),a=t.getBoundingClientRect();return{elem:{style:n,width:i.width,height:i.height,top:i.top,bottom:i.bottom,left:i.left,right:i.right,margin:mr(e,`margin`,n),border:mr(e,`border`,n)},parent:{style:r,width:a.width,height:a.height,top:a.top,bottom:a.bottom,left:a.left,right:a.right,padding:mr(t,`padding`,r),border:mr(t,`border`,r)}}}var yr={down:`mousedown`,move:`mousemove`,up:`mouseup mouseleave`};typeof window<`u`&&(typeof window.PointerEvent==`function`?yr={down:`pointerdown`,move:`pointermove`,up:`pointerup pointerleave pointercancel`}:typeof window.TouchEvent==`function`&&(yr={down:`touchstart`,move:`touchmove`,up:`touchend touchcancel`}));function br(e,t,n,r){yr[e].split(` `).forEach(e=>{t.addEventListener(e,n,r)})}function xr(e,t,n){yr[e].split(` `).forEach(e=>{t.removeEventListener(e,n)})}function Sr(e,t){let n=e.length;for(;n--;)if(e[n].pointerId===t.pointerId)return n;return-1}function Cr(e,t){let n;if(t.touches){n=0;for(let r of t.touches)r.pointerId=n++,Cr(e,r);return}n=Sr(e,t),n>-1&&e.splice(n,1),e.push(t)}function wr(e,t){if(t.touches){for(;e.length;)e.pop();return}let n=Sr(e,t);n>-1&&e.splice(n,1)}function Tr(e){e=e.slice(0);let t=e.pop(),n;for(;n=e.pop();)t={clientX:(n.clientX-t.clientX)/2+t.clientX,clientY:(n.clientY-t.clientY)/2+t.clientY};return t}function Er(e){if(e.length<2)return 0;let t=e[0],n=e[1];return Math.sqrt(Math.abs(n.clientX-t.clientX)**2+Math.abs(n.clientY-t.clientY)**2)}function Dr(e){let t=e;for(;t&&t.parentNode;){if(t.parentNode===document)return!0;t=t.parentNode instanceof ShadowRoot?t.parentNode.host:t.parentNode}return!1}function Or(e){return(e.getAttribute(`class`)||``).trim()}function kr(e,t){return e.nodeType===1&&` ${Or(e)} `.indexOf(` ${t} `)>-1}function Ar(e,t){for(let n=e;n!=null;n=n.parentNode)if(kr(n,t.excludeClass)||t.exclude.indexOf(n)>-1)return!0;return!1}var jr=/^http:[\w\.\/]+svg$/;function Mr(e){return jr.test(e.namespaceURI)&&e.nodeName.toLowerCase()!==`svg`}function Nr(e){let t={};for(let n in e)e.hasOwnProperty(n)&&(t[n]=e[n]);return t}var Pr={animate:!1,canvas:!1,cursor:`move`,disablePan:!1,disableZoom:!1,disableXAxis:!1,disableYAxis:!1,duration:200,easing:`ease-in-out`,exclude:[],excludeClass:`panzoom-exclude`,handleStartEvent:e=>{e.preventDefault(),e.stopPropagation()},maxScale:4,minScale:.125,overflow:`hidden`,panOnlyWhenZoomed:!1,pinchAndPan:!1,relative:!1,setTransform:_r,startX:0,startY:0,startScale:1,step:.3,touchAction:`none`};function Fr(e,t){if(!e)throw Error(`Panzoom requires an element as an argument`);if(e.nodeType!==1)throw Error(`Panzoom requires an element with a nodeType of 1`);if(!Dr(e))throw Error(`Panzoom should be called on elements that have been attached to the DOM`);t={...Pr,...t};let n=Mr(e),r=e.parentNode;r.style.overflow=t.overflow,r.style.userSelect=`none`,r.style.touchAction=t.touchAction,(t.canvas?r:e).style.cursor=t.cursor,e.style.userSelect=`none`,e.style.touchAction=t.touchAction,hr(e,`transformOrigin`,typeof t.origin==`string`?t.origin:n?`0 0`:`50% 50%`);function i(){r.style.overflow=``,r.style.userSelect=``,r.style.touchAction=``,r.style.cursor=``,e.style.cursor=``,e.style.userSelect=``,e.style.touchAction=``,hr(e,`transformOrigin`,``)}function a(n={}){for(let e in n)n.hasOwnProperty(e)&&(t[e]=n[e]);(n.hasOwnProperty(`cursor`)||n.hasOwnProperty(`canvas`))&&(r.style.cursor=e.style.cursor=``,(t.canvas?r:e).style.cursor=t.cursor),n.hasOwnProperty(`overflow`)&&(r.style.overflow=n.overflow),n.hasOwnProperty(`touchAction`)&&(r.style.touchAction=n.touchAction,e.style.touchAction=n.touchAction)}let o=0,s=0,c=1,l=!1;h(t.startScale,{animate:!1,force:!0}),setTimeout(()=>{m(t.startX,t.startY,{animate:!1,force:!0})});function u(t,n,r){if(r.silent)return;let i=new CustomEvent(t,{detail:n});e.dispatchEvent(i)}function d(t,r,i){let a={x:o,y:s,scale:c,isSVG:n,originalEvent:i};return requestAnimationFrame(()=>{typeof r.animate==`boolean`&&(r.animate?gr(e,r):hr(e,`transition`,`none`)),r.setTransform(e,a,r),u(t,a,r),u(`panzoomchange`,a,r)}),a}function f(n,r,i,a){let l={...t,...a},u={x:o,y:s,opts:l};if(!a?.force&&(l.disablePan||l.panOnlyWhenZoomed&&c===l.startScale))return u;if(n=parseFloat(n),r=parseFloat(r),l.disableXAxis||(u.x=(l.relative?o:0)+n),l.disableYAxis||(u.y=(l.relative?s:0)+r),l.contain){let t=vr(e),n=t.elem.width/c,r=t.elem.height/c,a=n*i,o=r*i,s=(a-n)/2,d=(o-r)/2;if(l.contain===`inside`){let e=(-t.elem.margin.left-t.parent.padding.left+s)/i,n=(t.parent.width-a-t.parent.padding.left-t.elem.margin.left-t.parent.border.left-t.parent.border.right+s)/i;u.x=Math.max(Math.min(u.x,n),e);let r=(-t.elem.margin.top-t.parent.padding.top+d)/i,c=(t.parent.height-o-t.parent.padding.top-t.elem.margin.top-t.parent.border.top-t.parent.border.bottom+d)/i;u.y=Math.max(Math.min(u.y,c),r)}else if(l.contain===`outside`){let e=(-(a-t.parent.width)-t.parent.padding.left-t.parent.border.left-t.parent.border.right+s)/i,n=(s-t.parent.padding.left)/i;u.x=Math.max(Math.min(u.x,n),e);let r=(-(o-t.parent.height)-t.parent.padding.top-t.parent.border.top-t.parent.border.bottom+d)/i,c=(d-t.parent.padding.top)/i;u.y=Math.max(Math.min(u.y,c),r)}}return l.roundPixels&&(u.x=Math.round(u.x),u.y=Math.round(u.y)),u}function p(n,r){let i={...t,...r},a={scale:c,opts:i};if(!r?.force&&i.disableZoom)return a;let o=t.minScale,s=t.maxScale;if(i.contain){let n=vr(e),r=n.elem.width/c,i=n.elem.height/c;if(r>1&&i>1){let e=n.parent.width-n.parent.border.left-n.parent.border.right,a=n.parent.height-n.parent.border.top-n.parent.border.bottom,c=e/r,l=a/i;t.contain===`inside`?s=Math.min(s,c,l):t.contain===`outside`&&(o=Math.max(o,c,l))}}return a.scale=Math.min(Math.max(n,o),s),a}function m(e,t,r,i){let a=f(e,t,c,r);return o!==a.x||s!==a.y?(o=a.x,s=a.y,d(`panzoompan`,a.opts,i)):{x:o,y:s,scale:c,isSVG:n,originalEvent:i}}function h(e,t,n){let r=p(e,t),i=r.opts;if(!t?.force&&i.disableZoom)return;e=r.scale;let a=o,l=s;if(i.focal){let t=i.focal;a=(t.x/e-t.x/c+o*e)/e,l=(t.y/e-t.y/c+s*e)/e}let u=f(a,l,e,{relative:!1,force:!0});return o=u.x,s=u.y,c=e,d(`panzoomzoom`,i,n)}function g(e,n){let r={...t,animate:!0,...n};return h(c*Math.exp((e?1:-1)*r.step),r)}function _(e){return g(!0,e)}function ee(e){return g(!1,e)}function te(t,r,i,a){let o=vr(e),s={width:o.parent.width-o.parent.padding.left-o.parent.padding.right-o.parent.border.left-o.parent.border.right,height:o.parent.height-o.parent.padding.top-o.parent.padding.bottom-o.parent.border.top-o.parent.border.bottom},l=r.clientX-o.parent.left-o.parent.padding.left-o.parent.border.left-o.elem.margin.left,u=r.clientY-o.parent.top-o.parent.padding.top-o.parent.border.top-o.elem.margin.top;n||(l-=o.elem.width/c/2,u-=o.elem.height/c/2);let d={x:l/s.width*(s.width*t),y:u/s.height*(s.height*t)};return h(t,{...i,animate:!1,focal:d},a)}function v(e,n){e.preventDefault();let r={...t,...n,animate:!1},i=(e.deltaY===0&&e.deltaX?e.deltaX:e.deltaY)<0?1:-1,a=p(c*Math.exp(i*r.step/3),r).scale;return te(a,e,r,e)}function ne(e){let n={...t,animate:!0,force:!0,...e};c=p(n.startScale,n).scale;let r=f(n.startX,n.startY,c,n);return o=r.x,s=r.y,d(`panzoomreset`,n)}let re,y,b,x,S,ie,C=[];function ae(e){if(Ar(e.target,t))return;Cr(C,e),l=!0,t.handleStartEvent(e),re=o,y=s,u(`panzoomstart`,{x:o,y:s,scale:c,isSVG:n,originalEvent:e},t);let r=Tr(C);b=r.clientX,x=r.clientY,S=c,ie=Er(C)}function w(e){if(!l||re===void 0||y===void 0||b===void 0||x===void 0)return;Cr(C,e);let n=Tr(C),r=C.length>1,i=c;r&&(ie===0&&(ie=Er(C)),i=p((Er(C)-ie)*t.step/80+S).scale,te(i,n,{animate:!1},e)),(!r||t.pinchAndPan)&&m(re+(n.clientX-b)/i,y+(n.clientY-x)/i,{animate:!1},e)}function T(e){C.length===1&&u(`panzoomend`,{x:o,y:s,scale:c,isSVG:n,originalEvent:e},t),wr(C,e),l&&(l=!1,re=y=b=x=void 0)}let E=!1;function oe(){E||(E=!0,br(`down`,t.canvas?r:e,ae),br(`move`,document,w,{passive:!0}),br(`up`,document,T,{passive:!0}))}function D(){E=!1,xr(`down`,t.canvas?r:e,ae),xr(`move`,document,w),xr(`up`,document,T)}return t.noBind||oe(),{bind:oe,destroy:D,eventNames:yr,getPan:()=>({x:o,y:s}),getScale:()=>c,getOptions:()=>Nr(t),handleDown:ae,handleMove:w,handleUp:T,pan:m,reset:ne,resetStyle:i,setOptions:a,setStyle:(t,n)=>hr(e,t,n),zoom:h,zoomIn:_,zoomOut:ee,zoomToPoint:te,zoomWithWheel:v}}Fr.defaultOptions=Pr;var Ir=new Set([`image`,`video`,`audio`,`iframe`]);function Lr(e,t){let n=Math.max(0,Number.parseInt(t,10)||0);return n?((Number.parseInt(e,10)||0)%n+n)%n:0}function Rr(e){let t=Number(e);return Number.isFinite(t)?Math.min(6,Math.max(1,t)):1}function zr(e,t=``){return Array.isArray(e)?e.flatMap(e=>{let n=String(e?.type||``)||t,r=String(e?.url||``).trim();return!Ir.has(n)||!/^https:\/\//i.test(r)?[]:[{...e,type:n,url:r}]}):[]}var Br=`modulepreload`,Vr=function(e){return`/`+e},Hr={},Ur=function(e,t,n){let r=Promise.resolve();if(t&&t.length>0){let e=document.getElementsByTagName(`link`),i=document.querySelector(`meta[property=csp-nonce]`),a=i?.nonce||i?.getAttribute(`nonce`);function o(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))}r=o(t.map(t=>{if(t=Vr(t,n),t in Hr)return;Hr[t]=!0;let r=t.endsWith(`.css`),i=r?`[rel="stylesheet"]`:``;if(n)for(let n=e.length-1;n>=0;n--){let i=e[n];if(i.href===t&&(!r||i.rel===`stylesheet`))return}else if(document.querySelector(`link[href="${t}"]${i}`))return;let o=document.createElement(`link`);if(o.rel=r?`stylesheet`:Br,r||(o.as=`script`),o.crossOrigin=``,o.href=t,a&&o.setAttribute(`nonce`,a),document.head.appendChild(o),r)return new Promise((e,n)=>{o.addEventListener(`load`,e),o.addEventListener(`error`,()=>n(Error(`Unable to preload CSS for ${t}`)))})}))}function i(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return r.then(t=>{for(let e of t||[])e.status===`rejected`&&i(e.reason);return e().catch(i)})},Wr={image:`图片`,video:`视频`,audio:`音频`,iframe:`页面`},K=[],q=0,Gr=null,Kr=null,qr=null,Jr=null,Yr=null,Xr=0,Zr=null,Qr=!1,$r=``,ei=null,ti=null;function ni(){return window.matchMedia?.(`(prefers-reduced-motion: reduce)`).matches===!0}function ri(e){return String(e?.title||Wr[e?.type]||`媒体预览`)}function ii(e){if(e?.displayUrl)return String(e.displayUrl);try{return new URL(e?.url).hostname}catch{return``}}function ai(e){return String(e?.renderUrl||e?.url||``)}function oi(e){return String(e?.canonicalUrl||e?.sourceUrl||e?.url||``)}function si(e){return{video:`▶`,audio:`♪`,iframe:`▣`}[e]||`◫`}function ci(e){return/\.m3u8(?:$|[?#])/i.test(String(e||``))}function li(){let e=document.createElement(`div`);return e.id=`app-media-preview`,e.className=`media-preview-root`,e.hidden=!0,e.setAttribute(`aria-hidden`,`true`),e.innerHTML=`
  ...
  `}function Ba(e,t,n){let r=wa(t,n);!r||ma.readOnly||!e||e.querySelectorAll(`[data-favorite-action]`).forEach(e=>{e.dataset.favoriteBound!==`true`&&(e.dataset.favoriteBound=`true`,e.addEventListener(`click`,e=>{e.preventDefault(),e.stopPropagation(),Ra(r)}))})}function Va(e={}){ma={...ma,readOnly:!!e.readOnly},ga||=ta(Aa),Aa()}var Ha=``.split(`,`).map(e=>e.trim()).filter(Boolean),Ua=null,Wa=new WeakMap;function Y(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function Ga(){let e=typeof window<`u`?window:null,t=e?.MAP_SERVICE_KML_IFRAME_ALLOWLIST||e?.mapServiceKmlIframeAllowlist||Ha;return Array.isArray(t)?t:String(t||``).split(`,`).map(e=>e.trim()).filter(Boolean)}function Ka(){return{iframeAllowlist:Ga()}}function qa(e){return qn(e,Ka())}function Ja(e){return{image:`图片`,video:`视频`,audio:`音频`,iframe:`页面`}[e]||`媒体`}function Ya(e){return{video:`▶`,audio:`♪`,iframe:`▣`}[e]||`◫`}function Xa(e){let t=String(e?.name||``).trim();return/^未命名(?:点位|要素(?:\s*\d+)?)$/.test(t)?``:t}function Za(e){return Xa({name:e?.title})||Xa({name:e?.featureName})}function Qa(e){let t=Ja(e.type),n=Za(e);return e.type===`image`?`
  ...
  `}function $a(e,t,n){let r=or(t,{contentOptions:Ka()}),i=Jn(r.contentSummary),a=Yn(t),o=za(e,t),s=n?`
    ...
    `:``,l=Xa(t),u=l?`<div class="kml-popup-title">${Y(l)}</div>`:``,d=a?`<div class="kml-popup-desc">${Y(a)}</div>`:``;return`
  ...
  `}function eo(e,t,n=null){let r=ir(e,{featureViews:n&&t?.id?new Map([[String(t.id),n]]):null,contentOptions:Ka()});return r.length?r:rr(t,n||qa(t)).map((t,n)=>({...t,kmlId:String(e?.id||``),kmlName:String(e?.name||``).trim()||`未命名 KML`,galleryIndex:n}))}function to(e){let t=String(e?.kmlId||``),n=String(e?.featureId||``);return t&&n?`${t}:${n}`:``}function no(e,t,n,r,i=null){let a=eo(e,t,i);if(!a.length)return!1;let o=to({kmlId:e?.id,featureId:t?.id});return Fi({items:a,index:ar(a,{...n,featureId:String(t?.id||``)}),trigger:r,collectionTitle:String(e?.name||``).trim()||`未命名 KML`,onActiveItemChange:e=>{let t=to(e);!t||t===o||(o=t,window.activateKmlFeatureForMedia?.(e))}})}function ro(e,t,n){if(!e)return;Ba(e,t,n);let r=e.querySelector(`.leaflet-popup-content`)||e,i=Wa.get(r);if(i){i.kmlFile=t,i.feature=n;return}let a={kmlFile:t,feature:n};Wa.set(r,a),r.addEventListener(`click`,e=>{let t=e.target.closest?.(`[data-kml-popup-media]`);if(!t||!r.contains(t))return;e.stopPropagation(),e.preventDefault();let n=Wa.get(r);n&&no(n.kmlFile,n.feature,{id:t.dataset.mediaId,url:t.dataset.mediaUrl,type:t.dataset.mediaType},t)}),r.addEventListener(`error`,e=>{let t=e.target;t?.matches?.(`.kml-popup-media-image img`)&&t.closest(`.kml-popup-media-image`)?.classList.add(`is-load-error`)},!0)}function io(){let e=document.getElementById(`kml-feature-content-panel`);return e||(e=document.createElement(`section`),e.id=`kml-feature-content-panel`,e.className=`kml-content-panel`,e.setAttribute(`role`,`dialog`),e.setAttribute(`aria-modal`,`false`),e.hidden=!0,document.body.appendChild(e)),e}function ao(){Ua?.abort(),Ua=null;let e=document.getElementById(`kml-feature-content-panel`);e&&(e.hidden=!0,e.innerHTML=``)}async function oo(e,t){if(e?.isPublic&&!e?.isShare&&e.id&&t?.id){Ua?.abort(),Ua=new AbortController;try{let n=await window.fetch(`/api/v1/kml/shared/${encodeURIComponent(e.id)}/features/${encodeURIComponent(t.id)}/content`,{signal:Ua.signal}),r=await n.json();if(!n.ok||r.code!==0)throw Error(r.error?.message||`点位内容加载失败`);return r.result}finally{Ua=null}}return qa(t)}function so(e,t){let n=Yn(t),r=Array.isArray(t?.coordinates)&&t.type===`Point`?`${Number(t.coordinates[0]).toFixed(6)}, ${Number(t.coordinates[1]).toFixed(6)}`:``;return`
  ...
  `}function lo(e,t,n,r,i,a){return`
  ...
  `}function uo(e,t,n){return lo(e,t,n,`video`,`视频`,`▶`)}function fo(e,t,n){return lo(e,t,n,`audio`,`音频`,`♪`)}function po(e,t,n){return lo(e,t,n,`iframe`,`页面`,`▣`)}function mo(e){return`
  ...
  `}function ho(e,t){if(!e.items?.length)return``;let n={image:co,video:uo,audio:fo,iframe:po,link:mo}[e.type]||mo,r={image:`◫`,video:`▶`,audio:`♪`,iframe:`▣`,link:`↗`}[e.type]||`•`;return`
  ...
  `}function go(e){e.querySelectorAll(`.kml-content-image-item img`).forEach(e=>{e.addEventListener(`error`,()=>e.closest(`.kml-content-image-item`)?.classList.add(`is-load-error`),{once:!0})})}function _o(e,t,n,r){let i=r?.groups||[];e.querySelectorAll(`[data-kml-media-preview]`).forEach(e=>{e.addEventListener(`click`,()=>{let a=i[Number(e.dataset.kmlMediaGroup)],o=a?.items?.[Number(e.dataset.kmlMediaIndex)];o&&no(t,n,{id:o.id,url:o.url,type:a.type},e,r)})})}function vo(e,t,n,r,i=``){let a=Jn(r?.contentSummary),o=(r?.groups||[]).map(ho).join(``);e.innerHTML=`
  ...
  `,e.querySelector(`[data-kml-content-close]`)?.addEventListener(`click`,ao),Ba(e,t,n),go(e),_o(e,t,n,r)}async function yo(e,t){let n=io();n.hidden=!1,n.innerHTML=`
    <header class="kml-content-header">
      <div>
  ...
  `,n.querySelector(`[data-kml-content-close]`)?.addEventListener(`click`,ao),Ba(n,e,t);try{vo(n,e,t,await oo(e,t))}catch(r){if(r.name===`AbortError`)return;vo(n,e,t,qa(t),r.message||`点位内容加载失败，已展示本地解析结果。`)}}var bo={image:`包含图片`,video:`包含视频`,audio:`包含音频`,iframe:`包含页面`,link:`包含链接`},xo={image:`#0f766e`,video:`#dc2626`,audio:`#7c3aed`,iframe:`#2563eb`,link:`#475569`},So={image:`<rect x="8" y="8" width="16" height="13" rx="2"/><circle cx="13" cy="12.5" r="1.5"/><path d="m9.5 19 4.5-4 3 2.5 2-2 3.5 3.5"/>`,video:`<rect x="8" y="8" width="16" height="13" rx="2"/><path d="m14 12 5 3-5 3z"/>`,audio:`<path d="M9 14h3l4-4v10l-4-4H9z"/><path d="M19 12.5a4 4 0 0 1 0 5M21 10a7 7 0 0 1 0 10"/>`,iframe:`<rect x="8" y="8" width="16" height="13" rx="2"/><path d="M8 12h16M11 10h.01M14 10h.01"/>`,link:`<path d="M13.5 17.5 12 19a3 3 0 0 1-4.2-4.2l2.5-2.5a3 3 0 0 1 4.2 0M18.5 12.5 20 11a3 3 0 0 1 4.2 4.2l-2.5 2.5a3 3 0 0 1-4.2 0M12.5 15.5h7"/>`};function Co(e){let t=xo[e],n=So[e];return!t||!n?``:`<svg viewBox="0 0 32 40" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"><path class="kml-media-marker-pin" fill="${t}" d="M16 1C7.9 1 3 6.7 3 14.1 3 24.2 16 38.5 16 38.5S29 24.2 29 14.1C29 6.7 24.1 1 16 1Z"/><path fill="none" stroke="rgba(255,255,255,.9)" stroke-width="1.2" d="M16 2.5C8.9 2.5 4.5 7.4 4.5 14.1c0 8.1 9.2 19.5 11.5 22.3 2.3-2.8 11.5-14.2 11.5-22.3C27.5 7.4 23.1 2.5 16 2.5Z"/><g fill="none" stroke="#fff" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round">${n}</g></svg>`}function wo(e){let t=Qn(e);return bo[t]?{type:t,label:bo[t],html:`<span class="kml-media-marker kml-media-marker-${t}" role="img" aria-label="${bo[t]}">${Co(t)}</span>`,iconSize:[32,40],iconAnchor:[16,39],popupAnchor:[0,-36],tooltipAnchor:[16,-26]}:null}function To(e){let t=wo(e);if(!t)return null;let n=Co(t.type);return{...t,image:`data:image/svg+xml;charset=utf-8,${encodeURIComponent(n)}`}}function Eo(e){let t=wo(e);return t?`<svg class="svg-icon kml-media-list-icon kml-media-list-icon-${t.type}" viewBox="0 0 32 30" role="img" aria-label="${t.label}" xmlns="http://www.w3.org/2000/svg"><g fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">${So[t.type]}</g></svg>`:``}var Do=`map-service-kml-recovery`,Oo=1,ko=`kml-account-drafts`,Ao=`map_kml_account_recovery_v1:`;function jo(e){return`${Ao}${encodeURIComponent(String(e||``))}`}function Mo(e){return!!(e&&typeof e==`object`&&String(e.userId||``))}function No(e){return!!(Mo(e)&&e.metadataOnly===!0&&!e.deleted)}function Po(e){return{userId:String(e.userId),generation:Math.max(0,Number(e.generation||0)),updatedAt:e.updatedAt||new Date().toISOString(),metadataOnly:!0,fileCount:Array.isArray(e.files)?e.files.length:0}}function Fo(e){return[Number(e?.generation||0),Date.parse(e?.updatedAt||``)||0]}function Io(e,t){let n=Fo(e),r=Fo(t);return n[0]>r[0]||n[0]===r[0]&&n[1]>=r[1]}function Lo(e,t){return Io(e,t)&&!Io(t,e)}function Ro(e,t){let n=Mo(e)?e:null,r=Mo(t)?t:null,i=Math.max(Number(n?.generation||0),Number(r?.generation||0));return r?.deleted&&(!n||Io(r,n))||r&&!No(r)&&(!n||Lo(r,n))?{record:r,storageGeneration:i,incompleteWrite:!1}:n?{record:n,storageGeneration:i,incompleteWrite:!!(No(r)&&Lo(r,n))}:{record:null,storageGeneration:i,incompleteWrite:No(r)}}function zo(e,t){if(!e?.getItem)return null;try{let n=JSON.parse(e.getItem(jo(t))||`null`);return Mo(n)?n:null}catch{return null}}function Bo(e,t){if(!e?.setItem)throw Error(`本地恢复存储不可用`);e.setItem(jo(t.userId),JSON.stringify(t))}function Vo(e,t){if(!e?.setItem)throw Error(`本地恢复存储不可用`);let n=zo(e,t.userId);(!n||Io(t,n))&&Bo(e,t)}function Ho(e){return new Promise((t,n)=>{let r=e.open(Do,Oo);r.onupgradeneeded=()=>{let e=r.result;e.objectStoreNames.contains(ko)||e.createObjectStore(ko,{keyPath:`userId`})},r.onsuccess=()=>t(r.result),r.onerror=()=>n(r.error||Error(`恢复草稿数据库打开失败`))})}function Uo(e,t,n){return new Promise((r,i)=>{let a;try{a=e.transaction(ko,t);let o=n(a.objectStore(ko));o.onsuccess=()=>r(o.result),o.onerror=()=>i(o.error||Error(`恢复草稿数据库请求失败`)),a.onerror=()=>i(a.error||Error(`恢复草稿数据库事务失败`))}catch(e){i(e)}})}function Wo(e,t){return new Promise((n,r)=>{try{let i=e.transaction(ko,`readwrite`),a=i.objectStore(ko),o=a.get(t.userId);o.onsuccess=()=>{let e=o.result;(!Mo(e)||Io(t,e))&&a.put(t)},o.onerror=()=>r(o.error||Error(`恢复草稿数据库读取失败`)),i.oncomplete=()=>n(),i.onerror=()=>r(i.error||Error(`恢复草稿数据库事务失败`)),i.onabort=()=>r(i.error||Error(`恢复草稿数据库事务已中止`))}catch(e){r(e)}})}function Go(e={}){let t=e.indexedDB||globalThis.indexedDB,n=e.localStorage||globalThis.localStorage,r=null,i=()=>t?.open?(r||=Ho(t),r):Promise.reject(Error(`IndexedDB 不可用`));return{async get(e,t={}){let r=String(e||``),a=zo(n,r),o;try{o=await Uo(await i(),`readonly`,e=>e.get(r))}catch(e){if(a){if(a.deleted&&t.includeDeleted!==!0)return null;if(No(a))throw Error(`IndexedDB 不可用，无法读取完整 KML 恢复草稿`,{cause:e});return structuredClone(a)}throw e}let s=Ro(o,a);if(!s.record){if(!s.incompleteWrite)return null;throw Error(`最新 KML 恢复草稿尚未完整写入 IndexedDB`)}if(s.record.deleted&&t.includeDeleted!==!0)return null;let c=structuredClone(s.record);return s.incompleteWrite&&(c.incompleteWrite=!0,c.storageGeneration=s.storageGeneration),c},async put(e){if(!Mo(e))throw TypeError(`恢复草稿记录无效`);let t=structuredClone(e),r=!1;try{Vo(n,Po(t)),r=!0}catch{}try{return await Wo(await i(),t),{persistent:r?`indexeddb+metadata`:`indexeddb`}}catch(e){throw Error(`IndexedDB 不可用，完整 KML 恢复草稿未持久化`,{cause:e})}},async delete(e,t={}){let r={userId:String(e||``),deleted:!0,generation:Math.max(0,Number(t.generation||0)),updatedAt:t.updatedAt||new Date().toISOString()},a=!1;try{Vo(n,r),a=!0}catch{}try{await Wo(await i(),r)}catch(e){if(!a)throw e}return{persistent:`deleted`}}}}var Ko=null,qo=null;function Jo(){return qo||(Ko||=Go(),Ko)}var Yo=!1,Xo=!1,Zo=``,Qo=new Map,$o=new Set,es=new Set,ts=[],ns=null,rs=!1,is=!1,as=!1,os=[],ss=0,cs=0,ls=null,us=null,ds=!1,fs={state:`guest`,detail:{}},ps=Promise.resolve(!0),ms=new Set([`discard`,`restore`,`save-as-all`,`reload-conflicts`,`save-as-conflicts`]);function hs(e){return typeof structuredClone==`function`?structuredClone(e):JSON.parse(JSON.stringify(e))}function gs(e,t={}){let n=String(t.message||``);return{dirty:{visible:!0,label:`待保存`,tone:`dirty`,title:`修改已写入本机恢复草稿，将在稍后同步`},saving:{visible:!0,label:`保存中…`,tone:`saving`,title:`正在同步到账号`},saved:{visible:!0,label:`已保存`,tone:`saved`,title:`账号 KML 已同步`},loaded:{visible:!0,label:`已保存`,tone:`saved`,title:`已加载账号 KML`},readonly:{visible:!0,label:`只读`,tone:`readonly`,title:`当前账号只能查看 KML`},conflict:{visible:!0,label:`保存冲突`,tone:`conflict`,title:n||`服务器内容已更新，点击处理本地恢复草稿`},error:{visible:!0,label:t.phase===`load`?`加载失败`:`保存失败`,tone:`error`,title:n||(t.phase===`load`?`账号 KML 加载失败`:`账号 KML 保存失败`)}}[e]||{visible:!1,label:``,tone:`guest`,title:``}}function _s(e,t=fs){let n=gs(t.state,t.detail);e.hidden=!n.visible,e.textContent=n.label,e.dataset.state=n.tone,e.dataset.actionable=t.state===`conflict`?`true`:`false`,e.title=n.title,`disabled`in e&&(e.disabled=t.state!==`conflict`)}function vs(e=`automatic`){typeof window>`u`||!(window.dispatchEvent instanceof Function)||window.dispatchEvent(new CustomEvent(`map-kml-sync-resolution-request`,{detail:{source:e}}))}function ys(e=`kml-sync-status`){if(typeof window>`u`||typeof document>`u`)return()=>{};let t=document.getElementById(e);if(!t||!(window.addEventListener instanceof Function))return()=>{};let n=e=>{let n=e?.detail||{};_s(t,{state:String(n.state||`guest`),detail:n})},r=()=>{fs.state===`conflict`&&vs(`status`)};return window.addEventListener(`map-kml-sync-state`,n),t.addEventListener(`click`,r),_s(t),()=>{window.removeEventListener(`map-kml-sync-state`,n),t.removeEventListener(`click`,r)}}function bs(e,t={}){fs={state:e,detail:{...t}},!(typeof window>`u`||!(window.dispatchEvent instanceof Function))&&window.dispatchEvent(new CustomEvent(`map-kml-sync-state`,{detail:{state:e,...t}}))}function xs(e){return{name:String(e.name||`未命名 KML`),description:String(e.description||``),isDefault:!!e.isDefault,coordCorrection:e.coordCorrection||`wgs84-to-gcj02`,theme:e.theme||`default`,color:e.color||`#0f766e`,lockDrag:!!e.lockDrag,enabled:e.enabled!==!1,isLiveTrack:!!e.isLiveTrack,features:Array.isArray(e.features)?e.features:[]}}function Ss(e){return JSON.stringify(xs(e))}function Cs(e,t=e.id){return{localId:String(t||e.id||``),serverId:String(e.id||e.serverId||``),revision:Number(e.revision||1),hash:Ss(e),status:e.status===`trashed`?`trashed`:`active`}}function ws(e=[]){return e instanceof Map?new Map(e):new Map((e||[]).flatMap(e=>{let t=String(e?.localId||``);return t?[[t,{...e,localId:t}]]:[]}))}function Ts(e,t,n=t?.id){let r=ws(e),i=String(n||``),a=String(t?.id||t?.serverId||``);return!i||!a||!t||typeof t!=`object`||r.set(i,Cs({...t,id:a},i)),r}function Es(e=[]){return Array.isArray(e)?e.slice(0,100).flatMap(e=>{let t=String(e?.action||``);if(![`create`,`update`,`trash`,`restore`].includes(t))return[];let n=String(e?.kmlId||``),r=String(e?.clientId||``);return t===`create`?r&&e?.data&&typeof e.data==`object`?[{action:t,clientId:r,data:hs(e.data)}]:[]:t===`update`?n&&e?.data&&typeof e.data==`object`?[{action:t,kmlId:n,data:hs(e.data)}]:[]:!n&&!r?[]:[{action:t,...n?{kmlId:n}:{clientId:r}}]}):[]}function Ds(e,t){let n=ws(t?.snapshots),r=new Set([...(t?.files||[]).map(e=>String(e?.id||``)).filter(Boolean),...(t?.deletedClientIds||[]).map(e=>String(e||``)).filter(Boolean)]),i=new Set(Array.from(n.values(),e=>String(e.serverId||``)));for(let t of e||[]){let e=String(t?.syncClientId||``),a=String(t?.id||``);!e||!a||!r.has(e)||n.has(e)||i.has(a)||(n.set(e,Cs(t,e)),i.add(a))}return n}function Os(e,t=Qo,n=[]){let r=[],i=new Set;e.forEach(e=>{let n=String(e.id||``);if(!n)return;i.add(n);let a=t.get(n),o=xs(e),s=JSON.stringify(o);a?a.status===`trashed`?r.push(a.serverId?{action:`restore`,kmlId:a.serverId}:{action:`restore`,clientId:n}):a.hash!==s&&r.push({action:`update`,kmlId:a.serverId,data:{...o,revision:a.revision}}):r.push({action:`create`,clientId:n,data:o})}),t.forEach(e=>{!i.has(e.localId)&&e.status!==`trashed`&&r.push({action:`trash`,kmlId:e.serverId})});for(let e of n||[]){let n=String(e||``);!n||i.has(n)||t.has(n)||r.push({action:`trash`,clientId:n})}return r}function ks(e,t){let n=ws(e),r=new Set,i=new Set,a=e=>[...n.values()].find(t=>t.serverId===String(e||``));for(let e of t?.results||[]){if(e.action===`create`&&e.document){let t=String(e.clientId||``);t&&(n.set(t,Cs(e.document,t)),r.add(t));continue}if(e.action===`update`&&e.document){let t=a(e.document.id),r=String(t?.localId||e.document.syncClientId||e.document.id||``);r&&n.set(r,Cs(e.document,r));continue}if(e.action===`trash`){let t=a(e.document?.id||e.result?.id),i=String(e.clientId||t?.localId||``);e.document&&i?n.set(i,Cs(e.document,i)):i&&n.set(i,{localId:i,serverId:``,revision:0,hash:``,status:`trashed`}),i&&r.add(i);continue}if(e.action===`restore`){let t=String(e.clientId||``),r=e.document?a(e.document.id):null,o=String(t||r?.localId||e.document?.syncClientId||e.document?.id||``);e.document&&o?n.set(o,Cs(e.document,o)):t&&(n.delete(o),i.add(o))}}return{snapshots:n,resolvedLocalIds:[...r],releasedClientIds:[...i]}}function As(e,t,n,r={}){return{version:1,userId:String(e||``),generation:Math.max(1,Number(r.generation||1)),reason:String(r.reason||`dirty`),updatedAt:r.updatedAt||new Date().toISOString(),files:hs(Array.isArray(t)?t:[]),snapshots:Array.from(ws(n).values(),e=>({...e})),deletedClientIds:[...new Set(Array.from(r.deletedClientIds||[],e=>String(e||``)).filter(Boolean))],pendingOperations:Es(r.pendingOperations)}}function js(e,t){if(!e||e.version!==1||String(e.userId||``)!==String(t||``)||!Array.isArray(e.files)||!Array.isArray(e.snapshots))return null;let n=As(t,e.files,e.snapshots,{generation:e.generation,reason:e.reason,updatedAt:e.updatedAt,deletedClientIds:e.deletedClientIds,pendingOperations:e.pendingOperations});return e.incompleteWrite&&(n.incompleteWrite=!0,n.storageGeneration=Math.max(Number(e.storageGeneration||0),Number(e.generation||0))),n}function Ms(e){return Math.max(Number(e?.generation||0),Number(e?.storageGeneration||0))}function Ns(e,t){return Number(e?.generation||0)-Number(t?.generation||0)||(Date.parse(e?.updatedAt||``)||0)-(Date.parse(t?.updatedAt||``)||0)}function Ps(e,t){return e.map(e=>js(e,t)).filter(Boolean).sort((e,t)=>Ns(t,e))[0]||null}function Fs(e,t){let n=Ds(e,t),r=Os(t?.files||[],n,t?.deletedClientIds),i=Es(t?.pendingOperations),a=new Map((e||[]).map(e=>[String(e.id||``),e])),o=new Map(Array.from(n.values(),e=>[e.serverId,e])),s=[...new Set(i.filter(e=>e.action===`trash`||e.action===`restore`).map(e=>String(e.clientId||o.get(String(e.kmlId||``))?.localId||``)).filter(Boolean))],c=new Set(s),l=new Map(r.filter(e=>e.action===`update`).map(e=>[e.kmlId,e])),u=new Map(r.filter(e=>e.action===`trash`).map(e=>[e.kmlId,e])),d=[];return n.forEach(e=>{if(c.has(e.localId)||!l.has(e.serverId)&&!u.has(e.serverId))return;let t=a.get(e.serverId);(!t||Number(t.revision||0)!==Number(e.revision||0))&&d.push(e.localId)}),{hasChanges:r.length>0||i.length>0,operations:r,pendingOperations:i,pendingPresenceLocalIds:s,conflictedLocalIds:d,createdLocalIds:r.filter(e=>e.action===`create`).map(e=>e.clientId),updatedLocalIds:r.filter(e=>e.action===`update`).map(e=>o.get(e.kmlId)?.localId).filter(Boolean),restoredLocalIds:r.filter(e=>e.action===`restore`).map(e=>e.clientId||o.get(e.kmlId)?.localId).filter(Boolean),deletedLocalIds:r.filter(e=>e.action===`trash`).map(e=>e.clientId||o.get(e.kmlId)?.localId).filter(Boolean)}}function Is(e){return`kml-recovery-${globalThis.crypto?.randomUUID?.()||`${Date.now()}-${Math.random().toString(16).slice(2)}`}-${e}`}function Ls(e,t,n,r){let i=xs(e);return{...i,id:r(t),name:`${i.name.slice(0,Math.max(1,200-n.length))}${n}`,isDefault:!1}}function Rs(e,t){let n=new Map(Array.from(ws(t).values(),e=>[e.serverId,e]));return(e||[]).map(e=>{let t=n.get(String(e.id||``));return t?{...hs(e),id:t.localId,serverId:e.id}:hs(e)})}function zs(e,t,n,r={}){if(!ms.has(n))throw Error(`KML 恢复处理方式无效`);let i=Fs(e,t),a=hs(t?.files||[]),o=new Map(a.map(e=>[String(e.id||``),e])),s=Ds(e,t),c=Rs(e,s),l=new Map(c.map(e=>[String(e.id||``),e])),u=r.idFactory||Is,d=new Set(i.conflictedLocalIds),f=new Set(i.createdLocalIds),p=new Set(i.updatedLocalIds),m=new Set(i.restoredLocalIds),h=new Set(i.deletedLocalIds),g=new Set(i.pendingPresenceLocalIds),_=new Map(Array.from(s.values(),e=>[e.serverId,e])),ee=Es(i.pendingOperations),te=e=>String(e.clientId||_.get(String(e.kmlId||``))?.localId||``),v=n===`restore`?ee:[`reload-conflicts`,`save-as-conflicts`].includes(n)?ee.filter(e=>!d.has(te(e))):[],ne=[...new Set((t?.deletedClientIds||[]).map(e=>String(e||``)).filter(Boolean))],re=(t={})=>{let n=Hs(e,s),r=new Set;return t.preserveConflicts&&d.forEach(e=>r.add(e)),t.preserveRestores&&m.forEach(e=>r.add(e)),t.preservePendingPresence&&g.forEach(e=>r.add(e)),r.forEach(e=>{let t=s.get(e);t&&n.set(e,t)}),n},y=e=>Array.from(e.values(),e=>({...e}));if(n===`discard`)return{files:c,snapshots:y(re()),analysis:i,copiedCount:0,shouldSync:!1,blockedByConflict:!1,deletedClientIds:[],pendingOperations:[]};if(n===`save-as-all`){let e=[...new Set([...f,...p,...m,...g])].flatMap((e,t)=>{let n=o.get(e);return n?[Ls(n,t,`（恢复副本）`,u)]:[]});return{files:[...c,...e],snapshots:y(re()),analysis:i,copiedCount:e.length,shouldSync:e.length>0,blockedByConflict:!1,deletedClientIds:[],pendingOperations:[]}}let b=[],x=new Set,S=[];s.forEach(e=>{let t=e.localId;x.add(t);let r=o.get(t),i=l.get(t),a=d.has(t);if(g.has(t)){r&&b.push(r);return}if(h.has(t)){a&&(n===`reload-conflicts`||n===`save-as-conflicts`)&&i&&b.push(i);return}if(m.has(t)){r&&b.push(r);return}if(p.has(t)){a&&(n===`reload-conflicts`||n===`save-as-conflicts`)?(i&&b.push(i),n===`save-as-conflicts`&&r&&S.push(Ls(r,S.length,`（冲突副本）`,u))):r&&b.push(r);return}i&&b.push(i)}),f.forEach(e=>{x.add(e);let t=o.get(e);t&&b.push(t)}),c.forEach(e=>{x.has(String(e.id||``))||b.push(e)});let ie=[...b,...S],C=re({preserveConflicts:n===`restore`&&i.conflictedLocalIds.length>0,preserveRestores:!0,preservePendingPresence:v.length>0}),ae=new Set(ie.map(e=>String(e?.id||``)).filter(Boolean)),w=ne.filter(e=>!ae.has(e));return{files:ie,snapshots:y(C),analysis:i,copiedCount:S.length,shouldSync:!i.conflictedLocalIds.length||n!==`restore`?v.length>0||Os(ie,C,w).length>0:!1,blockedByConflict:n===`restore`&&i.conflictedLocalIds.length>0,deletedClientIds:w,pendingOperations:v}}async function Bs(e,t=4){let n=Array(e.length),r=0;async function i(){for(;r<e.length;){let t=r;r+=1,n[t]=await qi(`/kml/files/${encodeURIComponent(e[t].id)}`)}}return await Promise.all(Array.from({length:Math.min(t,e.length)},i)),n.filter(Boolean)}async function Vs(){let e=[],t=1,n=null;for(;t<=100;){let r=await qi(`/kml/files`,{query:{page:t,limit:100,status:`active`}}),i=Array.isArray(r?.items)?r.items:[];e.push(...i),n=r?.usage||n;let a=Number(r?.total||e.length);if(!i.length||e.length>=a||i.length<100)break;t+=1}return{files:await Bs(e),usage:n}}function Hs(e,t=[]){let n=new Map,r=new Map(Array.from(ws(t).values(),e=>[e.serverId,e]));return e.forEach(e=>{let t=r.get(String(e.id||``))?.localId||e.id;n.set(t,Cs(e,t))}),n}function Us(e){let t=new Set((e||[]).map(e=>String(e?.id||``)).filter(Boolean));t.forEach(e=>{es.delete(e),Qo.has(e)?$o.delete(e):$o.add(e)});for(let e of $o)t.has(e)||($o.delete(e),es.add(e))}function Ws(e=`dirty`){if(!Yo||!Xo||!Zo)return null;cs+=1;let t=As(Zo,os,Qo,{generation:cs,reason:e,deletedClientIds:es,pendingOperations:ts});ls=t,as&&(us={...us||{},draft:hs(t)});let n=Jo().put(t);return ps=Promise.resolve(n).then(()=>!0,e=>(bs(`error`,{phase:`recovery`,code:`KML_RECOVERY_UNAVAILABLE`,message:`本机恢复草稿保存失败：${e.message}`}),!1)),t}function Gs(){Zo&&(cs+=1,ls=null,us=null,Promise.resolve(Jo().delete(Zo,{generation:cs})).catch(()=>{}))}function Ks(){if(ds||typeof window>`u`)return;ds=!0;let e=e=>{!Yo||!Xo||(as||ts.length>0||Os(os,Qo,es).length>0)&&Ws(e)};window.addEventListener(`pagehide`,()=>e(`pagehide`)),typeof document<`u`&&document.addEventListener(`visibilitychange`,()=>{document.visibilityState===`hidden`&&e(`pagehide`)})}async function qs(){let e=++ss;Yo=!1,Xo=!1,Zo=``,Qo=new Map,$o=new Set,es=new Set,ts=[],os=[],rs=!1,is=!1,as=!1,ls=null,us=null,ns&&clearTimeout(ns),ns=null,Ks();let t=await ra();if(e!==ss)return{mode:`guest`,files:[]};if(Yo=!!(t.authenticated&&ca(`kml.own.read`,t)),Xo=!!(Yo&&ca(`kml.own.write`,t)),Zo=Yo?String(t.user?.id||``):``,!Yo)return bs(`guest`),{mode:`guest`,files:[]};try{let t=await Vs();if(!Yo||e!==ss)return{mode:`guest`,files:[]};os=t.files,Qo=Hs(t.files);let n=null,r=null;if(Xo&&Zo)try{let e=await Jo().get(Zo,{includeDeleted:!0});cs=Math.max(cs,Ms(e));let r=js(e,Zo),i=r?Fs(t.files,r):null;r&&(i?.hasChanges||r.incompleteWrite)?(ls=r,cs=Math.max(cs,Ms(r)),n={draft:r,analysis:i}):r&&Gs()}catch(e){r=e}return r?bs(`error`,{phase:`recovery`,code:`KML_RECOVERY_UNAVAILABLE`,message:`无法读取本机恢复草稿：${r.message}`}):bs(Xo?`loaded`:`readonly`,{count:t.files.length,readOnly:!Xo}),{mode:`account`,files:t.files,usage:t.usage||null,canWrite:Xo,userId:Zo,recovery:n,recoveryError:r}}catch(t){return!Yo||e!==ss?{mode:`guest`,files:[]}:(bs(`error`,{phase:`load`,code:t.code,message:t.message}),{mode:`account`,files:[],canWrite:Xo,userId:Zo,error:t})}}function Js(){return Yo}function Ys(){return Yo&&Xo}function Xs(e,t={}){if(!Yo||!Xo||!e||typeof e!=`object`)return!1;let n=String(t.localId||e.id||``),r=String(e.id||e.serverId||``);if(!n||!r)return!1;Qo=Ts(Qo,{...e,id:r},n),$o.delete(n),es.delete(n),ts=ts.filter(e=>e.action!==`create`||String(e.clientId||``)!==n);let i=os.findIndex(e=>String(e?.id||``)===n);return i>=0?os.splice(i,1,e):os=[...os,e],!0}function Zs(e,t){let n=e?.results||[],r=ks(Qo,e);Qo=r.snapshots,r.resolvedLocalIds.forEach(e=>{$o.delete(e),es.delete(e)}),r.releasedClientIds.forEach(e=>{t.some(t=>String(t?.id||``)===e)?(es.delete(e),$o.add(e)):($o.delete(e),es.add(e))}),n.forEach(e=>{if(e.action===`create`&&e.document){let n=String(e.clientId||``),r=t.find(e=>e.id===n);r&&(r.serverId=e.document.id,r.revision=e.document.revision,r.updatedAt=e.document.updatedAt);return}if((e.action===`update`||e.action===`restore`)&&e.document){let n=[...Qo.values()].find(t=>t.serverId===e.document.id)?.localId||e.document.id,r=t.find(e=>e.id===n);r&&(r.revision=e.document.revision,r.updatedAt=e.document.updatedAt)}})}async function Qs(){if(!Yo||!Xo||as)return;if(rs){is=!0;return}let e=Es(ts),t=e.length>0?e:Os(os,Qo,es);if(!t.length){Gs(),bs(`saved`);return}let n=ss;rs=!0,bs(`saving`,{operationCount:t.length});try{if(e.length===0){ts=Es(t),t=Es(ts),Ws(`in-flight`);let e=await ps;if(!Yo||n!==ss)return;if(!e){ts=[];return}}let r=await qi(`/kml/sync`,{method:`POST`,body:{operations:t}});if(!Yo||n!==ss)return;ts=[],Zs(r,os);let i=Os(os,Qo,es);i.length===0?(Gs(),bs(`saved`,{syncedAt:r.syncedAt})):(Ws(`dirty`),bs(`dirty`,{operationCount:i.length}),is=!0)}catch(e){if(!Yo||n!==ss)return;if(Number(e?.status||0)>0&&(ts=[]),e.code===`KML_REVISION_CONFLICT`){as=!0;let t=Ws(`conflict`)||ls;us=t?{draft:hs(t)}:null,bs(`conflict`,{code:e.code,message:e.message,recoveryAvailable:!!t}),vs(`automatic`)}else Ws(`error`),bs(`error`,{code:e.code,message:e.message})}finally{if(n!==ss)return;rs=!1,is&&!as&&(is=!1,ns&&clearTimeout(ns),ns=null,await Qs())}}function $s(e,t={}){os=Array.isArray(e)?e:[],Us(os),t.persist!==!1&&Xo&&Ws(t.reason||`dirty`)}function ec(e,t={}){return!Yo||!Xo?!1:(os=e,Us(os),Ws(as?`conflict`:`dirty`),as?(bs(`conflict`,{code:`KML_REVISION_CONFLICT`,message:`服务器内容已更新，请先处理保存冲突`,recoveryAvailable:!0}),!0):(ns&&clearTimeout(ns),ns=setTimeout(()=>{ns=null,Qs()},t.delayMs===0?0:Number(t.delayMs)||600),rs&&(is=!0),bs(`dirty`),!0))}async function tc(e,t=null){if(!Yo||!Xo||!Zo)throw Error(`当前账号不能恢复 KML 草稿`);let n=String(e||``);if(!ms.has(n))throw Error(`KML 恢复处理方式无效`);let r=ss,i=Zo,a=Jo(),o=await a.get(Zo,{includeDeleted:!0});cs=Math.max(cs,Ms(o));let s=Ps([t?.draft,us?.draft,ls,o],Zo);if(!s)throw Error(`没有可恢复的 KML 草稿`);if(o?.deleted&&Ns(o,s)>=0)throw Error(`KML 恢复草稿已被丢弃`);let c=await Vs();if(!Yo||!Xo||r!==ss||i!==Zo)throw Error(`账号会话已变化，请重新加载 KML`);let l=await a.get(Zo,{includeDeleted:!0});cs=Math.max(cs,Ms(l));let u=Ps([ls,l],Zo);if(l?.deleted&&Ns(l,s)>=0||u&&Ns(u,s)>0)throw Error(`KML 草稿在处理期间又有更新，请重新选择处理方式`);let d=zs(c.files,s,n);return Qo=ws(d.snapshots),os=d.files,es=new Set(d.deletedClientIds||[]),ts=Es(d.pendingOperations),$o=new Set,Us(os),as=d.blockedByConflict,us=d.blockedByConflict?{draft:hs(s),analysis:d.analysis}:null,ls=s,n===`discard`?(Gs(),bs(`loaded`,{count:d.files.length})):d.blockedByConflict?(Ws(`conflict`),bs(`conflict`,{code:`KML_REVISION_CONFLICT`,message:`恢复草稿基于旧版本，请选择加载服务器版本或另存为新 KML`,recoveryAvailable:!0})):d.shouldSync?(Ws(`recovery`),bs(`dirty`)):(Gs(),bs(`loaded`,{count:d.files.length})),d}async function nc(e){if(![`reload`,`save-as`].includes(e))throw Error(`KML 冲突处理方式无效`);return tc(e===`reload`?`reload-conflicts`:`save-as-conflicts`)}function rc(e={}){e.preserveDraft!==!1&&Yo&&Xo&&(as||ts.length>0||Os(os,Qo,es).length>0)&&Ws(e.reason||`session-expired`),ss+=1,Yo=!1,Xo=!1,Zo=``,Qo=new Map,$o=new Set,es=new Set,ts=[],os=[],rs=!1,is=!1,as=!1,ls=null,us=null,ns&&clearTimeout(ns),ns=null,bs(`guest`)}async function ic(e,t){let n=await t(e.files,e),r=Array.isArray(n)?n:e.files;return e.blockedByConflict?$s(r,{persist:!1}):e.shouldSync?ec(r,{delayMs:0}):$s(r,{persist:!1}),{...e,files:r}}async function ac(e,t){if(!e?.draft||!(t instanceof Function))return null;try{let n=e.analysis||{},r=Number(n.operations?.length||0),i=Number(n.conflictedLocalIds?.length||0),a=i?`其中 ${i} 项基于旧的服务器版本，恢复后会暂停同步并要求处理冲突。`:`服务器版本未变化，恢复后会继续自动同步。`,o=e.draft?.incompleteWrite?`浏览器关闭前最后一次草稿写入未完成，将从最近一份完整草稿恢复。`:``,s=[{value:`restore`,text:e.draft?.incompleteWrite?`使用最近完整草稿`:`恢复草稿`,class:`app-dialog-primary`},...r?[{value:`save-as-all`,text:`另存为新 KML`}]:[],{value:`discard`,text:`丢弃草稿`,class:`app-dialog-danger`}];return ic(await tc(await De({title:`恢复未同步的 KML`,message:`${r?`检测到当前账号有 ${r} 项未完成的 KML 修改。`:``}${a}${o}`,dismissible:!1,choices:s}),e),t)}catch(e){return Js()&&await Ce(e.message||`KML 恢复失败，请稍后重试`,{title:`无法恢复 KML 草稿`}),null}}function oc(e){if(typeof window>`u`||!(e instanceof Function))return()=>{};let t=!1,n=async()=>{if(!t){t=!0;try{let t=await De({title:`处理 KML 保存冲突`,message:`服务器上的 KML 已被其他客户端更新。自动同步已暂停，本地修改仍保存在当前账号的恢复草稿中。`,cancelText:`保留草稿，稍后处理`,choices:[{value:`reload`,text:`加载服务器版本`,class:`app-dialog-primary`},{value:`save-as`,text:`本地版本另存为`}]});if(!t||t===`cancel`)return;await ic(await nc(t),e)}catch(e){if(!Js())return;await Ce(e.message||`KML 冲突处理失败，请稍后重试`,{title:`无法处理保存冲突`})}finally{t=!1}}};return window.addEventListener(`map-kml-sync-resolution-request`,n),()=>window.removeEventListener(`map-kml-sync-resolution-request`,n)}var sc=null;function cc(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function lc(e=window.location){let t=/^\/share\/([^/]+)\/?$/.exec(e.pathname||``)?.[1]||(e.pathname===`/3d`||e.pathname===`/3d.html`?new URLSearchParams(e.search||``).get(`share`):``);if(!t)return``;try{return decodeURIComponent(t)}catch{return``}}function uc(e=window.location){return!!lc(e)}function dc(){return sc?{publicId:sc.publicId,manifest:{...sc.manifest}}:null}function fc(e){document.body.classList.add(`share-view`,`share-unavailable`),document.getElementById(`map-lock-screen`)?.remove();let t=document.createElement(`div`);t.id=`map-lock-screen`,t.className=`lock-screen-backdrop`,t.innerHTML=`
    <section class="lock-screen-card" role="alert">
      <div class="lock-screen-icon">🗺️</div>
      <h2>分享暂不可用</h2>
      <p>${cc(e||`该分享不存在、已暂停或已过期。`)}</p>
      <a class="lock-screen-link" href="/">返回地图首页</a>
    </section>
  `,document.body.appendChild(t)}function pc(e){document.getElementById(`map-lock-screen`)?.remove();let t=document.createElement(`div`);t.id=`map-lock-screen`,t.className=`lock-screen-backdrop`,t.innerHTML=`
  ...
  `}function Vc(e,t){return`${e}?url=${encodeURIComponent(t).replace(/%7B/g,`{`).replace(/%7D/g,`}`)}`}function Hc(e){let t=e.system,n=e.visits||{},r=t?.userSystem||{},i=r.counts||{},a=t?.package?.version||`-`,o=e.visitsError||(e.visitsLoading?`统计中`:``);return`
    <div class="admin-grid">
      <section class="admin-panel">
        ...
        <dl class="admin-metrics">
          ...
          <div><dt>运行</dt><dd>${Lc(t?.uptime||0)}</dd></div>
          <div><dt>环境</dt><dd>${Q(t?.env||`-`)}</dd></div>
          <div><dt>时间</dt><dd>${Rc(t?.serverTime)}</dd></div>
        </dl>
      </section>
      <section class="admin-panel">
        <div class="admin-panel-head">
        ...
        <dl class="admin-metrics">
          ...
          <div><dt>数据库占用</dt><dd>${Ic(r.database?.allocatedBytes||0)}</dd></div>
          ...
          <div><dt>KML 逻辑用量</dt><dd>${Ic(r.storage?.kmlBytes||0)}</dd></div>
        </dl>
      </section>
  ...
  `}function Uc(e){let t=e.cache||{},n=e.cacheError||(e.cacheLoading?`统计中`:``),r=t.bySource||{},i=e.tileSources||[];return`
    <section class="admin-panel">
      <div class="admin-panel-head">
        <h2>缓存治理</h2>
      ...
      <dl class="admin-metrics admin-metrics-five">
        ...
        <div class="metric-size"><dt>总大小</dt><dd>${Ic(t.bytes||0)}</dd></div>
  ...
  `}async function Wc({api:e,event:t,renderDashboard:n,setNotice:r,showConfirm:i,state:a}){let o=t.target.closest(`[data-admin-action]`);if(!o)return!1;let s=o.getAttribute(`data-admin-action`);if(s===`clear-cache`){if(!await i(`清空所有瓦片缓存？此操作不可逆！`))return!0;try{await e.clearCache(),a.cache=await e.cache(),r(`所有瓦片缓存已清空`),n()}catch(e){r(``,e.message),n()}return!0}if(s===`clear-source-cache`){let t=o.getAttribute(`data-source-id`);if(!t)return!1;let s=(a.tileSources||[]).find(e=>e.id===t),c=s?s.name:t;if(!await i(`确定要清空图源【${c}】的全部瓦片缓存吗？`))return!0;try{await e.clearCache({sourceId:t}),a.cache=await e.cache(),r(`已清空图源【${c}】的专属瓦片缓存`),n()}catch(e){r(``,e.message),n()}return!0}return!1}var Gc={queued:`排队中`,running:`执行中`,pausing:`暂停中`,paused:`已暂停`,completed:`已完成`,completed_with_errors:`完成有错误`,failed:`失败`,interrupted:`已中断`,deleting:`删除中`},Kc=1e3,qc=1500,Jc=new Set([`queued`,`running`,`pausing`,`deleting`]),Yc=null,Xc=0,Zc=``,Qc=``,$c=null,el=0;function tl(e){return Gc[e]||e}var nl={queued:`⏳`,running:`⚙`,pausing:`⏸`,paused:`⏸`,completed:`✓`,completed_with_errors:`⚠`,failed:`✗`,interrupted:`⏹`,deleting:`🗑`};function rl(e){return nl[e]||`•`}function il(e,t){let n=t[0],r=e.precacheForm||{};return{providerId:t.some(e=>e.id===r.providerId)?r.providerId:n?.id||``,bounds:{west:Number(r.bounds?.west??113.24),south:Number(r.bounds?.south??23.11),east:Number(r.bounds?.east??113.29),north:Number(r.bounds?.north??23.15)},minZoom:Number(r.minZoom??12),maxZoom:Number(r.maxZoom??12),concurrency:Number(r.concurrency??4),requestIntervalMs:Number(r.requestIntervalMs??0),refresh:!!r.refresh}}function al(e,t){return e.find(e=>e.id===t.providerId)||e[0]||null}function ol(e){let t=e.expandedTaskIds||new Set;return(e.tasks||[]).map(e=>({...e,expanded:t.has(e.id)}))}function sl(e=[]){return e.some(e=>Jc.has(e.status))}function cl(e){let t=e.precacheCatalog||[],n=il(e,t),r=al(t,n),i=ol(e);return`
  ...
  `}function ll(e){let t=e.precacheEstimate;return e.precacheEstimateStatus===`loading`?`<div class="admin-estimate" data-precache-estimate><p>正在估算瓦片数量和下载体积</p></div>`:e.precacheEstimateError?`<div class="admin-estimate is-error" data-precache-estimate><p>${Q(e.precacheEstimateError)}</p></div>`:t?`
    <div class="admin-estimate ${t.withinLimit?``:`is-warning`}" data-precache-estimate>
      <dl class="admin-metrics">
        <div><dt>预计文件</dt><dd>${Q(t.total||0)}</dd></div>
        <div><dt>估算体积</dt><dd>${Ic(t.estimatedBytesRange?.min||0)} - ${Ic(t.estimatedBytesRange?.max||0)}</dd></div>
        <div><dt>建议上限</dt><dd>${Q(t.maxTiles||0)}</dd></div>
        <div><dt>建议</dt><dd>${t.withinLimit?`可以创建`:`任务较大，建议设置请求间隔`}</dd></div>
      </dl>
      <p>${fl(t)}</p>
    </div>
  `:`<div class="admin-estimate" data-precache-estimate><p>停止移动地图后会自动估算任务规模</p></div>`}function ul(e){let t=e.root?.querySelector(`[data-precache-estimate]`);t&&(t.outerHTML=ll(e))}function dl(e){return e.length?e.map(e=>`Z${e.z}: ${e.count}`).join(`，`):`暂无分级明细`}function fl(e){if(e.targetType===`layer`){let t=e.sources||[];return t.length?t.map(e=>`${e.sourceName||e.sourceId}: ${e.total||0} 张，约 ${Ic(e.estimatedBytes||0)}`).join(`，`):`暂无可预缓存图源明细`}return dl(e.ranges||[])}function pl(e){return`
    <section class="admin-panel admin-panel-wide admin-precache-task-panel" data-precache-task-panel>
      ...
      <div class="admin-task-list">
        ${e.slice(0,10).map(e=>ml(e)).join(``)||`<p class="admin-empty">暂无任务</p>`}
      </div>
    </section>
  `}function ml(e){let t=e.expanded;return`
    <article class="admin-task-card">
      <div class="admin-task-main">
        <div class="admin-task-title">
          <span class="admin-status admin-status-${e.status}" title="${Q(tl(e.status))}">${Q(rl(e.status))}</span>
          <strong>${Q(e.providerId)}</strong>
          <small>${Rc(e.updatedAt)}</small>
        </div>
        ${hl(e)}
      </div>
      <dl class="admin-task-summary">
        <div><dt>体积</dt><dd>${Ic(e.bytes||0)}</dd></div>
  ...
  `}function hl(e){let t=Number(e.completed||0),n=Number(e.total||0),r=n?Math.min(100,Math.round(t/n*100)):0;return`
    <div class="admin-task-progress">
      <span>${Q(t)} / ${Q(n)} (${r}%)</span>
      <small>成功 ${Q(e.succeeded||0)}，失败 ${Q(e.failed||0)}</small>
    </div>
  `}function gl(e){let t=[`queued`,`running`].includes(e.status),n=[`paused`,`interrupted`,`failed`,`completed_with_errors`].includes(e.status),r=e.status!==`deleting`,i=e.expanded?`收起`:`详情`;return`
  ...
  `}function _l(e){let t=e.bounds||{},n=e.ranges||[],r=e.errors||[],i=Object.values(e.failedTiles||{});return`
    <div class="admin-task-details">
      <dl>
        <div><dt>区域</dt><dd>西 ${Q(t.west)} / 南 ${Q(t.south)} / 东 ${Q(t.east)} / 北 ${Q(t.north)}</dd></div>
        <div><dt>级别明细</dt><dd>${dl(n)}</dd></div>
        <div><dt>失败待重试</dt><dd>${Q(i.length)}</dd></div>
        <div><dt>创建时间</dt><dd>${Rc(e.createdAt)}</dd></div>
        <div><dt>完成时间</dt><dd>${Rc(e.finishedAt)}</dd></div>
      </dl>
      ${i.length?`
  ...
  `}function vl(e,t){Il(e,t);let n=t.elements.providerId,r=n.options[n.selectedIndex]?.getAttribute(`data-type`)||`source`,i=n.value;return{targetType:r,targetId:i,providerId:i,bounds:{west:Number(t.elements.west.value),south:Number(t.elements.south.value),east:Number(t.elements.east.value),north:Number(t.elements.north.value)},minZoom:Number(t.elements.minZoom.value),maxZoom:Number(t.elements.maxZoom.value),concurrency:Number(t.elements.concurrency.value),requestIntervalMs:Number(t.elements.requestIntervalMs.value),refresh:t.elements.refresh.checked}}function yl(e,t){e.tasks=e.tasks.map(e=>e.id===t.id?t:e)}function bl(e,t){e.tasks=e.tasks.filter(e=>e.id!==t)}function xl(e){let t=e.root?.querySelector(`[data-precache-task-panel]`);t&&(t.outerHTML=pl(ol(e)))}function Sl(e){return Array.isArray(e)?`[${e.map(Sl).join(`,`)}]`:e&&typeof e==`object`?`{${Object.keys(e).sort().map(t=>`${JSON.stringify(t)}:${Sl(e[t])}`).join(`,`)}}`:JSON.stringify(e)}function Cl(e){Xc+=1,Zc=``,e.precacheEstimate=null,e.precacheEstimateStatus=``,e.precacheEstimateError=``,ul(e)}function wl(e,t,n=Kc){e.activeTab===`precache`&&(window.clearTimeout(Yc),Yc=window.setTimeout(()=>{Tl(e,t)},n))}async function Tl(e,t){if(e.activeTab!==`precache`)return;let n=e.root?.querySelector(`[data-precache-form]`);if(!n)return;let r=vl(e,n),i=Sl(r);if(i===Qc||i===Zc)return;let a=Xc+1;Xc=a,Zc=i,e.precacheEstimateStatus=`loading`,e.precacheEstimateError=``,ul(e);try{let n=await t.estimateTask(r);if(a!==Xc)return;e.precacheEstimate=n,e.precacheEstimateStatus=``,e.precacheEstimateError=``,Qc=i,Zc=``,ul(e)}catch(t){if(a!==Xc)return;e.precacheEstimate=null,e.precacheEstimateStatus=``,e.precacheEstimateError=t.message,Zc=``,ul(e)}}function El(e,t,n=qc){window.clearTimeout($c),!(e.activeTab!==`precache`||!sl(e.tasks))&&($c=window.setTimeout(()=>{Dl(e,t)},n))}async function Dl(e,t){if(e.activeTab!==`precache`)return;let n=el+1;el=n;try{let r=await t.tasks();if(n!==el||e.activeTab!==`precache`)return;e.tasks=r,xl(e),El(e,t)}catch(n){console.warn(`预缓存任务状态刷新失败`,n),El(e,t,qc*2)}}async function Ol({api:e,event:t,renderDashboard:n,setNotice:r,state:i}){let a=t.target.closest(`[data-precache-form]`),o=t.target.closest(`[data-place-search-form]`);if(a)return t.preventDefault(),e.createTask(vl(i,a)).then(t=>{Array.isArray(t)?(i.tasks=[...t,...i.tasks],r(`成功创建了 ${t.length} 个图源缓存子任务`)):(i.tasks=[t,...i.tasks],r(`预缓存任务已创建`)),n(),El(i,e,300)}).catch(e=>{r(``,e.message),n()}),!0;if(o){t.preventDefault();let e=o.elements.keyword.value.trim();return e&&await Vl(i,e),!0}return!1}async function kl({api:e,event:t,renderDashboard:n,setNotice:r,showCheckboxConfirm:i,showConfirm:a,state:o}){let s=t.target.closest(`[data-precache-task-action]`);if(s)return await jl({actionTarget:s,api:e,renderDashboard:n,setNotice:r,showCheckboxConfirm:i,showConfirm:a,state:o}),!0;let c=t.target.closest(`[data-place-lng][data-place-lat]`);return c?(zl(o,Number(c.getAttribute(`data-place-lng`)),Number(c.getAttribute(`data-place-lat`))),!0):t.target.closest(`[data-admin-action]`)?.getAttribute(`data-admin-action`)===`sync-bounds`?(Fl(o),Cl(o),wl(o,e),!0):!1}async function Al({api:e,event:t,state:n}){let r=t.target.closest(`[data-precache-form]`);return r?(Il(n,r),Cl(n),wl(n,e),!0):!1}async function jl({actionTarget:e,api:t,renderDashboard:n,setNotice:r,showCheckboxConfirm:i,showConfirm:a,state:o}){let s=e.getAttribute(`data-precache-task-action`),c=e.getAttribute(`data-task-id`),l=o.tasks.find(e=>e.id===c);if(!(!s||!c))try{if(s===`pause`){yl(o,await t.pauseTask(c)),r(`预缓存任务已暂停`),n(),El(o,t,300);return}if(s===`resume`){yl(o,await t.resumeTask(c)),r(`预缓存任务已继续`),n(),El(o,t,300);return}if(s===`delete`){let e=!1;if(i instanceof Function){let t=await i(`删除此预缓存任务？执行中的任务会停止并从列表移除。`,{confirmText:`删除`,checkboxLabel:`同时删除该任务范围内已缓存的瓦片文件`});if(!t?.confirmed)return;e=!!t.checked}else if(!await a(`删除此预缓存任务？执行中的任务会停止并从列表移除。`))return;await t.deleteTask(c,{deleteCache:e}),bl(o,c),r(e?`预缓存任务已删除，关联缓存文件清理已提交`:`预缓存任务已删除`),n();return}if(s===`edit`&&l){Rl(o,l),Cl(o),wl(o,t),r(`任务参数已回填，可调整后创建新任务`),n();return}if(s===`update`&&l){o.tasks=[await t.createTask({providerId:l.providerId,bounds:l.bounds,minZoom:l.minZoom,maxZoom:l.maxZoom,concurrency:l.concurrency,requestIntervalMs:l.requestIntervalMs||0,refresh:!1}),...o.tasks],r(`更新任务已创建，将跳过新鲜缓存并补齐缺失瓦片`),n(),El(o,t,300);return}if(s===`toggle-details`){o.expandedTaskIds.has(c)?o.expandedTaskIds.delete(c):o.expandedTaskIds.add(c),n();return}s===`preview`&&l&&(window.location.href=Ll(l))}catch(e){r(``,e.message),n(),El(o,t,300)}}async function Ml(e){return e.AMap?e.AMap:(window._AMapSecurityConfig={securityJsCode:_.securityJsCode},e.amapLoader?(e.AMap=await e.amapLoader.load({key:_.key,version:`2.0`,plugins:_.plugins}).catch(e=>(console.warn(`高德 JSAPI 加载失败，后台地点搜索不可用`,e),null)),e.AMap):(console.warn(`高德 JSAPI Loader 未初始化，后台地点搜索不可用`),null))}function Nl(e){let t=e.root.querySelector(`[data-precache-form]`);return{west:Number(t?.elements.west.value),south:Number(t?.elements.south.value),east:Number(t?.elements.east.value),north:Number(t?.elements.north.value)}}function Pl(e,t){let n=e.root.querySelector(`[data-precache-form]`);n&&(n.elements.west.value=t.getWest().toFixed(6),n.elements.south.value=t.getSouth().toFixed(6),n.elements.east.value=t.getEast().toFixed(6),n.elements.north.value=t.getNorth().toFixed(6),Il(e,n))}function Fl(e){if(!e.map||!e.rectangle)return;let t=e.map.getBounds();e.rectangle.setBounds(t),Pl(e,t)}function Il(e,t){return t?(e.precacheForm={providerId:t.elements.providerId.value,bounds:{west:Number(t.elements.west.value),south:Number(t.elements.south.value),east:Number(t.elements.east.value),north:Number(t.elements.north.value)},minZoom:Number(t.elements.minZoom.value),maxZoom:Number(t.elements.maxZoom.value),concurrency:Number(t.elements.concurrency.value),requestIntervalMs:Number(t.elements.requestIntervalMs.value),refresh:t.elements.refresh.checked},e.precacheForm):null}function Ll(e){let t=e.bounds||{},n=(Number(t.south)+Number(t.north))/2,r=(Number(t.west)+Number(t.east))/2,i=Number(e.maxZoom||e.minZoom||ee.zoom);if(!Number.isFinite(n)||!Number.isFinite(r))return`/`;let a=[n.toFixed(6),r.toFixed(6),Math.max(3,Math.min(20,i)),0].join(`,`);return`/?coords=${encodeURIComponent(a)}`}function Rl(e,t){if(!t)return;let n=t.bounds||{};e.precacheForm={providerId:t.providerId||e.precacheForm?.providerId||``,bounds:{west:Number(n.west),south:Number(n.south),east:Number(n.east),north:Number(n.north)},minZoom:Number(t.minZoom),maxZoom:Number(t.maxZoom),concurrency:Number(t.concurrency||e.precacheForm?.concurrency||4),requestIntervalMs:Number(t.requestIntervalMs||e.precacheForm?.requestIntervalMs||0),refresh:!1}}function zl(e,t,n,r=15){e.map&&(e.map.setView([n,t],r),Fl(e),e.onPrecacheBoundsChange instanceof Function&&e.onPrecacheBoundsChange())}function Bl(e,t){El(e,t);let n=e.root.querySelector(`#admin-precache-map`);if(!n)return;e.precacheMapHeight&&(n.style.height=`${e.precacheMapHeight}px`),e.onPrecacheBoundsChange=()=>wl(e,t),document.querySelectorAll(`.amap-sug-result`).forEach(e=>e.remove()),e.map&&(e.map.remove(),e.map=null,e.rectangle=null);let r=p.default.map(n,{center:ee.center,zoom:Math.min(ee.zoom,13),zoomControl:!0,attributionControl:!1});p.default.tileLayer(Vc(te,`https://webst01.is.autonavi.com/appmaptile?style=8&x={x}&y={y}&z={z}`),{minZoom:3,maxZoom:18,keepBuffer:4}).addTo(r);let i=Nl(e),a=p.default.latLngBounds([i.south,i.west],[i.north,i.east]);e.rectangle=p.default.rectangle(a,{color:`#0f766e`,weight:2,fillColor:`#f59e0b`,fillOpacity:.14}).addTo(r);let o=!1;r.fitBounds(a),r.on(`moveend zoomend`,()=>Fl(e)),r.on(`moveend zoomend`,()=>{o&&e.onPrecacheBoundsChange instanceof Function&&e.onPrecacheBoundsChange()}),window.requestAnimationFrame(()=>{o=!0}),e.map=r;let s=e.root.querySelector(`[data-place-search-form] input[name="keyword"]`);s&&(s.id=`admin-precache-search-input`,Ml(e).then(t=>{t&&t.AutoComplete&&new t.AutoComplete({input:`admin-precache-search-input`}).on(`select`,t=>{if(t.poi?.location){let{lng:n,lat:r}=t.poi.location;zl(e,n,r)}})}));let c=e.root.querySelector(`.admin-map-resizer`);if(c&&n){let t=0,r=0,i=e=>{t=e.clientY,r=n.offsetHeight,document.addEventListener(`pointermove`,a),document.addEventListener(`pointerup`,o),c.classList.add(`is-dragging`),e.preventDefault()},a=i=>{let a=i.clientY-t,o=Math.min(800,Math.max(150,r+a));n.style.height=`${o}px`,e.precacheMapHeight=o,e.map&&e.map.invalidateSize()},o=()=>{document.removeEventListener(`pointermove`,a),document.removeEventListener(`pointerup`,o),c.classList.remove(`is-dragging`)};c.addEventListener(`pointerdown`,i)}}async function Vl(e,t){let n=e.root.querySelector(`[data-place-search-results]`);if(!n)return;let r=await Ml(e);if(!r){n.innerHTML=`<p>高德搜索暂不可用</p>`;return}let i=new r.PlaceSearch({pageSize:8,pageIndex:1});n.innerHTML=`<p>正在搜索</p>`,i.search(t,(e,t)=>{if(e!==`complete`||!t?.poiList?.pois?.length){n.innerHTML=`<p>没有找到匹配地点</p>`;return}n.innerHTML=t.poiList.pois.map(e=>{let t=e.location;return`
        <button type="button" data-place-lng="${t.lng}" data-place-lat="${t.lat}">
          <strong>${Q(e.name)}</strong>
          <span>${Q(e.address||e.district||``)}</span>
        </button>
      `}).join(``)})}var Hl=4;function Ul(e){let t=e.settings?.access||{};return`
    <div class="admin-grid">
      <section class="admin-panel">
        <div class="admin-panel-head">
          <h2>访问控制</h2>
        ...
        <form class="admin-form" data-access-form autocomplete="off">
          ...
          <label>
            <span>设置访问密码</span>
            <input name="accessPassword" type="password" autocomplete="new-password" placeholder="${t.hasPassword?`已设置，输入新密码以修改`:`输入至少 ${Hl} 位访问密码`}">
          </label>
          ${t.hasPassword?`
            <label class="admin-check">
  ...
  `}async function Kl({api:e,event:t,renderDashboard:n,setNotice:r,showConfirm:i,state:a}){let o=t.target.closest(`[data-admin-action]`);if(!o)return!1;let s=o.getAttribute(`data-admin-action`),c=o.getAttribute(`data-kml-id`);if(s===`create-blank-kml`){let t=await Ee({title:`新建公共 KML`,fields:[{name:`name`,label:`图层名称`,type:`text`}],values:{name:`新建公共 KML ${a.kmls.length+1}`}});if(!t||!t.name?.trim())return!0;try{r(`正在创建...`),await e.createKml({name:t.name.trim(),status:`draft`,coordCorrection:`wgs84-to-gcj02`,features:[]}),a.kmls=await e.kmls(),r(`新建成功`),n()}catch(e){r(``,e.message),n()}return!0}if(s===`trigger-import`)return document.getElementById(`admin-kml-file-input`)?.click(),!0;if(s===`set-status`){let t=o.getAttribute(`data-kml-status`);try{r(`正在更新状态...`),await e.updateKml(c,{status:t}),a.kmls=await e.kmls(),r(`状态已更新`),n()}catch(e){r(``,e.message),n()}return!0}if(s===`rename`){let t=o.getAttribute(`data-kml-name`),i=await Ee({title:`重命名公共 KML`,fields:[{name:`name`,label:`图层名称`,type:`text`}],values:{name:t}});if(!i||!i.name?.trim()||i.name.trim()===t)return!0;try{r(`正在重命名...`),await e.updateKml(c,{name:i.name.trim()}),a.kmls=await e.kmls(),r(`重命名成功`),n()}catch(e){r(``,e.message),n()}return!0}if(s===`export`){try{r(`正在获取数据...`);let t=await e.getKml(c);r(``);let n=zt(t.name,t.features||[]),i=new Blob([n],{type:`application/vnd.google-earth.kml+xml;charset=utf-8`}),a=URL.createObjectURL(i),o=document.createElement(`a`);o.href=a,o.download=`${t.name}.kml`,document.body.appendChild(o),o.click(),document.body.removeChild(o),URL.revokeObjectURL(a)}catch(e){r(``,e.message),n()}return!0}if(s===`delete`){if(!await i(`确认永久删除此公共 KML 图层及其中所有要素？此操作不可撤销。`))return!0;try{r(`正在删除...`),await e.deleteKml(c),a.kmls=await e.kmls(),r(`删除成功`),n()}catch(e){r(``,e.message),n()}return!0}return!1}async function ql({api:e,event:t,renderDashboard:n,setNotice:r,state:i}){let a=t.target;if(a.id===`admin-kml-file-input`){let t=a.files[0];if(!t)return!0;let o=new FormData;o.append(`file`,t),o.append(`name`,t.name),o.append(`status`,`draft`),o.append(`coordCorrection`,`wgs84-to-gcj02`);try{r(`正在导入 KML 文件...`),await e.importKml(o),i.kmls=await e.kmls(),r(`导入成功（默认为草稿状态）`),n()}catch(e){r(``,e.message),n()}finally{a.value=``}return!0}if(a.matches(`[data-admin-action="toggle-correction"]`)){let t=a.getAttribute(`data-kml-id`),o=a.checked?`wgs84-to-gcj02`:`none`;try{r(`正在更新纠偏设置...`),await e.updateKml(t,{coordCorrection:o}),i.kmls=await e.kmls(),r(`纠偏设置已更新`),n()}catch(e){r(``,e.message),n()}return!0}return!1}var Jl=216e5,Yl=2592e6,Xl=60*1e3,Zl=60*Xl,Ql=24*Zl,$l={1:256,2:512,3:768},eu=[[`xyz`,`XYZ 栅格`],[`tms`,`TMS 栅格`],[`xyz-raster`,`XYZ 栅格`],[`tms-raster`,`TMS 栅格`],[`wmts-raster`,`WMTS 栅格`],[`arcgis-raster`,`ArcGIS 栅格`],[`quadkey-raster`,`QuadKey 栅格`],[`time-raster`,`时间序列栅格`],[`mvt`,`MVT 矢量瓦片`],[`vector-tilejson`,`矢量 TileJSON`],[`vector-style`,`矢量 Style JSON`],[`pmtiles-vector`,`PMTiles 矢量`],[`pmtiles-raster`,`PMTiles 栅格`],[`google-map-tiles-api`,`Google Map Tiles API`]],tu=[[`satellite`,`卫星`],[`road`,`街道/道路`],[`street`,`街道/道路`],[`label`,`注记`],[`terrain`,`地形`],[`vector`,`矢量`],[`overlay`,`叠加`],[`weather`,`天气`],[`other`,`其他`],[`custom`,`自定义`]],nu=[[`query`,`Query 参数`],[`header`,`请求头`],[`bearer`,`Bearer Token`],[`session`,`会话/适配器`]],ru=[[`round_robin`,`健康 Key 轮询`],[`priority_failover`,`优先级失败切换`],[`random`,`健康 Key 随机`],[`weighted_round_robin`,`按权重轮询`]],iu=[[`global`,`全局`],[`source`,`图源`],[`publish`,`发布项`]],au=[[`leaflet`,`Leaflet 栅格`],[`maplibre`,`MapLibre 矢量`],[`cesium`,`Cesium 3D`]],ou=new Set([`mvt`,`vector-tilejson`,`vector-style`,`pmtiles-vector`]),su=new Set([`pmtiles-vector`,`pmtiles-raster`]);function cu(e){return e?.errorMessage||e?.error||``}function lu(e,t=``){return e.map(([e,n])=>`<option value="${Q(e)}" ${t===e?`selected`:``}>${Q(n)}</option>`).join(``)}function uu(e,t){return!e||t.some(([t])=>t===e)?``:`<option value="${Q(e)}" selected>${Q(e)}</option>`}function du(e=``){return eu.find(([t])=>t===e)?.[1]||e||`-`}function fu(e=``){return ou.has(e)}function pu(e=``){return su.has(e)}function mu(e={},t){return e.entry?.[t]||e[t]||``}function hu(e={}){return e.kind===`vector-style`?mu(e,`styleJsonUrl`):e.kind===`vector-tilejson`?mu(e,`tileJsonUrl`):pu(e.kind)?mu(e,`pmtilesUrl`):mu(e,`template`)}function gu(e,t=`是`,n=`否`){return e?`<span class="badge-green">${Q(t)}</span>`:`<span class="badge-gray">${Q(n)}</span>`}function _u(e=`ready`){return e===`ready`?`<span class="badge-green">可创建</span>`:e===`requires_adapter`?`<span class="badge-blue">需适配器</span>`:e===`research_only`?`<span class="badge-gray">调研参考</span>`:`<span class="badge-gray">${Q(e)}</span>`}function vu(e=[],t=``){return e.map(e=>`<option value="${Q(e.id)}" ${e.id===t?`selected`:``}>${Q(e.name)} (${Q(e.id)})</option>`).join(``)}function yu(e={},t=[]){return e.requiresKey&&(t.find(t=>(t.allowedPresetIds||[]).includes(e.presetId))||t.find(t=>t.id===`default-${e.vendor}-key-pool`)||t.find(t=>t.vendor===e.vendor&&t.scope===`global`))||null}function bu(e={},t=`申请 Key`){return e.credentialUrl?`<a href="${Q(e.credentialUrl)}" target="_blank" rel="noopener noreferrer" class="btn-link">${Q(t)}</a>`:``}function xu(e){return e===`layer`?`组合图层`:e===`dedicated_source`?`专用图源`:`系统图源`}function Su(e){return e.visibility?.scope===`external_only`?`专用发布`:`系统图源`}function Cu(e,t){let n=window.location.origin,r=e.pathSlug,i=e.auth?.mode===`token`?`?token=您的TOKEN`:``,a=`${n}/api/v1/external/${r}/tilejson${i}`,o=`${n}/api/v1/external/${r}/tilejson.json${i}`,s=`${n}/api/v1/external/${r}/style.json${i}`,c=e.targetType===`source`||e.targetType===`dedicated_source`?(t.tileSources||[]).find(t=>t.id===e.targetId):null;if(c&&fu(c.kind)){let t=`${n}/api/v1/external/${r}/tiles/{z}/{x}/{y}.pbf${i}`,a=`${n}/api/v1/external/${r}.pmtiles${i}`,l=c.kind===`vector-style`?s:c.kind===`vector-tilejson`?o:pu(c.kind)?a:t,u=c.kind===`vector-style`?`const map = new maplibregl.Map({
  container: 'map',
  style: '${s}'
...
`):`// 当前组合图层没有可用图源`;return`
  ...
  `}function wu(e={},t=[],n=[],r=`proxy`){let i=[`fixed`,`pool`].includes(e.mode)?e.mode:`never`;return`
    <div class="form-grid">
  ...
  `}function Tu(e,t){let n=Number.isFinite(Number(e))?Math.max(0,Number(e)):t;return{days:Math.floor(n/Ql),hours:Math.floor(n%Ql/Zl),minutes:Math.floor(n%Zl/Xl)}}function Eu(e,t,n,r){let i=Tu(n,r);return`
    <div class="field-group">
      <label>${t}</label>
  ...
  `}function Du(e={},t=`cache`){return`
    <div class="checkbox-group">
      <input type="checkbox" id="${t}_enabled" name="${t}_enabled" ${e.enabled===!1?``:`checked`}>
      <label for="${t}_enabled">启用服务端缓存</label>
    </div>
    <div class="form-grid" style="margin-top:10px;">
      ${Eu(`${t}_ttl`,`缓存有效时间`,e.ttlMs,Jl)}
      ${Eu(`${t}_staleTtl`,`软过期时间`,e.staleTtlMs,Yl)}
    </div>
  `}function Ou(e,t,n=`proxy`){return{mode:t.get(`${n}_mode`)||`never`,outboundId:t.get(`${n}_outboundId`)||``,poolId:t.get(`${n}_poolId`)||``,fallbackToDirect:!!e.elements[`${n}_fallbackToDirect`]?.checked}}function ku(e,t){let n=Math.max(0,parseInt(e.get(`${t}_days`)||`0`,10)||0),r=Math.max(0,parseInt(e.get(`${t}_hours`)||`0`,10)||0),i=Math.max(0,parseInt(e.get(`${t}_minutes`)||`0`,10)||0);return n*Ql+r*Zl+i*Xl}function Au(e,t,n=`cache`){return{enabled:!!e.elements[`${n}_enabled`]?.checked,ttlMs:ku(t,`${n}_ttl`),staleTtlMs:ku(t,`${n}_staleTtl`)}}function ju(e,t){return String(e.get(t)||``).split(`,`).map(e=>e.trim()).filter(Boolean)}function Mu(e){return{template:String(e.get(`entry_template`)||``).trim(),styleJsonUrl:String(e.get(`entry_styleJsonUrl`)||``).trim(),tileJsonUrl:String(e.get(`entry_tileJsonUrl`)||``).trim(),pmtilesUrl:String(e.get(`entry_pmtilesUrl`)||``).trim(),glyphsUrl:String(e.get(`entry_glyphsUrl`)||``).trim(),spritesUrl:String(e.get(`entry_spritesUrl`)||``).trim()}}function Nu(e,t){return{required:!!e.elements.secrets_required?.checked,keyPoolId:t.get(`secrets_keyPoolId`)||``,placement:t.get(`secrets_placement`)||`query`,paramName:t.get(`secrets_paramName`)||`key`}}function Pu(e,t){return{engine:t.get(`rendering_engine`)||`leaflet`,clients:[e.elements.rendering_client_2d?.checked?`2d`:``,e.elements.rendering_client_3d?.checked?`3d`:``].filter(Boolean),fallbackRasterSourceId:t.get(`rendering_fallbackRasterSourceId`)||``}}function Fu(e,t){return{attribution:t.get(`license_attribution`)||``,termsUrl:t.get(`license_termsUrl`)||``,officialStatus:t.get(`license_officialStatus`)||`official`,licenseType:t.get(`license_licenseType`)||`unknown`,cacheAllowedByLicense:!!e.elements.license_cacheAllowedByLicense?.checked,publicUseAllowed:!!e.elements.license_publicUseAllowed?.checked,chinaPublicUseReviewed:!!e.elements.license_chinaPublicUseReviewed?.checked,chinaPublicUseRisk:t.get(`license_chinaPublicUseRisk`)||``}}function Iu(e,t){let n=Array.from(e.querySelectorAll(`[data-key-row]`)).map(e=>{let t=t=>e.querySelector(`[name="${t}"]`),n={id:t(`key_id`)?.value||``,alias:t(`key_alias`)?.value||``,enabled:!!t(`key_enabled`)?.checked,secretType:t(`key_secretType`)?.value||`api_key`,placement:t(`key_placement`)?.value||`query`,paramName:t(`key_paramName`)?.value||`key`,priority:parseInt(t(`key_priority`)?.value||`100`,10),weight:parseInt(t(`key_weight`)?.value||`1`,10),qpsLimit:parseInt(t(`key_qpsLimit`)?.value||`0`,10),dailyLimit:parseInt(t(`key_dailyLimit`)?.value||`0`,10),monthlyLimit:parseInt(t(`key_monthlyLimit`)?.value||`0`,10)},r=t(`key_secret`)?.value||``;return r&&(n.secret=r),n});return{id:t.get(`id`),name:t.get(`name`),vendor:t.get(`vendor`),enabled:!!e.elements.enabled?.checked,scope:t.get(`scope`)||`global`,strategy:t.get(`strategy`)||`round_robin`,cooldownMs:parseInt(t.get(`cooldownMs`)||`300000`,10),maxRetriesPerRequest:parseInt(t.get(`maxRetriesPerRequest`)||`2`,10),defaultSecretType:t.get(`defaultSecretType`)||`api_key`,defaultPlacement:t.get(`defaultPlacement`)||`query`,defaultParamName:t.get(`defaultParamName`)||`key`,credentialUrl:String(t.get(`credentialUrl`)||``).trim(),allowedPresetIds:ju(t,`allowedPresetIds`),allowedSourceIds:ju(t,`allowedSourceIds`),keys:n,description:t.get(`description`)||``}}function Lu(e,t){if(!e.editingKeyPool||!t)return;let n=e.editingKeyPool.keys||[],r=new Map(n.filter(e=>e.id).map(e=>[e.id,e])),i=Iu(t,new FormData(t));i.keys=i.keys.map((e,t)=>({...n[t]||{},...r.get(e.id)||{},...e})),e.editingKeyPool={...e.editingKeyPool,...i}}function Ru(e={}){let t=e.entry||{};return`
  ...
  `}function zu(e={},t=[]){let n=e.secrets||{};return`
    <fieldset class="form-card" style="margin-top:15px; padding:15px; background:white;">
  ...
  `}function Bu(e={},t=[]){let n=e.rendering||{},r=n.clients||(fu(e.kind)?[`2d`]:[`2d`,`3d`]),i=t.filter(e=>!fu(e.kind)&&!pu(e.kind));return`
    <fieldset class="form-card" style="margin-top:15px; padding:15px; background:white;">
      ...
      <div class="form-grid">
        <div class="field-group">
          ...
          <select name="rendering_engine">
            ${lu(au,n.engine||(fu(e.kind)?`maplibre`:`leaflet`))}
          </select>
        </div>
        <div class="field-group">
  ...
  `}function Vu(e={}){let t=e.license||{};return`
    <fieldset class="form-card" style="margin-top:15px; padding:15px; background:white;">
      ...
      <div class="form-grid">
        <div class="field-group">
          ...
          <select name="license_officialStatus">
            ${lu([[`official`,`官方`],[`unofficial`,`非官方`],[`community`,`社区`],[`internal`,`内部`]],t.officialStatus||`official`)}
          </select>
        </div>
        <div class="field-group">
          <label>授权类型</label>
          <select name="license_licenseType">
            ${lu([[`free`,`免费`],[`api-key`,`API Key`],[`commercial`,`商业授权`],[`unknown`,`未知`]],t.licenseType||`unknown`)}
          </select>
        </div>
      </div>
      <div class="checkbox-group" style="margin-top:0;">
  ...
  `}function Hu(e={}){let t=Number(e.retina?.normalValue);return $l[t]?String(t):`1`}function Uu(e,t,n,r,i){let a=e!==!1,o=a?i:r;return`
    <button
      type="button"
      ...
      title="点击切换为${Q(o)}"
    >${Q(a?r:i)}</button>
  `}function Wu(e){let t=String(e||``).toUpperCase();return t===`HIT`?`<span class="badge-green">HIT</span>`:t===`MISS`?`<span class="badge-red">MISS</span>`:t===`BYPASS`?`<span class="badge-gray">BYPASS</span>`:t===`REVALIDATED`?`<span class="badge-blue">REVAL</span>`:t===`STALE`?`<span class="badge-blue">STALE</span>`:t===`ERROR`?`<span class="badge-red">ERROR</span>`:`<span class="badge-gray">${Q(t||`-`)}</span>`}function Gu(e){let t=Number(e.statusCode||0);return t>=200&&t<300?`<span class="badge-green">200 OK</span>`:`<span class="badge-red" title="${Q(e.errorMessage||``)}">${Q(e.statusCode||`-`)}</span>`}function Ku(e){return e.proxyOutboundId?`<span class="badge-blue" title="池: ${Q(e.proxyPoolId||``)}">${Q(e.proxyOutboundId)}</span>`:e.proxyPoolId?`<span class="badge-blue">${Q(e.proxyPoolId)}</span>`:e.proxyConfigured?`<span class="badge-red" title="已配置代理，但本次未命中可用出口">代理未命中</span>`:`<span style="color:#94a3b8;">直连</span>`}async function qu(e,t,n={}){let{tileSources:r=!1,sourcePresets:i=!1,keyPools:a=!1,mapLayers:o=!1,externalPublishes:s=!1,precacheCatalog:c=!0}=n,l=[],u=[];r&&(l.push(t.listTileSources()),u.push(t=>{e.tileSources=t})),i&&(l.push(t.listSourcePresets()),u.push(t=>{e.sourcePresets=t})),a&&(l.push(t.listKeyPools()),u.push(t=>{e.keyPools=t})),o&&(l.push(t.listMapLayers()),u.push(t=>{e.mapLayers=t})),s&&(l.push(t.listExternalPublishes()),u.push(t=>{e.externalPublishes=t})),c&&(l.push(t.precacheCatalog()),u.push(t=>{e.precacheCatalog=t})),(await Promise.all(l)).forEach((e,t)=>u[t](e))}function Ju(e){e.tileSourcesSubTab=e.tileSourcesSubTab||`sources`;let t=[{id:`sources`,label:`图源`},{id:`presets`,label:`图源预设`},{id:`key-pools`,label:`密钥池`},{id:`layers`,label:`图层组合`},{id:`publishes`,label:`发布/API`},{id:`diagnostics`,label:`诊断日志`}],n=``;switch(e.tileSourcesSubTab){case`sources`:n=Yu(e);break;case`presets`:n=Xu(e);break;case`key-pools`:n=Qu(e);break;case`layers`:n=$u(e);break;case`publishes`:n=ed(e);break;case`diagnostics`:n=td(e);break;default:n=`<p>未知子页面</p>`}return`
  ...
  `}function Yu(e){let t=e.tileSources||[],n=e.editingTileSource;if(n){let r=!t.some(e=>e.id===n.id),i=e.proxyOutbounds||[],a=e.proxyPools||[],o=e.keyPools||[],s=Hu(n),c=n.category||`custom`,l=n.kind||`xyz-raster`;return`
      <div class="form-card">
        ...
        <form data-tile-sources-form="source">
          ...
          <div class="form-grid">
            ...
            <div class="field-group">
              <label>适配器</label>
              <input name="adapter" value="${Q(n.adapter||(fu(l)?`maplibre-style`:`template`))}" placeholder="template / wmts-kvp / maplibre-style / pmtiles">
            </div>
          </div>
          <div class="form-grid">
            <div class="field-group">
    ...
    <table class="item-table">
      ...
      <tbody>
        ${t.map(t=>{let n=e[`test_source_${t.id}`]||``,r=hu(t);return`
            <tr>
              <td>
              ...
              <td>
                ...
                <span class="badge-blue" style="margin-left:4px;">${Q(du(t.kind))}</span>
                <span class="badge-gray" style="margin-left:4px;">${Q(Su(t))}</span>
              </td>
              <td>
              ...
              <td>
                ${Uu(t.enabled,`source`,t.id,`启用中`,`已禁用`)}
              </td>
              <td>
                <div style="display: flex; flex-direction: column; align-items: flex-start; gap: 4px;">
                  ...
                  ${n&&n!==`loading`&&!n.success?`<span class="test-status test-fail" style="margin-left: 0;" title="${Q(cu(n))}">失败</span>`:``}
                </div>
              </td>
              <td>
  ...
  `}function Xu(e){let t=e.sourcePresets||[],n=e.keyPools||[],r=e.creatingSourceFromPreset;if(r){let e=t.find(e=>e.presetId===r.presetId)||r,i=yu(e,n),a=r.keyPoolId||i?.id||``,o=e.status===`ready`;return`
      <div class="form-card">
        ...
        <form data-tile-sources-form="preset-source">
          ...
          <div class="form-grid">
            <div class="field-group">
              <label>预设类型</label>
              <input value="${Q(`${e.vendor||`custom`} / ${du(e.kind)}`)}" readonly>
            </div>
            <div class="field-group">
              <label>关联密钥池</label>
              ...
              ${i?`<p style="color:#64748b; font-size:12px; margin:6px 0 0;">已自动匹配：${Q(i.name)} ${bu(i)}</p>`:``}
            </div>
          </div>
    ...
    <table class="item-table">
      ...
      <tbody>
        ${t.map(e=>{let t=hu(e),r=yu(e,n);return`
            <tr>
              <td>
                <strong>${Q(e.name)}</strong>
              ...
              <td>
                ...
                <span class="badge-blue" style="margin-left:4px;">${Q(du(e.kind))}</span>
              ...
              <td>
                ...
                ${r?`<div style="margin-top:4px;"><span class="badge-gray">${Q(r.name)}</span> ${bu(r)}</div>`:``}
              </td>
              <td>${_u(e.status)}</td>
              <td>
                ${gu(e.cacheAllowedByLicense!==!1,`可缓存`,`禁缓存`)}
                ${gu(!!e.publicUseAllowed,`可公开`,`慎公开`)}
              </td>
              <td>
  ...
  `}function Zu(e,t=!1,n={}){return(e.keys||[]).map((r,i)=>{let a=n[`test_key_${e.id}_${r.id}`]||``,o=!r.hasSecret&&!r.maskedPreview,s=r.secretType||e.defaultSecretType||`api_key`,c=r.placement||e.defaultPlacement||`query`,l=r.paramName||e.defaultParamName||`key`;return`
      <div class="key-row" data-key-row="${i}">
        <div class="key-row-main">
          ...
          <select name="key_secretType">
            ${uu(s,[[`api_key`,`api_key`],[`token`,`token`],[`tk`,`tk`],[`ak`,`ak`],[`appid`,`appid`]])}
            ${lu([[`api_key`,`api_key`],[`token`,`token`],[`tk`,`tk`],[`ak`,`ak`],[`appid`,`appid`]],s)}
          </select>
        </div>
        <div class="key-row-main">
        ...
        <div class="flex-actions">
          ...
          ${a&&a!==`loading`&&!a.success?`<span class="test-status test-fail" title="${Q(cu(a))}">不可用</span>`:``}
        </div>
      </div>
    `}).join(``)||`<p style="color:#64748b;">暂无 Key，请添加至少一个 Key。</p>`}function Qu(e){let t=e.keyPools||[],n=e.sourcePresets||[],r=e.tileSources||[],i=e.editingKeyPool;if(i){let a=!t.some(e=>e.id===i.id);return`
      <div class="form-card">
          ...
          <div class="form-grid">
            <div class="field-group">
              ...
              <select name="defaultSecretType">
                ${uu(i.defaultSecretType||`api_key`,[[`api_key`,`api_key`],[`token`,`token`],[`tk`,`tk`],[`ak`,`ak`],[`appid`,`appid`]])}
                ${lu([[`api_key`,`api_key`],[`token`,`token`],[`tk`,`tk`],[`ak`,`ak`],[`appid`,`appid`]],i.defaultSecretType||`api_key`)}
              </select>
            </div>
            <div class="field-group">
              ...
              <div style="display:grid; grid-template-columns: 1fr 1fr; gap:8px;">
                <select name="defaultPlacement">
                  ${lu(nu,i.defaultPlacement||`query`)}
                </select>
        ...
        ${t.map(t=>{let n=e[`test_key_pool_${t.id}`]||``,r=(t.keys||[]).filter(e=>e.enabled!==!1).length;return`
            <tr>
              <td>
                <strong>${Q(t.name)}</strong>
                <div style="color:#64748b; font-size:11px; margin-top:2px;">${Q(t.id)}</div>
                ${t.credentialUrl?`<div style="margin-top:4px;">${bu(t,`申请 / 管理 Key`)}</div>`:``}
              </td>
              <td>
                <span class="badge-gray">${Q(t.vendor)}</span>
                <span class="badge-blue" style="margin-left:4px;">${Q(ru.find(([e])=>e===t.strategy)?.[1]||t.strategy)}</span>
              ...
              <td>
                ...
                ${n&&n!==`loading`&&!n.success?`<span class="test-status test-fail" title="${Q(cu(n))}">失败</span>`:``}
              </td>
              <td>${Uu(t.enabled,`key-pool`,t.id,`启用中`,`已禁用`)}</td>
              <td>
                <div class="flex-actions">
  ...
  `}function $u(e){let t=e.mapLayers||[],n=e.editingMapLayer;if(n){let r=!t.some(e=>e.id===n.id),i=e.tileSources||[],a=n.items||[{sourceId:``,opacity:1,zIndex:0}];return`
      <div class="form-card">
              ...
              ${a.map((e,t)=>`
                <div class="layer-item-row" data-layer-item-index="${t}">
                  ...
                  <select name="item_sourceId" required>
                    ...
                    ${i.map(t=>`<option value="${t.id}" ${e.sourceId===t.id?`selected`:``}>${Q(t.name)} (${t.id} / ${du(t.kind)})</option>`).join(``)}
                  </select>
      ...
      <tbody>
        ${t.map(t=>`
          <tr>
            ...
            <td>
              ${Uu(t.enabled,`layer`,t.id,`启用中`,`已禁用`)}
            </td>
            <td>
  ...
  `}function ed(e){let t=e.externalPublishes||[],n=e.editingExternalPublish,r=e.selectedPublishId||t[0]?.id||``;if(n){let r=!t.some(e=>e.id===n.id),i=e.tileSources||[],a=i.filter(e=>e.visibility?.scope!==`external_only`&&e.permissions?.externalApiAllowed!==!1),o=i.filter(e=>e.visibility?.scope===`external_only`),s=e.mapLayers||[],c=e.proxyOutbounds||[],l=e.proxyPools||[],u=n.targetType||`source`,d=u===`layer`?s.map(e=>`<option value="${e.id}" ${n.targetId===e.id?`selected`:``}>${Q(e.name)} (${e.id})</option>`).join(``):u===`dedicated_source`?o.map(e=>`<option value="${e.id}" ${n.targetId===e.id?`selected`:``}>${Q(e.name)} (${e.id} / ${du(e.kind)})</option>`).join(``):a.map(e=>`<option value="${e.id}" ${n.targetId===e.id?`selected`:``}>${Q(e.name)} (${e.id} / ${du(e.kind)})</option>`).join(``),f=n.overrides?.proxy||null,p=n.overrides?.cache||null;return`
      <div class="form-card">
        ...
        <form data-tile-sources-form="publish">
          ...
          <div class="form-grid">
            ...
            <div class="field-group">
              ...
              <select name="targetId" required>
                <option value="">请选择${Q(xu(u))}</option>
                ${d}
              </select>
            </div>
          </div>
          ...
          <fieldset class="form-card" style="margin-top:15px; padding:15px; background:white;">
            ...
            ${wu(f||{mode:`never`},c,l,`publish_proxy`)}
          </fieldset>
    ...
    `}let i=e.lastGeneratedToken?`<div class="admin-token-notice">
       ...
       </div>`:``,a=t.find(e=>e.id===r),o=``;return a&&(o=Cu(a,e)),`
    ${i}
      ...
      <tbody>
        ${t.map(t=>{let n=e[`test_publish_${t.id}`]||``;return`
            <tr style="background: ${t.id===r?`#f0fdfa`:`transparent`}; cursor:pointer;" data-tile-sources-select-publish="${t.id}">
              ...
              <td style="white-space: nowrap;"><span class="badge-gray">${Q(xu(t.targetType))}</span></td>
              ...
              <td style="white-space: nowrap;">
                ${Uu(t.enabled,`publish`,t.id,`已发布`,`已禁用`)}
              </td>
              <td style="white-space: nowrap;">
    ...
    ${o}
  `}function td(e){e.diagnosticsLogType=e.diagnosticsLogType||`source`;let t=e.diagnosticsPublishId||``,n=e.diagnosticsSourceId||``,r=e.externalPublishes||[],i=e.tileSources||[],a=e.diagnosticsLogType===`source`,o=a?e.sourceAccessLogs||[]:e.diagnosticLogs||[],s=a?e.sourceAccessLogsError||``:e.diagnosticLogsError||``;return`
    <div class="admin-panel-head">
      <h3>运行诊断日志</h3>
      <div style="display:flex; gap:10px; align-items:center;">
    ...
    `}else a=`
            ...
            ${t.map(t=>{let n=e[`test_outbound_${t.id}`]||``;return`
                <tr>
                  ...
                  <td>
                    ...
                    ${n&&n!==`loading`&&!n.success?`<span class="test-status test-fail" title="${Q(ld(n))}">失败: ${Q(ld(n))}</span>`:``}
                  </td>
                  <td>
      ...
      <div>
        ...
        <table class="item-table">
          ...
          <tbody>
            ${n.map(t=>{let n=e[`test_pool_${t.id}`]||``,r=n&&n!==`loading`?ud(n):null;return`
                <tr>
                  <td>
                    <strong>${Q(t.name)}</strong>
                    <div style="color: #64748b; font-size:11px; margin-top:2px;">${Q(t.id)}</div>
  ...
  `).join(``)}function Sd(e,t,n=1){let r=e?.[t];return r==null||r===``?``:Number(r)/n}function Cd(e,t){return{...e.adminUserFilters,page:t,limit:e.adminUsers?.limit||20}}async function wd(e,t,n=e.adminUsers?.page||1){e.adminUsers=await t.listUsers(Cd(e,n))}function Td(e){let t=e.adminUsers||{items:[]},n=t.items||[],r=e.roles||[],i=zc(e,`admin.user.manage`),a=zc(e,`admin.role.manage`),o=e.adminUserFilters||{};return`
        ...
        <form class="admin-filter-form" data-admin-users-filter>
          ...
          <label>
            ...
            <select name="status">
              ...
              ${yd.map(([e,t])=>`<option value="${e}" ${o.status===e?`selected`:``}>${t}</option>`).join(``)}
            </select>
          </label>
          <label>
            <span>角色</span>
            ...
            <tbody>
              ${n.map(e=>`
                <tr>
                  ...
                  <td>
                    <span class="admin-state-pill is-${Q(e.status)}">${Q(bd(e.status))}</span>
                  ...
                  <td>
                    <small class="admin-cell-secondary">登录：${Q(Rc(e.lastLoginAt))}</small>
                    <small class="admin-cell-secondary">创建：${Q(Rc(e.createdAt))}</small>
                  </td>
                  <td>
                    ...
                    ${i?`
                      <details class="admin-inline-details">
                        ...
                        <form class="admin-user-edit-form" data-admin-user-edit data-user-id="${Q(e.id)}">
                          ...
                          <label>
                            <span>账号状态</span>
                            <select name="status">${yd.map(([t,n])=>`<option value="${t}" ${e.status===t?`selected`:``}>${n}</option>`).join(``)}</select>
                          </label>
                          ...
                          <fieldset>
                            ...
                            <label><span>KML 文件数</span><input name="maxKmlFiles" type="number" min="1" max="10000" value="${Sd(e.quota,`maxKmlFiles`)}"></label>
                            <label><span>单文件上限（MB）</span><input name="maxKmlFileMb" type="number" min="1" max="100" value="${Sd(e.quota,`maxKmlFileBytes`,1024*1024)}"></label>
                            <label><span>单文件要素数</span><input name="maxFeaturesPerKml" type="number" min="1" max="1000000" value="${Sd(e.quota,`maxFeaturesPerKml`)}"></label>
                            <label><span>总要素数</span><input name="maxFeaturesPerUser" type="number" min="1" max="5000000" value="${Sd(e.quota,`maxFeaturesPerUser`)}"></label>
                            <label><span>回收站天数</span><input name="trashRetentionDays" type="number" min="1" max="3650" value="${Sd(e.quota,`trashRetentionDays`)}"></label>
                          </fieldset>
          ...
          <form class="admin-form admin-user-create-form" data-admin-user-create autocomplete="off">
            ...
            ${a?`
              <fieldset class="admin-permission-fieldset">
                <legend>初始角色</legend>
                <div class="admin-checkbox-grid">${xd(r,[`user`])}</div>
              </fieldset>
            `:``}
  ...
  `}async function Ed({api:e,event:t,renderDashboard:n,setNotice:r,state:i}){let a=t.target.closest(`[data-admin-users-filter]`);if(a){t.preventDefault();let o=new FormData(a);i.adminUserFilters={search:String(o.get(`search`)||``).trim(),status:String(o.get(`status`)||``),role:String(o.get(`role`)||``)};try{r(`正在筛选用户...`),await wd(i,e,1),r(``)}catch(e){r(``,e.message)}return n(),!0}let o=t.target.closest(`[data-admin-user-create]`);if(o){t.preventDefault();let a=new FormData(o),s={username:String(a.get(`username`)||``).trim(),displayName:String(a.get(`displayName`)||``).trim(),email:String(a.get(`email`)||``).trim(),roles:a.getAll(`roles`).map(String)},c=String(a.get(`password`)||``);c&&(s.password=c),s.roles.length||(s.roles=[`user`]);try{r(`正在创建用户...`);let t=await vd(e,()=>e.createUser(s));await wd(i,e,1),o.reset(),r(`用户创建成功`),n(),await Ce(`用户名：${t.user?.username||s.username}\n临时密码：${t.temporaryPassword}\n请通过安全渠道交付，关闭后将不再显示。`,{title:`临时密码（仅显示一次）`,confirmText:`我已安全保存`})}catch(e){r(``,e.code===`ACTION_CANCELLED`?``:e.message),n()}return!0}let s=t.target.closest(`[data-admin-user-roles]`);if(s){t.preventDefault();let a=new FormData(s).getAll(`roles`).map(String);if(!a.length)return r(``,`用户至少需要一个角色`),!0;try{r(`正在更新用户角色...`),await vd(e,()=>e.updateUserRoles(s.dataset.userId,a)),await wd(i,e),r(`角色已更新，用户原有会话已失效`)}catch(e){r(``,e.code===`ACTION_CANCELLED`?``:e.message)}return n(),!0}let c=t.target.closest(`[data-admin-user-edit]`);if(c){t.preventDefault();let a=new FormData(c),o={},s=!1;if([[`maxKmlFiles`,1],[`maxKmlFileBytes`,1024*1024,`maxKmlFileMb`],[`maxFeaturesPerKml`,1],[`maxFeaturesPerUser`,1],[`trashRetentionDays`,1]].forEach(([e,t,n=e])=>{let r=String(a.get(n)||``).trim();if(!r)return;let i=Number(r);if(!Number.isFinite(i)||i<=0){s=!0;return}o[e]=Math.round(i*t)}),s)return r(``,`个人配额必须为大于 0 的数字，或留空继承系统默认`),!0;let l={displayName:String(a.get(`displayName`)||``).trim(),status:String(a.get(`status`)||``),quota:o};a.get(`replaceEmail`)&&(l.email=String(a.get(`email`)||``).trim());try{r(`正在更新用户资料与配额...`),await vd(e,()=>e.updateUser(c.dataset.userId,l)),await wd(i,e),r(`用户资料与配额已更新`)}catch(e){r(``,e.code===`ACTION_CANCELLED`?``:e.message)}return n(),!0}return!1}async function Dd({api:e,event:t,renderDashboard:n,setNotice:r,showConfirm:i,state:a}){let o=t.target.closest(`[data-admin-action]`);if(!o)return!1;let s=o.dataset.adminAction,c=o.dataset.userId;if(s===`users-page`){let t=Number(o.dataset.page||1);if(t<1)return!0;try{r(`正在加载用户...`),await wd(a,e,t),r(``)}catch(e){r(``,e.message)}return n(),!0}let l=(a.adminUsers?.items||[]).find(e=>e.id===c);if(!l)return!1;if(s===`reset-user-password`){if(!await i(`确认重置用户“${l.username}”的密码？其全部会话将立即失效。`,{title:`重置用户密码`,confirmText:`确认重置`}))return!0;try{r(`正在重置密码...`);let t=await vd(e,()=>e.resetUserPassword(c));await wd(a,e),r(`密码已重置`),n(),await Ce(`临时密码：${t.temporaryPassword}\n请通过安全渠道交付，关闭后将不再显示。`,{title:`临时密码（仅显示一次）`,confirmText:`我已安全保存`})}catch(e){r(``,e.code===`ACTION_CANCELLED`?``:e.message),n()}return!0}if(s===`revoke-user-sessions`){if(!await i(`确认强制退出用户“${l.username}”的所有登录会话？`,{title:`强制退出`,confirmText:`确认退出全部会话`}))return!0;try{r(`正在注销用户会话...`);let t=await e.revokeUserSessions(c);r(`已注销 ${Number(t.revokedCount||0)} 个会话`)}catch(e){r(``,e.message)}return n(),!0}return!1}var Od=Object.freeze([[`account.self.read`,`查看个人账号`],[`account.self.update`,`修改个人账号`],[`session.self.manage`,`管理个人会话`],[`kml.own.read`,`查看个人 KML`],[`kml.own.write`,`管理个人 KML`],[`share.own.manage`,`管理个人分享`],[`favorite.own.manage`,`管理个人收藏`],[`admin.overview.read`,`查看后台概览`],[`admin.cache.manage`,`管理缓存`],[`admin.precache.manage`,`管理预缓存任务`],[`admin.layer.manage`,`管理图源、图层和代理`],[`admin.public_kml.manage`,`管理公共 KML 图层`],[`admin.share.moderate`,`治理用户分享`],[`admin.audit.read`,`查看审计日志`],[`admin.user.read`,`查看用户列表`],[`admin.user.manage`,`管理用户`],[`admin.role.manage`,`管理角色和权限`],[`admin.registration.manage`,`管理注册策略`],[`admin.security.manage`,`管理安全策略`],[`kml.any.read`,`读取任意用户 KML`],[`kml.any.manage`,`管理任意用户 KML`]]);function kd(e){return e.startsWith(`admin.`)?`后台管理`:e.startsWith(`kml.any.`)?`跨用户数据`:`个人能力`}function Ad(e=[],t=``){let n=new Set(e),r=new Map;return Od.forEach(([e,t])=>{let n=kd(e);r.has(n)||r.set(n,[]),r.get(n).push([e,t])}),[...r.entries()].map(([e,t])=>`
    <fieldset class="admin-permission-fieldset">
      <legend>${Q(e)}</legend>
  ...
  `}function Md(e){let t=e.roles||[];return`
    <div class="admin-user-system-stack">
      <section class="admin-panel">
        <div class="admin-panel-head">
          <div>
        ...
        <div class="admin-role-grid">
          ${t.filter(e=>e.builtIn).map(jd).join(``)||`<p class="admin-empty">暂无内置角色数据</p>`}
        </div>
      </section>
  ...
  `}function Nd(e,t=!1){let n=new FormData(e),r={name:String(n.get(`name`)||``).trim(),description:String(n.get(`description`)||``).trim(),permissions:n.getAll(`permissions`).map(String)};return t&&(r.code=String(n.get(`code`)||``).trim().toLowerCase()),r}async function Pd({api:e,event:t,renderDashboard:n,setNotice:r,state:i}){let a=t.target.closest(`[data-admin-role-create]`);if(a){t.preventDefault();try{r(`正在创建角色...`),await vd(e,()=>e.createRole(Nd(a,!0))),i.roles=await e.listRoles(),r(`角色已创建`)}catch(e){r(``,e.code===`ACTION_CANCELLED`?``:e.message)}return n(),!0}let o=t.target.closest(`[data-admin-role-edit]`);if(o){t.preventDefault();try{r(`正在保存角色...`),await vd(e,()=>e.updateRole(o.dataset.roleId,Nd(o))),i.roles=await e.listRoles(),r(`角色已更新，受影响用户需重新登录`)}catch(e){r(``,e.code===`ACTION_CANCELLED`?``:e.message)}return n(),!0}return!1}async function Fd({api:e,event:t,renderDashboard:n,setNotice:r,showConfirm:i,state:a}){let o=t.target.closest(`[data-admin-action="delete-role"]`);if(!o)return!1;if(!await i(`确认删除自定义角色“${o.dataset.roleName||``}”？`,{title:`删除角色`,confirmText:`确认删除`}))return!0;try{r(`正在删除角色...`),await vd(e,()=>e.deleteRole(o.dataset.roleId)),a.roles=await e.listRoles(),r(`角色已删除`)}catch(e){r(``,e.code===`ACTION_CANCELLED`?``:e.message)}return n(),!0}var Id=60*1e3,Ld=60*Id,Rd=24*Ld;function zd(e,t=1){let n=Number(e||0)/t;return Number.isFinite(n)?n:0}function Bd(e){return(e.roles||[]).filter(e=>{let t=e.permissions||[];return e.code===`user`||!t.some(e=>e.startsWith(`admin.`)||e.startsWith(`kml.any.`)||e===`system.super_admin`)})}function Vd(e){let t=e.userSystemSettings||{},n=t.registration||{},r=t.session||{},i=t.quota||{},a=t.share||{},o=zc(e,`admin.registration.manage`),s=zc(e,`admin.security.manage`),c=Bd(e),l=new Set(n.defaultRoleCodes||[`user`]);return`
    <div class="admin-user-system-stack">
      ...
      ${s?`
        <section class="admin-panel">
          ...
          <form class="admin-form" data-admin-user-security-settings>
            <div class="admin-field-grid admin-field-grid-three">
              <label><span>普通会话有效期（天）</span><input name="sessionTtlDays" type="number" min="1" max="30" step="1" value="${zd(r.ttlMs,Rd)}" required></label>
              <label><span>记住登录有效期（天）</span><input name="rememberTtlDays" type="number" min="1" max="90" step="1" value="${zd(r.rememberTtlMs,Rd)}" required></label>
              <label><span>高风险操作再验证窗口（分钟）</span><input name="reauthMinutes" type="number" min="1" max="60" step="1" value="${zd(r.reauthWindowMs,Id)}" required></label>
            </div>
            ...
            <fieldset class="admin-permission-fieldset">
              ...
              <div class="admin-field-grid admin-field-grid-three">
                ...
                <label><span>单个 KML 上限（MB）</span><input name="maxKmlFileMb" type="number" min="1" max="100" value="${zd(i.maxKmlFileBytes,1024*1024)}" required></label>
              ...
              <p class="admin-field-help">当前单文件限制：${Q(Ic(i.maxKmlFileBytes||0))}</p>
            </fieldset>
            ...
            <fieldset class="admin-permission-fieldset">
              ...
              <div class="admin-field-grid admin-field-grid-three">
                ...
                <label><span>分享密码授权有效期（小时）</span><input name="shareAccessHours" type="number" min="1" max="168" value="${zd(a.accessTtlMs,Ld)}" required></label>
              </div>
            </fieldset>
  ...
  `}function Hd(e,t){return Number.parseInt(String(e.get(t)||``),10)}async function Ud({api:e,event:t,renderDashboard:n,setNotice:r,state:i}){let a=t.target.closest(`[data-admin-registration-settings]`);if(a){t.preventDefault();let o=new FormData(a),s=[...new Set(o.getAll(`defaultRoleCodes`).map(String))];try{r(`正在保存注册策略...`),i.userSystemSettings=await vd(e,()=>e.updateUserSystemSettings({registration:{mode:String(o.get(`mode`)||`closed`),defaultRoleCodes:s}})),r(`注册策略已更新`)}catch(e){r(``,e.code===`ACTION_CANCELLED`?``:e.message)}return n(),!0}let o=t.target.closest(`[data-admin-user-security-settings]`);if(o){t.preventDefault();let a=new FormData(o),s={session:{ttlMs:Hd(a,`sessionTtlDays`)*Rd,rememberTtlMs:Hd(a,`rememberTtlDays`)*Rd,reauthWindowMs:Hd(a,`reauthMinutes`)*Id},quota:{maxKmlFiles:Hd(a,`maxKmlFiles`),maxKmlFileBytes:Hd(a,`maxKmlFileMb`)*1024*1024,maxFeaturesPerKml:Hd(a,`maxFeaturesPerKml`),maxFeaturesPerUser:Hd(a,`maxFeaturesPerUser`),trashRetentionDays:Hd(a,`trashRetentionDays`)},share:{publicAccessPolicy:String(a.get(`publicAccessPolicy`)||`inherit_site_access`),maxFilesPerShare:Hd(a,`maxFilesPerShare`),accessTtlMs:Hd(a,`shareAccessHours`)*Ld}};try{r(`正在保存用户体系策略...`),i.userSystemSettings=await vd(e,()=>e.updateUserSystemSettings(s)),r(`用户体系策略已更新`)}catch(e){r(``,e.code===`ACTION_CANCELLED`?``:e.message)}return n(),!0}return!1}var Wd=[[`active`,`有效`],[`paused`,`已暂停`],[`blocked`,`已封禁`],[`expired`,`已过期`],[`revoked`,`已撤销`],[`draft`,`草稿`]];function Gd(e){return Wd.find(([t])=>t===e)?.[1]||e||`-`}function Kd(e,t){return{...e.shareFilters,page:t,limit:e.moderatedShares?.limit||20}}async function qd(e,t,n=e.moderatedShares?.page||1){e.moderatedShares=await t.listUserShares(Kd(e,n))}function Jd(e){let t=e.moderatedShares||{items:[]},n=e.shareFilters||{};return`
    <div class="admin-user-system-stack">
      <section class="admin-panel">
        <div class="admin-panel-head">
          <div>
        ...
        <form class="admin-filter-form admin-filter-form-compact" data-admin-share-filter>
          ...
          <label>
            ...
            <select name="status">
              <option value="">全部状态</option>
              ${Wd.map(([e,t])=>`<option value="${e}" ${n.status===e?`selected`:``}>${t}</option>`).join(``)}
            </select>
          </label>
          <button type="submit">筛选</button>
        </form>
            ...
            <tbody>
              ${(t.items||[]).map(e=>`
                <tr>
                  ...
                  <td>
                    <span class="admin-state-pill is-${Q(e.status)}">${Q(Gd(e.status))}</span>
                  ...
                  <td>
                    ...
                    <small class="admin-cell-secondary">最近：${Q(Rc(e.lastAccessedAt))}</small>
                    <small class="admin-cell-secondary">到期：${Q(Rc(e.expiresAt))}</small>
                  </td>
                  <td>
                    <div class="admin-row-actions">
  ...
  `}async function Yd({api:e,event:t,renderDashboard:n,setNotice:r,state:i}){let a=t.target.closest(`[data-admin-share-filter]`);if(!a)return!1;t.preventDefault();let o=new FormData(a);i.shareFilters={search:String(o.get(`search`)||``).trim(),status:String(o.get(`status`)||``)};try{r(`正在筛选分享...`),await qd(i,e,1),r(``)}catch(e){r(``,e.message)}return n(),!0}async function Xd({api:e,event:t,renderDashboard:n,setNotice:r,showConfirm:i,state:a}){let o=t.target.closest(`[data-admin-action]`);if(!o)return!1;let s=o.dataset.adminAction;if(s===`shares-page`){let t=Number(o.dataset.page||1);if(t<1)return!0;try{r(`正在加载分享...`),await qd(a,e,t),r(``)}catch(e){r(``,e.message)}return n(),!0}if(s===`block-share`){let t=await Ee({title:`封禁分享：${o.dataset.shareTitle||``}`,fields:[{name:`reason`,label:`封禁原因`,type:`textarea`}],values:{reason:``},confirmText:`确认封禁`}),i=String(t?.reason||``).trim();if(!i)return!0;try{r(`正在封禁分享...`),await e.blockUserShare(o.dataset.shareId,i),await qd(a,e),r(`分享已封禁，公开访问立即失效`)}catch(e){r(``,e.message)}return n(),!0}if(s===`unblock-share`){if(!await i(`解除封禁后，分享将进入暂停状态，由所有者决定是否恢复公开。`,{title:`解除分享封禁`,confirmText:`解除封禁`}))return!0;try{r(`正在解除封禁...`),await e.unblockUserShare(o.dataset.shareId),await qd(a,e),r(`已解除封禁，分享当前为暂停状态`)}catch(e){r(``,e.message)}return n(),!0}return!1}function Zd(e,t){return{...e.auditFilters,page:t,limit:e.auditLogs?.limit||20}}async function Qd(e,t,n=e.auditLogs?.page||1){e.auditLogs=await t.listAuditLogs(Zd(e,n))}function $d(e){try{let t=JSON.stringify(e||{},null,2);return t.length>4e3?`${t.slice(0,4e3)}\n…已截断`:t}catch{return`{}`}}function ef(e){let t=e.auditLogs||{items:[]},n=e.auditFilters||{};return`
    <div class="admin-user-system-stack">
      <section class="admin-panel">
        <div class="admin-panel-head">
          <div>
          ...
          ${(t.items||[]).map(e=>`
            <article class="admin-audit-entry">
              <header>
                ...
                <time datetime="${Q(e.createdAt||``)}">${Q(Rc(e.createdAt))}</time>
              </header>
              <dl>
  ...
  `}async function tf({api:e,event:t,renderDashboard:n,setNotice:r,state:i}){let a=t.target.closest(`[data-admin-audit-filter]`);if(!a)return!1;t.preventDefault();let o=new FormData(a);i.auditFilters={action:String(o.get(`action`)||``).trim(),targetType:String(o.get(`targetType`)||``).trim()};try{r(`正在筛选审计日志...`),await Qd(i,e,1),r(``)}catch(e){r(``,e.message)}return n(),!0}async function nf({api:e,event:t,renderDashboard:n,setNotice:r,state:i}){let a=t.target.closest(`[data-admin-action="audit-page"]`);if(!a)return!1;let o=Number(a.dataset.page||1);if(o<1)return!0;try{r(`正在加载审计日志...`),await Qd(i,e,o),r(``)}catch(e){r(``,e.message)}return n(),!0}function rf(e){let t=e?.user?.permissions||e?.permissions||[];return Array.isArray(t)?t:[]}function af(e,t){if(!t)return!!(e?.user||e?.username);let n=rf(e);return n.includes(`system.super_admin`)||n.includes(t)}function of(e,t){return e?e.permissions?e.permissions.some(e=>af(t,e)):af(t,e.permission):!1}function sf(e,t){return e.filter(e=>of(e,t))}var cf=[{id:`overview`,label:`概览`,permission:`admin.overview.read`,render:Hc},{id:`cache`,label:`缓存`,permission:`admin.cache.manage`,render:Uc,handleClick:Wc},{id:`kml`,label:`公共 KML`,permission:`admin.public_kml.manage`,render:Gl,handleClick:Kl,handleChange:ql},{id:`precache`,label:`预缓存`,permission:`admin.precache.manage`,render:cl,afterRender:Bl,afterEnter:wl,afterLoad:wl,handleSubmit:Ol,handleClick:kl,handleChange:Al},{id:`tile-sources`,label:`图源管理`,permission:`admin.layer.manage`,render:Ju,afterEnter:nd,afterLoad:nd,handleClick:od,handleSubmit:sd,handleChange:cd},{id:`proxy`,label:`代理配置`,permission:`admin.layer.manage`,render:dd,afterEnter:fd,afterLoad:fd,handleClick:pd,handleSubmit:md,handleChange:hd},{id:`settings`,label:`站点设置`,permission:`admin.security.manage`,render:Ul,handleSubmit:Wl},{id:`users`,label:`用户管理`,permission:`admin.user.read`,render:Td,handleClick:Dd,handleSubmit:Ed},{id:`roles`,label:`角色权限`,permission:`admin.role.manage`,render:Md,handleClick:Fd,handleSubmit:Pd},{id:`user-system`,label:`用户体系设置`,permissions:[`admin.registration.manage`,`admin.security.manage`],render:Vd,handleSubmit:Ud},{id:`shares`,label:`分享治理`,permission:`admin.share.moderate`,render:Jd,handleClick:Xd,handleSubmit:Yd},{id:`audit`,label:`审计日志`,permission:`admin.audit.read`,render:ef,handleClick:nf,handleSubmit:tf}];function lf(e){return sf(cf,e)}function uf(e){return`/admin/${df(e).id}`}function df(e){return cf.find(t=>t.id===e)||cf[0]}function ff(e,t){let n=lf(t);return n.find(t=>t.id===e)||n[0]||null}function pf(e){return cf.some(t=>t.id===e)}function mf(e){return e.pathname===`/admin`||e.pathname.startsWith(`/admin/`)||new URLSearchParams(e.search).get(`view`)===`admin`}function hf(e){let[,t,n]=e.pathname.split(`/`);if(t===`admin`)return pf(n)?n:`overview`;let r=new URLSearchParams(e.search).get(`tab`);return pf(r)?r:`overview`}function gf(e){if(!e.message&&!e.error&&!e.loading)return``;let t=e.error||e.message||`正在加载`,n=!!e.error,r=!e.error&&(e.message===`正在加载`||e.message===`正在登录`||e.loading);return`
  ...
  `}function _f(e){e.root.innerHTML=`
  ...
  `}function vf(e){let t=e.session?.user?.username||``;e.root.innerHTML=`
    <section class="admin-login">
  ...
  `}function yf(e,t){let n=lf(e.session),r=e.session?.user||{};e.root.innerHTML=`
    <section class="admin-shell">
      ...
      <div class="admin-layout">
        <nav class="admin-tabs" aria-label="后台导航">
          ${n.map(t=>`
            <a href="${uf(t.id)}" data-admin-tab="${t.id}" class="${e.activeTab===t.id?`is-active`:``}">
              ${Q(t.label)}
            </a>
          `).join(``)}
        </nav>
  ...
  `}var $={root:null,activeTab:`overview`,loading:!1,message:``,error:``,session:null,system:null,cache:null,cacheLoading:!1,cacheError:``,visits:null,visitsLoading:!1,visitsError:``,settings:null,userSystemSettings:null,tasks:[],kmls:[],adminUsers:{items:[],page:1,limit:20,total:0},adminUserFilters:{search:``,status:``,role:``},roles:[],moderatedShares:{items:[],page:1,limit:20,total:0},shareFilters:{search:``,status:``},auditLogs:{items:[],page:1,limit:20,total:0},auditFilters:{action:``,targetType:``},precacheForm:{providerId:``,bounds:{west:113.24,south:23.11,east:113.29,north:23.15},minZoom:12,maxZoom:12,concurrency:4,requestIntervalMs:0,refresh:!1},precacheEstimate:null,precacheEstimateStatus:``,precacheEstimateError:``,expandedTaskIds:new Set,amapLoader:null,AMap:null,map:null,rectangle:null,precacheMapHeight:260},bf=null;function xf(e){bf=e}function Sf(e=``,t=``){$.message=e,$.error=t,bf&&bf(e,t)}function Cf(e){pf(e)&&($.activeTab=e)}var wf=null;function Tf(){$.session?$.session.user?.mustChangePassword?vf($):jf():_f($)}xf((e,t)=>{wf&&=(clearTimeout(wf),null);let n=t||e;n&&n!==`正在加载`&&n!==`正在登录`&&(wf=setTimeout(()=>{Sf(``),Tf()},4e3))});function Ef(){return hf(window.location)}function Df(e){window.history.replaceState(null,``,`${uf(e)}${window.location.hash}`)}function Of(){return ff($.activeTab,$.session)}function kf(){let e=Of();return e?(e.id!==$.activeTab&&(Cf(e.id),Df(e.id)),e):null}function Af(){let e=kf();return e?e.render($):`
      <section class="admin-panel">
        <h2>无后台访问权限</h2>
        <p class="admin-panel-description">当前账号没有可用的管理权限，请联系超级管理员。</p>
      </section>
    `}function jf(){yf($,Af()),Of()?.afterRender?.($,Z)}window.renderDashboard=jf;function Mf(e){return{api:Z,event:e,renderDashboard:jf,setNotice:Sf,showCheckboxConfirm:Te,showConfirm:we,state:$}}function Nf(...e){$.session&&(!e.length||e.includes($.activeTab))&&jf()}async function Pf(e,t){let n=Of()?.[e];return n instanceof Function?!!await n(Mf(t)):!1}function Ff(e){if(e?.authenticated===!1||!e?.user){let e=Error(`请先登录管理后台`);throw e.status=401,e.code=`AUTH_REQUIRED`,e}return e}async function If(e={}){let t=!!e.cacheOnly,n=af($.session,`admin.cache.manage`),r=af($.session,`admin.overview.read`);Object.assign($,{cacheLoading:n,cacheError:``,visitsLoading:t?$.visitsLoading:r,visitsError:t?$.visitsError:``}),Nf(`overview`,`cache`),n&&Z.cache().then(e=>{$.cache=e,$.cacheError=``,e.refreshing&&window.setTimeout(()=>If({cacheOnly:!0}),1500)}).catch(e=>{$.cacheError=e.message}).finally(()=>{$.cacheLoading=!1,Nf(`cache`)}),!(t||!r)&&Z.visits().then(e=>{$.visits=e,$.visitsError=``}).catch(e=>{$.visitsError=e.message}).finally(()=>{$.visitsLoading=!1,Nf(`overview`)})}function Lf(e){let t=e=>af($.session,e);t(`admin.overview.read`)&&e.push([`system`,()=>Z.system()]),t(`admin.security.manage`)&&e.push([`settings`,()=>Z.settings()]),t(`admin.precache.manage`)&&(e.push([`tasks`,()=>Z.tasks()]),e.push([`precacheCatalog`,()=>Z.precacheCatalog()])),t(`admin.public_kml.manage`)&&e.push([`kmls`,()=>Z.kmls()]),t(`admin.layer.manage`)&&e.push([`tileSources`,()=>Z.listTileSources()],[`sourcePresets`,()=>Z.listSourcePresets()],[`keyPools`,()=>Z.listKeyPools()],[`mapLayers`,()=>Z.listMapLayers()],[`proxyOutbounds`,()=>Z.listProxyOutbounds()],[`proxyPools`,()=>Z.listProxyPools()],[`externalPublishes`,()=>Z.listExternalPublishes()]),t(`admin.user.read`)&&e.push([`adminUsers`,()=>Z.listUsers({...$.adminUserFilters,page:1,limit:$.adminUsers.limit})]),t(`admin.role.manage`)&&e.push([`roles`,()=>Z.listRoles()]),(t(`admin.registration.manage`)||t(`admin.security.manage`))&&e.push([`userSystemSettings`,()=>Z.getUserSystemSettings()]),t(`admin.share.moderate`)&&e.push([`moderatedShares`,()=>Z.listUserShares({...$.shareFilters,page:1,limit:$.moderatedShares.limit})]),t(`admin.audit.read`)&&e.push([`auditLogs`,()=>Z.listAuditLogs({...$.auditFilters,page:1,limit:$.auditLogs.limit})])}async function Rf(){$.loading=!0,Sf(`正在加载`),$.session||_f($);try{if($.session=Ff(await Z.session()),$.session.user.mustChangePassword){$.loading=!1,Sf(``),vf($);return}kf();let e=[];Lf(e),(await Promise.all(e.map(async([e,t])=>[e,await t()]))).forEach(([e,t])=>{$[e]=t}),$.loading=!1,Sf(``),jf(),Of()?.afterLoad?.($,Z),If()}catch(e){$.loading=!1,e.status===401?($.session=null,Sf(``,e.message),_f($)):(Sf(``,e.message),Tf())}}async function zf(e){let t=e.target.closest(`[data-admin-login]`);if(t){e.preventDefault();let n={username:t.elements.username.value,password:t.elements.password.value,remember:!!t.elements.remember.checked};Sf(`正在登录`),_f($);try{await Mc(n),Sf(``),await Rf()}catch(e){$.session=null,Sf(``,e.message),_f($)}return}let n=e.target.closest(`[data-admin-required-password]`);if(n){e.preventDefault();let t=n.elements.currentPassword.value,r=n.elements.newPassword.value;if(r!==n.elements.confirmPassword.value){Sf(``,`两次输入的新密码不一致`),vf($);return}try{Sf(`正在修改密码`),vf($),await Z.updatePassword({currentPassword:t,newPassword:r}),$.session=null,Sf(`密码修改成功，正在加载后台`),await Rf()}catch(e){Sf(``,e.message),vf($)}return}await Pf(`handleSubmit`,e)}async function Bf(e){let t=e.target.closest(`[data-admin-tab]`);if(t){e.preventDefault();let n=ff(t.getAttribute(`data-admin-tab`),$.session);if(!n)return;Cf(n.id),Df(n.id),jf(),Of()?.afterEnter?.($,Z);return}let n=e.target.closest(`[data-admin-action]`);if(n){let e=n.getAttribute(`data-admin-action`);if(e===`logout`){try{await Nc()}catch(e){if(e.status!==401){Sf(``,e.message),Tf();return}}$.session=null,Sf(``),_f($);return}if(e===`refresh`){await Rf();return}if(e===`close-notice`){Sf(``),Tf();return}}await Pf(`handleClick`,e)}async function Vf(e){await Pf(`handleChange`,e)}async function Hf(e={}){document.body.classList.add(`admin-view`),Cf(Ef()),$.amapLoader=e.amapLoader||null,$.root=document.getElementById(`admin-root`),$.root.hidden=!1,$.root.addEventListener(`submit`,zf),$.root.addEventListener(`click`,Bf),$.root.addEventListener(`change`,Vf),$.root.addEventListener(`input`,Vf),_f($),await Rf()}function Uf(e){let t=e?.user?.permissions||[];return t.includes(`system.super_admin`)||t.some(e=>e.startsWith(`admin.`))}function Wf(e,t,n){if(!e)return;let r=n.authenticated?n.user?.displayName||n.user?.username||`用户`:`登录 / 注册`;e.dataset.authenticated=String(!!n.authenticated),e.setAttribute(`aria-label`,n.authenticated?`用户中心：${r}`:`登录或注册`),e.setAttribute(`title`,n.authenticated?`用户中心 · ${r}`:`登录 / 注册`);let i=e.querySelector(`[data-account-entry-label]`);i&&(i.textContent=n.authenticated?r:`登录`),t&&(t.hidden=!Uf(n))}function Gf(e={}){let t=e.button||document.querySelector(`[data-action="openAccount"]`),n=e.adminItem||document.querySelector(`[data-admin-identity-item]`),r=e=>Wf(t,n,e);r(ea());let i=ta(r);return ra().catch(()=>r(ea())),i}function Kf(){`serviceWorker`in navigator&&window.addEventListener(`load`,()=>{navigator.serviceWorker.register(`/sw.js`).catch(e=>{console.warn(`Service Worker 注册失败`,e)})})}async function qf(e){let{init:t,title:n=`私有地图服务`,message:r=`管理员启用了访问控制，请输入密码解锁`,submitText:i=`载入地图`,loadingText:a=`正在验证...`}=e;try{(await Pc()).required?Jf({init:t,title:n,message:r,submitText:i,loadingText:a}):await t()}catch(e){console.error(`Failed to check map access status`,e),Jf({init:t,title:n,message:`访问状态检查失败，请稍后重试`,submitText:i,loadingText:a,allowRetry:!0})}}function Jf(e){let{init:t,title:n,message:r,submitText:i,loadingText:a,allowRetry:o=!1}=e;document.getElementById(`map-lock-screen`)?.remove();let s=document.createElement(`div`);s.id=`map-lock-screen`,s.className=`lock-screen-backdrop`,s.innerHTML=`
    <div class="lock-screen-card">
      <div class="lock-screen-icon">🔒</div>
      <h2>${Q(n)}</h2>
      <p>${Q(r)}</p>
  ...
  `,document.body.appendChild(s);let c=document.getElementById(`lock-screen-form`),l=document.getElementById(`lock-screen-error`);s.querySelector(`[data-lock-retry]`)?.addEventListener(`click`,()=>{s.remove(),qf({init:t,title:n,submitText:i,loadingText:a})}),c.addEventListener(`submit`,async e=>{e.preventDefault(),l.style.display=`none`;let n=c.elements.password.value.trim();if(!n)return;let r=c.querySelector(`button[type="submit"]`);try{r.disabled=!0,r.textContent=a,await Fc(n),s.remove(),await t()}catch(e){r.disabled=!1,r.textContent=i,l.textContent=e.message||`访问密码错误`,l.style.display=`block`}})}export{Tt as $,Va as A,ee as At,Ji as B,rc as C,A as Ct,ro as D,ae as Dt,wo as E,T as Et,aa as F,o as Ft,Pt as G,zt as H,sa as I,s as It,ct as J,Nt as K,ra as L,u as Lt,ea as M,re as Mt,ca as N,f as Nt,yo as O,E as Ot,ia as P,d as Pt,jt as Q,oa as R,l as Rt,ec as S,O as St,Eo as T,N as Tt,It as U,qi as V,Ft as W,Dt as X,V as Y,yt as Z,ys as _,De as _t,mf as a,pt as at,Ys as b,ye as bt,Ac as c,z as ct,dc as d,ot as dt,Et as et,uc as f,Ze as ft,ac as g,Ce as gt,oc as h,Xe as ht,Hf as i,mt as it,Na as j,ne as jt,$a as k,_ as kt,xc as l,gt as lt,hc as m,it as mt,Kf as n,ft as nt,Q as o,B as ot,gc as p,Ye as pt,st as q,Gf as r,St as rt,kc as s,bt as st,qf as t,ht as tt,bc as u,wt as ut,qs as v,we as vt,To as w,M as wt,Xs as x,_e as xt,Js as y,Ee as yt,ta as z};