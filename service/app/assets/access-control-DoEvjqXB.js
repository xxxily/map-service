...
`)}function hr(e){let t=String(e||``).toLowerCase();return/(?:picture|photo|image)/.test(t)?`image`:/video/.test(t)?`video`:/(?:sound|audio)/.test(t)?`audio`:``}function gr(e,t={}){let{references:n}=sr(e?.description||``,t),r=ur(n),i=n.flatMap((e,n)=>{if(dr(e,r))return[];let i=lr(e.url.toString(),{...t,index:n,typeHint:e.typeHint});return i.accepted?e.typeHint||i.item.type:[]}),a=hr(e?.styleUrl);return[...new Set([a,...i].filter(Boolean))]}function _r(e,t={}){let{references:n}=sr(e?.description||``,t);return[...new Set(n.flatMap(e=>{let t=Cn(e.url);return t?.provider?[t.provider]:[]}))]}function vr(e,t={}){return _r(e,t)[0]||``}function yr(e,t={}){return gr(e,t)[0]||``}var br=/^未命名(?:点位|要素(?:\s*\d+)?)$/;function xr(e){let t=String(e?.name||``).trim();return e?.type===`Point`&&br.test(t)?``:t}function Sr(e){return e?.type===`LineString`?`未命名线段`:e?.type===`Polygon`?`未命名区域`:`未命名点位`}function Cr(e){let t=xr(e),n=Sr(e),r=t||(e?.type===`Point`?``:n);return{displayName:r,accessibleName:r||n}}var wr=new Set([`image`,`video`,`audio`,`iframe`]);function Tr(e,t,n){let r=/description-link-(\d+)$/i.exec(String(e?.id||``));if(r)return Number(r[1]);let i=Number(e?.sortOrder);return Number.isFinite(i)?i:1e5+t*1e4+n}function Er(e,t){return e?e instanceof Map?e.get(t)||null:e[t]||null:null}function Dr(e){try{return new URL(e).hostname}catch{return``}}function Or(e,t,n={}){let r=t||fr(e,n.contentOptions),i=xr(e),a=String(e?.id||``),o=[];return(r?.groups||[]).forEach((t,n)=>{wr.has(t?.type)&&(t.items||[]).forEach((r,s)=>{let c=String(r?.title||``).trim();o.push({...r,title:c&&c!==Dr(r?.url)?c:i,type:t.type,featureId:a,featureName:i,featureType:String(e?.type||``),sourceOrder:Tr(r,n,s)})})}),o.sort((e,t)=>e.sourceOrder-t.sourceOrder),o.map((e,t)=>({...e,featureMediaIndex:t,galleryId:`${a||`feature`}:${e.id||e.type}:${t}`}))}function kr(e,t={}){let n=Array.isArray(e?.features)?e.features:[],r=String(e?.id||``),i=String(e?.name||``).trim()||`未命名 KML`;return n.flatMap((e,n)=>{let a=String(e?.id||``);return Or(e,Er(t.featureViews,a),t).map(e=>({...e,kmlId:r,kmlName:i,featureIndex:n}))}).map((e,t)=>({...e,galleryIndex:t}))}function Ar(e,t={}){if(!Array.isArray(e)||!e.length)return 0;let n=String(t.featureId||``),r=String(t.id||``),i=String(t.url||``),a=String(t.type||``),o=Number(t.featureMediaIndex),s=e.findIndex(e=>n&&e.featureId!==n||a&&e.type!==a?!1:r&&e.id===r||i&&e.url===i&&(!a||e.type===a)||!r&&!i&&a?!0:Number.isInteger(o)&&e.featureMediaIndex===o);return s===-1&&n&&(s=e.findIndex(e=>e.featureId===n)),s===-1?0:s}function jr(e,t={}){let n=Math.max(1,Number.parseInt(t.limit,10)||4),r=t.view||fr(e,t.contentOptions),i=Or(e,r,t),a=i.length>n?Math.max(1,n-1):n,o=i.slice(0,a);return{items:o,overflowItem:i[o.length]||null,total:i.length,remaining:Math.max(0,i.length-a),contentSummary:r?.contentSummary||{}}}typeof window<`u`&&(window.NodeList&&!NodeList.prototype.forEach&&(NodeList.prototype.forEach=Array.prototype.forEach),typeof window.CustomEvent!=`function`&&(window.CustomEvent=function(e,t){t||={bubbles:!1,cancelable:!1,detail:null};var n=document.createEvent(`CustomEvent`);return n.initCustomEvent(e,t.bubbles,t.cancelable,t.detail),n}));var Mr=typeof document<`u`&&!!document.documentMode,Nr;function Pr(){return Nr||=document.createElement(`div`).style}var Fr=[`webkit`,`moz`,`ms`],Ir={};function Lr(e){if(Ir[e])return Ir[e];let t=Pr();if(e in t)return Ir[e]=e;let n=e[0].toUpperCase()+e.slice(1),r=Fr.length;for(;r--;){let i=`${Fr[r]}${n}`;if(i in t)return Ir[e]=i}}function Rr(e,t){return parseFloat(t[Lr(e)])||0}function zr(e,t,n=window.getComputedStyle(e)){let r=t===`border`?`Width`:``;return{left:Rr(`${t}Left${r}`,n),right:Rr(`${t}Right${r}`,n),top:Rr(`${t}Top${r}`,n),bottom:Rr(`${t}Bottom${r}`,n)}}function Br(e,t,n){e.style[Lr(t)]=n}function Vr(e,t){Br(e,`transition`,`${Lr(`transform`)} ${t.duration}ms ${t.easing}`)}function Hr(e,{x:t,y:n,scale:r,isSVG:i},a){if(Br(e,`transform`,`scale(${r}) translate(${t}px, ${n}px)`),i&&Mr){let t=window.getComputedStyle(e).getPropertyValue(`transform`);e.setAttribute(`transform`,t)}}function Ur(e){let t=e.parentNode;(!t||t.nodeType!==1)&&(t=document.documentElement);let n=window.getComputedStyle(e),r=window.getComputedStyle(t),i=e.getBoundingClientRect(),a=t.getBoundingClientRect();return{elem:{style:n,width:i.width,height:i.height,top:i.top,bottom:i.bottom,left:i.left,right:i.right,margin:zr(e,`margin`,n),border:zr(e,`border`,n)},parent:{style:r,width:a.width,height:a.height,top:a.top,bottom:a.bottom,left:a.left,right:a.right,padding:zr(t,`padding`,r),border:zr(t,`border`,r)}}}var Wr={down:`mousedown`,move:`mousemove`,up:`mouseup mouseleave`};typeof window<`u`&&(typeof window.PointerEvent==`function`?Wr={down:`pointerdown`,move:`pointermove`,up:`pointerup pointerleave pointercancel`}:typeof window.TouchEvent==`function`&&(Wr={down:`touchstart`,move:`touchmove`,up:`touchend touchcancel`}));function Gr(e,t,n,r){Wr[e].split(` `).forEach(e=>{t.addEventListener(e,n,r)})}function Kr(e,t,n){Wr[e].split(` `).forEach(e=>{t.removeEventListener(e,n)})}function qr(e,t){let n=e.length;for(;n--;)if(e[n].pointerId===t.pointerId)return n;return-1}function Jr(e,t){let n;if(t.touches){n=0;for(let r of t.touches)r.pointerId=n++,Jr(e,r);return}n=qr(e,t),n>-1&&e.splice(n,1),e.push(t)}function Yr(e,t){if(t.touches){for(;e.length;)e.pop();return}let n=qr(e,t);n>-1&&e.splice(n,1)}function Xr(e){e=e.slice(0);let t=e.pop(),n;for(;n=e.pop();)t={clientX:(n.clientX-t.clientX)/2+t.clientX,clientY:(n.clientY-t.clientY)/2+t.clientY};return t}function Zr(e){if(e.length<2)return 0;let t=e[0],n=e[1];return Math.sqrt(Math.abs(n.clientX-t.clientX)**2+Math.abs(n.clientY-t.clientY)**2)}function Qr(e){let t=e;for(;t&&t.parentNode;){if(t.parentNode===document)return!0;t=t.parentNode instanceof ShadowRoot?t.parentNode.host:t.parentNode}return!1}function $r(e){return(e.getAttribute(`class`)||``).trim()}function ei(e,t){return e.nodeType===1&&` ${$r(e)} `.indexOf(` ${t} `)>-1}function ti(e,t){for(let n=e;n!=null;n=n.parentNode)if(ei(n,t.excludeClass)||t.exclude.indexOf(n)>-1)return!0;return!1}var ni=/^http:[\w\.\/]+svg$/;function ri(e){return ni.test(e.namespaceURI)&&e.nodeName.toLowerCase()!==`svg`}function ii(e){let t={};for(let n in e)e.hasOwnProperty(n)&&(t[n]=e[n]);return t}var ai={animate:!1,canvas:!1,cursor:`move`,disablePan:!1,disableZoom:!1,disableXAxis:!1,disableYAxis:!1,duration:200,easing:`ease-in-out`,exclude:[],excludeClass:`panzoom-exclude`,handleStartEvent:e=>{e.preventDefault(),e.stopPropagation()},maxScale:4,minScale:.125,overflow:`hidden`,panOnlyWhenZoomed:!1,pinchAndPan:!1,relative:!1,setTransform:Hr,startX:0,startY:0,startScale:1,step:.3,touchAction:`none`};function oi(e,t){if(!e)throw Error(`Panzoom requires an element as an argument`);if(e.nodeType!==1)throw Error(`Panzoom requires an element with a nodeType of 1`);if(!Qr(e))throw Error(`Panzoom should be called on elements that have been attached to the DOM`);t={...ai,...t};let n=ri(e),r=e.parentNode;r.style.overflow=t.overflow,r.style.userSelect=`none`,r.style.touchAction=t.touchAction,(t.canvas?r:e).style.cursor=t.cursor,e.style.userSelect=`none`,e.style.touchAction=t.touchAction,Br(e,`transformOrigin`,typeof t.origin==`string`?t.origin:n?`0 0`:`50% 50%`);function i(){r.style.overflow=``,r.style.userSelect=``,r.style.touchAction=``,r.style.cursor=``,e.style.cursor=``,e.style.userSelect=``,e.style.touchAction=``,Br(e,`transformOrigin`,``)}function a(n={}){for(let e in n)n.hasOwnProperty(e)&&(t[e]=n[e]);(n.hasOwnProperty(`cursor`)||n.hasOwnProperty(`canvas`))&&(r.style.cursor=e.style.cursor=``,(t.canvas?r:e).style.cursor=t.cursor),n.hasOwnProperty(`overflow`)&&(r.style.overflow=n.overflow),n.hasOwnProperty(`touchAction`)&&(r.style.touchAction=n.touchAction,e.style.touchAction=n.touchAction)}let o=0,s=0,c=1,l=!1;h(t.startScale,{animate:!1,force:!0}),setTimeout(()=>{m(t.startX,t.startY,{animate:!1,force:!0})});function u(t,n,r){if(r.silent)return;let i=new CustomEvent(t,{detail:n});e.dispatchEvent(i)}function d(t,r,i){let a={x:o,y:s,scale:c,isSVG:n,originalEvent:i};return requestAnimationFrame(()=>{typeof r.animate==`boolean`&&(r.animate?Vr(e,r):Br(e,`transition`,`none`)),r.setTransform(e,a,r),u(t,a,r),u(`panzoomchange`,a,r)}),a}function f(n,r,i,a){let l={...t,...a},u={x:o,y:s,opts:l};if(!a?.force&&(l.disablePan||l.panOnlyWhenZoomed&&c===l.startScale))return u;if(n=parseFloat(n),r=parseFloat(r),l.disableXAxis||(u.x=(l.relative?o:0)+n),l.disableYAxis||(u.y=(l.relative?s:0)+r),l.contain){let t=Ur(e),n=t.elem.width/c,r=t.elem.height/c,a=n*i,o=r*i,s=(a-n)/2,d=(o-r)/2;if(l.contain===`inside`){let e=(-t.elem.margin.left-t.parent.padding.left+s)/i,n=(t.parent.width-a-t.parent.padding.left-t.elem.margin.left-t.parent.border.left-t.parent.border.right+s)/i;u.x=Math.max(Math.min(u.x,n),e);let r=(-t.elem.margin.top-t.parent.padding.top+d)/i,c=(t.parent.height-o-t.parent.padding.top-t.elem.margin.top-t.parent.border.top-t.parent.border.bottom+d)/i;u.y=Math.max(Math.min(u.y,c),r)}else if(l.contain===`outside`){let e=(-(a-t.parent.width)-t.parent.padding.left-t.parent.border.left-t.parent.border.right+s)/i,n=(s-t.parent.padding.left)/i;u.x=Math.max(Math.min(u.x,n),e);let r=(-(o-t.parent.height)-t.parent.padding.top-t.parent.border.top-t.parent.border.bottom+d)/i,c=(d-t.parent.padding.top)/i;u.y=Math.max(Math.min(u.y,c),r)}}return l.roundPixels&&(u.x=Math.round(u.x),u.y=Math.round(u.y)),u}function p(n,r){let i={...t,...r},a={scale:c,opts:i};if(!r?.force&&i.disableZoom)return a;let o=t.minScale,s=t.maxScale;if(i.contain){let n=Ur(e),r=n.elem.width/c,i=n.elem.height/c;if(r>1&&i>1){let e=n.parent.width-n.parent.border.left-n.parent.border.right,a=n.parent.height-n.parent.border.top-n.parent.border.bottom,c=e/r,l=a/i;t.contain===`inside`?s=Math.min(s,c,l):t.contain===`outside`&&(o=Math.max(o,c,l))}}return a.scale=Math.min(Math.max(n,o),s),a}function m(e,t,r,i){let a=f(e,t,c,r);return o!==a.x||s!==a.y?(o=a.x,s=a.y,d(`panzoompan`,a.opts,i)):{x:o,y:s,scale:c,isSVG:n,originalEvent:i}}function h(e,t,n){let r=p(e,t),i=r.opts;if(!t?.force&&i.disableZoom)return;e=r.scale;let a=o,l=s;if(i.focal){let t=i.focal;a=(t.x/e-t.x/c+o*e)/e,l=(t.y/e-t.y/c+s*e)/e}let u=f(a,l,e,{relative:!1,force:!0});return o=u.x,s=u.y,c=e,d(`panzoomzoom`,i,n)}function g(e,n){let r={...t,animate:!0,...n};return h(c*Math.exp((e?1:-1)*r.step),r)}function _(e){return g(!0,e)}function ee(e){return g(!1,e)}function te(t,r,i,a){let o=Ur(e),s={width:o.parent.width-o.parent.padding.left-o.parent.padding.right-o.parent.border.left-o.parent.border.right,height:o.parent.height-o.parent.padding.top-o.parent.padding.bottom-o.parent.border.top-o.parent.border.bottom},l=r.clientX-o.parent.left-o.parent.padding.left-o.parent.border.left-o.elem.margin.left,u=r.clientY-o.parent.top-o.parent.padding.top-o.parent.border.top-o.elem.margin.top;n||(l-=o.elem.width/c/2,u-=o.elem.height/c/2);let d={x:l/s.width*(s.width*t),y:u/s.height*(s.height*t)};return h(t,{...i,animate:!1,focal:d},a)}function v(e,n){e.preventDefault();let r={...t,...n,animate:!1},i=(e.deltaY===0&&e.deltaX?e.deltaX:e.deltaY)<0?1:-1,a=p(c*Math.exp(i*r.step/3),r).scale;return te(a,e,r,e)}function ne(e){let n={...t,animate:!0,force:!0,...e};c=p(n.startScale,n).scale;let r=f(n.startX,n.startY,c,n);return o=r.x,s=r.y,d(`panzoomreset`,n)}let y,b,x,S,C,re,w=[];function ie(e){if(ti(e.target,t))return;Jr(w,e),l=!0,t.handleStartEvent(e),y=o,b=s,u(`panzoomstart`,{x:o,y:s,scale:c,isSVG:n,originalEvent:e},t);let r=Xr(w);x=r.clientX,S=r.clientY,C=c,re=Zr(w)}function T(e){if(!l||y===void 0||b===void 0||x===void 0||S===void 0)return;Jr(w,e);let n=Xr(w),r=w.length>1,i=c;r&&(re===0&&(re=Zr(w)),i=p((Zr(w)-re)*t.step/80+C).scale,te(i,n,{animate:!1},e)),(!r||t.pinchAndPan)&&m(y+(n.clientX-x)/i,b+(n.clientY-S)/i,{animate:!1},e)}function E(e){w.length===1&&u(`panzoomend`,{x:o,y:s,scale:c,isSVG:n,originalEvent:e},t),Yr(w,e),l&&(l=!1,y=b=x=S=void 0)}let D=!1;function ae(){D||(D=!0,Gr(`down`,t.canvas?r:e,ie),Gr(`move`,document,T,{passive:!0}),Gr(`up`,document,E,{passive:!0}))}function O(){D=!1,Kr(`down`,t.canvas?r:e,ie),Kr(`move`,document,T),Kr(`up`,document,E)}return t.noBind||ae(),{bind:ae,destroy:O,eventNames:Wr,getPan:()=>({x:o,y:s}),getScale:()=>c,getOptions:()=>ii(t),handleDown:ie,handleMove:T,handleUp:E,pan:m,reset:ne,resetStyle:i,setOptions:a,setStyle:(t,n)=>Br(e,t,n),zoom:h,zoomIn:_,zoomOut:ee,zoomToPoint:te,zoomWithWheel:v}}oi.defaultOptions=ai;var si=new Set([`image`,`video`,`audio`,`iframe`]);function ci(e,t){let n=Math.max(0,Number.parseInt(t,10)||0);return n?((Number.parseInt(e,10)||0)%n+n)%n:0}function li(e){let t=Number(e);return Number.isFinite(t)?Math.min(6,Math.max(1,t)):1}function ui(e,t=!1){return Math.max(0,Number.parseInt(e,10)||0)>1&&!t}function di(e,t=``){return Array.isArray(e)?e.flatMap(e=>{let n=String(e?.type||``)||t,r=String(e?.url||``).trim();return!si.has(n)||!/^https:\/\//i.test(r)?[]:[{...e,type:n,url:r}]}):[]}var fi=`__mapServiceMediaPreview`;function pi(e={}){let t=e.window||globalThis.window,n=e.history||t?.history,r=e.isEnabled||(()=>!0),i=e.onBack||(()=>{}),a=e.setTimeout||globalThis.setTimeout,o=e.clearTimeout||globalThis.clearTimeout,s=Math.max(0,Number(e.fallbackDelay??500)),c=!1,l=!1,u=null,d=0,f=()=>{u!==null&&o(u),u=null},p=()=>c?(f(),c=!1,l=!1,i(),!0):!1,m=()=>p();return t?.addEventListener?.(`popstate`,m),{activate(){if(c||!r()||!(n?.pushState instanceof Function))return!1;let e=n.state&&typeof n.state==`object`?n.state:{},i=String(t?.location?.href||``);try{return n.pushState({...e,[fi]:++d},``,i),c=!0,l=!1,!0}catch{return!1}},requestClose(){if(!c||l||!(n?.back instanceof Function))return!1;l=!0,u=a(()=>p(),s);try{n.back()}catch{return f(),l=!1,!1}return!0},release(){f(),c=!1,l=!1},destroy(){f(),c=!1,l=!1,t?.removeEventListener?.(`popstate`,m)},isActive:()=>c,isCloseRequested:()=>l}}function mi(e={}){let t=e.window||globalThis.window,n=e.navigator||globalThis.navigator,r=e.matchMedia||t?.matchMedia?.bind(t);return r instanceof Function?r(`(hover: none) and (pointer: coarse)`).matches?!0:Number(n?.maxTouchPoints||0)>0&&r(`(max-width: 640px)`).matches:!1}var hi=`modulepreload`,gi=function(e){return`/`+e},_i={},vi=function(e,t,n){let r=Promise.resolve();if(t&&t.length>0){let e=document.getElementsByTagName(`link`),i=document.querySelector(`meta[property=csp-nonce]`),a=i?.nonce||i?.getAttribute(`nonce`);function o(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))}r=o(t.map(t=>{if(t=gi(t,n),t in _i)return;_i[t]=!0;let r=t.endsWith(`.css`),i=r?`[rel="stylesheet"]`:``;if(n)for(let n=e.length-1;n>=0;n--){let i=e[n];if(i.href===t&&(!r||i.rel===`stylesheet`))return}else if(document.querySelector(`link[href="${t}"]${i}`))return;let o=document.createElement(`link`);if(o.rel=r?`stylesheet`:hi,r||(o.as=`script`),o.crossOrigin=``,o.href=t,a&&o.setAttribute(`nonce`,a),document.head.appendChild(o),r)return new Promise((e,n)=>{o.addEventListener(`load`,e),o.addEventListener(`error`,()=>n(Error(`Unable to preload CSS for ${t}`)))})}))}function i(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return r.then(t=>{for(let e of t||[])e.status===`rejected`&&i(e.reason);return e().catch(i)})},yi={image:`图片`,video:`视频`,audio:`音频`,iframe:`页面`},bi=[],xi=0,Si=null,Ci=null,wi=null,Ti=null,Ei=null,Di=0,Oi=null,ki=!1,Ai=``,ji=null,Mi=null,Ni=!0,Pi=null;function Fi(){return window.matchMedia?.(`(prefers-reduced-motion: reduce)`).matches===!0}function Ii(e){return String(e?.title||yi[e?.type]||`媒体预览`)}function Li(e){if(e?.displayUrl)return String(e.displayUrl);try{return new URL(e?.url).hostname}catch{return``}}function Ri(e){return String(e?.renderUrl||e?.url||``)}function zi(e){return String(e?.canonicalUrl||e?.sourceUrl||e?.url||``)}function Bi(e){return{video:`▶`,audio:`♪`,iframe:`▣`}[e]||`◫`}function Vi(e){return/\.m3u8(?:$|[?#])/i.test(String(e||``))}function Hi(){let e=document.createElement(`div`);return e.id=`app-media-preview`,e.className=`media-preview-root`,e.hidden=!0,e.setAttribute(`aria-hidden`,`true`),e.innerHTML=`
  ...
  `,e.addEventListener(`click`,la),e.addEventListener(`input`,ua),document.body.appendChild(e),e}function Ui(){return Ei||=document.getElementById(`app-media-preview`)||Hi(),Ei}function J(e){return Ui().querySelector(e)}function Wi(){return Pi||=pi({isEnabled:mi,onBack:ha}),Pi}function Gi(e,t){let n=J(e);n&&(n.textContent=t)}function Ki(){wi&&Ti&&wi.removeEventListener(`wheel`,Ti),Ci?.destroy(),Ci=null,wi=null,Ti=null}function qi(){Ki(),Oi?.destroy(),Oi=null;let e=J(`[data-media-preview-content]`);e?.querySelectorAll(`video, audio`).forEach(e=>{e.pause(),e.removeAttribute(`src`),e.load()}),e?.querySelectorAll(`iframe`).forEach(e=>e.removeAttribute(`src`)),e?.replaceChildren()}function Ji(){ji?.disconnect(),ji=null}function Yi(e,t){if(t!==Di||Ei?.hidden)return;let n=J(`[data-media-preview-content]`);if(!n)return;let r=document.createElement(`div`);r.className=`media-preview-load-error`,r.setAttribute(`role`,`status`),r.textContent=e,n.replaceChildren(r)}function Xi(e){let t=li(e),n=J(`[data-media-preview-zoom]`),r=J(`[data-media-preview-zoom-output]`),i=J(`[data-media-preview-stage]`);n&&(n.value=String(t)),r&&(r.textContent=`${Math.round(t*100)}%`),i?.classList.toggle(`is-zoomed`,t>1.01)}function Zi(e,t=!Fi()){Ci&&Ci.zoom(li(e),{animate:t})}function Qi(e=!Fi()){Ci&&(Ci.reset({animate:e}),Xi(1))}function $i(e,t){Ki(),Ci=oi(e,{canvas:!0,minScale:1,maxScale:6,startScale:1,step:.2,duration:Fi()?0:160,panOnlyWhenZoomed:!0,pinchAndPan:!0,cursor:`grab`}),e.addEventListener(`panzoomchange`,e=>Xi(e.detail?.scale??Ci?.getScale())),t.addEventListener(`dblclick`,e=>{e.preventDefault(),Zi((Ci?.getScale()||1)>1.05?1:2)}),wi=t,Ti=Ci.zoomWithWheel,t.addEventListener(`wheel`,Ti,{passive:!1}),Xi(1)}function ea(e,t){let n=J(`[data-media-preview-content]`);if(!n)return;let r=document.createElement(`div`);r.className=`media-preview-image-canvas`;let i=document.createElement(`img`);i.className=`media-preview-image`,i.alt=Ii(e),i.draggable=!1,i.referrerPolicy=`no-referrer`,i.addEventListener(`load`,()=>{t===Di&&i.isConnected&&$i(i,r)},{once:!0}),i.addEventListener(`error`,()=>Yi(`图片加载失败`,t),{once:!0}),i.src=Ri(e),r.appendChild(i),n.appendChild(r)}async function ta(e,t,n){try{let{default:r}=await vi(async()=>{let{default:e}=await import(`./hls-IujbK-0_.js`);return{default:e}},[]);if(n!==Di||!e.isConnected)return;if(!r.isSupported()){e.src=t;return}Oi=new r({enableWorker:!0}),Oi.on(r.Events.ERROR,(e,t)=>{t?.fatal&&(Oi?.destroy(),Oi=null,Yi(`HLS 视频加载失败`,n))}),Oi.loadSource(t),Oi.attachMedia(e)}catch{n===Di&&e.isConnected&&(e.src=t)}}function na(e,t){let n=J(`[data-media-preview-content]`);if(!n)return;let r=document.createElement(`video`);r.className=`media-preview-video`,r.controls=!0,r.autoplay=!0,r.playsInline=!0,r.preload=`metadata`,r.referrerPolicy=`no-referrer`,r.addEventListener(`error`,()=>Yi(`视频加载失败`,t),{once:!0});let i=Ri(e);Vi(i)&&!r.canPlayType(`application/vnd.apple.mpegurl`)?ta(r,i,t):r.src=i,n.appendChild(r);let a=()=>{if(t!==Di||!r.isConnected)return;r.muted=!1;let e=r.play();e?.catch&&e.catch(()=>{t!==Di||!r.isConnected||(r.muted=!0,r.play().catch(()=>{}))})};a(),r.addEventListener(`loadedmetadata`,a,{once:!0})}function ra(e,t){let n=J(`[data-media-preview-content]`);if(!n)return;let r=document.createElement(`div`);r.className=`media-preview-audio-shell`;let i=document.createElement(`span`);i.className=`media-preview-audio-icon`,i.setAttribute(`aria-hidden`,`true`),i.textContent=`♪`;let a=document.createElement(`audio`);a.controls=!0,a.preload=`metadata`,a.addEventListener(`error`,()=>Yi(`音频加载失败`,t),{once:!0}),a.src=Ri(e),r.append(i,a),n.appendChild(r)}function ia(e){let t=J(`[data-media-preview-content]`);if(!t)return;let n=e.embedPolicy||{},r=document.createElement(`div`);r.className=`media-preview-iframe-shell`,e.provider&&(r.dataset.provider=String(e.provider));let i=document.createElement(`iframe`);i.className=`media-preview-iframe`,i.title=Ii(e),i.loading=`eager`,i.referrerPolicy=n.referrerPolicy||`no-referrer`,i.setAttribute(`sandbox`,n.sandbox||`allow-scripts allow-forms allow-popups`),n.allow&&i.setAttribute(`allow`,n.allow),n.allowFullscreen&&(i.allowFullscreen=!0),i.src=Ri(e),r.appendChild(i),t.appendChild(r)}function aa(){let e=J(`[data-media-preview-track]`);if(!e)return;Ji();let t=bi.map(e=>e.galleryId||`${e.type}:${e.url}`).join(`|`),n=e.children.length!==bi.length||e.dataset.signature!==t;n&&(e.replaceChildren(),e.dataset.signature=t),bi.forEach((t,r)=>{if(!n){let t=e.children[r];if(t){t.classList.toggle(`is-active`,r===xi),t.tabIndex=r===xi?0:-1,t.setAttribute(`aria-current`,r===xi?`true`:`false`);return}}let i=document.createElement(`button`);if(i.type=`button`,i.className=`media-preview-track-item`,i.dataset.mediaPreviewAction=`select`,i.dataset.mediaPreviewIndex=String(r),i.tabIndex=r===xi?0:-1,i.setAttribute(`aria-current`,r===xi?`true`:`false`),i.setAttribute(`aria-label`,`查看第 ${r+1} 项，${yi[t.type]||`媒体`}：${Ii(t)}`),i.title=`${Ii(t)} · ${t.featureName||``}`,t.type===`image`){let e=document.createElement(`img`),n=String(t.thumbnailUrl||t.renderUrl||t.url||``);e.alt=``,e.loading=`lazy`,e.referrerPolicy=`no-referrer`,e.addEventListener(`error`,()=>i.classList.add(`is-load-error`),{once:!0}),`IntersectionObserver`in window?e.dataset.src=n:e.src=n,i.appendChild(e)}else{let e=document.createElement(`span`);e.className=`media-preview-track-icon media-preview-track-icon-${t.type}`,e.setAttribute(`aria-hidden`,`true`),e.textContent=Bi(t.type),i.appendChild(e)}let a=document.createElement(`span`);a.className=`media-preview-track-marker`,a.textContent=String(r+1).padStart(2,`0`),i.appendChild(a),e.appendChild(i)}),`IntersectionObserver`in window&&(ji=new IntersectionObserver(e=>{e.forEach(e=>{if(!e.isIntersecting)return;let t=e.target;t.src=t.dataset.src||``,t.removeAttribute(`data-src`),ji?.unobserve(t)})},{root:e,rootMargin:`0px 160px`}),e.querySelectorAll(`img[data-src]`).forEach(e=>ji.observe(e))),e.querySelectorAll(`.media-preview-track-item`).forEach((e,t)=>{e.classList.toggle(`is-active`,t===xi),e.tabIndex=t===xi?0:-1,e.setAttribute(`aria-current`,t===xi?`true`:`false`)}),e.querySelector(`.media-preview-track-item.is-active`)?.scrollIntoView?.({block:`nearest`,inline:`center`})}function oa(){let e=Ui(),t=bi.length>1,n=t&&Ni,r=J(`[data-media-preview-track]`),i=J(`[data-media-preview-action="toggle-track"]`);e.classList.toggle(`is-track-collapsed`,!n),r?.setAttribute(`aria-hidden`,String(!n)),i&&(i.hidden=!t,i.setAttribute(`aria-expanded`,String(n)),i.setAttribute(`aria-label`,n?`收起缩略图`:`展开缩略图`),i.title=n?`收起缩略图`:`展开缩略图`)}function sa(){let e=++Di;qi();let t=bi[xi];if(!t)return;let n=Ui(),r=J(`[data-media-preview-source]`),i=J(`[data-media-preview-action="previous"]`),a=J(`[data-media-preview-action="next"]`),o=J(`[data-media-preview-zoom-controls]`),s=yi[t.type]||`媒体`,c=Ii(t);n.dataset.mediaType=t.type,n.dataset.mediaIndex=String(xi),Gi(`[data-media-preview-kind]`,s),Gi(`[data-media-preview-collection]`,Ai||t.kmlName||`媒体预览`),Gi(`[data-media-preview-title]`,c),Gi(`[data-media-preview-position]`,bi.length>1?`${xi+1} / ${bi.length}`:`单项`),Gi(`[data-media-preview-caption]`,c),Gi(`[data-media-preview-url]`,Li(t)),r&&(r.href=zi(t),r.title=t.type===`iframe`?`打开原始页面`:`打开原始文件`),Gi(`.media-preview-source-label`,t.type===`iframe`?`原始页面`:`原始文件`);let l=bi.length>1;i&&(i.hidden=!l),a&&(a.hidden=!l),o&&(o.hidden=t.type!==`image`),Xi(1),oa(),aa();let u={image:ea,video:na,audio:ra,iframe:ia}[t.type];u?.(t,e),Mi?.(t),ki||J(`.media-preview-stage`)?.focus({preventScroll:!0})}function ca(e){bi.length<2||(xi=ci(xi+e,bi.length),sa())}function la(e){let t=Ui();if(e.target===t){ga();return}let n=e.target.closest(`[data-media-preview-action]`)?.dataset.mediaPreviewAction;n&&(n===`close`&&ga(),n===`previous`&&ca(-1),n===`next`&&ca(1),n===`select`&&(xi=ci(e.target.closest(`[data-media-preview-action]`)?.dataset.mediaPreviewIndex,bi.length),sa()),n===`toggle-track`&&(Ni=!Ni,oa(),Ni&&requestAnimationFrame(()=>J(`.media-preview-track-item.is-active`)?.scrollIntoView?.({block:`nearest`,inline:`center`}))),n===`minimize`&&ma(!0),n===`restore`&&ma(!1),n===`zoom-in`&&Zi((Ci?.getScale()||1)+.5),n===`zoom-out`&&Zi((Ci?.getScale()||1)-.5),n===`reset`&&Qi())}function ua(e){e.target.matches(`[data-media-preview-zoom]`)&&Zi(Number(e.target.value),!1)}function da(e){if(ki)return;let t=Ui(),n=[...t.querySelectorAll(`a[href], button:not([hidden]):not([tabindex="-1"]), input:not([hidden]), video[controls], audio[controls]`)].filter(e=>!e.disabled&&e.getClientRects().length);if(!n.length)return;let r=n[0],i=n.at(-1);t.contains(document.activeElement)?e.shiftKey&&document.activeElement===r?(e.preventDefault(),i.focus()):!e.shiftKey&&document.activeElement===i&&(e.preventDefault(),r.focus()):(e.preventDefault(),r.focus())}function fa(e){if(Ui().hidden)return;if(e.key===`Escape`){e.preventDefault(),ga();return}if(ki){let t=Ui();t.contains(e.target)&&e.key===`ArrowLeft`&&(e.preventDefault(),ca(-1)),t.contains(e.target)&&e.key===`ArrowRight`&&(e.preventDefault(),ca(1));return}if(e.key===`Tab`&&!ki){da(e);return}let t=e.target.matches?.(`input, video, audio`);!t&&(e.key===`ArrowLeft`||e.key===`ArrowUp`)&&(e.preventDefault(),ca(-1)),!t&&(e.key===`ArrowRight`||e.key===`ArrowDown`)&&(e.preventDefault(),ca(1)),!t&&bi[xi]?.type===`image`&&((e.key===`+`||e.key===`=`)&&(e.preventDefault(),Zi((Ci?.getScale()||1)+.5)),e.key===`-`&&(e.preventDefault(),Zi((Ci?.getScale()||1)-.5)),e.key===`0`&&(e.preventDefault(),Qi()))}function pa(){!Ui().hidden&&!ki&&bi[xi]?.type===`image`&&Qi(!1)}function ma(e){let t=Ui();if(t.hidden)return;ki=!!e,t.classList.toggle(`is-minimized`,ki),J(`.media-preview-dialog`)?.setAttribute(`aria-modal`,ki?`false`:`true`),document.body.classList.toggle(`media-preview-open`,!ki);let n=J(`[data-media-preview-action="minimize"]`);n&&(n.hidden=ki,n.setAttribute(`aria-label`,ki?`预览已收缩`:`收缩为小窗`)),requestAnimationFrame(ki?()=>J(`[data-media-preview-action="restore"]`)?.focus():()=>J(`.media-preview-stage`)?.focus({preventScroll:!0}))}function ha(){let e=Ei||document.getElementById(`app-media-preview`);!e||e.hidden||(Di+=1,qi(),Ji(),e.hidden=!0,e.setAttribute(`aria-hidden`,`true`),e.removeAttribute(`data-media-type`),e.classList.remove(`is-minimized`,`is-track-collapsed`),document.body.classList.remove(`media-preview-open`),document.removeEventListener(`keydown`,fa),window.removeEventListener(`resize`,pa),bi=[],xi=0,Ai=``,Mi=null,ki=!1,Ni=!0,Si?.isConnected&&Si.focus({preventScroll:!0}),Si=null)}function ga(){let e=Ei||document.getElementById(`app-media-preview`);!e||e.hidden||Pi?.isActive()&&Pi.requestClose()||(Pi?.release(),ha())}function _a({items:e,index:t=0,type:n=``,trigger:r=null,collectionTitle:i=``,onActiveItemChange:a=null}={}){let o=di(e,n);if(!o.length)return!1;let s=Ui(),c=s.hidden;(c||ki)&&(Si=r||document.activeElement),bi=o,xi=ci(t,bi.length),Ai=String(i||o[xi]?.kmlName||``).trim(),Mi=typeof a==`function`?a:null,ki=!1,Ni=ui(bi.length,mi()),s.classList.remove(`is-minimized`),J(`.media-preview-dialog`)?.setAttribute(`aria-modal`,`true`);let l=J(`[data-media-preview-action="minimize"]`);return l&&(l.hidden=!1),s.hidden=!1,s.setAttribute(`aria-hidden`,`false`),document.body.classList.add(`media-preview-open`),document.removeEventListener(`keydown`,fa),document.addEventListener(`keydown`,fa),window.removeEventListener(`resize`,pa),window.addEventListener(`resize`,pa),c&&Wi().activate(),sa(),requestAnimationFrame(()=>J(`.media-preview-stage`)?.focus({preventScroll:!0})),!0}var va=`/api/v1`,ya=new Set([`GET`,`HEAD`,`OPTIONS`]),ba=class extends Error{constructor(e,t={}){super(e||`请求失败`),this.name=`ApiError`,this.status=Number(t.status||0),this.code=t.code||`REQUEST_FAILED`,this.details=t.details||null}};function xa(e=``){return String(e).split(`;`).map(e=>e.trim()).filter(Boolean).reduce((e,t)=>{let n=t.indexOf(`=`);if(n<=0)return e;let r=t.slice(0,n).trim(),i=t.slice(n+1);try{e[r]=decodeURIComponent(i)}catch{e[r]=i}return e},{})}function Sa(e){return xa(e===void 0&&typeof document<`u`?document.cookie:e).map_csrf_token||``}function Ca(e){return!ya.has(String(e||`GET`).toUpperCase())}function wa(e,t){let n=String(e||``).startsWith(`/`)?String(e):`/${e||``}`,r=(t instanceof URLSearchParams?t:new URLSearchParams(Object.entries(t||{}).filter(([,e])=>e!==``&&e!=null))).toString();return`${va}${n}${r?`?${r}`:``}`}function Ta(e){return typeof FormData<`u`&&e instanceof FormData}function Ea(e){e.status!==401||e.code!==`AUTH_REQUIRED`||typeof window<`u`&&window.dispatchEvent instanceof Function&&window.dispatchEvent(new CustomEvent(`map-auth-session-expired`))}async function Da(e){if((e.headers.get(`content-type`)||``).includes(`application/json`))return e.json().catch(()=>null);let t=await e.text().catch(()=>``);return t?{message:t}:null}function Oa(e,t){let n=t?.error||t||{};return new ba(n.message||e.statusText||`请求失败`,{status:e.status,code:n.code||`HTTP_${e.status}`,details:n.details||null})}async function ka(e,t={}){let n=String(t.method||`GET`).toUpperCase(),r=new Headers(t.headers||{});r.set(`Accept`,`application/json`);let i;if(t.body!==void 0&&(Ta(t.body)||typeof t.body==`string`||t.body instanceof Blob?i=t.body:(r.set(`Content-Type`,`application/json`),i=JSON.stringify(t.body))),Ca(n)&&t.csrf!==!1){let e=Sa();e&&r.set(`X-CSRF-Token`,e)}let a=await fetch(wa(e,t.query),{method:n,headers:r,body:i,credentials:`same-origin`,cache:`no-store`,redirect:`error`,signal:t.signal}),o=await Da(a);if(!a.ok||o&&Object.hasOwn(o,`code`)&&o.code!==0){let e=Oa(a,o);throw Ea(e),e}return o&&Object.hasOwn(o,`result`)?o.result:o}async function Aa(e,t={}){let n=String(t.method||`GET`).toUpperCase(),r=new Headers(t.headers||{});if(r.set(`Accept`,t.accept||`application/octet-stream`),Ca(n)&&t.csrf!==!1){let e=Sa();e&&r.set(`X-CSRF-Token`,e)}let i=await fetch(wa(e,t.query),{method:n,headers:r,credentials:`same-origin`,cache:`no-store`,redirect:`error`,signal:t.signal});if(!i.ok){let e=Oa(i,await Da(i));throw Ea(e),e}return{blob:await i.blob(),contentDisposition:i.headers.get(`content-disposition`)||``,contentType:i.headers.get(`content-type`)||``}}var ja=new Set,Ma={loaded:!1,loading:!1,authenticated:!1,user:null,session:null,config:null,error:``};function Na(){let e=Ia();ja.forEach(t=>t(e))}function Pa(e){return Ma={...Ma,...e},Na(),Ia()}function Fa(e){return!e||e.authenticated===!1||!e.user?{authenticated:!1,user:null,session:null}:{authenticated:!0,user:e.user,session:e.session||{expiresAt:e.expiresAt||null}}}function Ia(){return{...Ma,user:Ma.user?{...Ma.user}:null,session:Ma.session?{...Ma.session}:null,config:Ma.config?{...Ma.config}:null}}function La(e){return e instanceof Function?(ja.add(e),()=>ja.delete(e)):()=>{}}async function Ra(){let e=await ka(`/auth/config`,{csrf:!1});return Pa({config:e}),e}async function za(){Pa({loading:!0,error:``});try{return Pa({...Fa(await ka(`/auth/session`,{csrf:!1})),loaded:!0,loading:!1,error:``})}catch(e){if(e.status===401)return Pa({authenticated:!1,user:null,session:null,loaded:!0,loading:!1,error:``});throw Pa({loaded:!0,loading:!1,error:e.message}),e}}async function Ba(){let e=(await Promise.allSettled([Ra(),za()])).find(e=>e.status===`rejected`);if(e&&!Ma.loaded)throw e.reason;return Ia()}async function Va(e){return await ka(`/auth/login`,{method:`POST`,body:e,csrf:!1}),za()}async function Ha(e){return ka(`/auth/register`,{method:`POST`,body:e,csrf:!1})}async function Ua(){try{await ka(`/auth/logout`,{method:`POST`})}catch(e){if(e.status!==401||e.code!==`AUTH_REQUIRED`)throw e}return Pa({authenticated:!1,user:null,session:null,loaded:!0,loading:!1,error:``})}function Wa(e,t=Ma){let n=t?.user?.permissions||[];return!!(n.includes(e)||n.includes(`system.super_admin`)||e===`account.self.read`&&n.includes(`account.self.update`)||e===`kml.own.read`&&n.includes(`kml.own.write`)||e===`kml.any.read`&&n.includes(`kml.any.manage`))}typeof window<`u`&&window.addEventListener(`map-auth-session-expired`,()=>{Pa({authenticated:!1,user:null,session:null,loaded:!0,loading:!1,error:`登录已失效，请重新登录`})});var Ga=`favorite.own.manage`,Ka=new Set([`search`,`map`,`location`,`kml`,`manual`]),qa=/^#[0-9a-f]{6}$/i,Ja=`#2563eb`,Ya=Object.freeze({search:`搜索结果`,map:`地图中心`,location:`定位结果`,kml:`KML 点位`,manual:`手动位置`}),Xa={readOnly:!1},Za=null,Qa=!1;function $a(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function eo(e,t=1e3){return String(e??``).normalize(`NFKC`).replace(/[\u0000-\u0008\u000b\u000c\u000e-\u001f\u007f]/g,``).trim().slice(0,t)}function to(e,t,n,r){let i=Number(e);if(!Number.isFinite(i)||i<n||i>r)throw TypeError(`${t}不是有效坐标`);return i}function no(e){return e>=-180&&e<=180?e:ie(e)}function ro(e){let t=Array.isArray(e)?e:String(e??``).split(/[,，\n]/),n=[],r=new Set;for(let e of t){let t=eo(e,31);if(!t)continue;if(t.length>30)throw TypeError(`单个标签不能超过 30 个字符`);let i=t.toLocaleLowerCase();r.has(i)||(r.add(i),n.push(t))}if(n.length>20)throw TypeError(`标签数量不能超过 20 个`);return n}function io(e={}){let t=Ka.has(e.sourceType)?e.sourceType:`map`,n=e.coordType===`wgs84`?`wgs84`:`gcj02`,r=no(to(e.longitude??e.lng,`经度`,-360,360)),i=to(e.latitude??e.lat,`纬度`,-90,90),[a,o]=n===`gcj02`?E([r,i]):[r,i],s=to(no(a),`经度`,-180,180),c=to(o,`纬度`,-90,90);return{name:eo(e.name||Ya[t]||`收藏位置`,120)||`收藏位置`,note:eo(e.note,2e3),address:eo(e.address,500),category:eo(e.category,80),tags:ro(e.tags),color:qa.test(String(e.color||``))?String(e.color).toLowerCase():Ja,longitude:s,latitude:c,coordType:`wgs84`,sourceType:t,sourceRef:eo(e.sourceRef,200)}}function ao(e,t){if(e?.isShare||t?.type!==`Point`||!Array.isArray(t.coordinates))return null;try{let n=String(e?.id||``),r=!e?.isPublic&&/^kml_[A-Za-z0-9_-]+$/.test(n);return io({name:t.name||`KML 点位`,note:t.description||``,longitude:t.coordinates[0],latitude:t.coordinates[1],coordType:e?.coordCorrection===`none`?`gcj02`:`wgs84`,sourceType:`kml`,sourceRef:r?n:``,color:e?.color})}catch{return null}}function oo(e,t={}){let n=io(e),r=eo(t.name,121),i=eo(t.note,2001),a=eo(t.category,81),o=ro(t.tags),s=String(t.color||n.color||Ja).trim().toLowerCase();if(!r)throw TypeError(`请填写收藏名称`);if(r.length>120)throw TypeError(`收藏名称不能超过 120 个字符`);if(i.length>2e3)throw TypeError(`备注不能超过 2000 个字符`);if(a.length>80)throw TypeError(`分类不能超过 80 个字符`);if(!qa.test(s))throw TypeError(`请选择有效的收藏颜色`);return{name:r,note:i,longitude:n.longitude,latitude:n.latitude,sourceType:n.sourceType,sourceRef:n.sourceRef,address:n.address,category:a,tags:o,color:s}}function so(e={}){let t=String(e.pathname||`/`);return`${/^\/(?!\/)/.test(t)&&!t.includes(`\\`)?t:`/`}${String(e.search||``).startsWith(`?`)?String(e.search):``}${String(e.hash||``).startsWith(`#`)?String(e.hash):``}`}function co(e={}){return`/account?returnTo=${encodeURIComponent(so(e))}`}function lo(e,t=``,n=Date.now()){if(!e?.authenticated||!Wa(`favorite.own.manage`,e))return!1;let r=String(e.session?.id||``);if(t&&r!==String(t))return!1;let i=Date.parse(String(e.session?.expiresAt||``));return!Number.isFinite(i)||i>n}function uo(){if(Xa.readOnly)return!1;let e=Ia();return!e.loaded||!e.authenticated?!0:Wa(Ga,e)}function fo(){let e=uo();typeof document<`u`&&document.querySelectorAll(`[data-favorite-action]`).forEach(t=>{t.hidden=!e})}function po(){let e=document.getElementById(`app-dialog-root`);return e||(e=document.createElement(`div`),e.id=`app-dialog-root`,document.body.appendChild(e)),e}function mo(e){let t=po();t.hidden=!1,t.innerHTML=`
    <div class="app-dialog-backdrop" data-favorite-dialog-cancel>
      <form class="app-dialog favorite-dialog" role="dialog" aria-modal="true" aria-labelledby="favorite-dialog-title" data-favorite-dialog-form autocomplete="off">
        ...
        <p class="favorite-dialog-position"><strong>${$a(Ya[e.sourceType]||`候选位置`)}</strong><span>${$a(e.latitude.toFixed(6))}, ${$a(e.longitude.toFixed(6))} · WGS84</span></p>
        <div class="favorite-dialog-fields">
          <label><span>名称</span><input name="name" maxlength="120" value="${$a(e.name)}" required></label>
          <label><span>备注</span><textarea name="note" maxlength="2000" rows="3"></textarea></label>
          <label><span>分类</span><input name="category" maxlength="80" value="${$a(e.category)}" placeholder="例如：出行"></label>
          <label><span>标签</span><input name="tags" value="${$a(e.tags.join(`, `))}" placeholder="使用逗号分隔，最多 20 个"></label>
          <label class="favorite-dialog-color"><span>颜色</span><input name="color" type="color" value="${$a(e.color)}"><code data-favorite-color-value>${$a(e.color)}</code></label>
        </div>
  ...
  `;let n=t.querySelector(`[data-favorite-dialog-form]`),r=n.elements.note;r.value=e.note;let i=n.elements.color,a=n.querySelector(`[data-favorite-color-value]`);return i.addEventListener(`input`,()=>{a.textContent=i.value}),n.elements.name.focus(),new Promise(r=>{let i=!1,a=()=>{t.removeEventListener(`click`,s),n.removeEventListener(`submit`,c),document.removeEventListener(`keydown`,l),window.removeEventListener(`map-auth-session-expired`,u)},o=e=>{i||(i=!0,a(),t.innerHTML=``,t.hidden=!0,r(e))},s=e=>{let t=e.target.closest(`[data-favorite-dialog-cancel]`);t&&(t.classList.contains(`app-dialog-backdrop`)&&e.target!==t||o(null))},c=t=>{t.preventDefault();let r=n.querySelector(`[data-favorite-dialog-error]`);try{o({payload:oo(e,{name:n.elements.name.value,note:n.elements.note.value,category:n.elements.category.value,tags:n.elements.tags.value,color:n.elements.color.value})})}catch(e){r.textContent=e.message||`收藏信息不正确`,r.hidden=!1}},l=e=>{e.key===`Escape`&&(e.preventDefault(),o(null))},u=()=>o({sessionExpired:!0});t.addEventListener(`click`,s),n.addEventListener(`submit`,c),document.addEventListener(`keydown`,l),window.addEventListener(`map-auth-session-expired`,u,{once:!0})})}async function ho(){let e=Ia(),t=Date.parse(String(e.session?.expiresAt||``));if(!e.loaded||e.authenticated&&Number.isFinite(t)&&t<=Date.now())try{e=await za()}catch{return await De(`暂时无法确认登录状态，请稍后重试。`),null}return e.authenticated?Wa(`favorite.own.manage`,e)?e:(await De(`当前账号没有管理个人收藏的权限。`),null):(await Oe(`保存位置收藏需要先登录。是否前往用户中心登录？`,{title:`登录后保存收藏`,confirmText:`前往登录`})&&window.location.assign(co(window.location)),null)}async function go(){await Oe(`登录已失效，本次收藏未提交。是否重新登录？`,{title:`登录已失效`,confirmText:`重新登录`})&&window.location.assign(co(window.location))}async function _o(e){if(Xa.readOnly||Qa)return null;let t;try{t=io(e)}catch{return await De(`当前位置坐标无效，无法保存收藏。`),null}let n=await ho();if(!n)return null;let r=String(n.session?.id||``),i=await mo(t);if(!i)return null;if(i.sessionExpired||!lo(Ia(),r))return await go(),null;Qa=!0;try{let e=await ka(`/favorites`,{method:`POST`,body:i.payload});return await De(`已保存收藏“${e?.name||i.payload.name}”。`),e}catch(e){return e?.status===401||e?.code===`AUTH_REQUIRED`?await go():await De(`收藏保存失败：${e?.message||`请稍后重试`}`),null}finally{Qa=!1}}function vo(e,t){return!ao(e,t)||Xa.readOnly||!uo()?``:`
  ...
  `}function yo(e,t,n){let r=ao(t,n);!r||Xa.readOnly||!e||e.querySelectorAll(`[data-favorite-action]`).forEach(e=>{e.dataset.favoriteBound!==`true`&&(e.dataset.favoriteBound=`true`,e.addEventListener(`click`,e=>{e.preventDefault(),e.stopPropagation(),_o(r)}))})}function bo(e={}){Xa={...Xa,readOnly:!!e.readOnly},Za||=La(fo),fo()}var xo=``.split(`,`).map(e=>e.trim()).filter(Boolean),So=null,Co=new WeakMap;function Y(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function wo(){let e=typeof window<`u`?window:null,t=e?.MAP_SERVICE_KML_IFRAME_ALLOWLIST||e?.mapServiceKmlIframeAllowlist||xo;return Array.isArray(t)?t:String(t||``).split(`,`).map(e=>e.trim()).filter(Boolean)}function To(){return{iframeAllowlist:wo()}}function Eo(e){return fr(e,To())}function Do(e){return{image:`图片`,video:`视频`,audio:`音频`,iframe:`页面`}[e]||`媒体`}function Oo(e){return{video:`▶`,audio:`♪`,iframe:`▣`}[e]||`◫`}function ko(e){return xr({type:e?.type||`Point`,name:e?.name})}function Ao(e){return ko({name:e?.title})||ko({name:e?.featureName})}function jo(e){let t=Do(e.type),n=Ao(e);return e.type===`image`?`
    ...
    <button type="button" class="kml-popup-media-item kml-popup-media-type kml-popup-media-${Y(e.type)}" data-kml-popup-media data-media-id="${Y(e.id)}" data-media-url="${Y(e.url)}" data-media-type="${Y(e.type)}" aria-label="预览${Y(t)}${n?`：${Y(n)}`:``}">
      <span class="kml-popup-media-icon" aria-hidden="true">${Y(Oo(e.type))}</span>
      <span class="kml-popup-media-copy"><strong>${Y(t)}</strong><small>${Y(n||`点击查看`)}</small></span>
    </button>
  `}function Mo(e,t,n){let r=jr(t,{contentOptions:To()}),i=pr(r.contentSummary),a=mr(t),o=vo(e,t),s=n?`
    ...
    `:``,l=ko(t),u=l?`<div class="kml-popup-title">${Y(l)}</div>`:``,d=a?`<div class="kml-popup-desc">${Y(a)}</div>`:``;return`
  ...
  `}function No(e,t,n=null){let r=kr(e,{featureViews:n&&t?.id?new Map([[String(t.id),n]]):null,contentOptions:To()});return r.length?r:Or(t,n||Eo(t)).map((t,n)=>({...t,kmlId:String(e?.id||``),kmlName:String(e?.name||``).trim()||`未命名 KML`,galleryIndex:n}))}function Po(e){return jr(e,{contentOptions:To()}).total>0}function Fo(e){let t=String(e?.kmlId||``),n=String(e?.featureId||``);return t&&n?`${t}:${n}`:``}function Io(e,t,n={}){let{selection:r={},trigger:i=null,view:a=null,linkMapFeatures:o=!mi()}=n,s=No(e,t,a);if(!s.length)return!1;let c=Fo({kmlId:e?.id,featureId:t?.id});return _a({items:s,index:Ar(s,{...r,featureId:String(t?.id||``)}),trigger:i,collectionTitle:String(e?.name||``).trim()||`未命名 KML`,onActiveItemChange:e=>{if(!o)return;let t=Fo(e);!t||t===c||(c=t,window.activateKmlFeatureForMedia?.(e))}})}function Lo(e,t,n,r,i=null){return Io(e,t,{selection:n,trigger:r,view:i})}function Ro(e,t,n){if(!e)return;yo(e,t,n);let r=e.querySelector(`.leaflet-popup-content`)||e,i=Co.get(r);if(i){i.kmlFile=t,i.feature=n;return}let a={kmlFile:t,feature:n};Co.set(r,a),r.addEventListener(`click`,e=>{let t=e.target.closest?.(`[data-kml-popup-media]`);if(!t||!r.contains(t))return;e.stopPropagation(),e.preventDefault();let n=Co.get(r);n&&Lo(n.kmlFile,n.feature,{id:t.dataset.mediaId,url:t.dataset.mediaUrl,type:t.dataset.mediaType},t)}),r.addEventListener(`error`,e=>{let t=e.target;t?.matches?.(`.kml-popup-media-image img`)&&t.closest(`.kml-popup-media-image`)?.classList.add(`is-load-error`)},!0)}function zo(){let e=document.getElementById(`kml-feature-content-panel`);return e||(e=document.createElement(`section`),e.id=`kml-feature-content-panel`,e.className=`kml-content-panel`,e.setAttribute(`role`,`dialog`),e.setAttribute(`aria-modal`,`false`),e.hidden=!0,document.body.appendChild(e)),e}function Bo(){So?.abort(),So=null;let e=document.getElementById(`kml-feature-content-panel`);e&&(e.hidden=!0,e.innerHTML=``)}async function Vo(e,t){if(e?.isPublic&&!e?.isShare&&e.id&&t?.id){So?.abort(),So=new AbortController;try{let n=await window.fetch(`/api/v1/kml/shared/${encodeURIComponent(e.id)}/features/${encodeURIComponent(t.id)}/content`,{signal:So.signal}),r=await n.json();if(!n.ok||r.code!==0)throw Error(r.error?.message||`点位内容加载失败`);return r.result}finally{So=null}}return Eo(t)}function Ho(e,t){let n=mr(t),r=Array.isArray(t?.coordinates)&&t.type===`Point`?`${Number(t.coordinates[0]).toFixed(6)}, ${Number(t.coordinates[1]).toFixed(6)}`:``;return`
  ...
  `}function Wo(e,t,n,r,i,a){return`
  ...
  `}function Go(e,t,n){return Wo(e,t,n,`video`,`视频`,`▶`)}function Ko(e,t,n){return Wo(e,t,n,`audio`,`音频`,`♪`)}function qo(e,t,n){return Wo(e,t,n,`iframe`,`页面`,`▣`)}function Jo(e){return`
  ...
  `}function Yo(e,t){if(!e.items?.length)return``;let n={image:Uo,video:Go,audio:Ko,iframe:qo,link:Jo}[e.type]||Jo,r={image:`◫`,video:`▶`,audio:`♪`,iframe:`▣`,link:`↗`}[e.type]||`•`;return`
  ...
  `}function Xo(e){e.querySelectorAll(`.kml-content-image-item img`).forEach(e=>{e.addEventListener(`error`,()=>e.closest(`.kml-content-image-item`)?.classList.add(`is-load-error`),{once:!0})})}function Zo(e,t,n,r){let i=r?.groups||[];e.querySelectorAll(`[data-kml-media-preview]`).forEach(e=>{e.addEventListener(`click`,()=>{let a=i[Number(e.dataset.kmlMediaGroup)],o=a?.items?.[Number(e.dataset.kmlMediaIndex)];o&&Lo(t,n,{id:o.id,url:o.url,type:a.type},e,r)})})}function Qo(e,t,n,r,i=``){let a=pr(r?.contentSummary),o=(r?.groups||[]).map(Yo).join(``),s=xr(n);e.innerHTML=`
  ...
  `,e.querySelector(`[data-kml-content-close]`)?.addEventListener(`click`,Bo),yo(e,t,n),Xo(e),Zo(e,t,n,r)}async function $o(e,t){let n=zo(),r=xr(t);n.hidden=!1,n.innerHTML=`
    <header class="kml-content-header">
      <div>
  ...
  `,n.querySelector(`[data-kml-content-close]`)?.addEventListener(`click`,Bo),yo(n,e,t);try{Qo(n,e,t,await Vo(e,t))}catch(r){if(r.name===`AbortError`)return;Qo(n,e,t,Eo(t),r.message||`点位内容加载失败，已展示本地解析结果。`)}}function es(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function ts(e){let t=Number(e);return Number.isSafeInteger(t)&&t>=0?t:0}function ns(e={}){let t=Array.isArray(e.features)?e.features:null,n=ts(e.featureCount),r=!!(t&&(t.length>0||n===0)),i={Point:0,LineString:0,Polygon:0};return t&&t.forEach(e=>{Object.prototype.hasOwnProperty.call(i,e?.type)&&(i[e.type]+=1)}),{name:String(e.name||`未命名 KML`).slice(0,200),descriptionText:mr(e.description).slice(0,5e3),featureCount:t?.length||n,hasLoadedFeatures:r,typeCounts:i}}function rs(e){return e.hasLoadedFeatures?[e.typeCounts.Point?`${e.typeCounts.Point} 个点位`:``,e.typeCounts.LineString?`${e.typeCounts.LineString} 条线`:``,e.typeCounts.Polygon?`${e.typeCounts.Polygon} 个面`:``].filter(Boolean).map(e=>`<span>${es(e)}</span>`).join(``):``}function is(e={}){let t=ns(e);return`
    <section class="kml-file-overview" aria-label="KML 文件详情">
      <header>
        <span>KML 详情</span>
        <small>${t.featureCount.toLocaleString()} 个要素</small>
      </header>
      <p class="${t.descriptionText?``:`is-empty`}">${es(t.descriptionText||`暂无文件介绍`)}</p>
      <div class="kml-file-overview-stats">${rs(t)}</div>
    </section>
  `}var as={image:`包含图片`,video:`包含视频`,audio:`包含音频`,iframe:`包含页面`,link:`包含链接`},os={image:`#0f766e`,video:`#dc2626`,audio:`#7c3aed`,iframe:`#2563eb`,link:`#475569`},ss={image:`<rect x="8" y="8" width="16" height="13" rx="2"/><circle cx="13" cy="12.5" r="1.5"/><path d="m9.5 19 4.5-4 3 2.5 2-2 3.5 3.5"/>`,video:`<rect x="8" y="8" width="16" height="13" rx="2"/><path d="m14 12 5 3-5 3z"/>`,audio:`<path d="M9 14h3l4-4v10l-4-4H9z"/><path d="M19 12.5a4 4 0 0 1 0 5M21 10a7 7 0 0 1 0 10"/>`,iframe:`<rect x="8" y="8" width="16" height="13" rx="2"/><path d="M8 12h16M11 10h.01M14 10h.01"/>`,link:`<path d="M13.5 17.5 12 19a3 3 0 0 1-4.2-4.2l2.5-2.5a3 3 0 0 1 4.2 0M18.5 12.5 20 11a3 3 0 0 1 4.2 4.2l-2.5 2.5a3 3 0 0 1-4.2 0M12.5 15.5h7"/>`},cs={douyin:{type:`douyin`,label:`抖音视频`,color:`#111827`,iconPaths:`<path d="M14 10v7.2a3.1 3.1 0 1 1-2.2-3M14 10c1.2 1.8 2.8 2.8 5 3" stroke="#25f4ee"/><path d="M15.5 8.5v7.2a3.1 3.1 0 1 1-2.2-3M15.5 8.5c1.2 1.8 2.8 2.8 5 3" stroke="#fe2c55"/><path d="M14.8 9.2v7.2a3.1 3.1 0 1 1-2.2-3M14.8 9.2c1.2 1.8 2.8 2.8 5 3" stroke="#fff"/>`},"720yun":{type:`720yun`,label:`720 云全景`,color:`#075985`,iconPaths:`<path d="M8 14a8 8 0 0 1 16 0" stroke="#f59e0b" stroke-width="2.2"/><path d="M9 15.5h14" stroke="#fff"/><path d="m10 18 3-3 3 3 3-3 3 3" stroke="#fbbf24"/><text x="16" y="11.2" text-anchor="middle" fill="#fff" stroke="none" font-size="4.8" font-family="Arial,sans-serif" font-weight="700">720</text>`}};function ls(e){let t=Gt(e?.markerIcon);if(t){let e=Wt(t);return e?{type:`custom`,iconKey:t,label:e.label,color:e.color,iconPaths:e.glyph}:null}let n=vr(e);if(n&&cs[n])return cs[n];let r=yr(e);return as[r]?{type:r,label:as[r],color:os[r],iconPaths:ss[r]}:null}function us(e){if(!e?.color||!e?.iconPaths)return``;let t=e.iconKey?` transform="translate(4 4)"`:``;return`<svg viewBox="0 0 32 40" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"><path class="kml-media-marker-pin" fill="${e.color}" d="M16 1C7.9 1 3 6.7 3 14.1 3 24.2 16 38.5 16 38.5S29 24.2 29 14.1C29 6.7 24.1 1 16 1Z"/><path fill="none" stroke="rgba(255,255,255,.9)" stroke-width="1.2" d="M16 2.5C8.9 2.5 4.5 7.4 4.5 14.1c0 8.1 9.2 19.5 11.5 22.3 2.3-2.8 11.5-14.2 11.5-22.3C27.5 7.4 23.1 2.5 16 2.5Z"/><g${t} fill="none" stroke="#fff" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round">${e.iconPaths}</g></svg>`}function ds(e){let t=ls(e);return t?{type:t.type,iconKey:t.iconKey||``,label:t.label,html:`<span class="kml-media-marker kml-media-marker-${t.type}" role="img" aria-label="${t.label}">${us(t)}</span>`,iconSize:[32,40],iconAnchor:[16,39],popupAnchor:[0,-36],tooltipAnchor:[16,-26]}:null}function fs(e){let t=ds(e);if(!t)return null;let n=us(ls(e));return{...t,image:`data:image/svg+xml;charset=utf-8,${encodeURIComponent(n)}`}}function ps(e){let t=ds(e);if(!t)return``;let n=ls(e),r=n?.iconPaths||``;return r?n?.iconKey?`<svg class="svg-icon kml-media-list-icon kml-media-list-icon-${t.type}" style="color:${n.color}" viewBox="0 0 24 24" role="img" aria-label="${t.label}" xmlns="http://www.w3.org/2000/svg"><g fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">${r}</g></svg>`:`<svg class="svg-icon kml-media-list-icon kml-media-list-icon-${t.type}" style="color:${n.color}" viewBox="0 0 32 30" role="img" aria-label="${t.label}" xmlns="http://www.w3.org/2000/svg"><g fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">${r}</g></svg>`:``}var ms=`map_kml_marker_recent_icons_v1`,hs=Object.freeze([`pin`,`star`,`viewpoint`,`camera`,`campsite`,`parking`]);function gs(e){if(e)return e;if(typeof window>`u`)return null;try{return window.localStorage}catch{return null}}function _s(e){return{value:e.key,label:e.label,iconHtml:`<span class="kml-marker-picker-glyph" style="color:${e.color}">${G(e.key)}</span>`}}function vs(e){if(!Array.isArray(e))return[];let t=[];for(let n of e){let e=Gt(n);if(!(!e||t.includes(e))&&(t.push(e),t.length>=5))break}return t}function ys(e){let t=gs(e);if(!t)return[];try{return vs(JSON.parse(t.getItem(`map_kml_marker_recent_icons_v1`)||`[]`))}catch{return[]}}function bs(e,t){let n=Gt(e),r=ys(t);if(!n)return r;let i=vs([n,...r]),a=gs(t);if(a)try{a.setItem(ms,JSON.stringify(i))}catch{}return i}function xs(e,t=[]){let n=[zt,Gt(e,{allowAuto:!0}),...vs(t),...hs],r=[];for(let e of n)if(!(!e||r.includes(e))&&(r.push(e),r.length>=8))break;return r}function Ss(e=zt,t={}){return{name:`markerIcon`,label:`点位图标`,type:`icon-picker`,hint:`自动模式按内容匹配图标。`,options:Ut.map(_s),quickValues:xs(e,Array.isArray(t.recentIcons)?vs(t.recentIcons):ys(t.storage)),quickLimit:8,autoValue:zt}}function Cs(e){return Gt(e?.markerIcon)||`auto`}function ws(e,t){let n=Gt(t);return n?e.markerIcon=n:delete e.markerIcon,e}function Ts(e){let t={...e};return t.type===`Point`?ws(t,t.markerIcon):(delete t.markerIcon,t)}var Es=`map-service-kml-recovery`,Ds=1,Os=`kml-account-drafts`,ks=`map_kml_account_recovery_v1:`;function As(e){return`${ks}${encodeURIComponent(String(e||``))}`}function js(e){return!!(e&&typeof e==`object`&&String(e.userId||``))}function Ms(e){return!!(js(e)&&e.metadataOnly===!0&&!e.deleted)}function Ns(e){return{userId:String(e.userId),generation:Math.max(0,Number(e.generation||0)),updatedAt:e.updatedAt||new Date().toISOString(),metadataOnly:!0,fileCount:Array.isArray(e.files)?e.files.length:0}}function Ps(e){return[Number(e?.generation||0),Date.parse(e?.updatedAt||``)||0]}function Fs(e,t){let n=Ps(e),r=Ps(t);return n[0]>r[0]||n[0]===r[0]&&n[1]>=r[1]}function Is(e,t){return Fs(e,t)&&!Fs(t,e)}function Ls(e,t){let n=js(e)?e:null,r=js(t)?t:null,i=Math.max(Number(n?.generation||0),Number(r?.generation||0));return r?.deleted&&(!n||Fs(r,n))||r&&!Ms(r)&&(!n||Is(r,n))?{record:r,storageGeneration:i,incompleteWrite:!1}:n?{record:n,storageGeneration:i,incompleteWrite:!!(Ms(r)&&Is(r,n))}:{record:null,storageGeneration:i,incompleteWrite:Ms(r)}}function Rs(e,t){if(!e?.getItem)return null;try{let n=JSON.parse(e.getItem(As(t))||`null`);return js(n)?n:null}catch{return null}}function zs(e,t){if(!e?.setItem)throw Error(`本地恢复存储不可用`);e.setItem(As(t.userId),JSON.stringify(t))}function Bs(e,t){if(!e?.setItem)throw Error(`本地恢复存储不可用`);let n=Rs(e,t.userId);(!n||Fs(t,n))&&zs(e,t)}function Vs(e){return new Promise((t,n)=>{let r=e.open(Es,Ds);r.onupgradeneeded=()=>{let e=r.result;e.objectStoreNames.contains(Os)||e.createObjectStore(Os,{keyPath:`userId`})},r.onsuccess=()=>t(r.result),r.onerror=()=>n(r.error||Error(`恢复草稿数据库打开失败`))})}function Hs(e,t,n){return new Promise((r,i)=>{let a;try{a=e.transaction(Os,t);let o=n(a.objectStore(Os));o.onsuccess=()=>r(o.result),o.onerror=()=>i(o.error||Error(`恢复草稿数据库请求失败`)),a.onerror=()=>i(a.error||Error(`恢复草稿数据库事务失败`))}catch(e){i(e)}})}function Us(e,t){return new Promise((n,r)=>{try{let i=e.transaction(Os,`readwrite`),a=i.objectStore(Os),o=a.get(t.userId);o.onsuccess=()=>{let e=o.result;(!js(e)||Fs(t,e))&&a.put(t)},o.onerror=()=>r(o.error||Error(`恢复草稿数据库读取失败`)),i.oncomplete=()=>n(),i.onerror=()=>r(i.error||Error(`恢复草稿数据库事务失败`)),i.onabort=()=>r(i.error||Error(`恢复草稿数据库事务已中止`))}catch(e){r(e)}})}function Ws(e={}){let t=e.indexedDB||globalThis.indexedDB,n=e.localStorage||globalThis.localStorage,r=null,i=()=>t?.open?(r||=Vs(t),r):Promise.reject(Error(`IndexedDB 不可用`));return{async get(e,t={}){let r=String(e||``),a=Rs(n,r),o;try{o=await Hs(await i(),`readonly`,e=>e.get(r))}catch(e){if(a){if(a.deleted&&t.includeDeleted!==!0)return null;if(Ms(a))throw Error(`IndexedDB 不可用，无法读取完整 KML 恢复草稿`,{cause:e});return structuredClone(a)}throw e}let s=Ls(o,a);if(!s.record){if(!s.incompleteWrite)return null;throw Error(`最新 KML 恢复草稿尚未完整写入 IndexedDB`)}if(s.record.deleted&&t.includeDeleted!==!0)return null;let c=structuredClone(s.record);return s.incompleteWrite&&(c.incompleteWrite=!0,c.storageGeneration=s.storageGeneration),c},async put(e){if(!js(e))throw TypeError(`恢复草稿记录无效`);let t=structuredClone(e),r=!1;try{Bs(n,Ns(t)),r=!0}catch{}try{return await Us(await i(),t),{persistent:r?`indexeddb+metadata`:`indexeddb`}}catch(e){throw Error(`IndexedDB 不可用，完整 KML 恢复草稿未持久化`,{cause:e})}},async delete(e,t={}){let r={userId:String(e||``),deleted:!0,generation:Math.max(0,Number(t.generation||0)),updatedAt:t.updatedAt||new Date().toISOString()},a=!1;try{Bs(n,r),a=!0}catch{}try{await Us(await i(),r)}catch(e){if(!a)throw e}return{persistent:`deleted`}}}}var Gs=null,Ks=null;function qs(){return Ks||(Gs||=Ws(),Gs)}var Js=!1,Ys=!1,Xs=``,Zs=new Map,Qs=new Set,$s=new Set,ec=[],tc=null,nc=!1,rc=!1,ic=!1,ac=[],oc=0,sc=0,cc=null,lc=null,uc=!1,dc={state:`guest`,detail:{}},fc=Promise.resolve(!0),pc=new Set([`discard`,`restore`,`save-as-all`,`reload-conflicts`,`save-as-conflicts`]);function mc(e){return typeof structuredClone==`function`?structuredClone(e):JSON.parse(JSON.stringify(e))}function hc(e,t={}){let n=String(t.message||``);return{dirty:{visible:!0,label:`待保存`,tone:`dirty`,title:`修改已写入本机恢复草稿，将在稍后同步`},saving:{visible:!0,label:`保存中…`,tone:`saving`,title:`正在同步到账号`},saved:{visible:!0,label:`已保存`,tone:`saved`,title:`账号 KML 已同步`},loaded:{visible:!0,label:`已保存`,tone:`saved`,title:`已加载账号 KML`},readonly:{visible:!0,label:`只读`,tone:`readonly`,title:`当前账号只能查看 KML`},conflict:{visible:!0,label:`保存冲突`,tone:`conflict`,title:n||`服务器内容已更新，点击处理本地恢复草稿`},error:{visible:!0,label:t.phase===`load`?`加载失败`:`保存失败`,tone:`error`,title:n||(t.phase===`load`?`账号 KML 加载失败`:`账号 KML 保存失败`)}}[e]||{visible:!1,label:``,tone:`guest`,title:``}}function gc(e,t=dc){let n=hc(t.state,t.detail);e.hidden=!n.visible,e.textContent=n.label,e.dataset.state=n.tone,e.dataset.actionable=t.state===`conflict`?`true`:`false`,e.title=n.title,`disabled`in e&&(e.disabled=t.state!==`conflict`)}function _c(e=`automatic`){typeof window>`u`||!(window.dispatchEvent instanceof Function)||window.dispatchEvent(new CustomEvent(`map-kml-sync-resolution-request`,{detail:{source:e}}))}function vc(e=`kml-sync-status`){if(typeof window>`u`||typeof document>`u`)return()=>{};let t=document.getElementById(e);if(!t||!(window.addEventListener instanceof Function))return()=>{};let n=e=>{let n=e?.detail||{};gc(t,{state:String(n.state||`guest`),detail:n})},r=()=>{dc.state===`conflict`&&_c(`status`)};return window.addEventListener(`map-kml-sync-state`,n),t.addEventListener(`click`,r),gc(t),()=>{window.removeEventListener(`map-kml-sync-state`,n),t.removeEventListener(`click`,r)}}function yc(e,t={}){dc={state:e,detail:{...t}},!(typeof window>`u`||!(window.dispatchEvent instanceof Function))&&window.dispatchEvent(new CustomEvent(`map-kml-sync-state`,{detail:{state:e,...t}}))}function bc(e){return{name:String(e.name||`未命名 KML`),description:String(e.description||``),isDefault:!!e.isDefault,coordCorrection:e.coordCorrection||`wgs84-to-gcj02`,theme:e.theme||`default`,color:e.color||`#0f766e`,lockDrag:!!e.lockDrag,enabled:e.enabled!==!1,isLiveTrack:!!e.isLiveTrack,features:Array.isArray(e.features)?e.features:[]}}function xc(e){return JSON.stringify(bc(e))}function Sc(e,t=e.id){return{localId:String(t||e.id||``),serverId:String(e.id||e.serverId||``),revision:Number(e.revision||1),hash:xc(e),status:e.status===`trashed`?`trashed`:`active`}}function Cc(e=[]){return e instanceof Map?new Map(e):new Map((e||[]).flatMap(e=>{let t=String(e?.localId||``);return t?[[t,{...e,localId:t}]]:[]}))}function wc(e,t,n=t?.id){let r=Cc(e),i=String(n||``),a=String(t?.id||t?.serverId||``);return!i||!a||!t||typeof t!=`object`||r.set(i,Sc({...t,id:a},i)),r}function Tc(e=[]){return Array.isArray(e)?e.slice(0,100).flatMap(e=>{let t=String(e?.action||``);if(![`create`,`update`,`trash`,`restore`].includes(t))return[];let n=String(e?.kmlId||``),r=String(e?.clientId||``);return t===`create`?r&&e?.data&&typeof e.data==`object`?[{action:t,clientId:r,data:mc(e.data)}]:[]:t===`update`?n&&e?.data&&typeof e.data==`object`?[{action:t,kmlId:n,data:mc(e.data)}]:[]:!n&&!r?[]:[{action:t,...n?{kmlId:n}:{clientId:r}}]}):[]}function Ec(e,t){let n=Cc(t?.snapshots),r=new Set([...(t?.files||[]).map(e=>String(e?.id||``)).filter(Boolean),...(t?.deletedClientIds||[]).map(e=>String(e||``)).filter(Boolean)]),i=new Set(Array.from(n.values(),e=>String(e.serverId||``)));for(let t of e||[]){let e=String(t?.syncClientId||``),a=String(t?.id||``);!e||!a||!r.has(e)||n.has(e)||i.has(a)||(n.set(e,Sc(t,e)),i.add(a))}return n}function Dc(e,t=Zs,n=[]){let r=[],i=new Set;e.forEach(e=>{let n=String(e.id||``);if(!n)return;i.add(n);let a=t.get(n),o=bc(e),s=JSON.stringify(o);a?a.status===`trashed`?r.push(a.serverId?{action:`restore`,kmlId:a.serverId}:{action:`restore`,clientId:n}):a.hash!==s&&r.push({action:`update`,kmlId:a.serverId,data:{...o,revision:a.revision}}):r.push({action:`create`,clientId:n,data:o})}),t.forEach(e=>{!i.has(e.localId)&&e.status!==`trashed`&&r.push({action:`trash`,kmlId:e.serverId})});for(let e of n||[]){let n=String(e||``);!n||i.has(n)||t.has(n)||r.push({action:`trash`,clientId:n})}return r}function Oc(e,t){let n=Cc(e),r=new Set,i=new Set,a=e=>[...n.values()].find(t=>t.serverId===String(e||``));for(let e of t?.results||[]){if(e.action===`create`&&e.document){let t=String(e.clientId||``);t&&(n.set(t,Sc(e.document,t)),r.add(t));continue}if(e.action===`update`&&e.document){let t=a(e.document.id),r=String(t?.localId||e.document.syncClientId||e.document.id||``);r&&n.set(r,Sc(e.document,r));continue}if(e.action===`trash`){let t=a(e.document?.id||e.result?.id),i=String(e.clientId||t?.localId||``);e.document&&i?n.set(i,Sc(e.document,i)):i&&n.set(i,{localId:i,serverId:``,revision:0,hash:``,status:`trashed`}),i&&r.add(i);continue}if(e.action===`restore`){let t=String(e.clientId||``),r=e.document?a(e.document.id):null,o=String(t||r?.localId||e.document?.syncClientId||e.document?.id||``);e.document&&o?n.set(o,Sc(e.document,o)):t&&(n.delete(o),i.add(o))}}return{snapshots:n,resolvedLocalIds:[...r],releasedClientIds:[...i]}}function kc(e,t,n,r={}){return{version:1,userId:String(e||``),generation:Math.max(1,Number(r.generation||1)),reason:String(r.reason||`dirty`),updatedAt:r.updatedAt||new Date().toISOString(),files:mc(Array.isArray(t)?t:[]),snapshots:Array.from(Cc(n).values(),e=>({...e})),deletedClientIds:[...new Set(Array.from(r.deletedClientIds||[],e=>String(e||``)).filter(Boolean))],pendingOperations:Tc(r.pendingOperations)}}function Ac(e,t){if(!e||e.version!==1||String(e.userId||``)!==String(t||``)||!Array.isArray(e.files)||!Array.isArray(e.snapshots))return null;let n=kc(t,e.files,e.snapshots,{generation:e.generation,reason:e.reason,updatedAt:e.updatedAt,deletedClientIds:e.deletedClientIds,pendingOperations:e.pendingOperations});return e.incompleteWrite&&(n.incompleteWrite=!0,n.storageGeneration=Math.max(Number(e.storageGeneration||0),Number(e.generation||0))),n}function jc(e){return Math.max(Number(e?.generation||0),Number(e?.storageGeneration||0))}function Mc(e,t){return Number(e?.generation||0)-Number(t?.generation||0)||(Date.parse(e?.updatedAt||``)||0)-(Date.parse(t?.updatedAt||``)||0)}function Nc(e,t){return e.map(e=>Ac(e,t)).filter(Boolean).sort((e,t)=>Mc(t,e))[0]||null}function Pc(e,t){let n=Ec(e,t),r=Dc(t?.files||[],n,t?.deletedClientIds),i=Tc(t?.pendingOperations),a=new Map((e||[]).map(e=>[String(e.id||``),e])),o=new Map(Array.from(n.values(),e=>[e.serverId,e])),s=[...new Set(i.filter(e=>e.action===`trash`||e.action===`restore`).map(e=>String(e.clientId||o.get(String(e.kmlId||``))?.localId||``)).filter(Boolean))],c=new Set(s),l=new Map(r.filter(e=>e.action===`update`).map(e=>[e.kmlId,e])),u=new Map(r.filter(e=>e.action===`trash`).map(e=>[e.kmlId,e])),d=[];return n.forEach(e=>{if(c.has(e.localId)||!l.has(e.serverId)&&!u.has(e.serverId))return;let t=a.get(e.serverId);(!t||Number(t.revision||0)!==Number(e.revision||0))&&d.push(e.localId)}),{hasChanges:r.length>0||i.length>0,operations:r,pendingOperations:i,pendingPresenceLocalIds:s,conflictedLocalIds:d,createdLocalIds:r.filter(e=>e.action===`create`).map(e=>e.clientId),updatedLocalIds:r.filter(e=>e.action===`update`).map(e=>o.get(e.kmlId)?.localId).filter(Boolean),restoredLocalIds:r.filter(e=>e.action===`restore`).map(e=>e.clientId||o.get(e.kmlId)?.localId).filter(Boolean),deletedLocalIds:r.filter(e=>e.action===`trash`).map(e=>e.clientId||o.get(e.kmlId)?.localId).filter(Boolean)}}function Fc(e){return`kml-recovery-${globalThis.crypto?.randomUUID?.()||`${Date.now()}-${Math.random().toString(16).slice(2)}`}-${e}`}function Ic(e,t,n,r){let i=bc(e);return{...i,id:r(t),name:`${i.name.slice(0,Math.max(1,200-n.length))}${n}`,isDefault:!1}}function Lc(e,t){let n=new Map(Array.from(Cc(t).values(),e=>[e.serverId,e]));return(e||[]).map(e=>{let t=n.get(String(e.id||``));return t?{...mc(e),id:t.localId,serverId:e.id}:mc(e)})}function Rc(e,t,n,r={}){if(!pc.has(n))throw Error(`KML 恢复处理方式无效`);let i=Pc(e,t),a=mc(t?.files||[]),o=new Map(a.map(e=>[String(e.id||``),e])),s=Ec(e,t),c=Lc(e,s),l=new Map(c.map(e=>[String(e.id||``),e])),u=r.idFactory||Fc,d=new Set(i.conflictedLocalIds),f=new Set(i.createdLocalIds),p=new Set(i.updatedLocalIds),m=new Set(i.restoredLocalIds),h=new Set(i.deletedLocalIds),g=new Set(i.pendingPresenceLocalIds),_=new Map(Array.from(s.values(),e=>[e.serverId,e])),ee=Tc(i.pendingOperations),te=e=>String(e.clientId||_.get(String(e.kmlId||``))?.localId||``),v=n===`restore`?ee:[`reload-conflicts`,`save-as-conflicts`].includes(n)?ee.filter(e=>!d.has(te(e))):[],ne=[...new Set((t?.deletedClientIds||[]).map(e=>String(e||``)).filter(Boolean))],y=(t={})=>{let n=Vc(e,s),r=new Set;return t.preserveConflicts&&d.forEach(e=>r.add(e)),t.preserveRestores&&m.forEach(e=>r.add(e)),t.preservePendingPresence&&g.forEach(e=>r.add(e)),r.forEach(e=>{let t=s.get(e);t&&n.set(e,t)}),n},b=e=>Array.from(e.values(),e=>({...e}));if(n===`discard`)return{files:c,snapshots:b(y()),analysis:i,copiedCount:0,shouldSync:!1,blockedByConflict:!1,deletedClientIds:[],pendingOperations:[]};if(n===`save-as-all`){let e=[...new Set([...f,...p,...m,...g])].flatMap((e,t)=>{let n=o.get(e);return n?[Ic(n,t,`（恢复副本）`,u)]:[]});return{files:[...c,...e],snapshots:b(y()),analysis:i,copiedCount:e.length,shouldSync:e.length>0,blockedByConflict:!1,deletedClientIds:[],pendingOperations:[]}}let x=[],S=new Set,C=[];s.forEach(e=>{let t=e.localId;S.add(t);let r=o.get(t),i=l.get(t),a=d.has(t);if(g.has(t)){r&&x.push(r);return}if(h.has(t)){a&&(n===`reload-conflicts`||n===`save-as-conflicts`)&&i&&x.push(i);return}if(m.has(t)){r&&x.push(r);return}if(p.has(t)){a&&(n===`reload-conflicts`||n===`save-as-conflicts`)?(i&&x.push(i),n===`save-as-conflicts`&&r&&C.push(Ic(r,C.length,`（冲突副本）`,u))):r&&x.push(r);return}i&&x.push(i)}),f.forEach(e=>{S.add(e);let t=o.get(e);t&&x.push(t)}),c.forEach(e=>{S.has(String(e.id||``))||x.push(e)});let re=[...x,...C],w=y({preserveConflicts:n===`restore`&&i.conflictedLocalIds.length>0,preserveRestores:!0,preservePendingPresence:v.length>0}),ie=new Set(re.map(e=>String(e?.id||``)).filter(Boolean)),T=ne.filter(e=>!ie.has(e));return{files:re,snapshots:b(w),analysis:i,copiedCount:C.length,shouldSync:!i.conflictedLocalIds.length||n!==`restore`?v.length>0||Dc(re,w,T).length>0:!1,blockedByConflict:n===`restore`&&i.conflictedLocalIds.length>0,deletedClientIds:T,pendingOperations:v}}async function zc(e,t=4){let n=Array(e.length),r=0;async function i(){for(;r<e.length;){let t=r;r+=1,n[t]=await ka(`/kml/files/${encodeURIComponent(e[t].id)}`)}}return await Promise.all(Array.from({length:Math.min(t,e.length)},i)),n.filter(Boolean)}async function Bc(){let e=[],t=1,n=null;for(;t<=100;){let r=await ka(`/kml/files`,{query:{page:t,limit:100,status:`active`}}),i=Array.isArray(r?.items)?r.items:[];e.push(...i),n=r?.usage||n;let a=Number(r?.total||e.length);if(!i.length||e.length>=a||i.length<100)break;t+=1}return{files:await zc(e),usage:n}}function Vc(e,t=[]){let n=new Map,r=new Map(Array.from(Cc(t).values(),e=>[e.serverId,e]));return e.forEach(e=>{let t=r.get(String(e.id||``))?.localId||e.id;n.set(t,Sc(e,t))}),n}function Hc(e){let t=new Set((e||[]).map(e=>String(e?.id||``)).filter(Boolean));t.forEach(e=>{$s.delete(e),Zs.has(e)?Qs.delete(e):Qs.add(e)});for(let e of Qs)t.has(e)||(Qs.delete(e),$s.add(e))}function Uc(e=`dirty`){if(!Js||!Ys||!Xs)return null;sc+=1;let t=kc(Xs,ac,Zs,{generation:sc,reason:e,deletedClientIds:$s,pendingOperations:ec});cc=t,ic&&(lc={...lc||{},draft:mc(t)});let n=qs().put(t);return fc=Promise.resolve(n).then(()=>!0,e=>(yc(`error`,{phase:`recovery`,code:`KML_RECOVERY_UNAVAILABLE`,message:`本机恢复草稿保存失败：${e.message}`}),!1)),t}function Wc(){Xs&&(sc+=1,cc=null,lc=null,Promise.resolve(qs().delete(Xs,{generation:sc})).catch(()=>{}))}function Gc(){if(uc||typeof window>`u`)return;uc=!0;let e=e=>{!Js||!Ys||(ic||ec.length>0||Dc(ac,Zs,$s).length>0)&&Uc(e)};window.addEventListener(`pagehide`,()=>e(`pagehide`)),typeof document<`u`&&document.addEventListener(`visibilitychange`,()=>{document.visibilityState===`hidden`&&e(`pagehide`)})}async function Kc(){let e=++oc;Js=!1,Ys=!1,Xs=``,Zs=new Map,Qs=new Set,$s=new Set,ec=[],ac=[],nc=!1,rc=!1,ic=!1,cc=null,lc=null,tc&&clearTimeout(tc),tc=null,Gc();let t=await za();if(e!==oc)return{mode:`guest`,files:[]};if(Js=!!(t.authenticated&&Wa(`kml.own.read`,t)),Ys=!!(Js&&Wa(`kml.own.write`,t)),Xs=Js?String(t.user?.id||``):``,!Js)return yc(`guest`),{mode:`guest`,files:[]};try{let t=await Bc();if(!Js||e!==oc)return{mode:`guest`,files:[]};ac=t.files,Zs=Vc(t.files);let n=null,r=null;if(Ys&&Xs)try{let e=await qs().get(Xs,{includeDeleted:!0});sc=Math.max(sc,jc(e));let r=Ac(e,Xs),i=r?Pc(t.files,r):null;r&&(i?.hasChanges||r.incompleteWrite)?(cc=r,sc=Math.max(sc,jc(r)),n={draft:r,analysis:i}):r&&Wc()}catch(e){r=e}return r?yc(`error`,{phase:`recovery`,code:`KML_RECOVERY_UNAVAILABLE`,message:`无法读取本机恢复草稿：${r.message}`}):yc(Ys?`loaded`:`readonly`,{count:t.files.length,readOnly:!Ys}),{mode:`account`,files:t.files,usage:t.usage||null,canWrite:Ys,userId:Xs,recovery:n,recoveryError:r}}catch(t){return!Js||e!==oc?{mode:`guest`,files:[]}:(yc(`error`,{phase:`load`,code:t.code,message:t.message}),{mode:`account`,files:[],canWrite:Ys,userId:Xs,error:t})}}function qc(){return Js}function Jc(){return Js&&Ys}function Yc(e,t={}){if(!Js||!Ys||!e||typeof e!=`object`)return!1;let n=String(t.localId||e.id||``),r=String(e.id||e.serverId||``);if(!n||!r)return!1;Zs=wc(Zs,{...e,id:r},n),Qs.delete(n),$s.delete(n),ec=ec.filter(e=>e.action!==`create`||String(e.clientId||``)!==n);let i=ac.findIndex(e=>String(e?.id||``)===n);return i>=0?ac.splice(i,1,e):ac=[...ac,e],!0}function Xc(e,t){let n=e?.results||[],r=Oc(Zs,e);Zs=r.snapshots,r.resolvedLocalIds.forEach(e=>{Qs.delete(e),$s.delete(e)}),r.releasedClientIds.forEach(e=>{t.some(t=>String(t?.id||``)===e)?($s.delete(e),Qs.add(e)):(Qs.delete(e),$s.add(e))}),n.forEach(e=>{if(e.action===`create`&&e.document){let n=String(e.clientId||``),r=t.find(e=>e.id===n);r&&(r.serverId=e.document.id,r.revision=e.document.revision,r.updatedAt=e.document.updatedAt);return}if((e.action===`update`||e.action===`restore`)&&e.document){let n=[...Zs.values()].find(t=>t.serverId===e.document.id)?.localId||e.document.id,r=t.find(e=>e.id===n);r&&(r.revision=e.document.revision,r.updatedAt=e.document.updatedAt)}})}async function Zc(){if(!Js||!Ys||ic)return;if(nc){rc=!0;return}let e=Tc(ec),t=e.length>0?e:Dc(ac,Zs,$s);if(!t.length){Wc(),yc(`saved`);return}let n=oc;nc=!0,yc(`saving`,{operationCount:t.length});try{if(e.length===0){ec=Tc(t),t=Tc(ec),Uc(`in-flight`);let e=await fc;if(!Js||n!==oc)return;if(!e){ec=[];return}}let r=await ka(`/kml/sync`,{method:`POST`,body:{operations:t}});if(!Js||n!==oc)return;ec=[],Xc(r,ac);let i=Dc(ac,Zs,$s);i.length===0?(Wc(),yc(`saved`,{syncedAt:r.syncedAt})):(Uc(`dirty`),yc(`dirty`,{operationCount:i.length}),rc=!0)}catch(e){if(!Js||n!==oc)return;if(Number(e?.status||0)>0&&(ec=[]),e.code===`KML_REVISION_CONFLICT`){ic=!0;let t=Uc(`conflict`)||cc;lc=t?{draft:mc(t)}:null,yc(`conflict`,{code:e.code,message:e.message,recoveryAvailable:!!t}),_c(`automatic`)}else Uc(`error`),yc(`error`,{code:e.code,message:e.message})}finally{if(n!==oc)return;nc=!1,rc&&!ic&&(rc=!1,tc&&clearTimeout(tc),tc=null,await Zc())}}function Qc(e,t={}){ac=Array.isArray(e)?e:[],Hc(ac),t.persist!==!1&&Ys&&Uc(t.reason||`dirty`)}function $c(e,t={}){return!Js||!Ys?!1:(ac=e,Hc(ac),Uc(ic?`conflict`:`dirty`),ic?(yc(`conflict`,{code:`KML_REVISION_CONFLICT`,message:`服务器内容已更新，请先处理保存冲突`,recoveryAvailable:!0}),!0):(tc&&clearTimeout(tc),tc=setTimeout(()=>{tc=null,Zc()},t.delayMs===0?0:Number(t.delayMs)||600),nc&&(rc=!0),yc(`dirty`),!0))}async function el(e,t=null){if(!Js||!Ys||!Xs)throw Error(`当前账号不能恢复 KML 草稿`);let n=String(e||``);if(!pc.has(n))throw Error(`KML 恢复处理方式无效`);let r=oc,i=Xs,a=qs(),o=await a.get(Xs,{includeDeleted:!0});sc=Math.max(sc,jc(o));let s=Nc([t?.draft,lc?.draft,cc,o],Xs);if(!s)throw Error(`没有可恢复的 KML 草稿`);if(o?.deleted&&Mc(o,s)>=0)throw Error(`KML 恢复草稿已被丢弃`);let c=await Bc();if(!Js||!Ys||r!==oc||i!==Xs)throw Error(`账号会话已变化，请重新加载 KML`);let l=await a.get(Xs,{includeDeleted:!0});sc=Math.max(sc,jc(l));let u=Nc([cc,l],Xs);if(l?.deleted&&Mc(l,s)>=0||u&&Mc(u,s)>0)throw Error(`KML 草稿在处理期间又有更新，请重新选择处理方式`);let d=Rc(c.files,s,n);return Zs=Cc(d.snapshots),ac=d.files,$s=new Set(d.deletedClientIds||[]),ec=Tc(d.pendingOperations),Qs=new Set,Hc(ac),ic=d.blockedByConflict,lc=d.blockedByConflict?{draft:mc(s),analysis:d.analysis}:null,cc=s,n===`discard`?(Wc(),yc(`loaded`,{count:d.files.length})):d.blockedByConflict?(Uc(`conflict`),yc(`conflict`,{code:`KML_REVISION_CONFLICT`,message:`恢复草稿基于旧版本，请选择加载服务器版本或另存为新 KML`,recoveryAvailable:!0})):d.shouldSync?(Uc(`recovery`),yc(`dirty`)):(Wc(),yc(`loaded`,{count:d.files.length})),d}async function tl(e){if(![`reload`,`save-as`].includes(e))throw Error(`KML 冲突处理方式无效`);return el(e===`reload`?`reload-conflicts`:`save-as-conflicts`)}function nl(e={}){e.preserveDraft!==!1&&Js&&Ys&&(ic||ec.length>0||Dc(ac,Zs,$s).length>0)&&Uc(e.reason||`session-expired`),oc+=1,Js=!1,Ys=!1,Xs=``,Zs=new Map,Qs=new Set,$s=new Set,ec=[],ac=[],nc=!1,rc=!1,ic=!1,cc=null,lc=null,tc&&clearTimeout(tc),tc=null,yc(`guest`)}async function rl(e,t){let n=await t(e.files,e),r=Array.isArray(n)?n:e.files;return e.blockedByConflict?Qc(r,{persist:!1}):e.shouldSync?$c(r,{delayMs:0}):Qc(r,{persist:!1}),{...e,files:r}}async function il(e,t){if(!e?.draft||!(t instanceof Function))return null;try{let n=e.analysis||{},r=Number(n.operations?.length||0),i=Number(n.conflictedLocalIds?.length||0),a=i?`其中 ${i} 项基于旧的服务器版本，恢复后会暂停同步并要求处理冲突。`:`服务器版本未变化，恢复后会继续自动同步。`,o=e.draft?.incompleteWrite?`浏览器关闭前最后一次草稿写入未完成，将从最近一份完整草稿恢复。`:``,s=[{value:`restore`,text:e.draft?.incompleteWrite?`使用最近完整草稿`:`恢复草稿`,class:`app-dialog-primary`},...r?[{value:`save-as-all`,text:`另存为新 KML`}]:[],{value:`discard`,text:`丢弃草稿`,class:`app-dialog-danger`}];return rl(await el(await je({title:`恢复未同步的 KML`,message:`${r?`检测到当前账号有 ${r} 项未完成的 KML 修改。`:``}${a}${o}`,dismissible:!1,choices:s}),e),t)}catch(e){return qc()&&await De(e.message||`KML 恢复失败，请稍后重试`,{title:`无法恢复 KML 草稿`}),null}}function al(e){if(typeof window>`u`||!(e instanceof Function))return()=>{};let t=!1,n=async()=>{if(!t){t=!0;try{let t=await je({title:`处理 KML 保存冲突`,message:`服务器上的 KML 已被其他客户端更新。自动同步已暂停，本地修改仍保存在当前账号的恢复草稿中。`,cancelText:`保留草稿，稍后处理`,choices:[{value:`reload`,text:`加载服务器版本`,class:`app-dialog-primary`},{value:`save-as`,text:`本地版本另存为`}]});if(!t||t===`cancel`)return;await rl(await tl(t),e)}catch(e){if(!qc())return;await De(e.message||`KML 冲突处理失败，请稍后重试`,{title:`无法处理保存冲突`})}finally{t=!1}}};return window.addEventListener(`map-kml-sync-resolution-request`,n),()=>window.removeEventListener(`map-kml-sync-resolution-request`,n)}var ol=null;function sl(){let e=document.querySelector(`meta[name="robots"]`);e||(e=document.createElement(`meta`),e.name=`robots`,document.head.appendChild(e)),e.content=`noindex, nofollow`}function cl(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function ll(e=window.location){let t=/^\/share\/([^/]+)\/?$/.exec(e.pathname||``)?.[1]||(e.pathname===`/3d`||e.pathname===`/3d.html`?new URLSearchParams(e.search||``).get(`share`):``);if(!t)return``;try{return decodeURIComponent(t)}catch{return``}}function ul(e=window.location){return!!ll(e)}function dl(e){let t=e?.spatialAccess;if(!t||t.mode===`unrestricted`)return{restricted:!1,valid:!0,mode:`unrestricted`};if(t.mode!==`kml_bounds`||t.status!==`ready`)return{restricted:!0,valid:!1,mode:t.mode||`unknown`,reasonCode:t.reasonCode||`SHARE_SPATIAL_UNAVAILABLE`};let n=Array.isArray(t.cameraBounds)&&t.cameraBounds.length===4?t.cameraBounds.map(Number):null,r=Number(t.minZoom),i=!!(n&&n.every(Number.isFinite)&&n[2]-n[0]>0&&n[2]-n[0]<=360&&n[1]>=-90&&n[1]<=90&&n[3]>=-90&&n[3]<=90&&n[1]<n[3]&&Number.isFinite(r)&&r>=0&&r<=24);return{restricted:!0,valid:i,mode:`kml_bounds`,cameraBounds:i?n:null,minZoom:i?r:null,maxCameraHeight:Number.isFinite(Number(t.maxCameraHeight))?Number(t.maxCameraHeight):null,reasonCode:i?null:`SHARE_SPATIAL_UNAVAILABLE`}}function fl(){return ol?{publicId:ol.publicId,manifest:{...ol.manifest}}:null}function pl(e){document.body.classList.add(`share-view`,`share-unavailable`),document.getElementById(`map-lock-screen`)?.remove();let t=document.createElement(`div`);t.id=`map-lock-screen`,t.className=`lock-screen-backdrop`,t.innerHTML=`
    <section class="lock-screen-card" role="alert">
      <div class="lock-screen-icon">🗺️</div>
      <h2>分享暂不可用</h2>
      <p>${cl(e||`该分享不存在、已暂停或已过期。`)}</p>
      <a class="lock-screen-link" href="/">返回地图首页</a>
    </section>
  `,document.body.appendChild(t)}function ml(e){document.getElementById(`map-lock-screen`)?.remove();let t=document.createElement(`div`);t.id=`map-lock-screen`,t.className=`lock-screen-backdrop`,t.innerHTML=`
  ...
  `}function Ql(e,t){return`${e}?url=${encodeURIComponent(t).replace(/%7B/g,`{`).replace(/%7D/g,`}`)}`}function $l(e){let t=e.system,n=e.visits||{},r=t?.userSystem||{},i=r.counts||{},a=t?.package?.version||`-`,o=e.visitsError||(e.visitsLoading?`统计中`:``);return`
    <div class="admin-grid">
      <section class="admin-panel">
        ...
        <dl class="admin-metrics">
          ...
          <div><dt>运行</dt><dd>${Jl(t?.uptime||0)}</dd></div>
          <div><dt>环境</dt><dd>${Q(t?.env||`-`)}</dd></div>
          <div><dt>时间</dt><dd>${Yl(t?.serverTime)}</dd></div>
        </dl>
      </section>
      <section class="admin-panel">
        <div class="admin-panel-head">
  ...
  `}function eu(e){let t=e.cache||{},n=e.cacheError||(e.cacheLoading?`统计中`:``),r=t.bySource||{},i=e.tileSources||[];return`
    <section class="admin-panel">
      <div class="admin-panel-head">
        <h2>缓存治理</h2>
  ...
  `}async function tu({api:e,event:t,renderDashboard:n,setNotice:r,showConfirm:i,state:a}){let o=t.target.closest(`[data-admin-action]`);if(!o)return!1;let s=o.getAttribute(`data-admin-action`);if(s===`clear-cache`){if(!await i(`清空所有瓦片缓存？此操作不可逆！`))return!0;try{await e.clearCache(),a.cache=await e.cache(),r(`所有瓦片缓存已清空`),n()}catch(e){r(``,e.message),n()}return!0}if(s===`clear-source-cache`){let t=o.getAttribute(`data-source-id`);if(!t)return!1;let s=(a.tileSources||[]).find(e=>e.id===t),c=s?s.name:t;if(!await i(`确定要清空图源【${c}】的全部瓦片缓存吗？`))return!0;try{await e.clearCache({sourceId:t}),a.cache=await e.cache(),r(`已清空图源【${c}】的专属瓦片缓存`),n()}catch(e){r(``,e.message),n()}return!0}return!1}var nu={queued:`排队中`,running:`执行中`,pausing:`暂停中`,paused:`已暂停`,completed:`已完成`,completed_with_errors:`完成有错误`,failed:`失败`,interrupted:`已中断`,deleting:`删除中`},ru=1e3,iu=1500,au=new Set([`queued`,`running`,`pausing`,`deleting`]),ou=null,su=0,cu=``,lu=``,uu=null,du=0;function fu(e){return nu[e]||e}var pu={queued:`⏳`,running:`⚙`,pausing:`⏸`,paused:`⏸`,completed:`✓`,completed_with_errors:`⚠`,failed:`✗`,interrupted:`⏹`,deleting:`🗑`};function mu(e){return pu[e]||`•`}function hu(e,t){let n=t[0],r=e.precacheForm||{};return{providerId:t.some(e=>e.id===r.providerId)?r.providerId:n?.id||``,bounds:{west:Number(r.bounds?.west??113.24),south:Number(r.bounds?.south??23.11),east:Number(r.bounds?.east??113.29),north:Number(r.bounds?.north??23.15)},minZoom:Number(r.minZoom??12),maxZoom:Number(r.maxZoom??12),concurrency:Number(r.concurrency??4),requestIntervalMs:Number(r.requestIntervalMs??0),refresh:!!r.refresh}}function gu(e,t){return e.find(e=>e.id===t.providerId)||e[0]||null}function _u(e){let t=e.expandedTaskIds||new Set;return(e.tasks||[]).map(e=>({...e,expanded:t.has(e.id)}))}function vu(e=[]){return e.some(e=>au.has(e.status))}function yu(e){let t=e.precacheCatalog||[],n=hu(e,t),r=gu(t,n),i=_u(e);return`
  ...
  `}function bu(e){let t=e.precacheEstimate;return e.precacheEstimateStatus===`loading`?`<div class="admin-estimate" data-precache-estimate><p>正在估算瓦片数量和下载体积</p></div>`:e.precacheEstimateError?`<div class="admin-estimate is-error" data-precache-estimate><p>${Q(e.precacheEstimateError)}</p></div>`:t?`
  ...
  `:`<div class="admin-estimate" data-precache-estimate><p>停止移动地图后会自动估算任务规模</p></div>`}function xu(e){let t=e.root?.querySelector(`[data-precache-estimate]`);t&&(t.outerHTML=bu(e))}function Su(e){return e.length?e.map(e=>`Z${e.z}: ${e.count}`).join(`，`):`暂无分级明细`}function Cu(e){if(e.targetType===`layer`){let t=e.sources||[];return t.length?t.map(e=>`${e.sourceName||e.sourceId}: ${e.total||0} 张，约 ${ql(e.estimatedBytes||0)}`).join(`，`):`暂无可预缓存图源明细`}return Su(e.ranges||[])}function wu(e){return`
    <section class="admin-panel admin-panel-wide admin-precache-task-panel" data-precache-task-panel>
      ...
      <div class="admin-task-list">
        ${e.slice(0,10).map(e=>Tu(e)).join(``)||`<p class="admin-empty">暂无任务</p>`}
      </div>
    </section>
  `}function Tu(e){let t=e.expanded;return`
    <article class="admin-task-card">
      <div class="admin-task-main">
        <div class="admin-task-title">
          <span class="admin-status admin-status-${e.status}" title="${Q(fu(e.status))}">${Q(mu(e.status))}</span>
          <strong>${Q(e.providerId)}</strong>
          <small>${Yl(e.updatedAt)}</small>
        </div>
        ${Eu(e)}
      </div>
  ...
  `}function Eu(e){let t=Number(e.completed||0),n=Number(e.total||0),r=n?Math.min(100,Math.round(t/n*100)):0;return`
    <div class="admin-task-progress">
      <span>${Q(t)} / ${Q(n)} (${r}%)</span>
      <small>成功 ${Q(e.succeeded||0)}，失败 ${Q(e.failed||0)}</small>
    </div>
  `}function Du(e){let t=[`queued`,`running`].includes(e.status),n=[`paused`,`interrupted`,`failed`,`completed_with_errors`].includes(e.status),r=e.status!==`deleting`,i=e.expanded?`收起`:`详情`;return`
  ...
  `}function Ou(e){let t=e.bounds||{},n=e.ranges||[],r=e.errors||[],i=Object.values(e.failedTiles||{});return`
    <div class="admin-task-details">
      <dl>
        <div><dt>区域</dt><dd>西 ${Q(t.west)} / 南 ${Q(t.south)} / 东 ${Q(t.east)} / 北 ${Q(t.north)}</dd></div>
        <div><dt>级别明细</dt><dd>${Su(n)}</dd></div>
        <div><dt>失败待重试</dt><dd>${Q(i.length)}</dd></div>
        <div><dt>创建时间</dt><dd>${Yl(e.createdAt)}</dd></div>
        <div><dt>完成时间</dt><dd>${Yl(e.finishedAt)}</dd></div>
      </dl>
      ${i.length?`
  ...
  `}function ku(e,t){qu(e,t);let n=t.elements.providerId,r=n.options[n.selectedIndex]?.getAttribute(`data-type`)||`source`,i=n.value;return{targetType:r,targetId:i,providerId:i,bounds:{west:Number(t.elements.west.value),south:Number(t.elements.south.value),east:Number(t.elements.east.value),north:Number(t.elements.north.value)},minZoom:Number(t.elements.minZoom.value),maxZoom:Number(t.elements.maxZoom.value),concurrency:Number(t.elements.concurrency.value),requestIntervalMs:Number(t.elements.requestIntervalMs.value),refresh:t.elements.refresh.checked}}function Au(e,t){e.tasks=e.tasks.map(e=>e.id===t.id?t:e)}function ju(e,t){e.tasks=e.tasks.filter(e=>e.id!==t)}function Mu(e){let t=e.root?.querySelector(`[data-precache-task-panel]`);t&&(t.outerHTML=wu(_u(e)))}function Nu(e){return Array.isArray(e)?`[${e.map(Nu).join(`,`)}]`:e&&typeof e==`object`?`{${Object.keys(e).sort().map(t=>`${JSON.stringify(t)}:${Nu(e[t])}`).join(`,`)}}`:JSON.stringify(e)}function Pu(e){su+=1,cu=``,e.precacheEstimate=null,e.precacheEstimateStatus=``,e.precacheEstimateError=``,xu(e)}function Fu(e,t,n=ru){e.activeTab===`precache`&&(window.clearTimeout(ou),ou=window.setTimeout(()=>{Iu(e,t)},n))}async function Iu(e,t){if(e.activeTab!==`precache`)return;let n=e.root?.querySelector(`[data-precache-form]`);if(!n)return;let r=ku(e,n),i=Nu(r);if(i===lu||i===cu)return;let a=su+1;su=a,cu=i,e.precacheEstimateStatus=`loading`,e.precacheEstimateError=``,xu(e);try{let n=await t.estimateTask(r);if(a!==su)return;e.precacheEstimate=n,e.precacheEstimateStatus=``,e.precacheEstimateError=``,lu=i,cu=``,xu(e)}catch(t){if(a!==su)return;e.precacheEstimate=null,e.precacheEstimateStatus=``,e.precacheEstimateError=t.message,cu=``,xu(e)}}function Lu(e,t,n=iu){window.clearTimeout(uu),!(e.activeTab!==`precache`||!vu(e.tasks))&&(uu=window.setTimeout(()=>{Ru(e,t)},n))}async function Ru(e,t){if(e.activeTab!==`precache`)return;let n=du+1;du=n;try{let r=await t.tasks();if(n!==du||e.activeTab!==`precache`)return;e.tasks=r,Mu(e),Lu(e,t)}catch(n){console.warn(`预缓存任务状态刷新失败`,n),Lu(e,t,iu*2)}}async function zu({api:e,event:t,renderDashboard:n,setNotice:r,state:i}){let a=t.target.closest(`[data-precache-form]`),o=t.target.closest(`[data-place-search-form]`);if(a)return t.preventDefault(),e.createTask(ku(i,a)).then(t=>{Array.isArray(t)?(i.tasks=[...t,...i.tasks],r(`成功创建了 ${t.length} 个图源缓存子任务`)):(i.tasks=[t,...i.tasks],r(`预缓存任务已创建`)),n(),Lu(i,e,300)}).catch(e=>{r(``,e.message),n()}),!0;if(o){t.preventDefault();let e=o.elements.keyword.value.trim();return e&&await Qu(i,e),!0}return!1}async function Bu({api:e,event:t,renderDashboard:n,setNotice:r,showCheckboxConfirm:i,showConfirm:a,state:o}){let s=t.target.closest(`[data-precache-task-action]`);if(s)return await Hu({actionTarget:s,api:e,renderDashboard:n,setNotice:r,showCheckboxConfirm:i,showConfirm:a,state:o}),!0;let c=t.target.closest(`[data-place-lng][data-place-lat]`);return c?(Xu(o,Number(c.getAttribute(`data-place-lng`)),Number(c.getAttribute(`data-place-lat`))),!0):t.target.closest(`[data-admin-action]`)?.getAttribute(`data-admin-action`)===`sync-bounds`?(Ku(o),Pu(o),Fu(o,e),!0):!1}async function Vu({api:e,event:t,state:n}){let r=t.target.closest(`[data-precache-form]`);return r?(qu(n,r),Pu(n),Fu(n,e),!0):!1}async function Hu({actionTarget:e,api:t,renderDashboard:n,setNotice:r,showCheckboxConfirm:i,showConfirm:a,state:o}){let s=e.getAttribute(`data-precache-task-action`),c=e.getAttribute(`data-task-id`),l=o.tasks.find(e=>e.id===c);if(!(!s||!c))try{if(s===`pause`){Au(o,await t.pauseTask(c)),r(`预缓存任务已暂停`),n(),Lu(o,t,300);return}if(s===`resume`){Au(o,await t.resumeTask(c)),r(`预缓存任务已继续`),n(),Lu(o,t,300);return}if(s===`delete`){let e=!1;if(i instanceof Function){let t=await i(`删除此预缓存任务？执行中的任务会停止并从列表移除。`,{confirmText:`删除`,checkboxLabel:`同时删除该任务范围内已缓存的瓦片文件`});if(!t?.confirmed)return;e=!!t.checked}else if(!await a(`删除此预缓存任务？执行中的任务会停止并从列表移除。`))return;await t.deleteTask(c,{deleteCache:e}),ju(o,c),r(e?`预缓存任务已删除，关联缓存文件清理已提交`:`预缓存任务已删除`),n();return}if(s===`edit`&&l){Yu(o,l),Pu(o),Fu(o,t),r(`任务参数已回填，可调整后创建新任务`),n();return}if(s===`update`&&l){o.tasks=[await t.createTask({providerId:l.providerId,bounds:l.bounds,minZoom:l.minZoom,maxZoom:l.maxZoom,concurrency:l.concurrency,requestIntervalMs:l.requestIntervalMs||0,refresh:!1}),...o.tasks],r(`更新任务已创建，将跳过新鲜缓存并补齐缺失瓦片`),n(),Lu(o,t,300);return}if(s===`toggle-details`){o.expandedTaskIds.has(c)?o.expandedTaskIds.delete(c):o.expandedTaskIds.add(c),n();return}s===`preview`&&l&&(window.location.href=Ju(l))}catch(e){r(``,e.message),n(),Lu(o,t,300)}}async function Uu(e){return e.AMap?e.AMap:(window._AMapSecurityConfig={securityJsCode:_.securityJsCode},e.amapLoader?(e.AMap=await e.amapLoader.load({key:_.key,version:`2.0`,plugins:_.plugins}).catch(e=>(console.warn(`高德 JSAPI 加载失败，后台地点搜索不可用`,e),null)),e.AMap):(console.warn(`高德 JSAPI Loader 未初始化，后台地点搜索不可用`),null))}function Wu(e){let t=e.root.querySelector(`[data-precache-form]`);return{west:Number(t?.elements.west.value),south:Number(t?.elements.south.value),east:Number(t?.elements.east.value),north:Number(t?.elements.north.value)}}function Gu(e,t){let n=e.root.querySelector(`[data-precache-form]`);n&&(n.elements.west.value=t.getWest().toFixed(6),n.elements.south.value=t.getSouth().toFixed(6),n.elements.east.value=t.getEast().toFixed(6),n.elements.north.value=t.getNorth().toFixed(6),qu(e,n))}function Ku(e){if(!e.map||!e.rectangle)return;let t=e.map.getBounds();e.rectangle.setBounds(t),Gu(e,t)}function qu(e,t){return t?(e.precacheForm={providerId:t.elements.providerId.value,bounds:{west:Number(t.elements.west.value),south:Number(t.elements.south.value),east:Number(t.elements.east.value),north:Number(t.elements.north.value)},minZoom:Number(t.elements.minZoom.value),maxZoom:Number(t.elements.maxZoom.value),concurrency:Number(t.elements.concurrency.value),requestIntervalMs:Number(t.elements.requestIntervalMs.value),refresh:t.elements.refresh.checked},e.precacheForm):null}function Ju(e){let t=e.bounds||{},n=(Number(t.south)+Number(t.north))/2,r=(Number(t.west)+Number(t.east))/2,i=Number(e.maxZoom||e.minZoom||ee.zoom);if(!Number.isFinite(n)||!Number.isFinite(r))return`/`;let a=[n.toFixed(6),r.toFixed(6),Math.max(3,Math.min(20,i)),0].join(`,`);return`/?coords=${encodeURIComponent(a)}`}function Yu(e,t){if(!t)return;let n=t.bounds||{};e.precacheForm={providerId:t.providerId||e.precacheForm?.providerId||``,bounds:{west:Number(n.west),south:Number(n.south),east:Number(n.east),north:Number(n.north)},minZoom:Number(t.minZoom),maxZoom:Number(t.maxZoom),concurrency:Number(t.concurrency||e.precacheForm?.concurrency||4),requestIntervalMs:Number(t.requestIntervalMs||e.precacheForm?.requestIntervalMs||0),refresh:!1}}function Xu(e,t,n,r=15){e.map&&(e.map.setView([n,t],r),Ku(e),e.onPrecacheBoundsChange instanceof Function&&e.onPrecacheBoundsChange())}function Zu(e,t){Lu(e,t);let n=e.root.querySelector(`#admin-precache-map`);if(!n)return;e.precacheMapHeight&&(n.style.height=`${e.precacheMapHeight}px`),e.onPrecacheBoundsChange=()=>Fu(e,t),document.querySelectorAll(`.amap-sug-result`).forEach(e=>e.remove()),e.map&&(e.map.remove(),e.map=null,e.rectangle=null);let r=p.default.map(n,{center:ee.center,zoom:Math.min(ee.zoom,13),zoomControl:!0,attributionControl:!1});p.default.tileLayer(Ql(te,`https://webst01.is.autonavi.com/appmaptile?style=8&x={x}&y={y}&z={z}`),{minZoom:3,maxZoom:18,keepBuffer:4}).addTo(r);let i=Wu(e),a=p.default.latLngBounds([i.south,i.west],[i.north,i.east]);e.rectangle=p.default.rectangle(a,{color:`#0f766e`,weight:2,fillColor:`#f59e0b`,fillOpacity:.14}).addTo(r);let o=!1;r.fitBounds(a),r.on(`moveend zoomend`,()=>Ku(e)),r.on(`moveend zoomend`,()=>{o&&e.onPrecacheBoundsChange instanceof Function&&e.onPrecacheBoundsChange()}),window.requestAnimationFrame(()=>{o=!0}),e.map=r;let s=e.root.querySelector(`[data-place-search-form] input[name="keyword"]`);s&&(s.id=`admin-precache-search-input`,Uu(e).then(t=>{t&&t.AutoComplete&&new t.AutoComplete({input:`admin-precache-search-input`}).on(`select`,t=>{if(t.poi?.location){let{lng:n,lat:r}=t.poi.location;Xu(e,n,r)}})}));let c=e.root.querySelector(`.admin-map-resizer`);if(c&&n){let t=0,r=0,i=e=>{t=e.clientY,r=n.offsetHeight,document.addEventListener(`pointermove`,a),document.addEventListener(`pointerup`,o),c.classList.add(`is-dragging`),e.preventDefault()},a=i=>{let a=i.clientY-t,o=Math.min(800,Math.max(150,r+a));n.style.height=`${o}px`,e.precacheMapHeight=o,e.map&&e.map.invalidateSize()},o=()=>{document.removeEventListener(`pointermove`,a),document.removeEventListener(`pointerup`,o),c.classList.remove(`is-dragging`)};c.addEventListener(`pointerdown`,i)}}async function Qu(e,t){let n=e.root.querySelector(`[data-place-search-results]`);if(!n)return;let r=await Uu(e);if(!r){n.innerHTML=`<p>高德搜索暂不可用</p>`;return}let i=new r.PlaceSearch({pageSize:8,pageIndex:1});n.innerHTML=`<p>正在搜索</p>`,i.search(t,(e,t)=>{if(e!==`complete`||!t?.poiList?.pois?.length){n.innerHTML=`<p>没有找到匹配地点</p>`;return}n.innerHTML=t.poiList.pois.map(e=>{let t=e.location;return`
        <button type="button" data-place-lng="${t.lng}" data-place-lat="${t.lat}">
          <strong>${Q(e.name)}</strong>
          <span>${Q(e.address||e.district||``)}</span>
        </button>
      `}).join(``)})}var $u=4;function ed(e){let t=e.settings?.access||{};return`
    <div class="admin-grid">
      <section class="admin-panel">
        <div class="admin-panel-head">
          <h2>访问控制</h2>
        ...
        <form class="admin-form" data-access-form autocomplete="off">
          ...
          <label>
            <span>设置访问密码</span>
            <input name="accessPassword" type="password" autocomplete="new-password" placeholder="${t.hasPassword?`已设置，输入新密码以修改`:`输入至少 ${$u} 位访问密码`}">
          </label>
          ${t.hasPassword?`
            <label class="admin-check">
...
`):`// 当前组合图层没有可用图源`;return`
  ...
  `}function Fd(e={},t=[],n=[],r=`proxy`){let i=[`fixed`,`pool`].includes(e.mode)?e.mode:`never`;return`
    <div class="form-grid">
  ...
  `}function Id(e,t){let n=Number.isFinite(Number(e))?Math.max(0,Number(e)):t;return{days:Math.floor(n/ld),hours:Math.floor(n%ld/cd),minutes:Math.floor(n%cd/sd)}}function Ld(e,t,n,r){let i=Id(n,r);return`
    <div class="field-group">
      <label>${t}</label>
  ...
  `}function Rd(e={},t=`cache`){return`
    <div class="checkbox-group">
      <input type="checkbox" id="${t}_enabled" name="${t}_enabled" ${e.enabled===!1?``:`checked`}>
      <label for="${t}_enabled">启用服务端缓存</label>
    </div>
    <div class="form-grid" style="margin-top:10px;">
      ${Ld(`${t}_ttl`,`缓存有效时间`,e.ttlMs,ad)}
      ${Ld(`${t}_staleTtl`,`软过期时间`,e.staleTtlMs,od)}
    </div>
  `}function zd(e,t,n=`proxy`){return{mode:t.get(`${n}_mode`)||`never`,outboundId:t.get(`${n}_outboundId`)||``,poolId:t.get(`${n}_poolId`)||``,fallbackToDirect:!!e.elements[`${n}_fallbackToDirect`]?.checked}}function Bd(e,t){let n=Math.max(0,parseInt(e.get(`${t}_days`)||`0`,10)||0),r=Math.max(0,parseInt(e.get(`${t}_hours`)||`0`,10)||0),i=Math.max(0,parseInt(e.get(`${t}_minutes`)||`0`,10)||0);return n*ld+r*cd+i*sd}function Vd(e,t,n=`cache`){return{enabled:!!e.elements[`${n}_enabled`]?.checked,ttlMs:Bd(t,`${n}_ttl`),staleTtlMs:Bd(t,`${n}_staleTtl`)}}function Hd(e,t){return String(e.get(t)||``).split(`,`).map(e=>e.trim()).filter(Boolean)}function Ud(e){return{template:String(e.get(`entry_template`)||``).trim(),styleJsonUrl:String(e.get(`entry_styleJsonUrl`)||``).trim(),tileJsonUrl:String(e.get(`entry_tileJsonUrl`)||``).trim(),pmtilesUrl:String(e.get(`entry_pmtilesUrl`)||``).trim(),glyphsUrl:String(e.get(`entry_glyphsUrl`)||``).trim(),spritesUrl:String(e.get(`entry_spritesUrl`)||``).trim()}}function Wd(e,t){return{required:!!e.elements.secrets_required?.checked,keyPoolId:t.get(`secrets_keyPoolId`)||``,placement:t.get(`secrets_placement`)||`query`,paramName:t.get(`secrets_paramName`)||`key`}}function Gd(e,t){return{engine:t.get(`rendering_engine`)||`leaflet`,clients:[e.elements.rendering_client_2d?.checked?`2d`:``,e.elements.rendering_client_3d?.checked?`3d`:``].filter(Boolean),fallbackRasterSourceId:t.get(`rendering_fallbackRasterSourceId`)||``}}function Kd(e,t){return{attribution:t.get(`license_attribution`)||``,termsUrl:t.get(`license_termsUrl`)||``,officialStatus:t.get(`license_officialStatus`)||`official`,licenseType:t.get(`license_licenseType`)||`unknown`,cacheAllowedByLicense:!!e.elements.license_cacheAllowedByLicense?.checked,publicUseAllowed:!!e.elements.license_publicUseAllowed?.checked,chinaPublicUseReviewed:!!e.elements.license_chinaPublicUseReviewed?.checked,chinaPublicUseRisk:t.get(`license_chinaPublicUseRisk`)||``}}function qd(e,t){let n=Array.from(e.querySelectorAll(`[data-key-row]`)).map(e=>{let t=t=>e.querySelector(`[name="${t}"]`),n={id:t(`key_id`)?.value||``,alias:t(`key_alias`)?.value||``,enabled:!!t(`key_enabled`)?.checked,secretType:t(`key_secretType`)?.value||`api_key`,placement:t(`key_placement`)?.value||`query`,paramName:t(`key_paramName`)?.value||`key`,priority:parseInt(t(`key_priority`)?.value||`100`,10),weight:parseInt(t(`key_weight`)?.value||`1`,10),qpsLimit:parseInt(t(`key_qpsLimit`)?.value||`0`,10),dailyLimit:parseInt(t(`key_dailyLimit`)?.value||`0`,10),monthlyLimit:parseInt(t(`key_monthlyLimit`)?.value||`0`,10)},r=t(`key_secret`)?.value||``;return r&&(n.secret=r),n});return{id:t.get(`id`),name:t.get(`name`),vendor:t.get(`vendor`),enabled:!!e.elements.enabled?.checked,scope:t.get(`scope`)||`global`,strategy:t.get(`strategy`)||`round_robin`,cooldownMs:parseInt(t.get(`cooldownMs`)||`300000`,10),maxRetriesPerRequest:parseInt(t.get(`maxRetriesPerRequest`)||`2`,10),defaultSecretType:t.get(`defaultSecretType`)||`api_key`,defaultPlacement:t.get(`defaultPlacement`)||`query`,defaultParamName:t.get(`defaultParamName`)||`key`,credentialUrl:String(t.get(`credentialUrl`)||``).trim(),allowedPresetIds:Hd(t,`allowedPresetIds`),allowedSourceIds:Hd(t,`allowedSourceIds`),keys:n,description:t.get(`description`)||``}}function Jd(e,t){if(!e.editingKeyPool||!t)return;let n=e.editingKeyPool.keys||[],r=new Map(n.filter(e=>e.id).map(e=>[e.id,e])),i=qd(t,new FormData(t));i.keys=i.keys.map((e,t)=>({...n[t]||{},...r.get(e.id)||{},...e})),e.editingKeyPool={...e.editingKeyPool,...i}}function Yd(e={}){let t=e.entry||{};return`
  ...
  `}function Xd(e={},t=[]){let n=e.secrets||{};return`
    <fieldset class="form-card" style="margin-top:15px; padding:15px; background:white;">
  ...
  `}function Zd(e={},t=[]){let n=e.rendering||{},r=n.clients||(Cd(e.kind)?[`2d`]:[`2d`,`3d`]),i=t.filter(e=>!Cd(e.kind)&&!wd(e.kind));return`
    <fieldset class="form-card" style="margin-top:15px; padding:15px; background:white;">
      ...
      <div class="form-grid">
        <div class="field-group">
          ...
          <select name="rendering_engine">
            ${bd(gd,n.engine||(Cd(e.kind)?`maplibre`:`leaflet`))}
          </select>
        </div>
        <div class="field-group">
  ...
  `}function Qd(e={}){let t=e.license||{};return`
    <fieldset class="form-card" style="margin-top:15px; padding:15px; background:white;">
      ...
      <div class="form-grid">
        <div class="field-group">
          ...
          <select name="license_officialStatus">
            ${bd([[`official`,`官方`],[`unofficial`,`非官方`],[`community`,`社区`],[`internal`,`内部`]],t.officialStatus||`official`)}
          </select>
        </div>
        <div class="field-group">
          <label>授权类型</label>
          <select name="license_licenseType">
            ${bd([[`free`,`免费`],[`api-key`,`API Key`],[`commercial`,`商业授权`],[`unknown`,`未知`]],t.licenseType||`unknown`)}
          </select>
        </div>
      </div>
      <div class="checkbox-group" style="margin-top:0;">
  ...
  `}function $d(e={}){let t=Number(e.retina?.normalValue);return ud[t]?String(t):`1`}function ef(e,t,n,r,i){let a=e!==!1,o=a?i:r;return`
    <button
      type="button"
      ...
      title="点击切换为${Q(o)}"
    >${Q(a?r:i)}</button>
  `}function tf(e){let t=String(e||``).toUpperCase();return t===`HIT`?`<span class="badge-green">HIT</span>`:t===`MISS`?`<span class="badge-red">MISS</span>`:t===`BYPASS`?`<span class="badge-gray">BYPASS</span>`:t===`REVALIDATED`?`<span class="badge-blue">REVAL</span>`:t===`STALE`?`<span class="badge-blue">STALE</span>`:t===`ERROR`?`<span class="badge-red">ERROR</span>`:`<span class="badge-gray">${Q(t||`-`)}</span>`}function nf(e){let t=Number(e.statusCode||0);return t>=200&&t<300?`<span class="badge-green">200 OK</span>`:`<span class="badge-red" title="${Q(e.errorMessage||``)}">${Q(e.statusCode||`-`)}</span>`}function rf(e){return e.proxyOutboundId?`<span class="badge-blue" title="池: ${Q(e.proxyPoolId||``)}">${Q(e.proxyOutboundId)}</span>`:e.proxyPoolId?`<span class="badge-blue">${Q(e.proxyPoolId)}</span>`:e.proxyConfigured?`<span class="badge-red" title="已配置代理，但本次未命中可用出口">代理未命中</span>`:`<span style="color:#94a3b8;">直连</span>`}async function af(e,t,n={}){let{tileSources:r=!1,sourcePresets:i=!1,keyPools:a=!1,mapLayers:o=!1,externalPublishes:s=!1,precacheCatalog:c=!0}=n,l=[],u=[];r&&(l.push(t.listTileSources()),u.push(t=>{e.tileSources=t})),i&&(l.push(t.listSourcePresets()),u.push(t=>{e.sourcePresets=t})),a&&(l.push(t.listKeyPools()),u.push(t=>{e.keyPools=t})),o&&(l.push(t.listMapLayers()),u.push(t=>{e.mapLayers=t})),s&&(l.push(t.listExternalPublishes()),u.push(t=>{e.externalPublishes=t})),c&&(l.push(t.precacheCatalog()),u.push(t=>{e.precacheCatalog=t})),(await Promise.all(l)).forEach((e,t)=>u[t](e))}function of(e){e.tileSourcesSubTab=e.tileSourcesSubTab||`sources`;let t=[{id:`sources`,label:`图源`},{id:`presets`,label:`图源预设`},{id:`key-pools`,label:`密钥池`},{id:`layers`,label:`图层组合`},{id:`publishes`,label:`发布/API`},{id:`diagnostics`,label:`诊断日志`}],n=``;switch(e.tileSourcesSubTab){case`sources`:n=sf(e);break;case`presets`:n=cf(e);break;case`key-pools`:n=uf(e);break;case`layers`:n=df(e);break;case`publishes`:n=ff(e);break;case`diagnostics`:n=pf(e);break;default:n=`<p>未知子页面</p>`}return`
  ...
  `}function sf(e){let t=e.tileSources||[],n=e.editingTileSource;if(n){let r=!t.some(e=>e.id===n.id),i=e.proxyOutbounds||[],a=e.proxyPools||[],o=e.keyPools||[],s=$d(n),c=n.category||`custom`,l=n.kind||`xyz-raster`;return`
      <div class="form-card">
        ...
        <form data-tile-sources-form="source">
          ...
          <div class="form-grid">
            ...
            <div class="field-group">
              <label>适配器</label>
              <input name="adapter" value="${Q(n.adapter||(Cd(l)?`maplibre-style`:`template`))}" placeholder="template / wmts-kvp / maplibre-style / pmtiles">
            </div>
          </div>
          <div class="form-grid">
            <div class="field-group">
    ...
    <table class="item-table">
      ...
      <tbody>
        ${t.map(t=>{let n=e[`test_source_${t.id}`]||``,r=Ed(t);return`
            <tr>
              <td>
              ...
              <td>
                ...
                <span class="badge-blue" style="margin-left:4px;">${Q(Sd(t.kind))}</span>
                <span class="badge-gray" style="margin-left:4px;">${Q(Nd(t))}</span>
              </td>
              <td>
              ...
              <td>
                ${ef(t.enabled,`source`,t.id,`启用中`,`已禁用`)}
              </td>
              <td>
                <div style="display: flex; flex-direction: column; align-items: flex-start; gap: 4px;">
                  ...
                  ${n&&n!==`loading`&&!n.success?`<span class="test-status test-fail" style="margin-left: 0;" title="${Q(yd(n))}">失败</span>`:``}
                </div>
              </td>
              <td>
  ...
  `}function cf(e){let t=e.sourcePresets||[],n=e.keyPools||[],r=e.creatingSourceFromPreset;if(r){let e=t.find(e=>e.presetId===r.presetId)||r,i=Ad(e,n),a=r.keyPoolId||i?.id||``,o=e.status===`ready`;return`
      <div class="form-card">
        ...
        <form data-tile-sources-form="preset-source">
          ...
          <div class="form-grid">
            <div class="field-group">
              <label>预设类型</label>
              <input value="${Q(`${e.vendor||`custom`} / ${Sd(e.kind)}`)}" readonly>
            </div>
            <div class="field-group">
              <label>关联密钥池</label>
              ...
              ${i?`<p style="color:#64748b; font-size:12px; margin:6px 0 0;">已自动匹配：${Q(i.name)} ${jd(i)}</p>`:``}
            </div>
          </div>
    ...
    <table class="item-table">
      ...
      <tbody>
        ${t.map(e=>{let t=Ed(e),r=Ad(e,n);return`
            <tr>
              <td>
                <strong>${Q(e.name)}</strong>
              ...
              <td>
                ...
                <span class="badge-blue" style="margin-left:4px;">${Q(Sd(e.kind))}</span>
              ...
              <td>
                ...
                ${r?`<div style="margin-top:4px;"><span class="badge-gray">${Q(r.name)}</span> ${jd(r)}</div>`:``}
              </td>
              <td>${Od(e.status)}</td>
              <td>
                ${Dd(e.cacheAllowedByLicense!==!1,`可缓存`,`禁缓存`)}
                ${Dd(!!e.publicUseAllowed,`可公开`,`慎公开`)}
              </td>
              <td>
  ...
  `}function lf(e,t=!1,n={}){return(e.keys||[]).map((r,i)=>{let a=n[`test_key_${e.id}_${r.id}`]||``,o=!r.hasSecret&&!r.maskedPreview,s=r.secretType||e.defaultSecretType||`api_key`,c=r.placement||e.defaultPlacement||`query`,l=r.paramName||e.defaultParamName||`key`;return`
      <div class="key-row" data-key-row="${i}">
        <div class="key-row-main">
          ...
          <select name="key_secretType">
            ${xd(s,[[`api_key`,`api_key`],[`token`,`token`],[`tk`,`tk`],[`ak`,`ak`],[`appid`,`appid`]])}
            ${bd([[`api_key`,`api_key`],[`token`,`token`],[`tk`,`tk`],[`ak`,`ak`],[`appid`,`appid`]],s)}
          </select>
        </div>
        <div class="key-row-main">
        ...
        <div class="flex-actions">
          ...
          ${a&&a!==`loading`&&!a.success?`<span class="test-status test-fail" title="${Q(yd(a))}">不可用</span>`:``}
        </div>
      </div>
    `}).join(``)||`<p style="color:#64748b;">暂无 Key，请添加至少一个 Key。</p>`}function uf(e){let t=e.keyPools||[],n=e.sourcePresets||[],r=e.tileSources||[],i=e.editingKeyPool;if(i){let a=!t.some(e=>e.id===i.id);return`
      <div class="form-card">
          ...
          <div class="form-grid">
            <div class="field-group">
              ...
              <select name="defaultSecretType">
                ${xd(i.defaultSecretType||`api_key`,[[`api_key`,`api_key`],[`token`,`token`],[`tk`,`tk`],[`ak`,`ak`],[`appid`,`appid`]])}
                ${bd([[`api_key`,`api_key`],[`token`,`token`],[`tk`,`tk`],[`ak`,`ak`],[`appid`,`appid`]],i.defaultSecretType||`api_key`)}
              </select>
            </div>
            <div class="field-group">
              ...
              <div style="display:grid; grid-template-columns: 1fr 1fr; gap:8px;">
                <select name="defaultPlacement">
                  ${bd(pd,i.defaultPlacement||`query`)}
                </select>
        ...
        ${t.map(t=>{let n=e[`test_key_pool_${t.id}`]||``,r=(t.keys||[]).filter(e=>e.enabled!==!1).length;return`
            <tr>
              <td>
                <strong>${Q(t.name)}</strong>
                <div style="color:#64748b; font-size:11px; margin-top:2px;">${Q(t.id)}</div>
                ${t.credentialUrl?`<div style="margin-top:4px;">${jd(t,`申请 / 管理 Key`)}</div>`:``}
              </td>
              <td>
                <span class="badge-gray">${Q(t.vendor)}</span>
                <span class="badge-blue" style="margin-left:4px;">${Q(md.find(([e])=>e===t.strategy)?.[1]||t.strategy)}</span>
              ...
              <td>
                ...
                ${n&&n!==`loading`&&!n.success?`<span class="test-status test-fail" title="${Q(yd(n))}">失败</span>`:``}
              </td>
              <td>${ef(t.enabled,`key-pool`,t.id,`启用中`,`已禁用`)}</td>
              <td>
                <div class="flex-actions">
  ...
  `}function df(e){let t=e.mapLayers||[],n=e.editingMapLayer;if(n){let r=!t.some(e=>e.id===n.id),i=e.tileSources||[],a=n.items||[{sourceId:``,opacity:1,zIndex:0}];return`
      <div class="form-card">
              ...
              ${a.map((e,t)=>`
                <div class="layer-item-row" data-layer-item-index="${t}">
                  ...
                  <select name="item_sourceId" required>
                    ...
                    ${i.map(t=>`<option value="${t.id}" ${e.sourceId===t.id?`selected`:``}>${Q(t.name)} (${t.id} / ${Sd(t.kind)})</option>`).join(``)}
                  </select>
      ...
      <tbody>
        ${t.map(t=>`
          <tr>
            ...
            <td>
              ${ef(t.enabled,`layer`,t.id,`启用中`,`已禁用`)}
            </td>
            <td>
  ...
  `}function ff(e){let t=e.externalPublishes||[],n=e.editingExternalPublish,r=e.selectedPublishId||t[0]?.id||``;if(n){let r=!t.some(e=>e.id===n.id),i=e.tileSources||[],a=i.filter(e=>e.visibility?.scope!==`external_only`&&e.permissions?.externalApiAllowed!==!1),o=i.filter(e=>e.visibility?.scope===`external_only`),s=e.mapLayers||[],c=e.proxyOutbounds||[],l=e.proxyPools||[],u=n.targetType||`source`,d=u===`layer`?s.map(e=>`<option value="${e.id}" ${n.targetId===e.id?`selected`:``}>${Q(e.name)} (${e.id})</option>`).join(``):u===`dedicated_source`?o.map(e=>`<option value="${e.id}" ${n.targetId===e.id?`selected`:``}>${Q(e.name)} (${e.id} / ${Sd(e.kind)})</option>`).join(``):a.map(e=>`<option value="${e.id}" ${n.targetId===e.id?`selected`:``}>${Q(e.name)} (${e.id} / ${Sd(e.kind)})</option>`).join(``),f=n.overrides?.proxy||null,p=n.overrides?.cache||null;return`
      <div class="form-card">
        ...
        <form data-tile-sources-form="publish">
          ...
          <div class="form-grid">
            ...
            <div class="field-group">
              ...
              <select name="targetId" required>
                <option value="">请选择${Q(Md(u))}</option>
                ${d}
              </select>
            </div>
          </div>
          ...
          <fieldset class="form-card" style="margin-top:15px; padding:15px; background:white;">
            ...
            ${Fd(f||{mode:`never`},c,l,`publish_proxy`)}
          </fieldset>
    ...
    `}let i=e.lastGeneratedToken?`<div class="admin-token-notice">
       ...
       </div>`:``,a=t.find(e=>e.id===r),o=``;return a&&(o=Pd(a,e)),`
    ${i}
      ...
      <tbody>
        ${t.map(t=>{let n=e[`test_publish_${t.id}`]||``;return`
            <tr style="background: ${t.id===r?`#f0fdfa`:`transparent`}; cursor:pointer;" data-tile-sources-select-publish="${t.id}">
              ...
              <td style="white-space: nowrap;"><span class="badge-gray">${Q(Md(t.targetType))}</span></td>
              ...
              <td style="white-space: nowrap;">
                ${ef(t.enabled,`publish`,t.id,`已发布`,`已禁用`)}
              </td>
              <td style="white-space: nowrap;">
    ...
    ${o}
  `}function pf(e){e.diagnosticsLogType=e.diagnosticsLogType||`source`;let t=e.diagnosticsPublishId||``,n=e.diagnosticsSourceId||``,r=e.externalPublishes||[],i=e.tileSources||[],a=e.diagnosticsLogType===`source`,o=a?e.sourceAccessLogs||[]:e.diagnosticLogs||[],s=a?e.sourceAccessLogsError||``:e.diagnosticLogsError||``;return`
    <div class="admin-panel-head">
      <h3>运行诊断日志</h3>
      <div style="display:flex; gap:10px; align-items:center;">
    ...
    `}else a=`
            ...
            ${t.map(t=>{let n=e[`test_outbound_${t.id}`]||``;return`
                <tr>
                  ...
                  <td>
                    ...
                    ${n&&n!==`loading`&&!n.success?`<span class="test-status test-fail" title="${Q(xf(n))}">失败: ${Q(xf(n))}</span>`:``}
                  </td>
                  <td>
      ...
      <div>
        ...
        <table class="item-table">
          ...
          <tbody>
            ${n.map(t=>{let n=e[`test_pool_${t.id}`]||``,r=n&&n!==`loading`?Sf(n):null;return`
                <tr>
                  <td>
                    <strong>${Q(t.name)}</strong>
                    <div style="color: #64748b; font-size:11px; margin-top:2px;">${Q(t.id)}</div>
  ...
  `).join(``)}function Pf(e,t,n=1){let r=e?.[t];return r==null||r===``?``:Number(r)/n}function Ff(e,t){return{...e.adminUserFilters,page:t,limit:e.adminUsers?.limit||20}}async function If(e,t,n=e.adminUsers?.page||1){e.adminUsers=await t.listUsers(Ff(e,n))}function Lf(e){let t=e.adminUsers||{items:[]},n=t.items||[],r=e.roles||[],i=Xl(e,`admin.user.manage`),a=Xl(e,`admin.role.manage`),o=e.adminUserFilters||{};return`
        ...
        <form class="admin-filter-form" data-admin-users-filter>
          ...
          <label>
            ...
            <select name="status">
              ...
              ${jf.map(([e,t])=>`<option value="${e}" ${o.status===e?`selected`:``}>${t}</option>`).join(``)}
            </select>
          </label>
          <label>
            <span>角色</span>
            ...
            <tbody>
              ${n.map(e=>`
                <tr>
                  ...
                  <td>
                    <span class="admin-state-pill is-${Q(e.status)}">${Q(Mf(e.status))}</span>
                  ...
                  <td>
                    <small class="admin-cell-secondary">登录：${Q(Yl(e.lastLoginAt))}</small>
                    <small class="admin-cell-secondary">创建：${Q(Yl(e.createdAt))}</small>
                  </td>
                  <td>
                    ...
                    ${i?`
                      <details class="admin-inline-details">
                        ...
                        <form class="admin-user-edit-form" data-admin-user-edit data-user-id="${Q(e.id)}">
                          ...
                          <label>
                            <span>账号状态</span>
                            <select name="status">${jf.map(([t,n])=>`<option value="${t}" ${e.status===t?`selected`:``}>${n}</option>`).join(``)}</select>
                          </label>
                          ...
                          <fieldset>
                            ...
                            <label><span>KML 文件数</span><input name="maxKmlFiles" type="number" min="1" max="10000" value="${Pf(e.quota,`maxKmlFiles`)}"></label>
                            <label><span>单文件上限（MB）</span><input name="maxKmlFileMb" type="number" min="1" max="100" value="${Pf(e.quota,`maxKmlFileBytes`,1024*1024)}"></label>
                            <label><span>单文件要素数</span><input name="maxFeaturesPerKml" type="number" min="1" max="1000000" value="${Pf(e.quota,`maxFeaturesPerKml`)}"></label>
                            <label><span>总要素数</span><input name="maxFeaturesPerUser" type="number" min="1" max="5000000" value="${Pf(e.quota,`maxFeaturesPerUser`)}"></label>
                            <label><span>回收站天数</span><input name="trashRetentionDays" type="number" min="1" max="3650" value="${Pf(e.quota,`trashRetentionDays`)}"></label>
                          </fieldset>
          ...
          <form class="admin-form admin-user-create-form" data-admin-user-create autocomplete="off">
            ...
            ${a?`
              <fieldset class="admin-permission-fieldset">
                <legend>初始角色</legend>
                <div class="admin-checkbox-grid">${Nf(r,[`user`])}</div>
              </fieldset>
            `:``}
  ...
  `}async function Rf({api:e,event:t,renderDashboard:n,setNotice:r,state:i}){let a=t.target.closest(`[data-admin-users-filter]`);if(a){t.preventDefault();let o=new FormData(a);i.adminUserFilters={search:String(o.get(`search`)||``).trim(),status:String(o.get(`status`)||``),role:String(o.get(`role`)||``)};try{r(`正在筛选用户...`),await If(i,e,1),r(``)}catch(e){r(``,e.message)}return n(),!0}let o=t.target.closest(`[data-admin-user-create]`);if(o){t.preventDefault();let a=new FormData(o),s={username:String(a.get(`username`)||``).trim(),displayName:String(a.get(`displayName`)||``).trim(),email:String(a.get(`email`)||``).trim(),roles:a.getAll(`roles`).map(String)},c=String(a.get(`password`)||``);c&&(s.password=c),s.roles.length||(s.roles=[`user`]);try{r(`正在创建用户...`);let t=await Af(e,()=>e.createUser(s));await If(i,e,1),o.reset(),r(`用户创建成功`),n(),await De(`用户名：${t.user?.username||s.username}\n临时密码：${t.temporaryPassword}\n请通过安全渠道交付，关闭后将不再显示。`,{title:`临时密码（仅显示一次）`,confirmText:`我已安全保存`})}catch(e){r(``,e.code===`ACTION_CANCELLED`?``:e.message),n()}return!0}let s=t.target.closest(`[data-admin-user-roles]`);if(s){t.preventDefault();let a=new FormData(s).getAll(`roles`).map(String);if(!a.length)return r(``,`用户至少需要一个角色`),!0;try{r(`正在更新用户角色...`),await Af(e,()=>e.updateUserRoles(s.dataset.userId,a)),await If(i,e),r(`角色已更新，用户原有会话已失效`)}catch(e){r(``,e.code===`ACTION_CANCELLED`?``:e.message)}return n(),!0}let c=t.target.closest(`[data-admin-user-edit]`);if(c){t.preventDefault();let a=new FormData(c),o={},s=!1;if([[`maxKmlFiles`,1],[`maxKmlFileBytes`,1024*1024,`maxKmlFileMb`],[`maxFeaturesPerKml`,1],[`maxFeaturesPerUser`,1],[`trashRetentionDays`,1]].forEach(([e,t,n=e])=>{let r=String(a.get(n)||``).trim();if(!r)return;let i=Number(r);if(!Number.isFinite(i)||i<=0){s=!0;return}o[e]=Math.round(i*t)}),s)return r(``,`个人配额必须为大于 0 的数字，或留空继承系统默认`),!0;let l={displayName:String(a.get(`displayName`)||``).trim(),status:String(a.get(`status`)||``),quota:o};a.get(`replaceEmail`)&&(l.email=String(a.get(`email`)||``).trim());try{r(`正在更新用户资料与配额...`),await Af(e,()=>e.updateUser(c.dataset.userId,l)),await If(i,e),r(`用户资料与配额已更新`)}catch(e){r(``,e.code===`ACTION_CANCELLED`?``:e.message)}return n(),!0}return!1}async function zf({api:e,event:t,renderDashboard:n,setNotice:r,showConfirm:i,state:a}){let o=t.target.closest(`[data-admin-action]`);if(!o)return!1;let s=o.dataset.adminAction,c=o.dataset.userId;if(s===`users-page`){let t=Number(o.dataset.page||1);if(t<1)return!0;try{r(`正在加载用户...`),await If(a,e,t),r(``)}catch(e){r(``,e.message)}return n(),!0}let l=(a.adminUsers?.items||[]).find(e=>e.id===c);if(!l)return!1;if(s===`reset-user-password`){if(!await i(`确认重置用户“${l.username}”的密码？其全部会话将立即失效。`,{title:`重置用户密码`,confirmText:`确认重置`}))return!0;try{r(`正在重置密码...`);let t=await Af(e,()=>e.resetUserPassword(c));await If(a,e),r(`密码已重置`),n(),await De(`临时密码：${t.temporaryPassword}\n请通过安全渠道交付，关闭后将不再显示。`,{title:`临时密码（仅显示一次）`,confirmText:`我已安全保存`})}catch(e){r(``,e.code===`ACTION_CANCELLED`?``:e.message),n()}return!0}if(s===`revoke-user-sessions`){if(!await i(`确认强制退出用户“${l.username}”的所有登录会话？`,{title:`强制退出`,confirmText:`确认退出全部会话`}))return!0;try{r(`正在注销用户会话...`);let t=await e.revokeUserSessions(c);r(`已注销 ${Number(t.revokedCount||0)} 个会话`)}catch(e){r(``,e.message)}return n(),!0}return!1}var Bf=Object.freeze([[`account.self.read`,`查看个人账号`],[`account.self.update`,`修改个人账号`],[`session.self.manage`,`管理个人会话`],[`kml.own.read`,`查看个人 KML`],[`kml.own.write`,`管理个人 KML`],[`share.own.manage`,`管理个人分享`],[`favorite.own.manage`,`管理个人收藏`],[`admin.overview.read`,`查看后台概览`],[`admin.cache.manage`,`管理缓存`],[`admin.precache.manage`,`管理预缓存任务`],[`admin.layer.manage`,`管理图源、图层和代理`],[`admin.public_kml.manage`,`管理公共 KML 图层`],[`admin.share.moderate`,`治理用户分享`],[`admin.audit.read`,`查看审计日志`],[`admin.user.read`,`查看用户列表`],[`admin.user.manage`,`管理用户`],[`admin.role.manage`,`管理角色和权限`],[`admin.registration.manage`,`管理注册策略`],[`admin.security.manage`,`管理安全策略`],[`kml.any.read`,`读取任意用户 KML`],[`kml.any.manage`,`管理任意用户 KML`]]);function Vf(e){return e.startsWith(`admin.`)?`后台管理`:e.startsWith(`kml.any.`)?`跨用户数据`:`个人能力`}function Hf(e=[],t=``){let n=new Set(e),r=new Map;return Bf.forEach(([e,t])=>{let n=Vf(e);r.has(n)||r.set(n,[]),r.get(n).push([e,t])}),[...r.entries()].map(([e,t])=>`
    <fieldset class="admin-permission-fieldset">
      <legend>${Q(e)}</legend>
  ...
  `}function Wf(e){let t=e.roles||[];return`
    <div class="admin-user-system-stack">
      <section class="admin-panel">
        <div class="admin-panel-head">
          <div>
        ...
        <div class="admin-role-grid">
          ${t.filter(e=>e.builtIn).map(Uf).join(``)||`<p class="admin-empty">暂无内置角色数据</p>`}
        </div>
      </section>
  ...
  `}function Gf(e,t=!1){let n=new FormData(e),r={name:String(n.get(`name`)||``).trim(),description:String(n.get(`description`)||``).trim(),permissions:n.getAll(`permissions`).map(String)};return t&&(r.code=String(n.get(`code`)||``).trim().toLowerCase()),r}async function Kf({api:e,event:t,renderDashboard:n,setNotice:r,state:i}){let a=t.target.closest(`[data-admin-role-create]`);if(a){t.preventDefault();try{r(`正在创建角色...`),await Af(e,()=>e.createRole(Gf(a,!0))),i.roles=await e.listRoles(),r(`角色已创建`)}catch(e){r(``,e.code===`ACTION_CANCELLED`?``:e.message)}return n(),!0}let o=t.target.closest(`[data-admin-role-edit]`);if(o){t.preventDefault();try{r(`正在保存角色...`),await Af(e,()=>e.updateRole(o.dataset.roleId,Gf(o))),i.roles=await e.listRoles(),r(`角色已更新，受影响用户需重新登录`)}catch(e){r(``,e.code===`ACTION_CANCELLED`?``:e.message)}return n(),!0}return!1}async function qf({api:e,event:t,renderDashboard:n,setNotice:r,showConfirm:i,state:a}){let o=t.target.closest(`[data-admin-action="delete-role"]`);if(!o)return!1;if(!await i(`确认删除自定义角色“${o.dataset.roleName||``}”？`,{title:`删除角色`,confirmText:`确认删除`}))return!0;try{r(`正在删除角色...`),await Af(e,()=>e.deleteRole(o.dataset.roleId)),a.roles=await e.listRoles(),r(`角色已删除`)}catch(e){r(``,e.code===`ACTION_CANCELLED`?``:e.message)}return n(),!0}var Jf=60*1e3,Yf=60*Jf,Xf=24*Yf;function Zf(e,t=1){let n=Number(e||0)/t;return Number.isFinite(n)?n:0}function Qf(e){return(e.roles||[]).filter(e=>{let t=e.permissions||[];return e.code===`user`||!t.some(e=>e.startsWith(`admin.`)||e.startsWith(`kml.any.`)||e===`system.super_admin`)})}function $f(e){return(e?.session?.user?.permissions||e?.session?.permissions||[]).includes(`system.super_admin`)}function ep(e){let t=e.userSystemSettings||{},n=t.registration||{},r=t.session||{},i=t.quota||{},a=t.share||{},o=Xl(e,`admin.registration.manage`),s=Xl(e,`admin.security.manage`),c=$f(e),l=Qf(e),u=new Set(n.defaultRoleCodes||[`user`]);return`
    <div class="admin-user-system-stack">
      ...
      ${s?`
        <section class="admin-panel">
          ...
          <form class="admin-form" data-admin-user-security-settings>
            <div class="admin-field-grid admin-field-grid-three">
              <label><span>普通会话有效期（天）</span><input name="sessionTtlDays" type="number" min="1" max="30" step="1" value="${Zf(r.ttlMs,Xf)}" required></label>
              <label><span>记住登录有效期（天）</span><input name="rememberTtlDays" type="number" min="1" max="90" step="1" value="${Zf(r.rememberTtlMs,Xf)}" required></label>
              <label><span>高风险操作再验证窗口（分钟）</span><input name="reauthMinutes" type="number" min="1" max="60" step="1" value="${Zf(r.reauthWindowMs,Jf)}" required></label>
            </div>
            ...
            <fieldset class="admin-permission-fieldset">
              ...
              <div class="admin-field-grid admin-field-grid-three">
                ...
                <label><span>单个 KML 上限（MB）</span><input name="maxKmlFileMb" type="number" min="1" max="100" value="${Zf(i.maxKmlFileBytes,1024*1024)}" required></label>
            ...
            <fieldset class="admin-permission-fieldset">
              ...
              <div class="admin-field-grid admin-field-grid-three">
                ...
                <label><span>分享密码授权有效期（小时）</span><input name="shareAccessHours" type="number" min="1" max="168" value="${Zf(a.accessTtlMs,Yf)}" required></label>
              </div>
            </fieldset>
            ${c?`
              <fieldset class="admin-permission-fieldset">
  ...
  `}function tp(e,t){return Number.parseInt(String(e.get(t)||``),10)}function np(e,t){return Number(e.get(t))}var rp=[`spatialAccessEnabled`,`spatialPaddingMeters`,`spatialMaxAreaKm2`,`spatialMaxDiagonalKm`,`unlimitedAccessEnabled`,`unlimitedAccessMaxAreaKm2`,`unlimitedAccessMaxDiagonalKm`];function ip(e={},t={}){return rp.some(n=>t[n]===void 0?!1:Number.isFinite(Number(t[n]))&&Number.isFinite(Number(e[n]))?Number(t[n])!==Number(e[n]):t[n]!==e[n])}function ap(e={},t={}){return e.spatialAccessEnabled===!0&&t.spatialAccessEnabled===!1||e.unlimitedAccessEnabled===!0&&t.unlimitedAccessEnabled===!1||Number(t.spatialPaddingMeters)>Number(e.spatialPaddingMeters)?!0:[`spatialMaxAreaKm2`,`spatialMaxDiagonalKm`,`unlimitedAccessMaxAreaKm2`,`unlimitedAccessMaxDiagonalKm`].some(n=>Number(t[n])<Number(e[n]))}async function op({api:e,event:t,renderDashboard:n,setNotice:r,showConfirm:i,state:a}){let o=t.target.closest(`[data-admin-registration-settings]`);if(o){t.preventDefault();let i=new FormData(o),s=[...new Set(i.getAll(`defaultRoleCodes`).map(String))];try{r(`正在保存注册策略...`),a.userSystemSettings=await Af(e,()=>e.updateUserSystemSettings({registration:{mode:String(i.get(`mode`)||`closed`),defaultRoleCodes:s}})),r(`注册策略已更新`)}catch(e){r(``,e.code===`ACTION_CANCELLED`?``:e.message)}return n(),!0}let s=t.target.closest(`[data-admin-user-security-settings]`);if(s){t.preventDefault();let o=new FormData(s),c={session:{ttlMs:tp(o,`sessionTtlDays`)*Xf,rememberTtlMs:tp(o,`rememberTtlDays`)*Xf,reauthWindowMs:tp(o,`reauthMinutes`)*Jf},quota:{maxKmlFiles:tp(o,`maxKmlFiles`),maxKmlFileBytes:tp(o,`maxKmlFileMb`)*1024*1024,maxFeaturesPerKml:tp(o,`maxFeaturesPerKml`),maxFeaturesPerUser:tp(o,`maxFeaturesPerUser`),trashRetentionDays:tp(o,`trashRetentionDays`)},share:{publicAccessPolicy:String(o.get(`publicAccessPolicy`)||`inherit_site_access`),maxFilesPerShare:tp(o,`maxFilesPerShare`),accessTtlMs:tp(o,`shareAccessHours`)*Yf}};if($f(a)){let e=np(o,`spatialMaxAreaKm2`),t=np(o,`spatialMaxDiagonalKm`),i=np(o,`unlimitedAccessMaxAreaKm2`),a=np(o,`unlimitedAccessMaxDiagonalKm`);if(![e,t,i,a].every(Number.isFinite))return r(``,`空间策略阈值必须是有效数字`),n(),!0;if(i>e||a>t)return r(``,`不限授权阈值不能大于空间限制总体阈值`),n(),!0;c.share.spatialAccessEnabled=o.get(`spatialAccessEnabled`)===`true`,c.share.spatialPaddingMeters=np(o,`spatialPaddingMeters`),c.share.spatialMaxAreaKm2=e,c.share.spatialMaxDiagonalKm=t,c.share.unlimitedAccessEnabled=o.get(`unlimitedAccessEnabled`)===`true`,c.share.unlimitedAccessMaxAreaKm2=i,c.share.unlimitedAccessMaxDiagonalKm=a}try{let t=a.userSystemSettings?.share||{};if($f(a)&&ip(t,c.share)){r(`正在评估空间策略影响...`);let a=(await Af(e,()=>e.previewUserSystemSettings(c))).sharePolicyImpact||{},o=Number(a.affectedShares||0),s=Number(a.revokedUnlimitedSessions||0),l=Number(a.downgradedShares||0);if((ap(t,c.share)||o>0||s>0||l>0)&&!(!(i instanceof Function)||await i(`本次策略变更将重新评估 ${o} 个分享，降级 ${l} 个分享，并撤销 ${s} 个不限授权会话。是否继续？`,{title:`确认空间策略变更`,confirmText:`继续保存`})))return r(``),n(),!0}r(`正在保存用户体系策略...`),a.userSystemSettings=await Af(e,()=>e.updateUserSystemSettings(c));let o=a.userSystemSettings.sharePolicyImpact;r(o?`用户体系策略已更新；影响 ${Number(o.affectedShares||0)} 个分享，降级 ${Number(o.downgradedShares||0)} 个，撤销长期授权 ${Number(o.revokedUnlimitedSessions||0)} 个`:`用户体系策略已更新`)}catch(e){r(``,e.code===`ACTION_CANCELLED`?``:e.message)}return n(),!0}return!1}var sp=[[`active`,`有效`],[`paused`,`已暂停`],[`blocked`,`已封禁`],[`expired`,`已过期`],[`revoked`,`已撤销`],[`draft`,`草稿`]];function cp(e){return sp.find(([t])=>t===e)?.[1]||e||`-`}function lp(e){return e?.spatialAccess?.mode===`kml_bounds`?`限制在 KML 区域`:`不限制地图范围`}function up(e){return{ready:`范围正常`,empty:`范围为空`,error:`范围异常`,out_of_policy:`超出策略`}[e?.spatialAccess?.status]||`未启用`}function dp(e){return e?.passwordProtected?e.passwordAccess?.ttlMode===`unlimited`?`不限授权`:`有限授权`:`无密码`}function fp(e,t){if(e==null||e===``)return``;let n=Number(e);return Number.isFinite(n)?`${n.toFixed(1)} ${t}`:``}function pp(e,t){return{...e.shareFilters,page:t,limit:e.moderatedShares?.limit||20}}async function mp(e,t,n=e.moderatedShares?.page||1){e.moderatedShares=await t.listUserShares(pp(e,n))}function hp(e){let t=e.moderatedShares||{items:[]},n=e.shareFilters||{};return`
    <div class="admin-user-system-stack">
      <section class="admin-panel">
        <div class="admin-panel-head">
          <div>
            ...
            <tbody>
              ${(t.items||[]).map(e=>`
                <tr>
                  ...
                  <td>
                    <small class="admin-cell-secondary">地图：${Q(lp(e))}</small>
                    <small class="admin-cell-secondary">范围：${Q(up(e))}</small>
                    ${e.spatialAccess?.mode===`kml_bounds`?`<small class="admin-cell-secondary">${Q([fp(e.spatialAccess.areaKm2,`km²`),fp(e.spatialAccess.diagonalKm,`km`)].filter(Boolean).join(` · `)||`暂无范围摘要`)}</small>`:``}
                    <small class="admin-cell-secondary">密码：${Q(dp(e))}</small>
                  </td>
                  <td>
                    <small class="admin-cell-secondary">访问 ${Number(e.accessCount||0)} 次</small>
                    <small class="admin-cell-secondary">最近：${Q(Yl(e.lastAccessedAt))}</small>
                    <small class="admin-cell-secondary">到期：${Q(Yl(e.expiresAt))}</small>
                  </td>
                  <td>
                    <div class="admin-row-actions">
  ...
  `}async function gp({api:e,event:t,renderDashboard:n,setNotice:r,state:i}){let a=t.target.closest(`[data-admin-share-filter]`);if(!a)return!1;t.preventDefault();let o=new FormData(a);i.shareFilters={search:String(o.get(`search`)||``).trim(),status:String(o.get(`status`)||``)};try{r(`正在筛选分享...`),await mp(i,e,1),r(``)}catch(e){r(``,e.message)}return n(),!0}async function _p({api:e,event:t,renderDashboard:n,setNotice:r,showConfirm:i,state:a}){let o=t.target.closest(`[data-admin-action]`);if(!o)return!1;let s=o.dataset.adminAction;if(s===`shares-page`){let t=Number(o.dataset.page||1);if(t<1)return!0;try{r(`正在加载分享...`),await mp(a,e,t),r(``)}catch(e){r(``,e.message)}return n(),!0}if(s===`block-share`){let t=await Ae({title:`封禁分享：${o.dataset.shareTitle||``}`,fields:[{name:`reason`,label:`封禁原因`,type:`textarea`}],values:{reason:``},confirmText:`确认封禁`}),i=String(t?.reason||``).trim();if(!i)return!0;try{r(`正在封禁分享...`),await e.blockUserShare(o.dataset.shareId,i),await mp(a,e),r(`分享已封禁，公开访问立即失效`)}catch(e){r(``,e.message)}return n(),!0}if(s===`unblock-share`){if(!await i(`解除封禁后，分享将进入暂停状态，由所有者决定是否恢复公开。`,{title:`解除分享封禁`,confirmText:`解除封禁`}))return!0;try{r(`正在解除封禁...`),await e.unblockUserShare(o.dataset.shareId),await mp(a,e),r(`已解除封禁，分享当前为暂停状态`)}catch(e){r(``,e.message)}return n(),!0}return!1}function vp(e,t){return{...e.auditFilters,page:t,limit:e.auditLogs?.limit||20}}async function yp(e,t,n=e.auditLogs?.page||1){e.auditLogs=await t.listAuditLogs(vp(e,n))}function bp(e){try{let t=JSON.stringify(e||{},null,2);return t.length>4e3?`${t.slice(0,4e3)}\n…已截断`:t}catch{return`{}`}}function xp(e){let t=e.auditLogs||{items:[]},n=e.auditFilters||{};return`
    <div class="admin-user-system-stack">
      <section class="admin-panel">
        <div class="admin-panel-head">
          <div>
          ...
          ${(t.items||[]).map(e=>`
            <article class="admin-audit-entry">
              <header>
                ...
                <time datetime="${Q(e.createdAt||``)}">${Q(Yl(e.createdAt))}</time>
              </header>
              <dl>
  ...
  `}async function Sp({api:e,event:t,renderDashboard:n,setNotice:r,state:i}){let a=t.target.closest(`[data-admin-audit-filter]`);if(!a)return!1;t.preventDefault();let o=new FormData(a);i.auditFilters={action:String(o.get(`action`)||``).trim(),targetType:String(o.get(`targetType`)||``).trim()};try{r(`正在筛选审计日志...`),await yp(i,e,1),r(``)}catch(e){r(``,e.message)}return n(),!0}async function Cp({api:e,event:t,renderDashboard:n,setNotice:r,state:i}){let a=t.target.closest(`[data-admin-action="audit-page"]`);if(!a)return!1;let o=Number(a.dataset.page||1);if(o<1)return!0;try{r(`正在加载审计日志...`),await yp(i,e,o),r(``)}catch(e){r(``,e.message)}return n(),!0}function wp(e){let t=e?.user?.permissions||e?.permissions||[];return Array.isArray(t)?t:[]}function Tp(e,t){if(!t)return!!(e?.user||e?.username);let n=wp(e);return n.includes(`system.super_admin`)||n.includes(t)}function Ep(e,t){return e?e.permissions?e.permissions.some(e=>Tp(t,e)):Tp(t,e.permission):!1}function Dp(e,t){return e.filter(e=>Ep(e,t))}var Op=[{id:`overview`,label:`概览`,permission:`admin.overview.read`,render:$l},{id:`cache`,label:`缓存`,permission:`admin.cache.manage`,render:eu,handleClick:tu},{id:`kml`,label:`公共 KML`,permission:`admin.public_kml.manage`,render:nd,handleClick:rd,handleChange:id},{id:`precache`,label:`预缓存`,permission:`admin.precache.manage`,render:yu,afterRender:Zu,afterEnter:Fu,afterLoad:Fu,handleSubmit:zu,handleClick:Bu,handleChange:Vu},{id:`tile-sources`,label:`图源管理`,permission:`admin.layer.manage`,render:of,afterEnter:mf,afterLoad:mf,handleClick:vf,handleSubmit:yf,handleChange:bf},{id:`proxy`,label:`代理配置`,permission:`admin.layer.manage`,render:Cf,afterEnter:wf,afterLoad:wf,handleClick:Tf,handleSubmit:Ef,handleChange:Df},{id:`settings`,label:`站点设置`,permission:`admin.security.manage`,render:ed,handleSubmit:td},{id:`users`,label:`用户管理`,permission:`admin.user.read`,render:Lf,handleClick:zf,handleSubmit:Rf},{id:`roles`,label:`角色权限`,permission:`admin.role.manage`,render:Wf,handleClick:qf,handleSubmit:Kf},{id:`user-system`,label:`用户体系设置`,permissions:[`admin.registration.manage`,`admin.security.manage`],render:ep,handleSubmit:op},{id:`shares`,label:`分享治理`,permission:`admin.share.moderate`,render:hp,handleClick:_p,handleSubmit:gp},{id:`audit`,label:`审计日志`,permission:`admin.audit.read`,render:xp,handleClick:Cp,handleSubmit:Sp}];function kp(e){return Dp(Op,e)}function Ap(e){return`/admin/${jp(e).id}`}function jp(e){return Op.find(t=>t.id===e)||Op[0]}function Mp(e,t){let n=kp(t);return n.find(t=>t.id===e)||n[0]||null}function Np(e){return Op.some(t=>t.id===e)}function Pp(e){return e.pathname===`/admin`||e.pathname.startsWith(`/admin/`)||new URLSearchParams(e.search).get(`view`)===`admin`}function Fp(e){let[,t,n]=e.pathname.split(`/`);if(t===`admin`)return Np(n)?n:`overview`;let r=new URLSearchParams(e.search).get(`tab`);return Np(r)?r:`overview`}function Ip(e){if(!e.message&&!e.error&&!e.loading)return``;let t=e.error||e.message||`正在加载`,n=!!e.error,r=!e.error&&(e.message===`正在加载`||e.message===`正在登录`||e.loading);return`
  ...
  `}function Lp(e){e.root.innerHTML=`
  ...
  `}function Rp(e){let t=e.session?.user?.username||``;e.root.innerHTML=`
    <section class="admin-login">
  ...
  `}function zp(e,t){let n=kp(e.session),r=e.session?.user||{};e.root.innerHTML=`
    <section class="admin-shell">
      ...
      <div class="admin-layout">
        <nav class="admin-tabs" aria-label="后台导航">
          ${n.map(t=>`
            <a href="${Ap(t.id)}" data-admin-tab="${t.id}" class="${e.activeTab===t.id?`is-active`:``}">
              ${Q(t.label)}
            </a>
          `).join(``)}
        </nav>
  ...
  `}var $={root:null,activeTab:`overview`,loading:!1,message:``,error:``,session:null,system:null,cache:null,cacheLoading:!1,cacheError:``,visits:null,visitsLoading:!1,visitsError:``,settings:null,userSystemSettings:null,tasks:[],kmls:[],adminUsers:{items:[],page:1,limit:20,total:0},adminUserFilters:{search:``,status:``,role:``},roles:[],moderatedShares:{items:[],page:1,limit:20,total:0},shareFilters:{search:``,status:``},auditLogs:{items:[],page:1,limit:20,total:0},auditFilters:{action:``,targetType:``},precacheForm:{providerId:``,bounds:{west:113.24,south:23.11,east:113.29,north:23.15},minZoom:12,maxZoom:12,concurrency:4,requestIntervalMs:0,refresh:!1},precacheEstimate:null,precacheEstimateStatus:``,precacheEstimateError:``,expandedTaskIds:new Set,amapLoader:null,AMap:null,map:null,rectangle:null,precacheMapHeight:260},Bp=null;function Vp(e){Bp=e}function Hp(e=``,t=``){$.message=e,$.error=t,Bp&&Bp(e,t)}function Up(e){Np(e)&&($.activeTab=e)}var Wp=null;function Gp(){$.session?$.session.user?.mustChangePassword?Rp($):Zp():Lp($)}Vp((e,t)=>{Wp&&=(clearTimeout(Wp),null);let n=t||e;n&&n!==`正在加载`&&n!==`正在登录`&&(Wp=setTimeout(()=>{Hp(``),Gp()},4e3))});function Kp(){return Fp(window.location)}function qp(e){window.history.replaceState(null,``,`${Ap(e)}${window.location.hash}`)}function Jp(){return Mp($.activeTab,$.session)}function Yp(){let e=Jp();return e?(e.id!==$.activeTab&&(Up(e.id),qp(e.id)),e):null}function Xp(){let e=Yp();return e?e.render($):`
      <section class="admin-panel">
        <h2>无后台访问权限</h2>
        <p class="admin-panel-description">当前账号没有可用的管理权限，请联系超级管理员。</p>
      </section>
    `}function Zp(){zp($,Xp()),Jp()?.afterRender?.($,Z)}window.renderDashboard=Zp;function Qp(e){return{api:Z,event:e,renderDashboard:Zp,setNotice:Hp,showCheckboxConfirm:ke,showConfirm:Oe,state:$}}function $p(...e){$.session&&(!e.length||e.includes($.activeTab))&&Zp()}async function em(e,t){let n=Jp()?.[e];return n instanceof Function?!!await n(Qp(t)):!1}function tm(e){if(e?.authenticated===!1||!e?.user){let e=Error(`请先登录管理后台`);throw e.status=401,e.code=`AUTH_REQUIRED`,e}return e}async function nm(e={}){let t=!!e.cacheOnly,n=Tp($.session,`admin.cache.manage`),r=Tp($.session,`admin.overview.read`);Object.assign($,{cacheLoading:n,cacheError:``,visitsLoading:t?$.visitsLoading:r,visitsError:t?$.visitsError:``}),$p(`overview`,`cache`),n&&Z.cache().then(e=>{$.cache=e,$.cacheError=``,e.refreshing&&window.setTimeout(()=>nm({cacheOnly:!0}),1500)}).catch(e=>{$.cacheError=e.message}).finally(()=>{$.cacheLoading=!1,$p(`cache`)}),!(t||!r)&&Z.visits().then(e=>{$.visits=e,$.visitsError=``}).catch(e=>{$.visitsError=e.message}).finally(()=>{$.visitsLoading=!1,$p(`overview`)})}function rm(e){let t=e=>Tp($.session,e);t(`admin.overview.read`)&&e.push([`system`,()=>Z.system()]),t(`admin.security.manage`)&&e.push([`settings`,()=>Z.settings()]),t(`admin.precache.manage`)&&(e.push([`tasks`,()=>Z.tasks()]),e.push([`precacheCatalog`,()=>Z.precacheCatalog()])),t(`admin.public_kml.manage`)&&e.push([`kmls`,()=>Z.kmls()]),t(`admin.layer.manage`)&&e.push([`tileSources`,()=>Z.listTileSources()],[`sourcePresets`,()=>Z.listSourcePresets()],[`keyPools`,()=>Z.listKeyPools()],[`mapLayers`,()=>Z.listMapLayers()],[`proxyOutbounds`,()=>Z.listProxyOutbounds()],[`proxyPools`,()=>Z.listProxyPools()],[`externalPublishes`,()=>Z.listExternalPublishes()]),t(`admin.user.read`)&&e.push([`adminUsers`,()=>Z.listUsers({...$.adminUserFilters,page:1,limit:$.adminUsers.limit})]),t(`admin.role.manage`)&&e.push([`roles`,()=>Z.listRoles()]),(t(`admin.registration.manage`)||t(`admin.security.manage`))&&e.push([`userSystemSettings`,()=>Z.getUserSystemSettings()]),t(`admin.share.moderate`)&&e.push([`moderatedShares`,()=>Z.listUserShares({...$.shareFilters,page:1,limit:$.moderatedShares.limit})]),t(`admin.audit.read`)&&e.push([`auditLogs`,()=>Z.listAuditLogs({...$.auditFilters,page:1,limit:$.auditLogs.limit})])}async function im(){$.loading=!0,Hp(`正在加载`),$.session||Lp($);try{if($.session=tm(await Z.session()),$.session.user.mustChangePassword){$.loading=!1,Hp(``),Rp($);return}Yp();let e=[];rm(e),(await Promise.all(e.map(async([e,t])=>[e,await t()]))).forEach(([e,t])=>{$[e]=t}),$.loading=!1,Hp(``),Zp(),Jp()?.afterLoad?.($,Z),nm()}catch(e){$.loading=!1,e.status===401?($.session=null,Hp(``,e.message),Lp($)):(Hp(``,e.message),Gp())}}async function am(e){let t=e.target.closest(`[data-admin-login]`);if(t){e.preventDefault();let n={username:t.elements.username.value,password:t.elements.password.value,remember:!!t.elements.remember.checked};Hp(`正在登录`),Lp($);try{await Ul(n),Hp(``),await im()}catch(e){$.session=null,Hp(``,e.message),Lp($)}return}let n=e.target.closest(`[data-admin-required-password]`);if(n){e.preventDefault();let t=n.elements.currentPassword.value,r=n.elements.newPassword.value;if(r!==n.elements.confirmPassword.value){Hp(``,`两次输入的新密码不一致`),Rp($);return}try{Hp(`正在修改密码`),Rp($),await Z.updatePassword({currentPassword:t,newPassword:r}),$.session=null,Hp(`密码修改成功，正在加载后台`),await im()}catch(e){Hp(``,e.message),Rp($)}return}await em(`handleSubmit`,e)}async function om(e){let t=e.target.closest(`[data-admin-tab]`);if(t){e.preventDefault();let n=Mp(t.getAttribute(`data-admin-tab`),$.session);if(!n)return;Up(n.id),qp(n.id),Zp(),Jp()?.afterEnter?.($,Z);return}let n=e.target.closest(`[data-admin-action]`);if(n){let e=n.getAttribute(`data-admin-action`);if(e===`logout`){try{await Wl()}catch(e){if(e.status!==401){Hp(``,e.message),Gp();return}}$.session=null,Hp(``),Lp($);return}if(e===`refresh`){await im();return}if(e===`close-notice`){Hp(``),Gp();return}}await em(`handleClick`,e)}async function sm(e){await em(`handleChange`,e)}async function cm(e={}){document.body.classList.add(`admin-view`),Up(Kp()),$.amapLoader=e.amapLoader||null,$.root=document.getElementById(`admin-root`),$.root.hidden=!1,$.root.addEventListener(`submit`,am),$.root.addEventListener(`click`,om),$.root.addEventListener(`change`,sm),$.root.addEventListener(`input`,sm),Lp($),await im()}function lm(e){let t=e?.user?.permissions||[];return t.includes(`system.super_admin`)||t.some(e=>e.startsWith(`admin.`))}function um(e,t,n){if(!e)return;let r=n.authenticated?n.user?.displayName||n.user?.username||`用户`:`登录 / 注册`;e.dataset.authenticated=String(!!n.authenticated),e.setAttribute(`aria-label`,n.authenticated?`用户中心：${r}`:`登录或注册`),e.setAttribute(`title`,n.authenticated?`用户中心 · ${r}`:`登录 / 注册`);let i=e.querySelector(`[data-account-entry-label]`);i&&(i.textContent=n.authenticated?r:`登录`),t&&(t.hidden=!lm(n))}function dm(e={}){let t=e.button||document.querySelector(`[data-action="openAccount"]`),n=e.adminItem||document.querySelector(`[data-admin-identity-item]`),r=e=>um(t,n,e);r(Ia());let i=La(r);return za().catch(()=>r(Ia())),i}function fm(){`serviceWorker`in navigator&&window.addEventListener(`load`,()=>{navigator.serviceWorker.register(`/sw.js`).catch(e=>{console.warn(`Service Worker 注册失败`,e)})})}async function pm(e){let{init:t,title:n=`私有地图服务`,message:r=`管理员启用了访问控制，请输入密码解锁`,submitText:i=`载入地图`,loadingText:a=`正在验证...`}=e;try{(await Gl()).required?mm({init:t,title:n,message:r,submitText:i,loadingText:a}):await t()}catch(e){console.error(`Failed to check map access status`,e),mm({init:t,title:n,message:`访问状态检查失败，请稍后重试`,submitText:i,loadingText:a,allowRetry:!0})}}function mm(e){let{init:t,title:n,message:r,submitText:i,loadingText:a,allowRetry:o=!1}=e;document.getElementById(`map-lock-screen`)?.remove();let s=document.createElement(`div`);s.id=`map-lock-screen`,s.className=`lock-screen-backdrop`,s.innerHTML=`
    <div class="lock-screen-card">
      <div class="lock-screen-icon">🔒</div>
      <h2>${Q(n)}</h2>
      <p>${Q(r)}</p>
  ...
  `,document.body.appendChild(s);let c=document.getElementById(`lock-screen-form`),l=document.getElementById(`lock-screen-error`);s.querySelector(`[data-lock-retry]`)?.addEventListener(`click`,()=>{s.remove(),pm({init:t,title:n,submitText:i,loadingText:a})}),c.addEventListener(`submit`,async e=>{e.preventDefault(),l.style.display=`none`;let n=c.elements.password.value.trim();if(!n)return;let r=c.querySelector(`button[type="submit"]`);try{r.disabled=!0,r.textContent=a,await Kl(n),s.remove(),await t()}catch(e){r.disabled=!1,r.textContent=i,l.textContent=e.message||`访问密码错误`,l.style.display=`block`}})}export{mi as $,l as $t,Cs as A,$e as At,Io as B,P as Bt,qc as C,Tt as Ct,nl as D,et as Dt,$c as E,ut as Et,ds as F,ve as Ft,Ba as G,ee as Gt,bo as H,ie as Ht,is as I,ge as It,za as J,f as Jt,Va as K,ne as Kt,Ro as L,k as Lt,bs as M,je as Mt,fs as N,Oe as Nt,ws as O,Qe as Ot,ps as P,Ae as Pt,ka as Q,u as Qt,Po as R,j as Rt,Kc as S,St,Yc as T,Et as Tt,Ia as U,D as Ut,Mo as V,E as Vt,Wa as W,_ as Wt,La as X,o as Xt,Ha as Y,d as Yt,Aa as Z,s as Zt,_l as _,gt as _t,Pp as a,Rt as at,il as b,_t as bt,Vl as c,dt as ct,jl as d,jt as dt,xr as et,Sl as f,V as ft,ul as g,yt as gt,dl as h,Ot as ht,cm as i,qt as it,Ts as j,De as jt,Ss as k,ct as kt,Rl as l,ft as lt,fl as m,Dt as mt,fm as n,mr as nt,Q as o,Lt as ot,xl as p,Pt as pt,Ua as q,y as qt,dm as r,Xt as rt,Il as s,It as st,pm as t,Cr as tt,Al as u,kt as ut,gl as v,wt as vt,Jc as w,bt as wt,vc as x,H as xt,al as y,vt as yt,$o as z,N as zt};