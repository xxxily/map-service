...
`)}function hn(e){let t=String(e||``).toLowerCase();return/(?:picture|photo|image)/.test(t)?`image`:/video/.test(t)?`video`:/(?:sound|audio)/.test(t)?`audio`:``}function gn(e,t={}){let{references:n}=un(e?.description||``,t),r=n.flatMap((e,n)=>{let r=dn(e.url.toString(),{...t,index:n,typeHint:e.typeHint});return r.accepted?e.typeHint||r.item.type:[]}),i=hn(e?.styleUrl);return[...new Set([i,...r].filter(Boolean))]}function _n(e,t={}){return gn(e,t)[0]||``}var vn=new Set([`image`,`video`,`audio`,`iframe`]);function yn(e,t,n){let r=/description-link-(\d+)$/i.exec(String(e?.id||``));if(r)return Number(r[1]);let i=Number(e?.sortOrder);return Number.isFinite(i)?i:1e5+t*1e4+n}function bn(e,t){return e?e instanceof Map?e.get(t)||null:e[t]||null:null}function xn(e){try{return new URL(e).hostname}catch{return``}}function Sn(e,t,n={}){let r=t||fn(e,n.contentOptions),i=String(e?.name||``).trim()||`未命名点位`,a=String(e?.id||``),o=[];return(r?.groups||[]).forEach((t,n)=>{vn.has(t?.type)&&(t.items||[]).forEach((r,s)=>{let c=String(r?.title||``).trim();o.push({...r,title:c&&c!==xn(r?.url)?c:i,type:t.type,featureId:a,featureName:i,featureType:String(e?.type||``),sourceOrder:yn(r,n,s)})})}),o.sort((e,t)=>e.sourceOrder-t.sourceOrder),o.map((e,t)=>({...e,featureMediaIndex:t,galleryId:`${a||`feature`}:${e.id||e.type}:${t}`}))}function Cn(e,t={}){let n=Array.isArray(e?.features)?e.features:[],r=String(e?.id||``),i=String(e?.name||``).trim()||`未命名 KML`;return n.flatMap((e,n)=>{let a=String(e?.id||``);return Sn(e,bn(t.featureViews,a),t).map(e=>({...e,kmlId:r,kmlName:i,featureIndex:n}))}).map((e,t)=>({...e,galleryIndex:t}))}function wn(e,t={}){if(!Array.isArray(e)||!e.length)return 0;let n=String(t.featureId||``),r=String(t.id||``),i=String(t.url||``),a=String(t.type||``),o=Number(t.featureMediaIndex),s=e.findIndex(e=>n&&e.featureId!==n||a&&e.type!==a?!1:r&&e.id===r||i&&e.url===i&&(!a||e.type===a)||!r&&!i&&a?!0:Number.isInteger(o)&&e.featureMediaIndex===o);return s===-1&&n&&(s=e.findIndex(e=>e.featureId===n)),s===-1?0:s}function Tn(e,t={}){let n=Math.max(1,Number.parseInt(t.limit,10)||4),r=t.view||fn(e,t.contentOptions),i=Sn(e,r,t),a=i.length>n?Math.max(1,n-1):n,o=i.slice(0,a);return{items:o,overflowItem:i[o.length]||null,total:i.length,remaining:Math.max(0,i.length-a),contentSummary:r?.contentSummary||{}}}typeof window<`u`&&(window.NodeList&&!NodeList.prototype.forEach&&(NodeList.prototype.forEach=Array.prototype.forEach),typeof window.CustomEvent!=`function`&&(window.CustomEvent=function(e,t){t||={bubbles:!1,cancelable:!1,detail:null};var n=document.createEvent(`CustomEvent`);return n.initCustomEvent(e,t.bubbles,t.cancelable,t.detail),n}));var En=typeof document<`u`&&!!document.documentMode,Dn;function On(){return Dn||=document.createElement(`div`).style}var kn=[`webkit`,`moz`,`ms`],An={};function jn(e){if(An[e])return An[e];let t=On();if(e in t)return An[e]=e;let n=e[0].toUpperCase()+e.slice(1),r=kn.length;for(;r--;){let i=`${kn[r]}${n}`;if(i in t)return An[e]=i}}function Mn(e,t){return parseFloat(t[jn(e)])||0}function Nn(e,t,n=window.getComputedStyle(e)){let r=t===`border`?`Width`:``;return{left:Mn(`${t}Left${r}`,n),right:Mn(`${t}Right${r}`,n),top:Mn(`${t}Top${r}`,n),bottom:Mn(`${t}Bottom${r}`,n)}}function Pn(e,t,n){e.style[jn(t)]=n}function Fn(e,t){Pn(e,`transition`,`${jn(`transform`)} ${t.duration}ms ${t.easing}`)}function In(e,{x:t,y:n,scale:r,isSVG:i},a){if(Pn(e,`transform`,`scale(${r}) translate(${t}px, ${n}px)`),i&&En){let t=window.getComputedStyle(e).getPropertyValue(`transform`);e.setAttribute(`transform`,t)}}function Ln(e){let t=e.parentNode;(!t||t.nodeType!==1)&&(t=document.documentElement);let n=window.getComputedStyle(e),r=window.getComputedStyle(t),i=e.getBoundingClientRect(),a=t.getBoundingClientRect();return{elem:{style:n,width:i.width,height:i.height,top:i.top,bottom:i.bottom,left:i.left,right:i.right,margin:Nn(e,`margin`,n),border:Nn(e,`border`,n)},parent:{style:r,width:a.width,height:a.height,top:a.top,bottom:a.bottom,left:a.left,right:a.right,padding:Nn(t,`padding`,r),border:Nn(t,`border`,r)}}}var Rn={down:`mousedown`,move:`mousemove`,up:`mouseup mouseleave`};typeof window<`u`&&(typeof window.PointerEvent==`function`?Rn={down:`pointerdown`,move:`pointermove`,up:`pointerup pointerleave pointercancel`}:typeof window.TouchEvent==`function`&&(Rn={down:`touchstart`,move:`touchmove`,up:`touchend touchcancel`}));function zn(e,t,n,r){Rn[e].split(` `).forEach(e=>{t.addEventListener(e,n,r)})}function Bn(e,t,n){Rn[e].split(` `).forEach(e=>{t.removeEventListener(e,n)})}function Vn(e,t){let n=e.length;for(;n--;)if(e[n].pointerId===t.pointerId)return n;return-1}function Hn(e,t){let n;if(t.touches){n=0;for(let r of t.touches)r.pointerId=n++,Hn(e,r);return}n=Vn(e,t),n>-1&&e.splice(n,1),e.push(t)}function Un(e,t){if(t.touches){for(;e.length;)e.pop();return}let n=Vn(e,t);n>-1&&e.splice(n,1)}function Wn(e){e=e.slice(0);let t=e.pop(),n;for(;n=e.pop();)t={clientX:(n.clientX-t.clientX)/2+t.clientX,clientY:(n.clientY-t.clientY)/2+t.clientY};return t}function Gn(e){if(e.length<2)return 0;let t=e[0],n=e[1];return Math.sqrt(Math.abs(n.clientX-t.clientX)**2+Math.abs(n.clientY-t.clientY)**2)}function Kn(e){let t=e;for(;t&&t.parentNode;){if(t.parentNode===document)return!0;t=t.parentNode instanceof ShadowRoot?t.parentNode.host:t.parentNode}return!1}function qn(e){return(e.getAttribute(`class`)||``).trim()}function Jn(e,t){return e.nodeType===1&&` ${qn(e)} `.indexOf(` ${t} `)>-1}function Yn(e,t){for(let n=e;n!=null;n=n.parentNode)if(Jn(n,t.excludeClass)||t.exclude.indexOf(n)>-1)return!0;return!1}var Xn=/^http:[\w\.\/]+svg$/;function Zn(e){return Xn.test(e.namespaceURI)&&e.nodeName.toLowerCase()!==`svg`}function Qn(e){let t={};for(let n in e)e.hasOwnProperty(n)&&(t[n]=e[n]);return t}var $n={animate:!1,canvas:!1,cursor:`move`,disablePan:!1,disableZoom:!1,disableXAxis:!1,disableYAxis:!1,duration:200,easing:`ease-in-out`,exclude:[],excludeClass:`panzoom-exclude`,handleStartEvent:e=>{e.preventDefault(),e.stopPropagation()},maxScale:4,minScale:.125,overflow:`hidden`,panOnlyWhenZoomed:!1,pinchAndPan:!1,relative:!1,setTransform:In,startX:0,startY:0,startScale:1,step:.3,touchAction:`none`};function er(e,t){if(!e)throw Error(`Panzoom requires an element as an argument`);if(e.nodeType!==1)throw Error(`Panzoom requires an element with a nodeType of 1`);if(!Kn(e))throw Error(`Panzoom should be called on elements that have been attached to the DOM`);t={...$n,...t};let n=Zn(e),r=e.parentNode;r.style.overflow=t.overflow,r.style.userSelect=`none`,r.style.touchAction=t.touchAction,(t.canvas?r:e).style.cursor=t.cursor,e.style.userSelect=`none`,e.style.touchAction=t.touchAction,Pn(e,`transformOrigin`,typeof t.origin==`string`?t.origin:n?`0 0`:`50% 50%`);function i(){r.style.overflow=``,r.style.userSelect=``,r.style.touchAction=``,r.style.cursor=``,e.style.cursor=``,e.style.userSelect=``,e.style.touchAction=``,Pn(e,`transformOrigin`,``)}function a(n={}){for(let e in n)n.hasOwnProperty(e)&&(t[e]=n[e]);(n.hasOwnProperty(`cursor`)||n.hasOwnProperty(`canvas`))&&(r.style.cursor=e.style.cursor=``,(t.canvas?r:e).style.cursor=t.cursor),n.hasOwnProperty(`overflow`)&&(r.style.overflow=n.overflow),n.hasOwnProperty(`touchAction`)&&(r.style.touchAction=n.touchAction,e.style.touchAction=n.touchAction)}let o=0,s=0,c=1,l=!1;h(t.startScale,{animate:!1,force:!0}),setTimeout(()=>{m(t.startX,t.startY,{animate:!1,force:!0})});function u(t,n,r){if(r.silent)return;let i=new CustomEvent(t,{detail:n});e.dispatchEvent(i)}function d(t,r,i){let a={x:o,y:s,scale:c,isSVG:n,originalEvent:i};return requestAnimationFrame(()=>{typeof r.animate==`boolean`&&(r.animate?Fn(e,r):Pn(e,`transition`,`none`)),r.setTransform(e,a,r),u(t,a,r),u(`panzoomchange`,a,r)}),a}function f(n,r,i,a){let l={...t,...a},u={x:o,y:s,opts:l};if(!a?.force&&(l.disablePan||l.panOnlyWhenZoomed&&c===l.startScale))return u;if(n=parseFloat(n),r=parseFloat(r),l.disableXAxis||(u.x=(l.relative?o:0)+n),l.disableYAxis||(u.y=(l.relative?s:0)+r),l.contain){let t=Ln(e),n=t.elem.width/c,r=t.elem.height/c,a=n*i,o=r*i,s=(a-n)/2,d=(o-r)/2;if(l.contain===`inside`){let e=(-t.elem.margin.left-t.parent.padding.left+s)/i,n=(t.parent.width-a-t.parent.padding.left-t.elem.margin.left-t.parent.border.left-t.parent.border.right+s)/i;u.x=Math.max(Math.min(u.x,n),e);let r=(-t.elem.margin.top-t.parent.padding.top+d)/i,c=(t.parent.height-o-t.parent.padding.top-t.elem.margin.top-t.parent.border.top-t.parent.border.bottom+d)/i;u.y=Math.max(Math.min(u.y,c),r)}else if(l.contain===`outside`){let e=(-(a-t.parent.width)-t.parent.padding.left-t.parent.border.left-t.parent.border.right+s)/i,n=(s-t.parent.padding.left)/i;u.x=Math.max(Math.min(u.x,n),e);let r=(-(o-t.parent.height)-t.parent.padding.top-t.parent.border.top-t.parent.border.bottom+d)/i,c=(d-t.parent.padding.top)/i;u.y=Math.max(Math.min(u.y,c),r)}}return l.roundPixels&&(u.x=Math.round(u.x),u.y=Math.round(u.y)),u}function p(n,r){let i={...t,...r},a={scale:c,opts:i};if(!r?.force&&i.disableZoom)return a;let o=t.minScale,s=t.maxScale;if(i.contain){let n=Ln(e),r=n.elem.width/c,i=n.elem.height/c;if(r>1&&i>1){let e=n.parent.width-n.parent.border.left-n.parent.border.right,a=n.parent.height-n.parent.border.top-n.parent.border.bottom,c=e/r,l=a/i;t.contain===`inside`?s=Math.min(s,c,l):t.contain===`outside`&&(o=Math.max(o,c,l))}}return a.scale=Math.min(Math.max(n,o),s),a}function m(e,t,r,i){let a=f(e,t,c,r);return o!==a.x||s!==a.y?(o=a.x,s=a.y,d(`panzoompan`,a.opts,i)):{x:o,y:s,scale:c,isSVG:n,originalEvent:i}}function h(e,t,n){let r=p(e,t),i=r.opts;if(!t?.force&&i.disableZoom)return;e=r.scale;let a=o,l=s;if(i.focal){let t=i.focal;a=(t.x/e-t.x/c+o*e)/e,l=(t.y/e-t.y/c+s*e)/e}let u=f(a,l,e,{relative:!1,force:!0});return o=u.x,s=u.y,c=e,d(`panzoomzoom`,i,n)}function g(e,n){let r={...t,animate:!0,...n};return h(c*Math.exp((e?1:-1)*r.step),r)}function _(e){return g(!0,e)}function ee(e){return g(!1,e)}function v(t,r,i,a){let o=Ln(e),s={width:o.parent.width-o.parent.padding.left-o.parent.padding.right-o.parent.border.left-o.parent.border.right,height:o.parent.height-o.parent.padding.top-o.parent.padding.bottom-o.parent.border.top-o.parent.border.bottom},l=r.clientX-o.parent.left-o.parent.padding.left-o.parent.border.left-o.elem.margin.left,u=r.clientY-o.parent.top-o.parent.padding.top-o.parent.border.top-o.elem.margin.top;n||(l-=o.elem.width/c/2,u-=o.elem.height/c/2);let d={x:l/s.width*(s.width*t),y:u/s.height*(s.height*t)};return h(t,{...i,animate:!1,focal:d},a)}function te(e,n){e.preventDefault();let r={...t,...n,animate:!1},i=(e.deltaY===0&&e.deltaX?e.deltaX:e.deltaY)<0?1:-1,a=p(c*Math.exp(i*r.step/3),r).scale;return v(a,e,r,e)}function ne(e){let n={...t,animate:!0,force:!0,...e};c=p(n.startScale,n).scale;let r=f(n.startX,n.startY,c,n);return o=r.x,s=r.y,d(`panzoomreset`,n)}let re,y,b,x,S,ie,C=[];function ae(e){if(Yn(e.target,t))return;Hn(C,e),l=!0,t.handleStartEvent(e),re=o,y=s,u(`panzoomstart`,{x:o,y:s,scale:c,isSVG:n,originalEvent:e},t);let r=Wn(C);b=r.clientX,x=r.clientY,S=c,ie=Gn(C)}function w(e){if(!l||re===void 0||y===void 0||b===void 0||x===void 0)return;Hn(C,e);let n=Wn(C),r=C.length>1,i=c;r&&(ie===0&&(ie=Gn(C)),i=p((Gn(C)-ie)*t.step/80+S).scale,v(i,n,{animate:!1},e)),(!r||t.pinchAndPan)&&m(re+(n.clientX-b)/i,y+(n.clientY-x)/i,{animate:!1},e)}function T(e){C.length===1&&u(`panzoomend`,{x:o,y:s,scale:c,isSVG:n,originalEvent:e},t),Un(C,e),l&&(l=!1,re=y=b=x=void 0)}let E=!1;function oe(){E||(E=!0,zn(`down`,t.canvas?r:e,ae),zn(`move`,document,w,{passive:!0}),zn(`up`,document,T,{passive:!0}))}function D(){E=!1,Bn(`down`,t.canvas?r:e,ae),Bn(`move`,document,w),Bn(`up`,document,T)}return t.noBind||oe(),{bind:oe,destroy:D,eventNames:Rn,getPan:()=>({x:o,y:s}),getScale:()=>c,getOptions:()=>Qn(t),handleDown:ae,handleMove:w,handleUp:T,pan:m,reset:ne,resetStyle:i,setOptions:a,setStyle:(t,n)=>Pn(e,t,n),zoom:h,zoomIn:_,zoomOut:ee,zoomToPoint:v,zoomWithWheel:te}}er.defaultOptions=$n;var tr=new Set([`image`,`video`,`audio`,`iframe`]);function nr(e,t){let n=Math.max(0,Number.parseInt(t,10)||0);return n?((Number.parseInt(e,10)||0)%n+n)%n:0}function rr(e){let t=Number(e);return Number.isFinite(t)?Math.min(6,Math.max(1,t)):1}function ir(e,t=``){return Array.isArray(e)?e.flatMap(e=>{let n=String(e?.type||``)||t,r=String(e?.url||``).trim();return!tr.has(n)||!/^https:\/\//i.test(r)?[]:[{...e,type:n,url:r}]}):[]}var ar=`modulepreload`,or=function(e){return`/`+e},sr={},cr=function(e,t,n){let r=Promise.resolve();if(t&&t.length>0){let e=document.getElementsByTagName(`link`),i=document.querySelector(`meta[property=csp-nonce]`),a=i?.nonce||i?.getAttribute(`nonce`);function o(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))}r=o(t.map(t=>{if(t=or(t,n),t in sr)return;sr[t]=!0;let r=t.endsWith(`.css`),i=r?`[rel="stylesheet"]`:``;if(n)for(let n=e.length-1;n>=0;n--){let i=e[n];if(i.href===t&&(!r||i.rel===`stylesheet`))return}else if(document.querySelector(`link[href="${t}"]${i}`))return;let o=document.createElement(`link`);if(o.rel=r?`stylesheet`:ar,r||(o.as=`script`),o.crossOrigin=``,o.href=t,a&&o.setAttribute(`nonce`,a),document.head.appendChild(o),r)return new Promise((e,n)=>{o.addEventListener(`load`,e),o.addEventListener(`error`,()=>n(Error(`Unable to preload CSS for ${t}`)))})}))}function i(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return r.then(t=>{for(let e of t||[])e.status===`rejected`&&i(e.reason);return e().catch(i)})},lr={image:`图片`,video:`视频`,audio:`音频`,iframe:`页面`},ur=[],q=0,dr=null,J=null,fr=null,pr=null,mr=null,hr=0,gr=null,_r=!1,vr=``,yr=null;function br(){return window.matchMedia?.(`(prefers-reduced-motion: reduce)`).matches===!0}function xr(e){return String(e?.title||lr[e?.type]||`媒体预览`)}function Sr(e){if(e?.displayUrl)return String(e.displayUrl);try{return new URL(e?.url).hostname}catch{return``}}function Cr(e){return String(e?.renderUrl||e?.url||``)}function wr(e){return{video:`▶`,audio:`♪`,iframe:`▣`}[e]||`◫`}function Tr(e){return/\.m3u8(?:$|[?#])/i.test(String(e||``))}function Er(){let e=document.createElement(`div`);return e.id=`app-media-preview`,e.className=`media-preview-root`,e.hidden=!0,e.setAttribute(`aria-hidden`,`true`),e.innerHTML=`
  ...
  `,e.addEventListener(`click`,Gr),e.addEventListener(`input`,Kr),document.body.appendChild(e),e}function Dr(){return mr||=document.getElementById(`app-media-preview`)||Er(),mr}function Y(e){return Dr().querySelector(e)}function Or(e,t){let n=Y(e);n&&(n.textContent=t)}function kr(){fr&&pr&&fr.removeEventListener(`wheel`,pr),J?.destroy(),J=null,fr=null,pr=null}function Ar(){kr(),gr?.destroy(),gr=null;let e=Y(`[data-media-preview-content]`);e?.querySelectorAll(`video, audio`).forEach(e=>{e.pause(),e.removeAttribute(`src`),e.load()}),e?.querySelectorAll(`iframe`).forEach(e=>e.removeAttribute(`src`)),e?.replaceChildren()}function jr(){yr?.disconnect(),yr=null}function Mr(e,t){if(t!==hr||mr?.hidden)return;let n=Y(`[data-media-preview-content]`);if(!n)return;let r=document.createElement(`div`);r.className=`media-preview-load-error`,r.setAttribute(`role`,`status`),r.textContent=e,n.replaceChildren(r)}function Nr(e){let t=rr(e),n=Y(`[data-media-preview-zoom]`),r=Y(`[data-media-preview-zoom-output]`),i=Y(`[data-media-preview-stage]`);n&&(n.value=String(t)),r&&(r.textContent=`${Math.round(t*100)}%`),i?.classList.toggle(`is-zoomed`,t>1.01)}function Pr(e,t=!br()){J&&J.zoom(rr(e),{animate:t})}function Fr(e=!br()){J&&(J.reset({animate:e}),Nr(1))}function Ir(e,t){kr(),J=er(e,{canvas:!0,minScale:1,maxScale:6,startScale:1,step:.2,duration:br()?0:160,panOnlyWhenZoomed:!0,pinchAndPan:!0,cursor:`grab`}),e.addEventListener(`panzoomchange`,e=>Nr(e.detail?.scale??J?.getScale())),t.addEventListener(`dblclick`,e=>{e.preventDefault(),Pr((J?.getScale()||1)>1.05?1:2)}),fr=t,pr=J.zoomWithWheel,t.addEventListener(`wheel`,pr,{passive:!1}),Nr(1)}function Lr(e,t){let n=Y(`[data-media-preview-content]`);if(!n)return;let r=document.createElement(`div`);r.className=`media-preview-image-canvas`;let i=document.createElement(`img`);i.className=`media-preview-image`,i.alt=xr(e),i.draggable=!1,i.referrerPolicy=`no-referrer`,i.addEventListener(`load`,()=>{t===hr&&i.isConnected&&Ir(i,r)},{once:!0}),i.addEventListener(`error`,()=>Mr(`图片加载失败`,t),{once:!0}),i.src=Cr(e),r.appendChild(i),n.appendChild(r)}async function Rr(e,t,n){try{let{default:r}=await cr(async()=>{let{default:e}=await import(`./hls-IujbK-0_.js`);return{default:e}},[]);if(n!==hr||!e.isConnected)return;if(!r.isSupported()){e.src=t;return}gr=new r({enableWorker:!0}),gr.on(r.Events.ERROR,(e,t)=>{t?.fatal&&(gr?.destroy(),gr=null,Mr(`HLS 视频加载失败`,n))}),gr.loadSource(t),gr.attachMedia(e)}catch{n===hr&&e.isConnected&&(e.src=t)}}function zr(e,t){let n=Y(`[data-media-preview-content]`);if(!n)return;let r=document.createElement(`video`);r.className=`media-preview-video`,r.controls=!0,r.playsInline=!0,r.preload=`metadata`,r.referrerPolicy=`no-referrer`,r.addEventListener(`error`,()=>Mr(`视频加载失败`,t),{once:!0});let i=Cr(e);Tr(i)&&!r.canPlayType(`application/vnd.apple.mpegurl`)?Rr(r,i,t):r.src=i,n.appendChild(r)}function Br(e,t){let n=Y(`[data-media-preview-content]`);if(!n)return;let r=document.createElement(`div`);r.className=`media-preview-audio-shell`;let i=document.createElement(`span`);i.className=`media-preview-audio-icon`,i.setAttribute(`aria-hidden`,`true`),i.textContent=`♪`;let a=document.createElement(`audio`);a.controls=!0,a.preload=`metadata`,a.addEventListener(`error`,()=>Mr(`音频加载失败`,t),{once:!0}),a.src=Cr(e),r.append(i,a),n.appendChild(r)}function Vr(e){let t=Y(`[data-media-preview-content]`);if(!t)return;let n=e.embedPolicy||{},r=document.createElement(`iframe`);r.className=`media-preview-iframe`,r.title=xr(e),r.loading=`eager`,r.referrerPolicy=n.referrerPolicy||`no-referrer`,r.setAttribute(`sandbox`,n.sandbox||`allow-scripts allow-forms allow-popups`),r.src=e.url,t.appendChild(r)}function Hr(){let e=Y(`[data-media-preview-track]`);if(!e)return;jr();let t=ur.map(e=>e.galleryId||`${e.type}:${e.url}`).join(`|`),n=e.children.length!==ur.length||e.dataset.signature!==t;n&&(e.replaceChildren(),e.dataset.signature=t),ur.forEach((t,r)=>{if(!n){let t=e.children[r];if(t){t.classList.toggle(`is-active`,r===q),t.tabIndex=r===q?0:-1,t.setAttribute(`aria-current`,r===q?`true`:`false`);return}}let i=document.createElement(`button`);if(i.type=`button`,i.className=`media-preview-track-item`,i.dataset.mediaPreviewAction=`select`,i.dataset.mediaPreviewIndex=String(r),i.tabIndex=r===q?0:-1,i.setAttribute(`aria-current`,r===q?`true`:`false`),i.setAttribute(`aria-label`,`查看第 ${r+1} 项，${lr[t.type]||`媒体`}：${xr(t)}`),i.title=`${xr(t)} · ${t.featureName||``}`,t.type===`image`){let e=document.createElement(`img`),n=String(t.thumbnailUrl||t.renderUrl||t.url||``);e.alt=``,e.loading=`lazy`,e.referrerPolicy=`no-referrer`,e.addEventListener(`error`,()=>i.classList.add(`is-load-error`),{once:!0}),`IntersectionObserver`in window?e.dataset.src=n:e.src=n,i.appendChild(e)}else{let e=document.createElement(`span`);e.className=`media-preview-track-icon media-preview-track-icon-${t.type}`,e.setAttribute(`aria-hidden`,`true`),e.textContent=wr(t.type),i.appendChild(e)}let a=document.createElement(`span`);a.className=`media-preview-track-marker`,a.textContent=String(r+1).padStart(2,`0`),i.appendChild(a),e.appendChild(i)}),`IntersectionObserver`in window&&(yr=new IntersectionObserver(e=>{e.forEach(e=>{if(!e.isIntersecting)return;let t=e.target;t.src=t.dataset.src||``,t.removeAttribute(`data-src`),yr?.unobserve(t)})},{root:e,rootMargin:`0px 160px`}),e.querySelectorAll(`img[data-src]`).forEach(e=>yr.observe(e))),e.querySelectorAll(`.media-preview-track-item`).forEach((e,t)=>{e.classList.toggle(`is-active`,t===q),e.tabIndex=t===q?0:-1,e.setAttribute(`aria-current`,t===q?`true`:`false`)}),e.querySelector(`.media-preview-track-item.is-active`)?.scrollIntoView?.({block:`nearest`,inline:`center`})}function Ur(){let e=++hr;Ar();let t=ur[q];if(!t)return;let n=Dr(),r=Y(`[data-media-preview-source]`),i=Y(`[data-media-preview-action="previous"]`),a=Y(`[data-media-preview-action="next"]`),o=Y(`[data-media-preview-zoom-controls]`),s=lr[t.type]||`媒体`,c=xr(t);n.dataset.mediaType=t.type,n.dataset.mediaIndex=String(q),Or(`[data-media-preview-kind]`,s),Or(`[data-media-preview-collection]`,vr||t.kmlName||`媒体预览`),Or(`[data-media-preview-title]`,c),Or(`[data-media-preview-position]`,ur.length>1?`${q+1} / ${ur.length}`:`单项`),Or(`[data-media-preview-caption]`,c),Or(`[data-media-preview-url]`,[t.featureName,Sr(t)].filter(Boolean).join(` · `)),Or(`[data-media-preview-restore-title]`,c),Or(`[data-media-preview-restore-position]`,`${q+1} / ${ur.length}`),r&&(r.href=t.url,r.title=t.type===`iframe`?`打开原始页面`:`打开原始文件`),Or(`.media-preview-source-label`,t.type===`iframe`?`原始页面`:`原始文件`);let l=ur.length>1;i&&(i.hidden=!l),a&&(a.hidden=!l),o&&(o.hidden=t.type!==`image`),Nr(1),Hr();let u={image:Lr,video:zr,audio:Br,iframe:Vr}[t.type];u?.(t,e),_r||Y(`.media-preview-stage`)?.focus({preventScroll:!0})}function Wr(e){ur.length<2||(q=nr(q+e,ur.length),Ur())}function Gr(e){let t=Dr();if(e.target===t){Zr();return}let n=e.target.closest(`[data-media-preview-action]`)?.dataset.mediaPreviewAction;n&&(n===`close`&&Zr(),n===`previous`&&Wr(-1),n===`next`&&Wr(1),n===`select`&&(q=nr(e.target.closest(`[data-media-preview-action]`)?.dataset.mediaPreviewIndex,ur.length),Ur()),n===`minimize`&&Xr(!0),n===`restore`&&Xr(!1),n===`zoom-in`&&Pr((J?.getScale()||1)+.5),n===`zoom-out`&&Pr((J?.getScale()||1)-.5),n===`reset`&&Fr())}function Kr(e){e.target.matches(`[data-media-preview-zoom]`)&&Pr(Number(e.target.value),!1)}function qr(e){if(_r)return;let t=Dr(),n=[...t.querySelectorAll(`a[href], button:not([hidden]):not([tabindex="-1"]), input:not([hidden]), video[controls], audio[controls]`)].filter(e=>!e.disabled&&e.getClientRects().length);if(!n.length)return;let r=n[0],i=n.at(-1);t.contains(document.activeElement)?e.shiftKey&&document.activeElement===r?(e.preventDefault(),i.focus()):!e.shiftKey&&document.activeElement===i&&(e.preventDefault(),r.focus()):(e.preventDefault(),r.focus())}function Jr(e){if(Dr().hidden)return;if(e.key===`Escape`){e.preventDefault(),Zr();return}if(_r){let t=Dr();t.contains(e.target)&&e.key===`ArrowLeft`&&(e.preventDefault(),Wr(-1)),t.contains(e.target)&&e.key===`ArrowRight`&&(e.preventDefault(),Wr(1));return}if(e.key===`Tab`&&!_r){qr(e);return}let t=e.target.matches?.(`input, video, audio`);!t&&(e.key===`ArrowLeft`||e.key===`ArrowUp`)&&(e.preventDefault(),Wr(-1)),!t&&(e.key===`ArrowRight`||e.key===`ArrowDown`)&&(e.preventDefault(),Wr(1)),!t&&ur[q]?.type===`image`&&((e.key===`+`||e.key===`=`)&&(e.preventDefault(),Pr((J?.getScale()||1)+.5)),e.key===`-`&&(e.preventDefault(),Pr((J?.getScale()||1)-.5)),e.key===`0`&&(e.preventDefault(),Fr()))}function Yr(){!Dr().hidden&&!_r&&ur[q]?.type===`image`&&Fr(!1)}function Xr(e){let t=Dr();if(t.hidden)return;_r=!!e,t.classList.toggle(`is-minimized`,_r),Y(`.media-preview-dialog`)?.setAttribute(`aria-modal`,_r?`false`:`true`),document.body.classList.toggle(`media-preview-open`,!_r);let n=Y(`[data-media-preview-action="minimize"]`);n&&(n.hidden=_r,n.setAttribute(`aria-label`,_r?`预览已收缩`:`收缩为小窗`)),requestAnimationFrame(_r?()=>Y(`[data-media-preview-action="restore"]`)?.focus():()=>Y(`.media-preview-stage`)?.focus({preventScroll:!0}))}function Zr(){let e=mr||document.getElementById(`app-media-preview`);!e||e.hidden||(hr+=1,Ar(),jr(),e.hidden=!0,e.setAttribute(`aria-hidden`,`true`),e.removeAttribute(`data-media-type`),e.classList.remove(`is-minimized`),document.body.classList.remove(`media-preview-open`),document.removeEventListener(`keydown`,Jr),window.removeEventListener(`resize`,Yr),ur=[],q=0,vr=``,_r=!1,dr?.isConnected&&dr.focus({preventScroll:!0}),dr=null)}function Qr({items:e,index:t=0,type:n=``,trigger:r=null,collectionTitle:i=``}={}){let a=ir(e,n);if(!a.length)return!1;let o=Dr();(o.hidden||_r)&&(dr=r||document.activeElement),ur=a,q=nr(t,ur.length),vr=String(i||a[q]?.kmlName||``).trim(),_r=!1,o.classList.remove(`is-minimized`),Y(`.media-preview-dialog`)?.setAttribute(`aria-modal`,`true`);let s=Y(`[data-media-preview-action="minimize"]`);return s&&(s.hidden=!1),o.hidden=!1,o.setAttribute(`aria-hidden`,`false`),document.body.classList.add(`media-preview-open`),document.removeEventListener(`keydown`,Jr),document.addEventListener(`keydown`,Jr),window.removeEventListener(`resize`,Yr),window.addEventListener(`resize`,Yr),Ur(),requestAnimationFrame(()=>Y(`.media-preview-stage`)?.focus({preventScroll:!0})),!0}var $r=``.split(`,`).map(e=>e.trim()).filter(Boolean),ei=null;function X(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function ti(){let e=typeof window<`u`?window:null,t=e?.MAP_SERVICE_KML_IFRAME_ALLOWLIST||e?.mapServiceKmlIframeAllowlist||$r;return Array.isArray(t)?t:String(t||``).split(`,`).map(e=>e.trim()).filter(Boolean)}function ni(){return{iframeAllowlist:ti()}}function ri(e){return fn(e,ni())}function ii(e){return{image:`图片`,video:`视频`,audio:`音频`,iframe:`页面`}[e]||`媒体`}function ai(e){return{video:`▶`,audio:`♪`,iframe:`▣`}[e]||`◫`}function oi(e){let t=ii(e.type);return e.type===`image`?`
      <button type="button" class="kml-popup-media-item kml-popup-media-image" data-kml-popup-media data-media-id="${X(e.id)}" data-media-url="${X(e.url)}" data-media-type="image" aria-label="预览${X(t)}：${X(e.title||t)}">
    ...
    `:`
    <button type="button" class="kml-popup-media-item kml-popup-media-type kml-popup-media-${X(e.type)}" data-kml-popup-media data-media-id="${X(e.id)}" data-media-url="${X(e.url)}" data-media-type="${X(e.type)}" aria-label="预览${X(t)}：${X(e.title||e.featureName||t)}">
      <span class="kml-popup-media-icon" aria-hidden="true">${X(ai(e.type))}</span>
      <span class="kml-popup-media-copy"><strong>${X(t)}</strong><small>${X(e.title||e.featureName||`点击查看`)}</small></span>
    </button>
  `}function si(e,t,n){let r=Tn(t,{contentOptions:ni()}),i=pn(r.contentSummary),a=mn(t),o=n?`
    ...
    `,s=r.items.length?`
      <section class="kml-popup-media" aria-label="点位媒体预览">
        <div class="kml-popup-media-heading">
          <span>媒体速览</span>
          <small>${X(r.total)} 项 · 可浏览整个 KML</small>
        </div>
    ...
    <div class="kml-popup-content">
      ...
      <div class="kml-popup-title">${X(t?.name||`未命名点位`)}</div>
      <div class="kml-popup-desc">${X(a||(i?`此点位包含可预览媒体`:`暂无描述`))}</div>
      ${i?`<div class="kml-popup-content-summary">${X(i)}</div>`:``}
      ${s}
      ${o}
    </div>
  `}function ci(e,t,n=null){let r=Cn(e,{featureViews:n&&t?.id?new Map([[String(t.id),n]]):null,contentOptions:ni()});return r.length?r:Sn(t,n||ri(t)).map((t,n)=>({...t,kmlId:String(e?.id||``),kmlName:String(e?.name||``).trim()||`未命名 KML`,galleryIndex:n}))}function li(e,t,n,r,i=null){let a=ci(e,t,i);return a.length?Qr({items:a,index:wn(a,{...n,featureId:String(t?.id||``)}),trigger:r,collectionTitle:String(e?.name||``).trim()||`未命名 KML`}):!1}function ui(e,t,n){e&&(e.querySelectorAll(`.kml-popup-media-image img`).forEach(e=>{e.dataset.kmlPopupMediaFallbackBound!==`true`&&(e.dataset.kmlPopupMediaFallbackBound=`true`,e.addEventListener(`error`,()=>e.closest(`.kml-popup-media-image`)?.classList.add(`is-load-error`),{once:!0}))}),e.querySelectorAll(`[data-kml-popup-media]`).forEach(e=>{e.dataset.kmlPopupMediaBound!==`true`&&(e.dataset.kmlPopupMediaBound=`true`,e.addEventListener(`click`,r=>{r.stopPropagation(),r.preventDefault(),li(t,n,{id:e.dataset.mediaId,url:e.dataset.mediaUrl,type:e.dataset.mediaType},e)}))}))}function di(){let e=document.getElementById(`kml-feature-content-panel`);return e||(e=document.createElement(`section`),e.id=`kml-feature-content-panel`,e.className=`kml-content-panel`,e.setAttribute(`role`,`dialog`),e.setAttribute(`aria-modal`,`false`),e.hidden=!0,document.body.appendChild(e)),e}function fi(){ei?.abort(),ei=null;let e=document.getElementById(`kml-feature-content-panel`);e&&(e.hidden=!0,e.innerHTML=``)}async function pi(e,t){if(e?.isPublic&&e.id&&t?.id){ei?.abort(),ei=new AbortController;try{let n=await window.fetch(`/api/v1/kml/shared/${encodeURIComponent(e.id)}/features/${encodeURIComponent(t.id)}/content`,{signal:ei.signal}),r=await n.json();if(!n.ok||r.code!==0)throw Error(r.error?.message||`点位内容加载失败`);return r.result}finally{ei=null}}return ri(t)}function mi(e,t){let n=mn(t),r=Array.isArray(t?.coordinates)&&t.type===`Point`?`${Number(t.coordinates[0]).toFixed(6)}, ${Number(t.coordinates[1]).toFixed(6)}`:``;return`
  ...
  `}function gi(e,t,n,r,i,a){return`
  ...
  `}function _i(e,t,n){return gi(e,t,n,`video`,`视频`,`▶`)}function vi(e,t,n){return gi(e,t,n,`audio`,`音频`,`♪`)}function yi(e,t,n){return gi(e,t,n,`iframe`,`页面`,`▣`)}function bi(e){return`
  ...
  `}function xi(e,t){if(!e.items?.length)return``;let n={image:hi,video:_i,audio:vi,iframe:yi,link:bi}[e.type]||bi,r={image:`◫`,video:`▶`,audio:`♪`,iframe:`▣`,link:`↗`}[e.type]||`•`;return`
  ...
  `}function Si(e){e.querySelectorAll(`.kml-content-image-item img`).forEach(e=>{e.addEventListener(`error`,()=>e.closest(`.kml-content-image-item`)?.classList.add(`is-load-error`),{once:!0})})}function Ci(e,t,n,r){let i=r?.groups||[];e.querySelectorAll(`[data-kml-media-preview]`).forEach(e=>{e.addEventListener(`click`,()=>{let a=i[Number(e.dataset.kmlMediaGroup)],o=a?.items?.[Number(e.dataset.kmlMediaIndex)];o&&li(t,n,{id:o.id,url:o.url,type:a.type},e,r)})})}function wi(e,t,n,r,i=``){let a=pn(r?.contentSummary),o=(r?.groups||[]).map(xi).join(``);e.innerHTML=`
  ...
  `,e.querySelector(`[data-kml-content-close]`)?.addEventListener(`click`,fi),Si(e),Ci(e,t,n,r)}async function Ti(e,t){let n=di();n.hidden=!1,n.innerHTML=`
    <header class="kml-content-header">
      <div>
  ...
  `,n.querySelector(`[data-kml-content-close]`)?.addEventListener(`click`,fi);try{wi(n,e,t,await pi(e,t))}catch(r){if(r.name===`AbortError`)return;wi(n,e,t,ri(t),r.message||`点位内容加载失败，已展示本地解析结果。`)}}var Ei={image:`包含图片`,video:`包含视频`,audio:`包含音频`,iframe:`包含页面`,link:`包含链接`},Di={image:`#0f766e`,video:`#dc2626`,audio:`#7c3aed`,iframe:`#2563eb`,link:`#475569`},Oi={image:`<rect x="8" y="8" width="16" height="13" rx="2"/><circle cx="13" cy="12.5" r="1.5"/><path d="m9.5 19 4.5-4 3 2.5 2-2 3.5 3.5"/>`,video:`<rect x="8" y="8" width="16" height="13" rx="2"/><path d="m14 12 5 3-5 3z"/>`,audio:`<path d="M9 14h3l4-4v10l-4-4H9z"/><path d="M19 12.5a4 4 0 0 1 0 5M21 10a7 7 0 0 1 0 10"/>`,iframe:`<rect x="8" y="8" width="16" height="13" rx="2"/><path d="M8 12h16M11 10h.01M14 10h.01"/>`,link:`<path d="M13.5 17.5 12 19a3 3 0 0 1-4.2-4.2l2.5-2.5a3 3 0 0 1 4.2 0M18.5 12.5 20 11a3 3 0 0 1 4.2 4.2l-2.5 2.5a3 3 0 0 1-4.2 0M12.5 15.5h7"/>`};function ki(e){let t=Di[e],n=Oi[e];return!t||!n?``:`<svg viewBox="0 0 32 40" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"><path class="kml-media-marker-pin" fill="${t}" d="M16 1C7.9 1 3 6.7 3 14.1 3 24.2 16 38.5 16 38.5S29 24.2 29 14.1C29 6.7 24.1 1 16 1Z"/><path fill="none" stroke="rgba(255,255,255,.9)" stroke-width="1.2" d="M16 2.5C8.9 2.5 4.5 7.4 4.5 14.1c0 8.1 9.2 19.5 11.5 22.3 2.3-2.8 11.5-14.2 11.5-22.3C27.5 7.4 23.1 2.5 16 2.5Z"/><g fill="none" stroke="#fff" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round">${n}</g></svg>`}function Ai(e){let t=_n(e);return Ei[t]?{type:t,label:Ei[t],html:`<span class="kml-media-marker kml-media-marker-${t}" role="img" aria-label="${Ei[t]}">${ki(t)}</span>`,iconSize:[32,40],iconAnchor:[16,39],popupAnchor:[0,-36]}:null}function ji(e){let t=Ai(e);if(!t)return null;let n=ki(t.type);return{...t,image:`data:image/svg+xml;charset=utf-8,${encodeURIComponent(n)}`}}function Mi(e){let t=Ai(e);return t?`<svg class="svg-icon kml-media-list-icon kml-media-list-icon-${t.type}" viewBox="0 0 32 30" role="img" aria-label="${t.label}" xmlns="http://www.w3.org/2000/svg"><g fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">${Oi[t.type]}</g></svg>`:``}var Ni=`data:audio/wav;base64,UklGRigAAABXQVZFZm10IBIAAAABAAEARKwAAIhYAQACABAAAABkYXRhAgAAAAEA`,Pi=`/location-keepalive.mp4`;function Fi(e,t){return Object.prototype.hasOwnProperty.call(e,t)?e[t]:globalThis?.[t]}function Ii(){}function Li(e={}){let t=Fi(e,`navigator`),n=Fi(e,`document`),r=Fi(e,`Audio`),i=Fi(e,`logger`)||globalThis.console,a=!1,o=0,s=!1,c=null,l=Ii,u=null,d=null,f={element:null,playPromise:null,playing:!1},p={element:null,playPromise:null,playing:!1,attached:!1};function m(e,t){try{i?.warn?.(`[LocationKeepAlive] ${e}`,t)}catch{}}function h(){return n?typeof n.visibilityState==`string`?n.visibilityState===`visible`:typeof n.hidden==`boolean`?!n.hidden:!0:!0}function g(e,t,{muted:n=!1}={}){if(!e)return null;try{e.src=t,e.loop=!0,e.setAttribute?.(`playsinline`,``),n&&(e.muted=!0,e.setAttribute?.(`muted`,``))}catch(e){m(`初始化媒体保活资源失败`,e)}return e}function _(){if(f.element)return f.element;try{typeof r==`function`?f.element=g(new r(Ni),Ni):typeof n?.createElement==`function`&&(f.element=g(n.createElement(`audio`),Ni))}catch(e){m(`创建音频保活资源失败`,e)}return f.element}function ee(){let e=p.element;if(!(!e||p.attached||!n?.body?.appendChild))try{n.body.appendChild(e),p.attached=!0}catch(e){m(`挂载视频保活资源失败`,e)}}function v(){if(!p.element){if(typeof n?.createElement!=`function`)return null;try{let e=g(n.createElement(`video`),Pi,{muted:!0});e&&(e.referrerPolicy=`no-referrer`,e.setAttribute?.(`referrerpolicy`,`no-referrer`)),e?.style&&(e.style.position=`absolute`,e.style.width=`1px`,e.style.height=`1px`,e.style.opacity=`0.01`,e.style.pointerEvents=`none`),p.element=e}catch(e){m(`创建视频保活资源失败`,e)}}return ee(),p.element}function te(e){if(e.playing=!1,e.element)try{e.element.pause?.()}catch(e){m(`暂停媒体保活资源失败`,e)}}function ne(e,t,n){if(!a)return Promise.resolve(!1);let r=t();if(!r||typeof r.play!=`function`)return Promise.resolve(!1);if(e.playing&&r.paused!==!0)return Promise.resolve(!0);if(e.playPromise)return e.playPromise;let i;try{i=r.play()}catch(e){return m(`${n}保活播放失败`,e),Promise.resolve(!1)}let o=Promise.resolve(i).then(()=>a?(e.playing=!0,!0):(te(e),!1)).catch(t=>(e.playing=!1,m(`${n}保活播放失败`,t),!1)).finally(()=>{e.playPromise===o&&(e.playPromise=null)});return e.playPromise=o,o}function re(){return ne(f,_,`音频`)}function y(){return ne(p,v,`视频`)}function b(){l(),l=Ii}function x(e,t){b();let n=()=>{c===e&&(c=null,b(),a&&o===t&&h()&&(u?.generation===t?d=t:T()))};if(typeof e?.addEventListener==`function`){e.addEventListener(`release`,n,{once:!0}),l=()=>{try{e.removeEventListener?.(`release`,n)}catch{}},e.released===!0&&n();return}if(e&&`onrelease`in e){let t=e.onrelease;e.onrelease=function(...e){try{t?.apply(this,e)}finally{n()}},l=()=>{e.onrelease!==t&&(e.onrelease=t||null)},e.released===!0&&n()}}async function S(e){if(!(!e||e.released===!0||typeof e.release!=`function`))try{await e.release()}catch(e){m(`释放 Screen Wake Lock 失败`,e)}}function ie(e){if(!a||o!==e||!h())return Promise.resolve(null);if(c?.released!==!0){if(c)return te(p),Promise.resolve(c)}else c=null,b();if(u?.generation===e)return u.promise;let n=t?.wakeLock;if(typeof n?.request!=`function`)return y().then(()=>null);let r=Promise.resolve().then(()=>n.request(`screen`)).then(async t=>t?!a||o!==e||!h()?(await S(t),null):t.released===!0?(await y(),null):c&&c!==t&&c.released!==!0?(await S(t),c):(c=t,x(t,e),te(p),c===t?t:null):(a&&o===e&&h()&&await y(),null)).catch(async t=>(a&&o===e&&h()&&(m(`申请 Screen Wake Lock 失败，启用视频降级保活`,t),await y()),null)).finally(()=>{u?.promise===r&&(u=null),d===e&&(d=null,a&&o===e&&h()&&T())});return u={generation:e,promise:r},r}function C(){a&&h()&&T()}function ae(){if(!(s||typeof n?.addEventListener!=`function`))try{n.addEventListener(`visibilitychange`,C),s=!0}catch(e){m(`监听页面可见性变化失败`,e)}}function w(){if(s){try{n?.removeEventListener?.(`visibilitychange`,C)}catch{}s=!1}}async function T(){if(!a)return!1;ae();let e=o,t=await Promise.allSettled([re(),ie(e)]);return a&&o===e&&t.length===2}function E(){return a||(a=!0,o+=1,ae()),T()}function oe(){a=!1,o+=1,d=null,w();let e=c;c=null,b(),te(f),te(p),S(e)}return{start:E,stop:oe,refresh:T,startLocationKeepAlive:E,stopLocationKeepAlive:oe,refreshLocationKeepAlive:T}}var Ri=null;function zi(){return Ri||=Li(),Ri}function Bi(){return zi().start()}function Vi(){return zi().stop()}var Hi=`/api/v1`,Ui=`mapServiceAdminToken`;function Wi(){return window.localStorage.getItem(Ui)||``}function Gi(e){e?window.localStorage.setItem(Ui,e):window.localStorage.removeItem(Ui)}async function Z(e,t={}){let n={Accept:`application/json`,...t.headers||{}};if(t.body!==void 0&&(typeof window<`u`&&t.body instanceof window.FormData||(n[`Content-Type`]=`application/json`)),t.auth!==!1){let e=Wi();e&&(n.Authorization=`Bearer ${e}`)}let r=await window.fetch(`${Hi}${e}`,{method:t.method||`GET`,headers:n,body:t.body===void 0?void 0:typeof window<`u`&&t.body instanceof window.FormData?t.body:JSON.stringify(t.body)}),i=await r.json().catch(()=>null);if(!r.ok||i?.code!==0){let e=i?.error?.message||r.statusText||`请求失败`,t=Error(e);throw t.status=r.status,t}return i.result}async function Ki(e){let t=await Z(`/admin/auth/login`,{method:`POST`,auth:!1,body:e});return Gi(t.token),t}function qi(){Gi(``)}var Ji={session:()=>Z(`/admin/session`),system:()=>Z(`/admin/system`),cache:()=>Z(`/admin/cache`),clearCache:(e={})=>{let t=new URLSearchParams(e).toString();return Z(`/admin/cache${t?`?${t}`:``}`,{method:`DELETE`})},visits:()=>Z(`/admin/visits`),settings:()=>Z(`/admin/settings`),updateSettings:e=>Z(`/admin/settings`,{method:`PUT`,body:e}),updatePassword:e=>Z(`/admin/auth/password`,{method:`POST`,body:e}),precacheCatalog:()=>Z(`/admin/precache/catalog`),tasks:()=>Z(`/admin/precache/tasks`),estimateTask:e=>Z(`/admin/precache/estimate`,{method:`POST`,body:e}),createTask:e=>Z(`/admin/precache/tasks`,{method:`POST`,body:e}),pauseTask:e=>Z(`/admin/precache/tasks/${encodeURIComponent(e)}/pause`,{method:`POST`}),resumeTask:e=>Z(`/admin/precache/tasks/${encodeURIComponent(e)}/resume`,{method:`POST`}),deleteTask:(e,t={})=>{let n=new URLSearchParams;t.deleteCache&&n.set(`deleteCache`,`true`);let r=n.toString();return Z(`/admin/precache/tasks/${encodeURIComponent(e)}${r?`?${r}`:``}`,{method:`DELETE`})},kmls:()=>Z(`/admin/kml`),getKml:e=>Z(`/admin/kml/${encodeURIComponent(e)}`),createKml:e=>Z(`/admin/kml`,{method:`POST`,body:e}),updateKml:(e,t)=>Z(`/admin/kml/${encodeURIComponent(e)}`,{method:`PUT`,body:t}),deleteKml:e=>Z(`/admin/kml/${encodeURIComponent(e)}`,{method:`DELETE`}),importKml:e=>Z(`/admin/kml/import`,{method:`POST`,body:e}),listTileSources:()=>Z(`/admin/tile-sources`),createTileSource:e=>Z(`/admin/tile-sources`,{method:`POST`,body:e}),getTileSource:e=>Z(`/admin/tile-sources/${encodeURIComponent(e)}`),updateTileSource:(e,t)=>Z(`/admin/tile-sources/${encodeURIComponent(e)}`,{method:`PUT`,body:t}),deleteTileSource:e=>Z(`/admin/tile-sources/${encodeURIComponent(e)}`,{method:`DELETE`}),testTileSource:e=>Z(`/admin/tile-sources/${encodeURIComponent(e)}/test`,{method:`POST`}),listSourcePresets:()=>Z(`/admin/source-presets`),createSourceFromPreset:(e,t)=>Z(`/admin/source-presets/${encodeURIComponent(e)}/create-source`,{method:`POST`,body:t}),listKeyPools:()=>Z(`/admin/key-pools`),getKeyPool:e=>Z(`/admin/key-pools/${encodeURIComponent(e)}`),createKeyPool:e=>Z(`/admin/key-pools`,{method:`POST`,body:e}),updateKeyPool:(e,t)=>Z(`/admin/key-pools/${encodeURIComponent(e)}`,{method:`PUT`,body:t}),deleteKeyPool:e=>Z(`/admin/key-pools/${encodeURIComponent(e)}`,{method:`DELETE`}),testKeyPool:e=>Z(`/admin/key-pools/${encodeURIComponent(e)}/test`,{method:`POST`}),testKeyPoolKey:(e,t)=>Z(`/admin/key-pools/${encodeURIComponent(e)}/keys/${encodeURIComponent(t)}/test`,{method:`POST`}),listMapLayers:()=>Z(`/admin/map-layers`),createMapLayer:e=>Z(`/admin/map-layers`,{method:`POST`,body:e}),updateMapLayer:(e,t)=>Z(`/admin/map-layers/${encodeURIComponent(e)}`,{method:`PUT`,body:t}),deleteMapLayer:e=>Z(`/admin/map-layers/${encodeURIComponent(e)}`,{method:`DELETE`}),setDefaultMapLayer:e=>Z(`/admin/map-layers-default`,{method:`PUT`,body:{id:e}}),listProxyOutbounds:()=>Z(`/admin/proxy-outbounds`),createProxyOutbound:e=>Z(`/admin/proxy-outbounds`,{method:`POST`,body:e}),updateProxyOutbound:(e,t)=>Z(`/admin/proxy-outbounds/${encodeURIComponent(e)}`,{method:`PUT`,body:t}),deleteProxyOutbound:e=>Z(`/admin/proxy-outbounds/${encodeURIComponent(e)}`,{method:`DELETE`}),testProxyOutbound:e=>Z(`/admin/proxy-outbounds/${encodeURIComponent(e)}/test`,{method:`POST`}),listProxyPools:()=>Z(`/admin/proxy-pools`),createProxyPool:e=>Z(`/admin/proxy-pools`,{method:`POST`,body:e}),updateProxyPool:(e,t)=>Z(`/admin/proxy-pools/${encodeURIComponent(e)}`,{method:`PUT`,body:t}),deleteProxyPool:e=>Z(`/admin/proxy-pools/${encodeURIComponent(e)}`,{method:`DELETE`}),testProxyPool:e=>Z(`/admin/proxy-pools/${encodeURIComponent(e)}/test`,{method:`POST`}),listExternalPublishes:()=>Z(`/admin/external-publishes`),createExternalPublish:e=>Z(`/admin/external-publishes`,{method:`POST`,body:e}),updateExternalPublish:(e,t)=>Z(`/admin/external-publishes/${encodeURIComponent(e)}`,{method:`PUT`,body:t}),deleteExternalPublish:e=>Z(`/admin/external-publishes/${encodeURIComponent(e)}`,{method:`DELETE`}),resetExternalPublishToken:e=>Z(`/admin/external-publishes/${encodeURIComponent(e)}/token`,{method:`POST`}),testExternalPublish:e=>Z(`/admin/external-publishes/${encodeURIComponent(e)}/test`,{method:`POST`}),listExternalPublishLogs:(e=``)=>Z(e?`/admin/external-publishes/${encodeURIComponent(e)}/logs`:`/admin/external-publish-logs`),listSourceAccessLogs:(e=``)=>Z(e?`/admin/tile-sources/${encodeURIComponent(e)}/access-logs`:`/admin/source-access-logs`)};async function Yi(){return Z(`/access/status`,{auth:!1})}async function Xi(e){return Z(`/access/verify`,{method:`POST`,auth:!1,body:{password:e}})}function Zi(e=0){if(!e)return`0 B`;let t=[`B`,`KB`,`MB`,`GB`],n=e,r=0;for(;n>=1024&&r<t.length-1;)n/=1024,r+=1;return`${n.toFixed(r===0?0:1)} ${t[r]}`}function Qi(e=0){let t=Math.floor(e),n=Math.floor(t/3600),r=Math.floor(t%3600/60),i=t%60;return n?`${n}h ${r}m`:r?`${r}m ${i}s`:`${i}s`}function $i(e){return e?new Date(e).toLocaleString():`-`}function Q(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function ea(e,t){return`${e}?url=${encodeURIComponent(t).replace(/%7B/g,`{`).replace(/%7D/g,`}`)}`}function ta(e){let t=e.system,n=e.visits||{},r=t?.package?.version||`-`,i=e.visitsError||(e.visitsLoading?`统计中`:``);return`
    <div class="admin-grid">
      <section class="admin-panel">
        ...
        <dl class="admin-metrics">
          ...
          <div><dt>运行</dt><dd>${Qi(t?.uptime||0)}</dd></div>
          <div><dt>环境</dt><dd>${Q(t?.env||`-`)}</dd></div>
          <div><dt>时间</dt><dd>${$i(t?.serverTime)}</dd></div>
        </dl>
      </section>
  ...
  `}function na(e){let t=e.cache||{},n=e.cacheError||(e.cacheLoading?`统计中`:``),r=t.bySource||{},i=e.tileSources||[];return`
    <section class="admin-panel">
      <div class="admin-panel-head">
        <h2>缓存治理</h2>
      ...
      <dl class="admin-metrics admin-metrics-five">
        ...
        <div class="metric-size"><dt>总大小</dt><dd>${Zi(t.bytes||0)}</dd></div>
  ...
  `}async function ra({api:e,event:t,renderDashboard:n,setNotice:r,showConfirm:i,state:a}){let o=t.target.closest(`[data-admin-action]`);if(!o)return!1;let s=o.getAttribute(`data-admin-action`);if(s===`clear-cache`){if(!await i(`清空所有瓦片缓存？此操作不可逆！`))return!0;try{await e.clearCache(),a.cache=await e.cache(),r(`所有瓦片缓存已清空`),n()}catch(e){r(``,e.message),n()}return!0}if(s===`clear-source-cache`){let t=o.getAttribute(`data-source-id`);if(!t)return!1;let s=(a.tileSources||[]).find(e=>e.id===t),c=s?s.name:t;if(!await i(`确定要清空图源【${c}】的全部瓦片缓存吗？`))return!0;try{await e.clearCache({sourceId:t}),a.cache=await e.cache(),r(`已清空图源【${c}】的专属瓦片缓存`),n()}catch(e){r(``,e.message),n()}return!0}return!1}var ia={queued:`排队中`,running:`执行中`,pausing:`暂停中`,paused:`已暂停`,completed:`已完成`,completed_with_errors:`完成有错误`,failed:`失败`,interrupted:`已中断`,deleting:`删除中`},aa=1e3,oa=1500,sa=new Set([`queued`,`running`,`pausing`,`deleting`]),ca=null,la=0,ua=``,da=``,fa=null,pa=0;function ma(e){return ia[e]||e}var ha={queued:`⏳`,running:`⚙`,pausing:`⏸`,paused:`⏸`,completed:`✓`,completed_with_errors:`⚠`,failed:`✗`,interrupted:`⏹`,deleting:`🗑`};function ga(e){return ha[e]||`•`}function _a(e,t){let n=t[0],r=e.precacheForm||{};return{providerId:t.some(e=>e.id===r.providerId)?r.providerId:n?.id||``,bounds:{west:Number(r.bounds?.west??113.24),south:Number(r.bounds?.south??23.11),east:Number(r.bounds?.east??113.29),north:Number(r.bounds?.north??23.15)},minZoom:Number(r.minZoom??12),maxZoom:Number(r.maxZoom??12),concurrency:Number(r.concurrency??4),requestIntervalMs:Number(r.requestIntervalMs??0),refresh:!!r.refresh}}function va(e,t){return e.find(e=>e.id===t.providerId)||e[0]||null}function ya(e){let t=e.expandedTaskIds||new Set;return(e.tasks||[]).map(e=>({...e,expanded:t.has(e.id)}))}function ba(e=[]){return e.some(e=>sa.has(e.status))}function xa(e){let t=e.precacheCatalog||[],n=_a(e,t),r=va(t,n),i=ya(e);return`
  ...
  `}function Sa(e){let t=e.precacheEstimate;return e.precacheEstimateStatus===`loading`?`<div class="admin-estimate" data-precache-estimate><p>正在估算瓦片数量和下载体积</p></div>`:e.precacheEstimateError?`<div class="admin-estimate is-error" data-precache-estimate><p>${Q(e.precacheEstimateError)}</p></div>`:t?`
    <div class="admin-estimate ${t.withinLimit?``:`is-warning`}" data-precache-estimate>
      <dl class="admin-metrics">
        <div><dt>预计文件</dt><dd>${Q(t.total||0)}</dd></div>
        <div><dt>估算体积</dt><dd>${Zi(t.estimatedBytesRange?.min||0)} - ${Zi(t.estimatedBytesRange?.max||0)}</dd></div>
        <div><dt>建议上限</dt><dd>${Q(t.maxTiles||0)}</dd></div>
        <div><dt>建议</dt><dd>${t.withinLimit?`可以创建`:`任务较大，建议设置请求间隔`}</dd></div>
      </dl>
      <p>${Ta(t)}</p>
    </div>
  `:`<div class="admin-estimate" data-precache-estimate><p>停止移动地图后会自动估算任务规模</p></div>`}function Ca(e){let t=e.root?.querySelector(`[data-precache-estimate]`);t&&(t.outerHTML=Sa(e))}function wa(e){return e.length?e.map(e=>`Z${e.z}: ${e.count}`).join(`，`):`暂无分级明细`}function Ta(e){if(e.targetType===`layer`){let t=e.sources||[];return t.length?t.map(e=>`${e.sourceName||e.sourceId}: ${e.total||0} 张，约 ${Zi(e.estimatedBytes||0)}`).join(`，`):`暂无可预缓存图源明细`}return wa(e.ranges||[])}function Ea(e){return`
    <section class="admin-panel admin-panel-wide admin-precache-task-panel" data-precache-task-panel>
      ...
      <div class="admin-task-list">
        ${e.slice(0,10).map(e=>Da(e)).join(``)||`<p class="admin-empty">暂无任务</p>`}
      </div>
    </section>
  `}function Da(e){let t=e.expanded;return`
    <article class="admin-task-card">
      <div class="admin-task-main">
        <div class="admin-task-title">
          <span class="admin-status admin-status-${e.status}" title="${Q(ma(e.status))}">${Q(ga(e.status))}</span>
          <strong>${Q(e.providerId)}</strong>
          <small>${$i(e.updatedAt)}</small>
        </div>
        ${Oa(e)}
      </div>
      <dl class="admin-task-summary">
        <div><dt>体积</dt><dd>${Zi(e.bytes||0)}</dd></div>
  ...
  `}function Oa(e){let t=Number(e.completed||0),n=Number(e.total||0),r=n?Math.min(100,Math.round(t/n*100)):0;return`
    <div class="admin-task-progress">
      <span>${Q(t)} / ${Q(n)} (${r}%)</span>
      <small>成功 ${Q(e.succeeded||0)}，失败 ${Q(e.failed||0)}</small>
    </div>
  `}function ka(e){let t=[`queued`,`running`].includes(e.status),n=[`paused`,`interrupted`,`failed`,`completed_with_errors`].includes(e.status),r=e.status!==`deleting`,i=e.expanded?`收起`:`详情`;return`
  ...
  `}function Aa(e){let t=e.bounds||{},n=e.ranges||[],r=e.errors||[],i=Object.values(e.failedTiles||{});return`
    <div class="admin-task-details">
      <dl>
        <div><dt>区域</dt><dd>西 ${Q(t.west)} / 南 ${Q(t.south)} / 东 ${Q(t.east)} / 北 ${Q(t.north)}</dd></div>
        <div><dt>级别明细</dt><dd>${wa(n)}</dd></div>
        <div><dt>失败待重试</dt><dd>${Q(i.length)}</dd></div>
        <div><dt>创建时间</dt><dd>${$i(e.createdAt)}</dd></div>
        <div><dt>完成时间</dt><dd>${$i(e.finishedAt)}</dd></div>
      </dl>
      ${i.length?`
  ...
  `}function ja(e,t){Ya(e,t);let n=t.elements.providerId,r=n.options[n.selectedIndex]?.getAttribute(`data-type`)||`source`,i=n.value;return{targetType:r,targetId:i,providerId:i,bounds:{west:Number(t.elements.west.value),south:Number(t.elements.south.value),east:Number(t.elements.east.value),north:Number(t.elements.north.value)},minZoom:Number(t.elements.minZoom.value),maxZoom:Number(t.elements.maxZoom.value),concurrency:Number(t.elements.concurrency.value),requestIntervalMs:Number(t.elements.requestIntervalMs.value),refresh:t.elements.refresh.checked}}function Ma(e,t){e.tasks=e.tasks.map(e=>e.id===t.id?t:e)}function Na(e,t){e.tasks=e.tasks.filter(e=>e.id!==t)}function Pa(e){let t=e.root?.querySelector(`[data-precache-task-panel]`);t&&(t.outerHTML=Ea(ya(e)))}function Fa(e){return Array.isArray(e)?`[${e.map(Fa).join(`,`)}]`:e&&typeof e==`object`?`{${Object.keys(e).sort().map(t=>`${JSON.stringify(t)}:${Fa(e[t])}`).join(`,`)}}`:JSON.stringify(e)}function Ia(e){la+=1,ua=``,e.precacheEstimate=null,e.precacheEstimateStatus=``,e.precacheEstimateError=``,Ca(e)}function La(e,t,n=aa){e.activeTab===`precache`&&(window.clearTimeout(ca),ca=window.setTimeout(()=>{Ra(e,t)},n))}async function Ra(e,t){if(e.activeTab!==`precache`)return;let n=e.root?.querySelector(`[data-precache-form]`);if(!n)return;let r=ja(e,n),i=Fa(r);if(i===da||i===ua)return;let a=la+1;la=a,ua=i,e.precacheEstimateStatus=`loading`,e.precacheEstimateError=``,Ca(e);try{let n=await t.estimateTask(r);if(a!==la)return;e.precacheEstimate=n,e.precacheEstimateStatus=``,e.precacheEstimateError=``,da=i,ua=``,Ca(e)}catch(t){if(a!==la)return;e.precacheEstimate=null,e.precacheEstimateStatus=``,e.precacheEstimateError=t.message,ua=``,Ca(e)}}function za(e,t,n=oa){window.clearTimeout(fa),!(e.activeTab!==`precache`||!ba(e.tasks))&&(fa=window.setTimeout(()=>{Ba(e,t)},n))}async function Ba(e,t){if(e.activeTab!==`precache`)return;let n=pa+1;pa=n;try{let r=await t.tasks();if(n!==pa||e.activeTab!==`precache`)return;e.tasks=r,Pa(e),za(e,t)}catch(n){console.warn(`预缓存任务状态刷新失败`,n),za(e,t,oa*2)}}async function Va({api:e,event:t,renderDashboard:n,setNotice:r,state:i}){let a=t.target.closest(`[data-precache-form]`),o=t.target.closest(`[data-place-search-form]`);if(a)return t.preventDefault(),e.createTask(ja(i,a)).then(t=>{Array.isArray(t)?(i.tasks=[...t,...i.tasks],r(`成功创建了 ${t.length} 个图源缓存子任务`)):(i.tasks=[t,...i.tasks],r(`预缓存任务已创建`)),n(),za(i,e,300)}).catch(e=>{r(``,e.message),n()}),!0;if(o){t.preventDefault();let e=o.elements.keyword.value.trim();return e&&await eo(i,e),!0}return!1}async function Ha({api:e,event:t,renderDashboard:n,setNotice:r,showCheckboxConfirm:i,showConfirm:a,state:o}){let s=t.target.closest(`[data-precache-task-action]`);if(s)return await Wa({actionTarget:s,api:e,renderDashboard:n,setNotice:r,showCheckboxConfirm:i,showConfirm:a,state:o}),!0;let c=t.target.closest(`[data-place-lng][data-place-lat]`);return c?(Qa(o,Number(c.getAttribute(`data-place-lng`)),Number(c.getAttribute(`data-place-lat`))),!0):t.target.closest(`[data-admin-action]`)?.getAttribute(`data-admin-action`)===`sync-bounds`?(Ja(o),Ia(o),La(o,e),!0):!1}async function Ua({api:e,event:t,state:n}){let r=t.target.closest(`[data-precache-form]`);return r?(Ya(n,r),Ia(n),La(n,e),!0):!1}async function Wa({actionTarget:e,api:t,renderDashboard:n,setNotice:r,showCheckboxConfirm:i,showConfirm:a,state:o}){let s=e.getAttribute(`data-precache-task-action`),c=e.getAttribute(`data-task-id`),l=o.tasks.find(e=>e.id===c);if(!(!s||!c))try{if(s===`pause`){Ma(o,await t.pauseTask(c)),r(`预缓存任务已暂停`),n(),za(o,t,300);return}if(s===`resume`){Ma(o,await t.resumeTask(c)),r(`预缓存任务已继续`),n(),za(o,t,300);return}if(s===`delete`){let e=!1;if(i instanceof Function){let t=await i(`删除此预缓存任务？执行中的任务会停止并从列表移除。`,{confirmText:`删除`,checkboxLabel:`同时删除该任务范围内已缓存的瓦片文件`});if(!t?.confirmed)return;e=!!t.checked}else if(!await a(`删除此预缓存任务？执行中的任务会停止并从列表移除。`))return;await t.deleteTask(c,{deleteCache:e}),Na(o,c),r(e?`预缓存任务已删除，关联缓存文件清理已提交`:`预缓存任务已删除`),n();return}if(s===`edit`&&l){Za(o,l),Ia(o),La(o,t),r(`任务参数已回填，可调整后创建新任务`),n();return}if(s===`update`&&l){o.tasks=[await t.createTask({providerId:l.providerId,bounds:l.bounds,minZoom:l.minZoom,maxZoom:l.maxZoom,concurrency:l.concurrency,requestIntervalMs:l.requestIntervalMs||0,refresh:!1}),...o.tasks],r(`更新任务已创建，将跳过新鲜缓存并补齐缺失瓦片`),n(),za(o,t,300);return}if(s===`toggle-details`){o.expandedTaskIds.has(c)?o.expandedTaskIds.delete(c):o.expandedTaskIds.add(c),n();return}s===`preview`&&l&&(window.location.href=Xa(l))}catch(e){r(``,e.message),n(),za(o,t,300)}}async function Ga(e){return e.AMap?e.AMap:(window._AMapSecurityConfig={securityJsCode:_.securityJsCode},e.amapLoader?(e.AMap=await e.amapLoader.load({key:_.key,version:`2.0`,plugins:_.plugins}).catch(e=>(console.warn(`高德 JSAPI 加载失败，后台地点搜索不可用`,e),null)),e.AMap):(console.warn(`高德 JSAPI Loader 未初始化，后台地点搜索不可用`),null))}function Ka(e){let t=e.root.querySelector(`[data-precache-form]`);return{west:Number(t?.elements.west.value),south:Number(t?.elements.south.value),east:Number(t?.elements.east.value),north:Number(t?.elements.north.value)}}function qa(e,t){let n=e.root.querySelector(`[data-precache-form]`);n&&(n.elements.west.value=t.getWest().toFixed(6),n.elements.south.value=t.getSouth().toFixed(6),n.elements.east.value=t.getEast().toFixed(6),n.elements.north.value=t.getNorth().toFixed(6),Ya(e,n))}function Ja(e){if(!e.map||!e.rectangle)return;let t=e.map.getBounds();e.rectangle.setBounds(t),qa(e,t)}function Ya(e,t){return t?(e.precacheForm={providerId:t.elements.providerId.value,bounds:{west:Number(t.elements.west.value),south:Number(t.elements.south.value),east:Number(t.elements.east.value),north:Number(t.elements.north.value)},minZoom:Number(t.elements.minZoom.value),maxZoom:Number(t.elements.maxZoom.value),concurrency:Number(t.elements.concurrency.value),requestIntervalMs:Number(t.elements.requestIntervalMs.value),refresh:t.elements.refresh.checked},e.precacheForm):null}function Xa(e){let t=e.bounds||{},n=(Number(t.south)+Number(t.north))/2,r=(Number(t.west)+Number(t.east))/2,i=Number(e.maxZoom||e.minZoom||ee.zoom);if(!Number.isFinite(n)||!Number.isFinite(r))return`/`;let a=[n.toFixed(6),r.toFixed(6),Math.max(3,Math.min(20,i)),0].join(`,`);return`/?coords=${encodeURIComponent(a)}`}function Za(e,t){if(!t)return;let n=t.bounds||{};e.precacheForm={providerId:t.providerId||e.precacheForm?.providerId||``,bounds:{west:Number(n.west),south:Number(n.south),east:Number(n.east),north:Number(n.north)},minZoom:Number(t.minZoom),maxZoom:Number(t.maxZoom),concurrency:Number(t.concurrency||e.precacheForm?.concurrency||4),requestIntervalMs:Number(t.requestIntervalMs||e.precacheForm?.requestIntervalMs||0),refresh:!1}}function Qa(e,t,n,r=15){e.map&&(e.map.setView([n,t],r),Ja(e),e.onPrecacheBoundsChange instanceof Function&&e.onPrecacheBoundsChange())}function $a(e,t){za(e,t);let n=e.root.querySelector(`#admin-precache-map`);if(!n)return;e.precacheMapHeight&&(n.style.height=`${e.precacheMapHeight}px`),e.onPrecacheBoundsChange=()=>La(e,t),document.querySelectorAll(`.amap-sug-result`).forEach(e=>e.remove()),e.map&&(e.map.remove(),e.map=null,e.rectangle=null);let r=p.default.map(n,{center:ee.center,zoom:Math.min(ee.zoom,13),zoomControl:!0,attributionControl:!1});p.default.tileLayer(ea(v,`https://webst01.is.autonavi.com/appmaptile?style=8&x={x}&y={y}&z={z}`),{minZoom:3,maxZoom:18,keepBuffer:4}).addTo(r);let i=Ka(e),a=p.default.latLngBounds([i.south,i.west],[i.north,i.east]);e.rectangle=p.default.rectangle(a,{color:`#0f766e`,weight:2,fillColor:`#f59e0b`,fillOpacity:.14}).addTo(r);let o=!1;r.fitBounds(a),r.on(`moveend zoomend`,()=>Ja(e)),r.on(`moveend zoomend`,()=>{o&&e.onPrecacheBoundsChange instanceof Function&&e.onPrecacheBoundsChange()}),window.requestAnimationFrame(()=>{o=!0}),e.map=r;let s=e.root.querySelector(`[data-place-search-form] input[name="keyword"]`);s&&(s.id=`admin-precache-search-input`,Ga(e).then(t=>{t&&t.AutoComplete&&new t.AutoComplete({input:`admin-precache-search-input`}).on(`select`,t=>{if(t.poi?.location){let{lng:n,lat:r}=t.poi.location;Qa(e,n,r)}})}));let c=e.root.querySelector(`.admin-map-resizer`);if(c&&n){let t=0,r=0,i=e=>{t=e.clientY,r=n.offsetHeight,document.addEventListener(`pointermove`,a),document.addEventListener(`pointerup`,o),c.classList.add(`is-dragging`),e.preventDefault()},a=i=>{let a=i.clientY-t,o=Math.min(800,Math.max(150,r+a));n.style.height=`${o}px`,e.precacheMapHeight=o,e.map&&e.map.invalidateSize()},o=()=>{document.removeEventListener(`pointermove`,a),document.removeEventListener(`pointerup`,o),c.classList.remove(`is-dragging`)};c.addEventListener(`pointerdown`,i)}}async function eo(e,t){let n=e.root.querySelector(`[data-place-search-results]`);if(!n)return;let r=await Ga(e);if(!r){n.innerHTML=`<p>高德搜索暂不可用</p>`;return}let i=new r.PlaceSearch({pageSize:8,pageIndex:1});n.innerHTML=`<p>正在搜索</p>`,i.search(t,(e,t)=>{if(e!==`complete`||!t?.poiList?.pois?.length){n.innerHTML=`<p>没有找到匹配地点</p>`;return}n.innerHTML=t.poiList.pois.map(e=>{let t=e.location;return`
        <button type="button" data-place-lng="${t.lng}" data-place-lat="${t.lat}">
          <strong>${Q(e.name)}</strong>
          <span>${Q(e.address||e.district||``)}</span>
        </button>
      `}).join(``)})}var to=4;function no(e){let t=e.settings?.access||{},n=e.settings?.auth||{},r=n.tokenTtl?Math.round(n.tokenTtl/(1e3*60*60*24)):15;return`
    <div class="admin-grid">
      <section class="admin-panel">
        <div class="admin-panel-head">
          <h2>访问控制</h2>
        ...
        <form class="admin-form" data-access-form autocomplete="off">
          ...
          <label>
            <span>设置访问密码</span>
            <input name="accessPassword" type="password" autocomplete="new-password" placeholder="${t.hasPassword?`已设置，输入新密码以修改`:`输入至少 ${to} 位访问密码`}">
          </label>
          ${t.hasPassword?`
            <label class="admin-check">
...
`):`// 当前组合图层没有可用图源`;return`
  ...
  `}function Ro(e={},t=[],n=[],r=`proxy`){let i=[`fixed`,`pool`].includes(e.mode)?e.mode:`never`;return`
    <div class="form-grid">
  ...
  `}function zo(e,t){let n=Number.isFinite(Number(e))?Math.max(0,Number(e)):t;return{days:Math.floor(n/fo),hours:Math.floor(n%fo/uo),minutes:Math.floor(n%uo/lo)}}function Bo(e,t,n,r){let i=zo(n,r);return`
    <div class="field-group">
      <label>${t}</label>
  ...
  `}function Vo(e={},t=`cache`){return`
    <div class="checkbox-group">
      <input type="checkbox" id="${t}_enabled" name="${t}_enabled" ${e.enabled===!1?``:`checked`}>
      <label for="${t}_enabled">启用服务端缓存</label>
    </div>
    <div class="form-grid" style="margin-top:10px;">
      ${Bo(`${t}_ttl`,`缓存有效时间`,e.ttlMs,so)}
      ${Bo(`${t}_staleTtl`,`软过期时间`,e.staleTtlMs,co)}
    </div>
  `}function Ho(e,t,n=`proxy`){return{mode:t.get(`${n}_mode`)||`never`,outboundId:t.get(`${n}_outboundId`)||``,poolId:t.get(`${n}_poolId`)||``,fallbackToDirect:!!e.elements[`${n}_fallbackToDirect`]?.checked}}function Uo(e,t){let n=Math.max(0,parseInt(e.get(`${t}_days`)||`0`,10)||0),r=Math.max(0,parseInt(e.get(`${t}_hours`)||`0`,10)||0),i=Math.max(0,parseInt(e.get(`${t}_minutes`)||`0`,10)||0);return n*fo+r*uo+i*lo}function Wo(e,t,n=`cache`){return{enabled:!!e.elements[`${n}_enabled`]?.checked,ttlMs:Uo(t,`${n}_ttl`),staleTtlMs:Uo(t,`${n}_staleTtl`)}}function Go(e,t){return String(e.get(t)||``).split(`,`).map(e=>e.trim()).filter(Boolean)}function Ko(e){return{template:String(e.get(`entry_template`)||``).trim(),styleJsonUrl:String(e.get(`entry_styleJsonUrl`)||``).trim(),tileJsonUrl:String(e.get(`entry_tileJsonUrl`)||``).trim(),pmtilesUrl:String(e.get(`entry_pmtilesUrl`)||``).trim(),glyphsUrl:String(e.get(`entry_glyphsUrl`)||``).trim(),spritesUrl:String(e.get(`entry_spritesUrl`)||``).trim()}}function qo(e,t){return{required:!!e.elements.secrets_required?.checked,keyPoolId:t.get(`secrets_keyPoolId`)||``,placement:t.get(`secrets_placement`)||`query`,paramName:t.get(`secrets_paramName`)||`key`}}function Jo(e,t){return{engine:t.get(`rendering_engine`)||`leaflet`,clients:[e.elements.rendering_client_2d?.checked?`2d`:``,e.elements.rendering_client_3d?.checked?`3d`:``].filter(Boolean),fallbackRasterSourceId:t.get(`rendering_fallbackRasterSourceId`)||``}}function Yo(e,t){return{attribution:t.get(`license_attribution`)||``,termsUrl:t.get(`license_termsUrl`)||``,officialStatus:t.get(`license_officialStatus`)||`official`,licenseType:t.get(`license_licenseType`)||`unknown`,cacheAllowedByLicense:!!e.elements.license_cacheAllowedByLicense?.checked,publicUseAllowed:!!e.elements.license_publicUseAllowed?.checked,chinaPublicUseReviewed:!!e.elements.license_chinaPublicUseReviewed?.checked,chinaPublicUseRisk:t.get(`license_chinaPublicUseRisk`)||``}}function Xo(e,t){let n=Array.from(e.querySelectorAll(`[data-key-row]`)).map(e=>{let t=t=>e.querySelector(`[name="${t}"]`),n={id:t(`key_id`)?.value||``,alias:t(`key_alias`)?.value||``,enabled:!!t(`key_enabled`)?.checked,secretType:t(`key_secretType`)?.value||`api_key`,placement:t(`key_placement`)?.value||`query`,paramName:t(`key_paramName`)?.value||`key`,priority:parseInt(t(`key_priority`)?.value||`100`,10),weight:parseInt(t(`key_weight`)?.value||`1`,10),qpsLimit:parseInt(t(`key_qpsLimit`)?.value||`0`,10),dailyLimit:parseInt(t(`key_dailyLimit`)?.value||`0`,10),monthlyLimit:parseInt(t(`key_monthlyLimit`)?.value||`0`,10)},r=t(`key_secret`)?.value||``;return r&&(n.secret=r),n});return{id:t.get(`id`),name:t.get(`name`),vendor:t.get(`vendor`),enabled:!!e.elements.enabled?.checked,scope:t.get(`scope`)||`global`,strategy:t.get(`strategy`)||`round_robin`,cooldownMs:parseInt(t.get(`cooldownMs`)||`300000`,10),maxRetriesPerRequest:parseInt(t.get(`maxRetriesPerRequest`)||`2`,10),defaultSecretType:t.get(`defaultSecretType`)||`api_key`,defaultPlacement:t.get(`defaultPlacement`)||`query`,defaultParamName:t.get(`defaultParamName`)||`key`,credentialUrl:String(t.get(`credentialUrl`)||``).trim(),allowedPresetIds:Go(t,`allowedPresetIds`),allowedSourceIds:Go(t,`allowedSourceIds`),keys:n,description:t.get(`description`)||``}}function Zo(e,t){if(!e.editingKeyPool||!t)return;let n=e.editingKeyPool.keys||[],r=new Map(n.filter(e=>e.id).map(e=>[e.id,e])),i=Xo(t,new FormData(t));i.keys=i.keys.map((e,t)=>({...n[t]||{},...r.get(e.id)||{},...e})),e.editingKeyPool={...e.editingKeyPool,...i}}function Qo(e={}){let t=e.entry||{};return`
  ...
  `}function $o(e={},t=[]){let n=e.secrets||{};return`
    <fieldset class="form-card" style="margin-top:15px; padding:15px; background:white;">
  ...
  `}function es(e={},t=[]){let n=e.rendering||{},r=n.clients||(Eo(e.kind)?[`2d`]:[`2d`,`3d`]),i=t.filter(e=>!Eo(e.kind)&&!Do(e.kind));return`
    <fieldset class="form-card" style="margin-top:15px; padding:15px; background:white;">
      ...
      <div class="form-grid">
        <div class="field-group">
          ...
          <select name="rendering_engine">
            ${Co(yo,n.engine||(Eo(e.kind)?`maplibre`:`leaflet`))}
          </select>
        </div>
        <div class="field-group">
  ...
  `}function ts(e={}){let t=e.license||{};return`
    <fieldset class="form-card" style="margin-top:15px; padding:15px; background:white;">
      ...
      <div class="form-grid">
        <div class="field-group">
          ...
          <select name="license_officialStatus">
            ${Co([[`official`,`官方`],[`unofficial`,`非官方`],[`community`,`社区`],[`internal`,`内部`]],t.officialStatus||`official`)}
          </select>
        </div>
        <div class="field-group">
          <label>授权类型</label>
          <select name="license_licenseType">
            ${Co([[`free`,`免费`],[`api-key`,`API Key`],[`commercial`,`商业授权`],[`unknown`,`未知`]],t.licenseType||`unknown`)}
          </select>
        </div>
      </div>
      <div class="checkbox-group" style="margin-top:0;">
  ...
  `}function ns(e={}){let t=Number(e.retina?.normalValue);return po[t]?String(t):`1`}function rs(e,t,n,r,i){let a=e!==!1,o=a?i:r;return`
    <button
      type="button"
      ...
      title="点击切换为${Q(o)}"
    >${Q(a?r:i)}</button>
  `}function is(e){let t=String(e||``).toUpperCase();return t===`HIT`?`<span class="badge-green">HIT</span>`:t===`MISS`?`<span class="badge-red">MISS</span>`:t===`BYPASS`?`<span class="badge-gray">BYPASS</span>`:t===`REVALIDATED`?`<span class="badge-blue">REVAL</span>`:t===`STALE`?`<span class="badge-blue">STALE</span>`:t===`ERROR`?`<span class="badge-red">ERROR</span>`:`<span class="badge-gray">${Q(t||`-`)}</span>`}function as(e){let t=Number(e.statusCode||0);return t>=200&&t<300?`<span class="badge-green">200 OK</span>`:`<span class="badge-red" title="${Q(e.errorMessage||``)}">${Q(e.statusCode||`-`)}</span>`}function os(e){return e.proxyOutboundId?`<span class="badge-blue" title="池: ${Q(e.proxyPoolId||``)}">${Q(e.proxyOutboundId)}</span>`:e.proxyPoolId?`<span class="badge-blue">${Q(e.proxyPoolId)}</span>`:e.proxyConfigured?`<span class="badge-red" title="已配置代理，但本次未命中可用出口">代理未命中</span>`:`<span style="color:#94a3b8;">直连</span>`}async function ss(e,t,n={}){let{tileSources:r=!1,sourcePresets:i=!1,keyPools:a=!1,mapLayers:o=!1,externalPublishes:s=!1,precacheCatalog:c=!0}=n,l=[],u=[];r&&(l.push(t.listTileSources()),u.push(t=>{e.tileSources=t})),i&&(l.push(t.listSourcePresets()),u.push(t=>{e.sourcePresets=t})),a&&(l.push(t.listKeyPools()),u.push(t=>{e.keyPools=t})),o&&(l.push(t.listMapLayers()),u.push(t=>{e.mapLayers=t})),s&&(l.push(t.listExternalPublishes()),u.push(t=>{e.externalPublishes=t})),c&&(l.push(t.precacheCatalog()),u.push(t=>{e.precacheCatalog=t})),(await Promise.all(l)).forEach((e,t)=>u[t](e))}function cs(e){e.tileSourcesSubTab=e.tileSourcesSubTab||`sources`;let t=[{id:`sources`,label:`图源`},{id:`presets`,label:`图源预设`},{id:`key-pools`,label:`密钥池`},{id:`layers`,label:`图层组合`},{id:`publishes`,label:`发布/API`},{id:`diagnostics`,label:`诊断日志`}],n=``;switch(e.tileSourcesSubTab){case`sources`:n=ls(e);break;case`presets`:n=us(e);break;case`key-pools`:n=fs(e);break;case`layers`:n=ps(e);break;case`publishes`:n=ms(e);break;case`diagnostics`:n=hs(e);break;default:n=`<p>未知子页面</p>`}return`
  ...
  `}function ls(e){let t=e.tileSources||[],n=e.editingTileSource;if(n){let r=!t.some(e=>e.id===n.id),i=e.proxyOutbounds||[],a=e.proxyPools||[],o=e.keyPools||[],s=ns(n),c=n.category||`custom`,l=n.kind||`xyz-raster`;return`
      <div class="form-card">
        ...
        <form data-tile-sources-form="source">
          ...
          <div class="form-grid">
            ...
            <div class="field-group">
              <label>适配器</label>
              <input name="adapter" value="${Q(n.adapter||(Eo(l)?`maplibre-style`:`template`))}" placeholder="template / wmts-kvp / maplibre-style / pmtiles">
            </div>
          </div>
          <div class="form-grid">
            <div class="field-group">
    ...
    <table class="item-table">
      ...
      <tbody>
        ${t.map(t=>{let n=e[`test_source_${t.id}`]||``,r=ko(t);return`
            <tr>
              <td>
              ...
              <td>
                ...
                <span class="badge-blue" style="margin-left:4px;">${Q(To(t.kind))}</span>
                <span class="badge-gray" style="margin-left:4px;">${Q(Io(t))}</span>
              </td>
              <td>
              ...
              <td>
                ${rs(t.enabled,`source`,t.id,`启用中`,`已禁用`)}
              </td>
              <td>
                <div style="display: flex; flex-direction: column; align-items: flex-start; gap: 4px;">
                  ...
                  ${n&&n!==`loading`&&!n.success?`<span class="test-status test-fail" style="margin-left: 0;" title="${Q(So(n))}">失败</span>`:``}
                </div>
              </td>
              <td>
  ...
  `}function us(e){let t=e.sourcePresets||[],n=e.keyPools||[],r=e.creatingSourceFromPreset;if(r){let e=t.find(e=>e.presetId===r.presetId)||r,i=No(e,n),a=r.keyPoolId||i?.id||``,o=e.status===`ready`;return`
      <div class="form-card">
        ...
        <form data-tile-sources-form="preset-source">
          ...
          <div class="form-grid">
            <div class="field-group">
              <label>预设类型</label>
              <input value="${Q(`${e.vendor||`custom`} / ${To(e.kind)}`)}" readonly>
            </div>
            <div class="field-group">
              <label>关联密钥池</label>
              ...
              ${i?`<p style="color:#64748b; font-size:12px; margin:6px 0 0;">已自动匹配：${Q(i.name)} ${Po(i)}</p>`:``}
            </div>
          </div>
    ...
    <table class="item-table">
      ...
      <tbody>
        ${t.map(e=>{let t=ko(e),r=No(e,n);return`
            <tr>
              <td>
                <strong>${Q(e.name)}</strong>
              ...
              <td>
                ...
                <span class="badge-blue" style="margin-left:4px;">${Q(To(e.kind))}</span>
              ...
              <td>
                ...
                ${r?`<div style="margin-top:4px;"><span class="badge-gray">${Q(r.name)}</span> ${Po(r)}</div>`:``}
              </td>
              <td>${jo(e.status)}</td>
              <td>
                ${Ao(e.cacheAllowedByLicense!==!1,`可缓存`,`禁缓存`)}
                ${Ao(!!e.publicUseAllowed,`可公开`,`慎公开`)}
              </td>
              <td>
  ...
  `}function ds(e,t=!1,n={}){return(e.keys||[]).map((r,i)=>{let a=n[`test_key_${e.id}_${r.id}`]||``,o=!r.hasSecret&&!r.maskedPreview,s=r.secretType||e.defaultSecretType||`api_key`,c=r.placement||e.defaultPlacement||`query`,l=r.paramName||e.defaultParamName||`key`;return`
      <div class="key-row" data-key-row="${i}">
        <div class="key-row-main">
          ...
          <select name="key_secretType">
            ${wo(s,[[`api_key`,`api_key`],[`token`,`token`],[`tk`,`tk`],[`ak`,`ak`],[`appid`,`appid`]])}
            ${Co([[`api_key`,`api_key`],[`token`,`token`],[`tk`,`tk`],[`ak`,`ak`],[`appid`,`appid`]],s)}
          </select>
        </div>
        <div class="key-row-main">
        ...
        <div class="flex-actions">
          ...
          ${a&&a!==`loading`&&!a.success?`<span class="test-status test-fail" title="${Q(So(a))}">不可用</span>`:``}
        </div>
      </div>
    `}).join(``)||`<p style="color:#64748b;">暂无 Key，请添加至少一个 Key。</p>`}function fs(e){let t=e.keyPools||[],n=e.sourcePresets||[],r=e.tileSources||[],i=e.editingKeyPool;if(i){let a=!t.some(e=>e.id===i.id);return`
      <div class="form-card">
          ...
          <div class="form-grid">
            <div class="field-group">
              ...
              <select name="defaultSecretType">
                ${wo(i.defaultSecretType||`api_key`,[[`api_key`,`api_key`],[`token`,`token`],[`tk`,`tk`],[`ak`,`ak`],[`appid`,`appid`]])}
                ${Co([[`api_key`,`api_key`],[`token`,`token`],[`tk`,`tk`],[`ak`,`ak`],[`appid`,`appid`]],i.defaultSecretType||`api_key`)}
              </select>
            </div>
            <div class="field-group">
              ...
              <div style="display:grid; grid-template-columns: 1fr 1fr; gap:8px;">
                <select name="defaultPlacement">
                  ${Co(go,i.defaultPlacement||`query`)}
                </select>
        ...
        ${t.map(t=>{let n=e[`test_key_pool_${t.id}`]||``,r=(t.keys||[]).filter(e=>e.enabled!==!1).length;return`
            <tr>
              <td>
                <strong>${Q(t.name)}</strong>
                <div style="color:#64748b; font-size:11px; margin-top:2px;">${Q(t.id)}</div>
                ${t.credentialUrl?`<div style="margin-top:4px;">${Po(t,`申请 / 管理 Key`)}</div>`:``}
              </td>
              <td>
                <span class="badge-gray">${Q(t.vendor)}</span>
                <span class="badge-blue" style="margin-left:4px;">${Q(_o.find(([e])=>e===t.strategy)?.[1]||t.strategy)}</span>
              ...
              <td>
                ...
                ${n&&n!==`loading`&&!n.success?`<span class="test-status test-fail" title="${Q(So(n))}">失败</span>`:``}
              </td>
              <td>${rs(t.enabled,`key-pool`,t.id,`启用中`,`已禁用`)}</td>
              <td>
                <div class="flex-actions">
  ...
  `}function ps(e){let t=e.mapLayers||[],n=e.editingMapLayer;if(n){let r=!t.some(e=>e.id===n.id),i=e.tileSources||[],a=n.items||[{sourceId:``,opacity:1,zIndex:0}];return`
      <div class="form-card">
              ...
              ${a.map((e,t)=>`
                <div class="layer-item-row" data-layer-item-index="${t}">
                  ...
                  <select name="item_sourceId" required>
                    ...
                    ${i.map(t=>`<option value="${t.id}" ${e.sourceId===t.id?`selected`:``}>${Q(t.name)} (${t.id} / ${To(t.kind)})</option>`).join(``)}
                  </select>
      ...
      <tbody>
        ${t.map(t=>`
          <tr>
            ...
            <td>
              ${rs(t.enabled,`layer`,t.id,`启用中`,`已禁用`)}
            </td>
            <td>
  ...
  `}function ms(e){let t=e.externalPublishes||[],n=e.editingExternalPublish,r=e.selectedPublishId||t[0]?.id||``;if(n){let r=!t.some(e=>e.id===n.id),i=e.tileSources||[],a=i.filter(e=>e.visibility?.scope!==`external_only`&&e.permissions?.externalApiAllowed!==!1),o=i.filter(e=>e.visibility?.scope===`external_only`),s=e.mapLayers||[],c=e.proxyOutbounds||[],l=e.proxyPools||[],u=n.targetType||`source`,d=u===`layer`?s.map(e=>`<option value="${e.id}" ${n.targetId===e.id?`selected`:``}>${Q(e.name)} (${e.id})</option>`).join(``):u===`dedicated_source`?o.map(e=>`<option value="${e.id}" ${n.targetId===e.id?`selected`:``}>${Q(e.name)} (${e.id} / ${To(e.kind)})</option>`).join(``):a.map(e=>`<option value="${e.id}" ${n.targetId===e.id?`selected`:``}>${Q(e.name)} (${e.id} / ${To(e.kind)})</option>`).join(``),f=n.overrides?.proxy||null,p=n.overrides?.cache||null;return`
      <div class="form-card">
        ...
        <form data-tile-sources-form="publish">
          ...
          <div class="form-grid">
            ...
            <div class="field-group">
              ...
              <select name="targetId" required>
                <option value="">请选择${Q(Fo(u))}</option>
                ${d}
              </select>
            </div>
          </div>
          ...
          <fieldset class="form-card" style="margin-top:15px; padding:15px; background:white;">
            ...
            ${Ro(f||{mode:`never`},c,l,`publish_proxy`)}
          </fieldset>
    ...
    `}let i=e.lastGeneratedToken?`<div class="admin-token-notice">
       ...
       </div>`:``,a=t.find(e=>e.id===r),o=``;return a&&(o=Lo(a,e)),`
    ${i}
      ...
      <tbody>
        ${t.map(t=>{let n=e[`test_publish_${t.id}`]||``;return`
            <tr style="background: ${t.id===r?`#f0fdfa`:`transparent`}; cursor:pointer;" data-tile-sources-select-publish="${t.id}">
              ...
              <td style="white-space: nowrap;"><span class="badge-gray">${Q(Fo(t.targetType))}</span></td>
              ...
              <td style="white-space: nowrap;">
                ${rs(t.enabled,`publish`,t.id,`已发布`,`已禁用`)}
              </td>
              <td style="white-space: nowrap;">
    ...
    ${o}
  `}function hs(e){e.diagnosticsLogType=e.diagnosticsLogType||`source`;let t=e.diagnosticsPublishId||``,n=e.diagnosticsSourceId||``,r=e.externalPublishes||[],i=e.tileSources||[],a=e.diagnosticsLogType===`source`,o=a?e.sourceAccessLogs||[]:e.diagnosticLogs||[],s=a?e.sourceAccessLogsError||``:e.diagnosticLogsError||``;return`
    <div class="admin-panel-head">
      <h3>运行诊断日志</h3>
      <div style="display:flex; gap:10px; align-items:center;">
    ...
    `}else a=`
            ...
            ${t.map(t=>{let n=e[`test_outbound_${t.id}`]||``;return`
                <tr>
                  ...
                  <td>
                    ...
                    ${n&&n!==`loading`&&!n.success?`<span class="test-status test-fail" title="${Q(Cs(n))}">失败: ${Q(Cs(n))}</span>`:``}
                  </td>
                  <td>
      ...
      <div>
        ...
        <table class="item-table">
          ...
          <tbody>
            ${n.map(t=>{let n=e[`test_pool_${t.id}`]||``,r=n&&n!==`loading`?ws(n):null;return`
                <tr>
                  <td>
                    <strong>${Q(t.name)}</strong>
                    <div style="color: #64748b; font-size:11px; margin-top:2px;">${Q(t.id)}</div>
  ...
  `}function Ls(e){e.root.innerHTML=`
  ...
  `}function Rs(e,t){e.root.innerHTML=`
    <section class="admin-shell">
      ...
      <div class="admin-layout">
        <nav class="admin-tabs" aria-label="后台导航">
          ${As.map(t=>`
            <a href="${js(t.id)}" data-admin-tab="${t.id}" class="${e.activeTab===t.id?`is-active`:``}">
              ${Q(t.label)}
            </a>
          `).join(``)}
        </nav>
  ...
  `}var $={root:null,activeTab:`overview`,loading:!1,message:``,error:``,session:null,system:null,cache:null,cacheLoading:!1,cacheError:``,visits:null,visitsLoading:!1,visitsError:``,settings:null,tasks:[],kmls:[],precacheForm:{providerId:``,bounds:{west:113.24,south:23.11,east:113.29,north:23.15},minZoom:12,maxZoom:12,concurrency:4,requestIntervalMs:0,refresh:!1},precacheEstimate:null,precacheEstimateStatus:``,precacheEstimateError:``,expandedTaskIds:new Set,amapLoader:null,AMap:null,map:null,rectangle:null,precacheMapHeight:260},zs=null;function Bs(e){zs=e}function Vs(e=``,t=``){$.message=e,$.error=t,zs&&zs(e,t)}function Hs(e){Ns(e)&&($.activeTab=e)}var Us=null;Bs((e,t)=>{Us&&=(clearTimeout(Us),null);let n=t||e;n&&n!==`正在加载`&&n!==`正在登录`&&(Us=setTimeout(()=>{Vs(``),document.querySelector(`[data-admin-login]`)?Ls($):qs()},4e3))});function Ws(){return Fs(window.location)}function Gs(e){window.history.replaceState(null,``,`${js(e)}${window.location.hash}`)}function Ks(){return Ms($.activeTab).render($)}function qs(){Rs($,Ks()),Ms($.activeTab).afterRender?.($,Ji)}window.renderDashboard=qs;function Js(e){return{api:Ji,event:e,renderDashboard:qs,setNotice:Vs,showCheckboxConfirm:Te,showConfirm:we,state:$}}function Ys(...e){(!e.length||e.includes($.activeTab))&&qs()}async function Xs(e,t){let n=Ms($.activeTab)[e];return n instanceof Function?!!await n(Js(t)):!1}async function Zs(e={}){let t=!!e.cacheOnly;Object.assign($,{cacheLoading:!0,cacheError:``,visitsLoading:t?$.visitsLoading:!0,visitsError:t?$.visitsError:``}),Ys(`overview`,`cache`),Ji.cache().then(e=>{$.cache=e,$.cacheError=``,e.refreshing&&window.setTimeout(()=>Zs({cacheOnly:!0}),1500)}).catch(e=>{$.cacheError=e.message}).finally(()=>{$.cacheLoading=!1,Ys(`cache`)}),!t&&Ji.visits().then(e=>{$.visits=e,$.visitsError=``}).catch(e=>{$.visitsError=e.message}).finally(()=>{$.visitsLoading=!1,Ys(`overview`)})}async function Qs(){$.loading=!0,Vs(`正在加载`),qs();try{let[e,t,n,r,i,a,o,s,c,l,u,d,f]=await Promise.all([Ji.session(),Ji.system(),Ji.settings(),Ji.tasks(),Ji.kmls(),Ji.listTileSources(),Ji.listSourcePresets(),Ji.listKeyPools(),Ji.listMapLayers(),Ji.listProxyOutbounds(),Ji.listProxyPools(),Ji.listExternalPublishes(),Ji.precacheCatalog()]);Object.assign($,{session:e,system:t,settings:n,tasks:r,kmls:i,tileSources:a,sourcePresets:o,keyPools:s,mapLayers:c,proxyOutbounds:l,proxyPools:u,externalPublishes:d,precacheCatalog:f,loading:!1}),Vs(``),qs(),Ms($.activeTab).afterLoad?.($,Ji),Zs()}catch(e){$.loading=!1,e.status===401?(qi(),Vs(``,e.message),Ls($)):(Vs(``,e.message),qs())}}async function $s(e){let t=e.target.closest(`[data-admin-login]`);if(t){e.preventDefault(),Vs(`正在登录`),Ls($);try{await Ki({username:t.elements.username.value,password:t.elements.password.value}),Vs(``),await Qs()}catch(e){Vs(``,e.message),Ls($)}return}await Xs(`handleSubmit`,e)}async function ec(e){let t=e.target.closest(`[data-admin-tab]`);if(t){e.preventDefault(),Hs(t.getAttribute(`data-admin-tab`)),Gs($.activeTab),qs(),Ms($.activeTab).afterEnter?.($,Ji);return}let n=e.target.closest(`[data-admin-action]`);if(n){let e=n.getAttribute(`data-admin-action`);if(e===`logout`){qi(),Vs(``),Ls($);return}if(e===`refresh`){await Qs();return}if(e===`close-notice`){Vs(``),document.querySelector(`[data-admin-login]`)?Ls($):qs();return}}await Xs(`handleClick`,e)}async function tc(e){await Xs(`handleChange`,e)}async function nc(e={}){if(document.body.classList.add(`admin-view`),Hs(Ws()),Gs($.activeTab),$.amapLoader=e.amapLoader||null,$.root=document.getElementById(`admin-root`),$.root.hidden=!1,$.root.addEventListener(`submit`,$s),$.root.addEventListener(`click`,ec),$.root.addEventListener(`change`,tc),$.root.addEventListener(`input`,tc),!Wi()){Ls($);return}await Qs()}function rc(){`serviceWorker`in navigator&&window.addEventListener(`load`,()=>{navigator.serviceWorker.register(`/sw.js`).catch(e=>{console.warn(`Service Worker 注册失败`,e)})})}async function ic(e){let{init:t,title:n=`私有地图服务`,message:r=`管理员启用了访问控制，请输入密码解锁`,submitText:i=`载入地图`,loadingText:a=`正在验证...`}=e;try{(await Yi()).required?ac({init:t,title:n,message:r,submitText:i,loadingText:a}):await t()}catch(e){console.error(`Failed to check map access status`,e),ac({init:t,title:n,message:`访问状态检查失败，请稍后重试`,submitText:i,loadingText:a,allowRetry:!0})}}function ac(e){let{init:t,title:n,message:r,submitText:i,loadingText:a,allowRetry:o=!1}=e;document.getElementById(`map-lock-screen`)?.remove();let s=document.createElement(`div`);s.id=`map-lock-screen`,s.className=`lock-screen-backdrop`,s.innerHTML=`
  ...
  `,document.body.appendChild(s);let c=document.getElementById(`lock-screen-form`),l=document.getElementById(`lock-screen-error`);s.querySelector(`[data-lock-retry]`)?.addEventListener(`click`,()=>{s.remove(),ic({init:t,title:n,submitText:i,loadingText:a})}),c.addEventListener(`submit`,async e=>{e.preventDefault(),l.style.display=`none`;let n=c.elements.password.value.trim();if(!n)return;let r=c.querySelector(`button[type="submit"]`);try{r.disabled=!0,r.textContent=a,await Xi(n),s.remove(),await t()}catch(e){r.disabled=!1,r.textContent=i,l.textContent=e.message||`访问密码错误`,l.style.display=`block`}})}export{ae as $,mt as A,it as B,yt as C,ht as D,Et as E,gt as F,Ee as G,Ce as H,wt as I,O as J,ye as K,ot as L,B as M,bt as N,ft as O,z as P,T as Q,Ze as R,Dt as S,Tt as T,De as U,Xe as V,we as W,M as X,A as Y,N as Z,Nt as _,Q as a,f as at,ct as b,ji as c,s as ct,ui as d,E as et,Ti as f,Pt as g,Ft as h,Ps as i,re as it,pt as j,St as k,Mi as l,u as lt,Rt as m,rc as n,ee as nt,Bi as o,d as ot,si as p,_e as q,nc as r,ne as rt,Vi as s,o as st,ic as t,_ as tt,Ai as u,l as ut,U as v,jt as w,V as x,st as y,Ye as z};